    ...
    items: [
      {
        ...
        items: [
          ...
          'user-documentation/moderne-platform/getting-started/proof-of-value-agent-tools',
...
const agentTools = {
  ...
  link: {
    ...
    keywords: ['agent', 'tools', 'ai', 'chat', 'prethink', 'trigrep', 'skills', 'mcp'],
  },
  items: [
    'user-documentation/agent-tools/agent-chat',
      ...
      items: [
        ...
        },
        {
          ...
          link: {
            ...
            slug: '/user-documentation/recipes/authoring-recipes/references',
            keywords: ['recipes', 'authoring', 'reference'],
          },
          items: [
            'user-documentation/recipes/authoring-recipes/references/yaml-format-reference',
            'user-documentation/recipes/authoring-recipes/references/method-patterns',
            'user-documentation/recipes/authoring-recipes/references/jsonpath-and-jsonpathmatcher-reference',
            'user-documentation/recipes/authoring-recipes/references/dependency-version-selectors',
            'user-documentation/recipes/authoring-recipes/references/framework-provided-markers',
            'user-documentation/recipes/authoring-recipes/references/type-attribution',
          ],
        },
      ],
    },
