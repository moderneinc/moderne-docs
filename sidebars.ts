...
import { PERSONA_CONFIGS } from './src/config/personaConfig';
...
const platform = {
  ...
  admin: {
    ...
    label: 'Platform',
    customProps: {
      personaSwitcher: PERSONA_CONFIGS['/administrator-documentation/moderne-platform']
    },
    link: {
      type: 'generated-index' as const,
      title: 'Moderne Platform',
...
const sidebars: SidebarsConfig = {
  docs: [
    'introduction',
    sectionDivider('User Documentation'),
    ...
    sectionDivider('Hands-on Learning'),
    ...handsOnLearning,
    sectionDivider('OpenRewrite Advanced Program Analysis'),
    ...openRewriteAdvanced,
    sectionDivider('Administrator Documentation'),
    platform.admin,
    dx,
    sharedReferences,
