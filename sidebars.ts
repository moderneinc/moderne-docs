        ...
        items: [
          'administrator-documentation/moderne-platform/how-to-guides/mass-ingest',
          {
            ...
            link: {
              ...
              slug: '/administrator-documentation/moderne-platform/connector-configuration',
              keywords: ['guides'],
            },
            items: [
              ...
              'administrator-documentation/moderne-platform/how-to-guides/connector-configuration/configure-a-connector-with-github',
              'administrator-documentation/moderne-platform/how-to-guides/connector-configuration/configure-a-connector-with-gitlab',
              'administrator-documentation/moderne-platform/how-to-guides/connector-configuration/configure-a-connector-with-maven-repository-access',
...
const platformV1 = {
  practitioner: {
    type: 'category' as const,
    label: 'Platform (SaaS v1)',
    customProps: {},
    link: {
      type: 'generated-index' as const,
      title: 'Moderne Platform (SaaS v1)',
      description: 'A secure platform and toolchain for fast, enterprise-wide code modernization.',
      slug: '/user-documentation/moderne-platform-v1',
      keywords: ['guides'],
    },
    items: [
      {
        ...
        link: {
          ...
          title: 'Getting started',
          description: 'Learn how to get started with the Moderne Platform.',
          slug: '/user-documentation/moderne-platform-v1/getting-started',
          keywords: ['guides'],
        },
        items: [
          'user-documentation/moderne-platform-v1/getting-started/running-your-first-recipe',
          'user-documentation/moderne-platform-v1/getting-started/proof-of-value-prerequisites',
          'user-documentation/moderne-platform-v1/getting-started/proof-of-value',
          'user-documentation/moderne-platform-v1/getting-started/code-quality',
          'user-documentation/moderne-platform-v1/getting-started/data-tables',
          'user-documentation/moderne-platform-v1/getting-started/visualizations',
      ...
      },
      {
        ...
        link: {
          ...
          title: 'How to guides',
          description: 'Learn how to work with the Moderne Platform.',
          slug: '/user-documentation/moderne-platform-v1/how-to-guides',
          keywords: ['guides'],
        },
        items: [
          'user-documentation/moderne-platform-v1/how-to-guides/find-pii',
          'user-documentation/moderne-platform-v1/how-to-guides/vulnerable-dependencies',
          'user-documentation/moderne-platform-v1/how-to-guides/addressing-cves',
          'user-documentation/moderne-platform-v1/how-to-guides/new-recipe-builder',
          'user-documentation/moderne-platform-v1/how-to-guides/introduction-to-type-aware-code-search',
          'user-documentation/moderne-platform-v1/how-to-guides/moderne-platform-search',
          'user-documentation/moderne-platform-v1/how-to-guides/accessing-the-moderne-api',
          'user-documentation/moderne-platform-v1/how-to-guides/recipe-execution-and-commits-with-graphql',
          'user-documentation/moderne-platform-v1/how-to-guides/managing-user-configured-organizations',
          'user-documentation/moderne-platform-v1/how-to-guides/create-api-access-tokens',
          'user-documentation/moderne-platform-v1/how-to-guides/preconditions',
      ...
      },
      {
        ...
        link: {
          ...
          title: 'References',
          description: 'Moderne Platform reference documentation.',
          slug: '/user-documentation/moderne-platform-v1/references',
          keywords: ['references'],
        },
        items: [
          'user-documentation/moderne-platform-v1/references/moderne-tokens',
          'user-documentation/moderne-platform-v1/references/create-scm-access-tokens',
        ],
      },
    ],
  },
  ...
  admin: {
    ...
    link: {
      ...
      slug: '/administrator-documentation/moderne-platform-v1',
      keywords: ['guides'],
    },
    items: [
      {
        ...
        link: {
          ...
          title: 'Getting started',
          description: 'Learn how to get started with the Moderne Platform as an administrator.',
          slug: '/administrator-documentation/moderne-platform-v1/getting-started',
          keywords: ['guides'],
        },
        items: [
          'administrator-documentation/moderne-platform-v1/getting-started/admin-pages',
        ],
      },
      {
        type: 'category' as const,
        ...
        link: {
          ...
          title: 'How to guides',
          description: 'Administrator setup and configuration documentation.',
          slug: '/administrator-documentation/moderne-platform-v1/how-to-guides',
          keywords: ['guides'],
        },
        items: [
          'administrator-documentation/moderne-platform-v1/how-to-guides/mass-ingest',
          {
            type: 'category' as const,
            label: 'Moderne Agent',
            link: {
              ...
              slug: '/administrator-documentation/moderne-platform-v1/agent-configuration',
              keywords: ['guides'],
            },
            items: [
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/agent-config',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-azure-devops-services',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-bitbucket-to-agent',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-bitbucket-cloud-to-agent',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-github',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-gitlab',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-maven-repository-access',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-artifactory-access',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configuring-artifactory-with-recipes',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-s3-access',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-pypi-access-visualizations',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-llm-for-moddy',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-organizations-hierarchy',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-generic-http-tools-for-use-in-recipes',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-strict-recipe-sources',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-client-ssl-certificates',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-a-moderne-tenant-ssl-certificate',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-to-connect-to-moderne-via-an-http-proxy',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-cli-download-instructions-override',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/configure-an-agent-with-ui-customizations',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/agent-variables',
              'administrator-documentation/moderne-platform-v1/how-to-guides/agent-configuration/multi-tenant-private-recipes',
            ],
          },
          'administrator-documentation/moderne-platform-v1/how-to-guides/creating-a-devcenter-recipe',
          'administrator-documentation/moderne-platform-v1/how-to-guides/recipe-based-devcenter',
          'administrator-documentation/moderne-platform-v1/how-to-guides/org-service',
          'administrator-documentation/moderne-platform-v1/how-to-guides/create-visualization',
          'administrator-documentation/moderne-platform-v1/how-to-guides/importing-external-recipes',
          'administrator-documentation/moderne-platform-v1/how-to-guides/lst-cleanup',
          'administrator-documentation/moderne-platform-v1/how-to-guides/troubleshooting-lst-issues',
          'administrator-documentation/moderne-platform-v1/how-to-guides/analyzing-build-failures',
        ],
      },
      {
        type: 'category' as const,
        ...
        link: {
          ...
          title: 'References',
          description: 'Administrator reference documentation for the Moderne Platform.',
          slug: '/administrator-documentation/moderne-platform-v1/references',
          keywords: ['reference'],
        },
        items: [
          'administrator-documentation/moderne-platform-v1/references/authentication',
          'administrator-documentation/moderne-platform-v1/references/reporting',
          'administrator-documentation/moderne-platform-v1/references/audit-logging',
          'administrator-documentation/moderne-platform-v1/references/architecture',
          'administrator-documentation/moderne-platform-v1/references/ai-architecture',
          'administrator-documentation/moderne-platform-v1/references/flow',
          'administrator-documentation/moderne-platform-v1/references/user-roles',
          'administrator-documentation/moderne-platform-v1/references/github-permissions',
          'administrator-documentation/moderne-platform-v1/references/how-moderne-applies-changes',
          'administrator-documentation/moderne-platform-v1/references/routing-requests-to-agents',
          'administrator-documentation/moderne-platform-v1/references/how-lst-artifacts-are-produced',
          'administrator-documentation/moderne-platform-v1/references/supported-scms',
          'administrator-documentation/moderne-platform-v1/references/standard-vs-enterprise-edition',
          'administrator-documentation/moderne-platform-v1/references/lossless-semantic-trees',
          {
            type: 'link' as const,
            label: 'GraphQL API reference',
            description: 'A link to the Moderne GraphQL API reference docs.',
      ...
      'administrator-documentation/moderne-platform-v1/faq',
    ],
  },
};
...
const recipes = {
  ...
  items: [
    ...
    },
    {
      ...
      // Recipe-catalog routes are excluded from Docusaurus' plugin-content-docs
      // and rendered by scripts/build-recipe-catalog/. The sidebar manifest
      // below (also generated by that script) ships these as `type: 'link'`
      // items so they appear in the nav without forcing MDX route loading.
      items: require('./src/sidebars/recipe-catalog.json') as any,
    },
    {
      type: 'category' as const,
      label: 'Lists',
      link: {
        type: 'generated-index' as const,
        title: 'Recipe lists',
        description: 'Browse recipes organized by module, tag, and more.',
        slug: '/user-documentation/recipes/lists',
        keywords: ['recipes', 'lists'],
      },
      items: [
        ...
        'user-documentation/recipes/lists/latest-versions-of-every-openrewrite-module',
      ],
    },
  ],
};
