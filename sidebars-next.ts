    ...
    items: [
      ...
      'administrator-documentation/moderne-platform/faq',
      {
        ...
        link: {
          ...
          slug: '/administrator-documentation/moderne-platform/shared-references',
          keywords: ['reference'],
        },
        items: [
  ...
  items: [
    ...
    },
    {
      ...
      link: {
        ...
        title: 'Shared references',
        description: 'Shared administrative reference documentation.',
        slug: '/administrator-documentation/moderne-dx/shared-references',
        keywords: ['reference'],
      },
      items: [
        'administrator-documentation/references/faq',
...
const handsOnLearning = {
  ...
  link: {
    ...
    description: 'Workshops and tutorials for learning OpenRewrite and Moderne.',
    slug: '/hands-on-learning',
    keywords: ['recipes', 'learning', 'workshop'],
  },
  items: [
    {
      type: 'category' as const,
