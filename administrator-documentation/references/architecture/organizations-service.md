...
* Communication with the Organizations service is done through the [Moderne agent](../../how-to-guides/agent-configuration/). Therefore, this service **must** be accessible from the agent.
