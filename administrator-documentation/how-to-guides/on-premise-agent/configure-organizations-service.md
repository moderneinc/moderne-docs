...
In order for Moderne to obtain information about your organizational structure, you will need to configure the Moderne agent to point to your [Organizations service](../../references/architecture/organizations-service.md). This guide will explain how to do that.
