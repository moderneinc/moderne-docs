...
To get started, run the [check for dependency vulnerabilities](https://public.moderne.io/recipes/org.openrewrite.java.dependencies.DependencyVulnerabilityCheck?) recipe:
