...
Get all currently active recipe runs by a user id (passed via header) sorted by most recent
...
<tr>
<td colspan="2" valign="top"><strong>githubOrganizations</strong></td>
<td valign="top">[<a href="#githuborganization">GithubOrganization</a>!]!</td>
<td>

Github Organizations the user belong to, includes public and private
...
Optional name to filter user's organizations by

</td>
</tr>
<tr>
<td colspan="2" valign="top"><strong>githubRepositories</strong></td>
<td valign="top">[<a href="#githubrepository">GithubRepository</a>!]!</td>
<td>

Github Repositories owned by the user directly, not an organization
...
Look up single recipe record by `id` \n
...
This query is only apart of MRE for the purposes of schema composition
...
Returns multiple recipes matching the list of strings provided
...
Captialization handled in services.
...
Sorted alphabetically by `RecipeCategory.name`
...
Example: {"fileType": "java", "count": 1392}
