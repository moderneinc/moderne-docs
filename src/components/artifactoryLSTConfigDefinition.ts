...
const artifactoryLSTConfigDefinition: ConfigDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        "The username used to connect to your Artifactory instance. This user must have permission to run AQL queries.",
      required: true,
      type: "text",
      defaultValue: "",
    },
    ...
    },
    {
      ...
      description:
        "The AQL query fragment used to select LST artifacts to send to Moderne. If multiple are specified, they are combined together with an AND.",
      required: true,
      type: "array",
      defaultValue: "",
    },
    {
      ...
      description:
        "Specifies whether or not to skip SSL verification for HTTP connections from the agent to this Artifactory instance.",
      required: false,
      type: "boolean",
      defaultValue: "false",
    },
