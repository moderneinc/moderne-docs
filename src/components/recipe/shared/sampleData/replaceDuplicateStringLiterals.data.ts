// AUTO-EXTRACTED from docs/user-documentation/recipes/recipe-catalog/staticanalysis/replaceduplicatestringliterals.md — real generated content for parity.
// Regenerate via scripts/.extract-preview-recipes.mjs if the source changes.

import type { ExtractedContent } from '../types';

export const replaceDuplicateStringLiteralsContent: ExtractedContent = {
  "tags": [
    "RSPEC-S1192",
    "RSPEC-S1889"
  ],
