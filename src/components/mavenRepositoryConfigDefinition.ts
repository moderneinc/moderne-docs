...
const mavenRepositoryConfigDefinition: ConfigDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        "Specifies whether or not this repository should be searched for releases.",
      required: false,
      type: "boolean",
      defaultValue: "true",
    },
    {
      ...
      description:
        "Specifies whether or not this repository should be searched for snapshots.",
      required: false,
      type: "boolean",
      defaultValue: "true",
    },
    {
      ...
      description:
        "Specifies whether or not this repository should be searched for LST artifacts. <strong>Set this to false if you configured Artifactory LST storage</strong>.",
      required: false,
      type: "boolean",
      defaultValue: "true",
    },
    ...
    },
    {
      ...
      description:
        "Whether or not to skip SSL/TLS verification for calls from the agent to this Maven repository. <strong>This must be set to true if you use a self-signed SSL/TLS certificate</strong>.",
      required: false,
      type: "boolean",
      defaultValue: "false",
    },
