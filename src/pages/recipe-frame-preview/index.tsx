    ...
    >
      <main className={styles.page}>
        <label
          ...
          title="Show design annotations, section rationale, and planning docs"
        >
          <input
            type="checkbox"
            checked={designMode}
            onChange={(e) => setDesignMode(e.target.checked)}
            className={styles.designToggleInput}
          />
          <span className={styles.designToggleTrack}>
            <span className={styles.designToggleThumb} />
          </span>
          <span className={styles.designToggleLabel}>Design mode</span>
        </label>
        ...
        <RecipeFrame recipe={recipe} designMode={designMode} />
      </main>
    </Layout>
  );
};
