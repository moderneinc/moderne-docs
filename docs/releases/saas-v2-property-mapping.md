...
| Agent                                                             | Connector                                                                                                                                                                                                            |
|:------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `moderne.agent.organization.repos-csv=https://internal/repos.csv` | `moderne.organization.sources.http[0].uri=https://internal/repos.csv` or `moderne.organization.sources.file[0].uri=/var/moderne/repos.csv` or `moderne.organization.sources.s3[0].uri=s3://my-bucket/repos-lock.csv` |
