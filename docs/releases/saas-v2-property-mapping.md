...
| `moderne.agent.organization.service.url=...`                      | `moderne.custom-integrations.organization-service.uri=...` (not auto-migrated; set it yourself -- see [Organizations service](../administrator-documentation/moderne-platform/how-to-guides/org-service.md))          |
