---
sidebar_label: "Module 1: Refaster recipes"
description: Exploring and writing Refaster recipes.
---

# Module 1: Refaster recipes
...
## Exercise 1a: Explore Refaster recipe support
...
## Exercise 1b: Create a Refaster recipe
...
3. Open the Refaster template [src/main/java/com/yourorg/StringIsEmpty.java](https://github.com/moderneinc/rewrite-recipe-starter/blob/main/src/main/java/com/yourorg/StringIsEmpty.java)
   * Using the knowledge gained in Exercise 1a, and the requirements from the test, write a Refaster recipe that matches various ways to check if a String is empty.
