...
3. Once the CLI is installed, please work through the [Moderne CLI workshop](../../user-documentation/moderne-cli/getting-started/moderne-cli-workshop) if you haven't already. (Please refrain from applying any recipe changes, though, as this may cause issues in future steps.)
