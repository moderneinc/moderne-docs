---
sidebar_label: "Module 3: Testing recipes"
description: Explore how to unit test recipes.
---

# Module 3: Testing recipes
...
## Exercise 3: Explore the various unit tests in the starter project
...
5. Open [src/test/java/com/yourorg/SimplifyTernaryTest.java](https://github.com/moderneinc/rewrite-recipe-starter/blob/main/src/test/java/com/yourorg/SimplifyTernaryTest.java).
   * Note how the instantiated recipe is a generated class, not the Refaster template class itself, as we saw in [Module 1](./module-1-refaster-recipes).
