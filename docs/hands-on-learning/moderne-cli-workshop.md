...
* You have [installed and configured the Moderne CLI](../user-documentation/moderne-cli/getting-started/cli-intro.md)
...
:::info
If you need to enter an SSH passphrase to clone repositories, please see our [SSH keys with passphrases guide](../user-documentation/moderne-cli/how-to-guides/ssh-key.md) before continuing.
:::
...
For more options, see the [CLI reference documentation](../user-documentation/moderne-cli/cli-reference.md#mod-git-push).
...
* [Layered configuration in the CLI](../user-documentation/moderne-cli/how-to-guides/layer-config-cli.md)
* [JDK selection and configuration](../user-documentation/moderne-cli/how-to-guides/jdk-selection-and-config.md)
* [Using the Moderne IntelliJ plugin with the CLI](../user-documentation/moderne-ide-integration/how-to-guides/moderne-plugin-install.md)
