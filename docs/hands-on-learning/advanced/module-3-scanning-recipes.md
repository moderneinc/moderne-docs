...
Before moving on to the following exercise, you should review the [OpenRewrite documentation](../../user-documentation/recipes/authoring-recipes/concepts/recipes.md#scanning-recipes) for more details about the different phases of scanning recipes and how they work.
