---
description: Interactive workshops to master OpenRewrite and Moderne.
---
...
[Start workshop →](./introduction/workshop-overview.md)
...
[Start workshop →](./fundamentals/workshop-overview.md)
...
[Start workshop →](./advanced/workshop-overview.md)
...
[Start workshop →](./spring-boot-migration/workshop-overview.md)
...
Looking for instructor-led training? Check out [upcoming live OpenRewrite training sessions](https://www.moderne.ai/moderne-openrewrite-training-hub).
