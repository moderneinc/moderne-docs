...
In this tutorial, we will walk through creating a practical data flow analysis recipe that detects dead code in a Java program. By the end, you will have a recipe that finds assignments to variables that are never used so you can remove those from your code.
