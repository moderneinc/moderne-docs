...
<VersionBanner version="v1" linkPath="/administrator-documentation/moderne-platform/how-to-guides/connector-configuration/configure-a-connector-with-maven-repository-access" />
...
| `MODERNE_AGENT_MAVEN_{index}_SKIPVALIDATECONNECTIVITY` | `false`                                               | `false`            | By default, on agent startup, we will validate that we can connect to this Maven repository, and fail to start up the agent if we cannot. Set this to `true` to skip this validation.                                                                                                                                                                                                                                                                                               |
...
| `--moderne.agent.maven[{index}].skipValidateConnectivity` | `false`                                               | `false`                       | By default, on agent startup, we will validate that we can connect to this Maven repository, and fail to start up the agent if we cannot. Set this to `true` to skip this validation.                                                                                                                                                                                                                                                                                               |
