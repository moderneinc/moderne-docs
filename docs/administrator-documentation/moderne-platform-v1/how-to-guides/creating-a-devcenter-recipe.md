...
<VersionBanner version="v1" linkPath="/administrator-documentation/moderne-platform/how-to-guides/creating-a-devcenter-recipe" />
...
description: >-
  ...
  For more information on how to customize your DevCenter configuration, see the [DevCenter documentation](../../../user-documentation/moderne-platform-v1/getting-started/dev-center.md).
```
