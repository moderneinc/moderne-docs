...
<VersionBanner version="v1" linkPath="/administrator-documentation/moderne-platform/references/architecture" />
...
Please see our [token documentation](../../../user-documentation/moderne-platform-v1/how-to-guides/create-api-access-tokens.md) for more information on how to create, work with, and revoke tokens.
