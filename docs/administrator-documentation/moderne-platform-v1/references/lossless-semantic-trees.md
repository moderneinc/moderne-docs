...
<VersionBanner version="v1" linkPath="/administrator-documentation/moderne-platform/references/lossless-semantic-trees" />
...
4. Once the recipe has finished running, the **modified LST will be discarded** and the code **will not** be changed. Instead, you will be [provided with a list of the changes it would make](../../../user-documentation/moderne-platform-v1/getting-started/running-your-first-recipe.md#step-5-run-the-recipe). You can [review them](../../../user-documentation/moderne-platform-v1/getting-started/running-your-first-recipe.md#step-6-view-the-results) and [choose what to do with them](../../../user-documentation/moderne-platform-v1/getting-started/running-your-first-recipe.md#step-7-commit-your-changes).
