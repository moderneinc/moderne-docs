...
* Configure the Connector to `skipSSL` for this service (See the [recipe marketplace repositories](./configure-recipe-marketplace-repositories.md) or [Maven repository](./configure-a-connector-with-maven-repository-access.md) Connector documentation)
