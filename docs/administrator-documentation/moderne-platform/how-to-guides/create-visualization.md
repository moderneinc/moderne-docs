...
<VersionBanner version="v2" linkPath="/administrator-documentation/moderne-platform-v1/how-to-guides/create-visualization" />
...
Once you've done that, please [configure your Connector with access to said repository](../how-to-guides/connector-configuration/configure-a-connector-with-pypi-access-visualizations.md).
