...
You will also need to ensure that your Moderne agent has access to this repository. An administrator should have [configured this when onboarding the agent](./agent-configuration/configuring-artifactory-with-recipes.md).
