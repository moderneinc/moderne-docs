...
| `MODERNE_AGENT_MAVEN_{index}_CONNECTTIMEOUT`  | `false`  | `10s`              | Timeout for establishing a connection to the Maven repository. Specified as a duration (e.g., `10s`, `1m`).                                                                                                                                                                                                                                                                                                                                                                          |
...
| `--moderne.agent.maven[{index}].connectTimeout`  | `false`  | `10s`              | Timeout for establishing a connection to the Maven repository. Specified as a duration (e.g., `10s`, `1m`).                                                                                                                                                                                                                                                                                                                                                                          |
...
| `MODERNE_AGENT_ARTIFACTORY_{index}_CONNECTTIMEOUT`          | `false`  | `10s`   | Timeout for establishing a connection to the Artifactory instance. Specified as a duration (e.g., `10s`, `1m`).                                                                                |
...
| `--moderne.agent.artifactory[{index}].connectTimeout`           | `false`  | `10s`   | Timeout for establishing a connection to the Artifactory instance. Specified as a duration (e.g., `10s`, `1m`).                                                                               |
...
| `MODERNE_AGENT_PYPI_{index}_CONNECTTIMEOUT`     | `false`  | `10s`   | Timeout for establishing a connection to the PyPI package index. Specified as a duration (e.g., `10s`, `1m`).                                                              |
...
| `--moderne.agent.pypi[{index}].connectTimeout`    | `false`  | `10s`   | Timeout for establishing a connection to the PyPI package index. Specified as a duration (e.g., `10s`, `1m`).                                                              |
