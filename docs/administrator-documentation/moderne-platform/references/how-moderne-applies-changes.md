---
title: Interactions with git when applying changes
...
<VersionBanner version="v2" linkPath="/administrator-documentation/moderne-platform-v1/references/how-moderne-applies-changes" />
...
![Commit reconciliation flowchart showing patch branch creation, rebase, and push steps](./assets/commit-recon.png)
