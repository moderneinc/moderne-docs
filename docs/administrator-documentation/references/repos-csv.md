...
| branch      | Required for the agent but not required for mass ingestion | The branch of the above repository that should be ingested. This column can't be used with the `changeset` column.                                                                                                                                                                                                                                                    | `main`                                                                        |
| changeset   | `false`                                                    | If provided, this will check out the repository at this specific commit SHA. Please do not use this column in your mass-ingestion or org hierarchy `repos.csv` file. This column can't be used with the `branch` column.                                                                                                                                           | `aa5f25ac0031`                                                                |
