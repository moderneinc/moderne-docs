...
| branch      | `true`*  | The branch of the repository that should be checked out. This column can't be used with the `changeset` column. <br /><br />Required for the agent (for Moderne Platform admins) or DX (for Moderne DX admins).<br /><br />Example: `main`                                                                                                            | ✅           | ✅             |
