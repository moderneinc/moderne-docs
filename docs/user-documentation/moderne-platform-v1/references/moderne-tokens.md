...
<VersionBanner version="v1" linkPath="/user-documentation/moderne-platform/references/moderne-tokens" />
...
:::info
The tokens described in this doc have the same permissions as `everyone` in the [user roles doc](../../../administrator-documentation/moderne-platform-v1/references/user-roles.md). They _do not_ have `administrator` permissions.
:::
