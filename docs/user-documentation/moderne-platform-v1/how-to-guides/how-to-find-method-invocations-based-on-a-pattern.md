...
<VersionBanner version="v1" linkPath="/user-documentation/moderne-platform/how-to-guides/how-to-find-method-invocations-based-on-a-pattern" />
...
<figure>
  ![Code diff showing highlighted List add method invocations across Java files](./assets/ai-find-method-usage.png)
...
<figure>
   ![Code diff showing highlighted HTTP request method invocation in a Spring test class](./assets/ai-method-pattern.png)
...
<figure>
  ![Recipe results tabs highlighting the Visualizations and Data tables options](./assets/ai-tabs.png)
...
<figure>
  ![Visualization card for Find uses of method in code with Run visualization button](./assets/ai-vis.png)
  <figcaption></figcaption>
</figure>

<figure>
  ![Table of method usage results showing repository, file path, and source code columns](./assets/ai-data-table.png)
  <figcaption></figcaption>
</figure>
...
<figure>
  ![Visualization card for Find uses of method using AI with Run visualization button](./assets/ai-find-uses.png)
  <figcaption></figcaption>
</figure>

<figure>
  ![AI results table listing method patterns, example code, and query matches](./assets/ai-find-uses-results.png)
  <figcaption></figcaption>
</figure>
...
<figure>
  ![Visualization card for Generated pre-filled YAML recipe with Run visualization button](./assets/ai-prefilled-yaml.png)
  <figcaption></figcaption>
</figure>

<figure>
  ![Generated YAML recipe with FindMethods entries for various HTTP request method patterns](./assets/ai-prefilled-yaml-result.png)
  <figcaption></figcaption>
</figure>
...
<figure>
  ![Data tables tab showing downloadable method calls table with CSV, XLS, and JSON options](./assets/method-usage-data-table.png)
  <figcaption>_Find method usages data table_</figcaption>
</figure>

<figure>
  ![Data tables tab showing AI-specific tables including Code Search and Top-K Method Matcher](./assets/ai-data-tables.png)
