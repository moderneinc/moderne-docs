...
<VersionBanner version="v1" linkPath="/user-documentation/moderne-platform/getting-started/running-your-first-recipe" />
...
:::info
For a better understanding of the permissions requested, please review our [GitHub permissions](../../../administrator-documentation/moderne-platform-v1/references/github-permissions.md#github-oauth-app-permissions) reference documentation.
:::
...
:::info
You will need to have [specific permissions](../../../administrator-documentation/moderne-platform-v1/references/github-permissions.md) depending on the commit strategy you decide to go with.
:::
