...
* **Main topic for the week**
  * This week we welcomed back Justine – who talked about our new AI agent: Moddy. For a detailed written guide on this, check out [our blog post introducing Moddy](https://www.moderne.ai/blog/introducing-moderne-multi-repo-ai-agent-for-transforming-code-at-scale).
...
* **Announcements for the week**
  ...
  * **Releases**
    ...
    * [We also did a new CLI release](../../releases/cli-releases.md)
