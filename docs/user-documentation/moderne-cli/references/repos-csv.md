...
|-------------------|----------|-----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| cloneUrl          | `true`   | String          | The URL of the repository that should be ingested. <br /><br />Example: `git@github.com:google/guava.git` or `https://github.com/openrewrite/rewrite`                                                                                                                                                                                                                                                       |
| branch            | `true`   | String          | The branch of the repository that should be checked out.<br /><br />Example: `main`                                                                                                                                                                                                                                                                                                                         |
| origin            | `true`   | String          | The host domain of the repository including any context root used by the server.<br /><br />Example: `github.com`, `gitlab.com`, `bitbucket.org`, `mycompany.com/bitbucket`                                                                                                                                                                                                                                 |
| path              | `true`   | String          | The organization and repository name portion of the clone URL. This is typically the remainder of the cloneUrl after `origin` minus any leading symbols and trailing `.git`. For SCP-style URLs (like `git@github.com:moderneinc/moderne-docs`), the path is typically the portion after the `:`. <br /><br />Example: `moderne-inc/moderne-docs`, `openrewrite/rewrite`, `businessunit/teamA/subteamB/app` |
| alternateCloneUrl | `false`  | String          | If the `cloneUrl` doesn't work, then we will attempt to clone from this URL. This is commonly filled out if you want to provide both an HTTP link and an SSH link for a repository. Multiple columns with this name are supported for organizations that have additional clone URLs.                                                                                                                        |
| changeset         | `false`  | String          | If provided, this will check out the repository at this specific commit SHA. <br /><br />Example: `aa5f25ac0031`                                                                                                                                                                                                                                                                                            |
| gradleArgs        | `false`  | List of Strings | Build arguments that are added to the end of the Gradle command line when building LSTs.<br /><br />Example: `-Dmyprop=myvalue`                                                                                                                                                                                                                                                                             |
| java              | `false`  | String          | Configures the JDK to use during LST generation.<br /><br />Example: `17` or `17-tem` or `17.0.6-tem`                                                                                                                                                                                                                                                                                                       |
| jvmopts           | `false`  | List of Strings | JVM options added to tools building LSTs. Must be configured before you can run the build command if non-standard VM options are required.<br /><br />Example: `-Xmx4G`                                                                                                                                                                                                                                     |
| mavenArgs         | `false`  | List of Strings | Build arguments are added to the end of the Maven command line when building LSTs.<br /><br />Example: `-Pfast`                                                                                                                                                                                                                                                                                             |
...
"https://github.com/Netflix/photon","-Dprop=value", "main"
"https://github.com/Netflix/ribbon","-Dprop1=value1
-Dprop2=/path to some/directory
-Dprop3=value3", "master"
