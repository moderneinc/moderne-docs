...
| gradleArgs        | `false`  | Build arguments that are added to the end of the Gradle command line when building LSTs. During `mod git sync csv`, these values are written to each repository's `.moderne` directory. See [configuration precedence](../how-to-guides/layer-config-cli.md#configuration-precedence) for details.<br /><br />Example: `-Dmyprop=myvalue`                                                                                                                                                                                                                   |
...
| mavenArgs         | `false`  | Build arguments that are added to the end of the Maven command line when building LSTs. During `mod git sync csv`, these values are written to each repository's `.moderne` directory. See [configuration precedence](../how-to-guides/layer-config-cli.md#configuration-precedence) for details.<br /><br />Example: `-Pfast`                                                                                                                                                                                                                                   |
