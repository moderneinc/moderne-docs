...
bash moderne-cli-linux-3-streaming-group-release.sh

# macOS (self-extracting installer)
bash moderne-cli-osx-3-streaming-group-release.sh

# Windows (PowerShell)
Expand-Archive moderne-cli-windows-3-streaming-group-release.zip -DestinationPath . ; .\install.cmd
```
