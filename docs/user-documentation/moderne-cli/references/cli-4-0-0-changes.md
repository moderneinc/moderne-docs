...
bash moderne-cli-linux-uln-suppress-simpleclient-tracer-otel-fp.sh

# macOS (self-extracting installer)
bash moderne-cli-osx-uln-suppress-simpleclient-tracer-otel-fp.sh

# Windows (PowerShell)
Expand-Archive moderne-cli-windows-uln-suppress-simpleclient-tracer-otel-fp.zip -DestinationPath . ; .\install.cmd
```
