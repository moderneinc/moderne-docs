---
sidebar_label: CLI 3.45.5 changes
description: The major changes in Moderne CLI 3.45.5.
---

import Zoom from 'react-medium-image-zoom';
import 'react-medium-image-zoom/dist/styles.css';

# Moderne CLI 3.45.5 changes

Moderne CLI 3.45.5 introduces full support for **organizational structures**, matching how repositories have been organized in the Moderne Platform. This document covers what's changed, why we made these changes, and how they affect your workflow.
