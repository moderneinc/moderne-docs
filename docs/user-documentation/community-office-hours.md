...
* **Main topic for the week**:
  * Our main topic this week was about the [new Moderne recipe builder](/docs/user-documentation/moderne-platform/how-to-guides/new-recipe-builder.md)
...
* Announcements for the week
  * **Content**:
    ...
    * [We've release some new docs on using AI through the Moderne platform](/docs/user-documentation/moderne-platform/how-to-guides/how-to-find-method-invocations-based-on-a-pattern).
  * **Releases**:
...
* Main topic - searching for method invocations using AI
  ...
  * To help explain how the AI stuff works, Justine created a diagram of what's actually happening when the recipe runs.
    * To understand the diagram and what Justine is talking about, you may want to check out our [documentation on Scanning Recipes](https://docs.openrewrite.org/concepts-and-explanations/recipes#scanning-recipes) or our [documentation on embeddings](/docs/user-documentation/moderne-platform/how-to-guides/how-to-gain-a-high-level-overview-of-your-codebase-using-clustering#embeddings).
  ...
  * We then dove into how you might [use those results to create or run recipes that are more focused and accurate](/docs/user-documentation/moderne-platform/how-to-guides/how-to-find-method-invocations-based-on-a-pattern.md#gain-insight-from-the-results).
  * Next up was a discussion on [how you should phrase your queries](/docs/user-documentation/moderne-platform/how-to-guides/how-to-find-method-invocations-based-on-a-pattern.md#find-method-invocations-that-resemble-a-pattern).
  * The last main topic for the week was looking at other AI recipes. In particular, the [get embeddings for code snippets in code recipe](https://app.moderne.io/recipes/io.moderne.ai.research.GetCodeEmbedding) which lets you [gain a high-level overview of your codebase through clustering](/docs/user-documentation/moderne-platform/how-to-guides/how-to-gain-a-high-level-overview-of-your-codebase-using-clustering.md).
...
* [We then jumped over to our main topic on automating impact analysis](https://youtu.be/jMxSWB5jJ5M?t=307).
  ...
  * After that, we quickly touched on a variety of topics such tracking Maven dependencies, [using data tables](/docs/user-documentation/moderne-platform/getting-started/data-tables.md), [the Moderne DevCenter](/docs/user-documentation/moderne-platform/getting-started/dev-center.md), [seeing what recipes have data tables](https://docs.openrewrite.org/reference/recipes-with-data-tables), etc.
  * Towards the end of our talk, we brought up that you can run all of these recipes locally using the [Moderne Plugin for JetBrains IDEs](/docs/user-documentation/moderne-ide-integration/how-to-guides/moderne-plugin-install.md).
...
* [Announcements for the week](https://youtu.be/6\_w6gx7GPII?t=123)
  ...
  * **Content**:
    ...
    * [The workshop that Tim gave on creating recipes is also available in our docs](/docs/user-documentation/workshops/recipe-authoring).
* [We then began our main discussion for the week – recipe authoring best practices](https://youtu.be/6\_w6gx7GPII?t=492)
  ...
  * [During the discussion of said recipe, a community member asked a pertinent question on mutating markers](https://youtu.be/6\_w6gx7GPII?t=1056). Markers are optional metadata attached to an LST element - the question was, effectively, what if you use the `Markers.add()` method? Will that not cause problems because you're modifying a collection?
...
* [We then jumped over to the main topic for the week – debugging recipes](https://youtu.be/lNLo6i7SVGI?t=264).
  ...
  * The next topic was about [debugging a recipe on real code](https://youtu.be/lNLo6i7SVGI?t=1991).
    ...
    * While the project was building, Sam mentioned that one of the downsides of using the OpenRewrite plugins instead of the CLI is that the plugins have to parse all the code every time rather than serializing the code to disk so it can be re-used. For more information about this, check out [our summary of the differences between the two](/docs/user-documentation/moderne-cli/getting-started/cli-intro#differences-between-the-moderne-cli-and-the-openrewrite-build-plugins).
...
* [Announcements for the week](https://youtu.be/egf5Q3fb6W0?t=30)
  ...
  * **Content**:
    ...
    * We also created a bunch of developer-focused docs about the [Moderne IDE plugin that are focused on installing, configuring, and using the plugin](/docs/user-documentation/moderne-ide-integration/moderne-plugin-for-jetbrains-ides/).
  ...
  * [After the announcements, we began our discussion with Jonathan about the Moderne IDE plugin](https://youtu.be/egf5Q3fb6W0?t=163).
    ...
    * After giving some context, [Jonathan then demonstrated how to install and configure the Moderne IDE plugin](https://youtu.be/egf5Q3fb6W0?t=405).
      * Behind the scenes the Moderne plugin uses the [Moderne CLI](/docs/user-documentation/moderne-cli/getting-started/cli-intro.md).
...
* [OpenRewrite parsers](https://youtu.be/svNf6qHUYXA?t=180):
  ...
  * We began by discussing the [Java parser](https://youtu.be/svNf6qHUYXA?t=242) (which is based on an existing language compiler) and how we interact with the Java compiler to map objects to our [Lossless Semantic Tree](/docs/administrator-documentation/moderne-platform/references/concepts/lossless-semantic-trees.md).
...
* Announcements for the week:
  * **Releases**:
    * Shout out to [Ryan Hudson](https://github.com/ryan-hudson) who [added support for data tables to the rewrite-maven-plugin](https://github.com/openrewrite/rewrite-maven-plugin/pull/751).
      ...
      * If you want to learn more about data tables, check out our [getting started with data tables doc](/docs/user-documentation/moderne-platform/getting-started/data-tables) that shows how useful they can be at scale with Moderne.
  * **Events**:
...
* Contributing to OSS:
  ...
  * We then dove into [how to get started with running recipes](/docs/user-documentation/moderne-platform/getting-started/running-your-first-recipe) and [creating your own user organization in Moderne](/docs/user-documentation/moderne-platform/how-to-guides/managing-user-configured-organizations).
  ...
  * We then touched upon building a community. If you work with any open-source project that you'd like to collaborate with us on (perhaps to have a space where many people can contribute recipes for), please fill out our [collaboration proposal form](https://github.com/openrewrite/collaboration-proposals/issues/new/choose).
    * If you have open-source projects and want help setting up your own [Moderne Dev Center](/docs/user-documentation/moderne-platform/getting-started/dev-center.md), please reach out, and we'd be happy to help create one.
...
* Announcements for the week:
  ...
  * To go along with that, we also have a [getting started guide](/docs/user-documentation/moderne-platform/getting-started/dev-center.md) for those of you who are Moderne customers and want to jump in.
* AI topic:
  * We started off by talking through [search in Moderne](/docs//user-documentation/moderne-platform/how-to-guides/moderne-platform-search.md). Prior to AI search being added, it was very hard to discover recipes, typos would result in no recipes being found, and words that were tangentially related did not provide results. Adding AI search helped fix all of these issues.
...
* We started off by covering all of the OpenRewrite and Moderne news for the past week:
  ...
  * We created a [new video showing you how to upgrade transitive dependencies in Gradle](https://www.youtube.com/watch?v=xicPgKzgz-M) – which can help keep you safe from security vulnerabilities. We also [wrote up a doc on this](/docs/user-documentation/moderne-platform/how-to-guides/transitive-dependencies.md) to go along with the video.
...
* We then jumped over to the main topic: automating code reviews with OpenRewrite and the [Moderne CLI](/docs/user-documentation/moderne-cli/getting-started/cli-intro.md).
...
* We then jumped into the main topic for the week: data tables and search recipes:
  ...
  * We ran and talked through our [Find and fix vulnerable dependencies recipe](https://app.moderne.io/recipes/org.openrewrite.java.dependencies.DependencyVulnerabilityCheck). We also walked through the [data table](/docs/user-documentation/moderne-platform/getting-started/data-tables) it produced.
  ...
  * We then showed how you can [produce your own class hierarchy and data table rows](/docs/user-documentation/moderne-platform/getting-started/data-tables) as well as how to [verify the rows you produced](https://github.com/moderneinc/rewrite-recipe-starter/blob/main/src/test/java/com/yourorg/ClassHierarchyTest.java#L36-L37).
...
* We started off by highlighting some of the big changes/additions since the last office hours:
  ...
  * We added [the ability to bump transitive dependencies in Gradle](/docs/user-documentation/moderne-platform/how-to-guides/transitive-dependencies).
...
* We demonstrated how to [create your own custom recipes quickly in Moderne without writing any code](/docs/user-documentation/moderne-platform/how-to-guides/recipe-builder).
...
* We explained what [Preconditions are and how to use them](/docs/user-documentation/moderne-platform/how-to-guides/preconditions).
