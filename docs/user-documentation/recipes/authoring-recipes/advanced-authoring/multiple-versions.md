...
<head>
  ...
  <link rel="canonical" href="https://docs.openrewrite.org/authoring-recipes/multiple-versions" />
</head>
...
The main downside of this task is that it can [result in security vulnerability scanners incorrectly flagging these JARs as a concern](https://docs.openrewrite.org/reference/faq#why-do-artifact-scanners-detect-vulnerabilities-in-recipe-artifactsjars).
