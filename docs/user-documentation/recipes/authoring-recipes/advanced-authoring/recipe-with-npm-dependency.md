...
<head>
  ...
  <link rel="canonical" href="https://docs.openrewrite.org/authoring-recipes/recipe-with-npm-dependency" />
</head>
...
* You are somewhat familiar with recipe development. If not, consider working through our [recipe authoring workshop](../../../../hands-on-learning/fundamentals/workshop-overview.md).
...
:::tip
You may find it useful to add code so that your recipe produces a [data table](../../../moderne-platform/getting-started/data-tables.md). Data tables are tabular data that people can use for analysis purposes. They also can be useful for creating visualizations of the results.
...
With your recipe created, you'll need to deploy it as usual. If you use the Moderne Platform, check out [our guide on how to import external recipes](../../../../administrator-documentation/moderne-platform/how-to-guides/importing-external-recipes.md).
