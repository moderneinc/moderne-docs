...
<head>
  ...
  <link rel="canonical" href="https://docs.openrewrite.org/concepts-and-explanations/recipes" />
</head>
...
For more information on how to work with and use declarative recipes, please read our [Declarative YAML guide](../references/yaml-format-reference.md).
:::
