...
1. Before you can run a recipe against a repository with the [Moderne CLI](../../../moderne-cli/getting-started/cli-intro.md), you must build the LST for said repository. This LST does not need to fit into memory entirely at once -- it can be built in pieces. The LST could be built locally or it could be pulled down from your artifact repository (if said LST is up-to-date). Regardless, at the end of the build process, you will have an LST artifact saved to disk.
...
4. Once the recipe has finished running, the **modified LST will be discarded** and the code **will not** be changed. Instead, you will be [provided with a list of the changes it would make](../../../moderne-platform/getting-started/running-your-first-recipe.md#step-5-run-the-recipe). You can [review them](../../../moderne-platform/getting-started/running-your-first-recipe.md#step-6-view-the-results) and [choose what to do with them](../../../moderne-platform/getting-started/running-your-first-recipe.md#step-7-commit-your-changes).
