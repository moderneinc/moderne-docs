...
<head>
  ...
  <link rel="canonical" href="https://docs.openrewrite.org/concepts-and-explanations/styles" />
</head>
...
1. In the `rewrite.yml` file of a project that applies rewrite recipes via the [rewrite gradle plugin](https://docs.openrewrite.org/reference/gradle-plugin-configuration) or the [rewrite maven plugin](https://docs.openrewrite.org/reference/rewrite-maven-plugin).
...
If you want to reformat your code to conform to your configured style so you can ensure consistency throughout your code base, you can use the [format Java code recipe](../../recipe-catalog/java/format/autoformat.md).
