...
<head>
  ...
  <link rel="canonical" href="https://docs.openrewrite.org/concepts-and-explanations/yaml-lst-examples" />
</head>
...
:::info
If you want a more thorough explanation of what LSTs are and how they're used in recipes, please read [this high-level LST explanation](./java.md#high-level-lst-explanation).
:::
