...
<head>
  ...
  <link rel="canonical" href="https://docs.openrewrite.org/concepts-and-explanations/javascript-lst-examples" />
</head>
...
* **Shared Java LST types (J.*)** - OpenRewrite reuses [Java LST nodes](./java.md) for constructs that are semantically similar between the two languages, such as classes, method declarations, variable declarations, and literals.
