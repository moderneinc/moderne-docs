...
<head>
  ...
  <link rel="canonical" href="https://docs.openrewrite.org/authoring-recipes/recipe-testing" />
</head>
...
* You're familiar with [creating Java refactoring recipes](../writing-recipes/writing-a-java-refactoring-recipe.md)
...
You may need to include additional dependencies depending on the type of recipes you want to create. For instance, [Refaster template recipes](../writing-recipes/types-of-recipes.md#refaster-template-recipes) will need a few more dependencies (included below with comments).
...
If you want to test multiple versions of the same dependency, you'll want to use `classpathFromResources` instead which you can find documentation for in the [using multiple versions of a library guide](../advanced-authoring/multiple-versions.md).
