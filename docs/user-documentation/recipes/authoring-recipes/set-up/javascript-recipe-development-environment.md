---
sidebar_label: JavaScript recipe development environment
...
<head>
  ...
  <link rel="canonical" href="https://docs.openrewrite.org/authoring-recipes/javascript-recipe-development-environment" />
</head>
...
* [Moderne CLI](../../../moderne-cli/getting-started/cli-intro.md)
...
* [Write a JavaScript refactoring recipe](../writing-recipes/writing-a-javascript-refactoring-recipe.md)
* [Learn more about using the Moderne CLI](../../../moderne-cli/getting-started/cli-intro.md)
* [Explore JavaScript LST examples](../concepts/lst-examples/javascript.md)
