---
sidebar_label: Recipe development environment
...
<head>
  ...
  <link rel="canonical" href="https://docs.openrewrite.org/authoring-recipes/recipe-development-environment" />
</head>
...
:::info
If you are looking to build [OpenRewrite](https://github.com/openrewrite/rewrite) itself instead of a specific recipe, check out our [building and developing OpenRewrite guide](https://docs.openrewrite.org/reference/building-openrewrite-from-source).
:::
...
:::warning
If the recipe you're wanting to use is a [Refaster template recipe](../writing-recipes/refaster-recipes.md), please keep in mind that the _recipe name_ is not the class name – it is the generated class name. For instance, if you wanted to test the [SimplifyTernary recipe](https://github.com/moderneinc/rewrite-recipe-starter/blob/main/src/main/java/com/yourorg/SimplifyTernary.java) - you would need to enter `com.yourorg.SimplifyTernaryRecipes` as the recipe name.
:::
...
Moderne offers a [CLI](../../../moderne-cli/getting-started/cli-intro.md) and an [IntelliJ plugin](../../../moderne-ide-integration/how-to-guides/moderne-plugin-install.md) that can help speed up the development and testing of recipes. We'd strongly encourage you to check those out while developing recipes.
