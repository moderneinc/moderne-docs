---
sidebar_label: Framework-provided markers
description: A reference doc that explains what LST metadata is available to recipe authors.
---

<head>
  <meta name="robots" content="noindex" />
  <link rel="canonical" href="https://docs.openrewrite.org/reference/framework-provided-markers" />
</head>

# Framework provided markers

Not everything a [Recipe](../concepts/recipes.md) may wish to know about an [LST](../concepts/lossless-semantic-trees.md) is contained in the LST itself.
OpenRewrite attaches [Markers](../concepts/markers.md) to an LST to provide Recipes access to relevant metadata.
...
From anywhere in a [Visitor](../concepts/visitors.md) the cursor can be used to access the markers on the root element like so:
...
is a named collection of [styles](../concepts/styles.md) representing code style/formatting and related configuration options.
