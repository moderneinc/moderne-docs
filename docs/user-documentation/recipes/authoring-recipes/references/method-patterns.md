...
<head>
  ...
  <link rel="canonical" href="https://docs.openrewrite.org/reference/method-patterns" />
</head>
...
:::info
Check out the [Moderne introduction to type-aware code searches](../../../moderne-platform/how-to-guides/introduction-to-type-aware-code-search.md#using-a-search-recipe) for an example of how method patterns can be used by users running recipes.
:::
