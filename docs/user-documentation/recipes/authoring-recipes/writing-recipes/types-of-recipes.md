---
sidebar_label: Types of recipes
description: Describes what the three types of recipes are, and what their advantages/disadvantages are.
---

<head>
  <meta name="robots" content="noindex" />
  <link rel="canonical" href="https://docs.openrewrite.org/authoring-recipes/types-of-recipes" />
</head>
...
[Declarative recipes](../references/yaml-format-reference.md) are the simplest and most common recipes. They are entirely written in YAML, and they generally tie together existing recipes while adding some light configuration to them.
...
* If you want more information about the types of recipes and the recipe execution pipeline, please see our [recipes documentation](../concepts/recipes.md)
...
* If you want to learn more about how to test recipes, please see our [recipe testing guide](../testing-and-best-practices/recipe-testing.md)