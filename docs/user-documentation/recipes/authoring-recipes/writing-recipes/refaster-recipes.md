...
<head>
  ...
  <link rel="canonical" href="https://docs.openrewrite.org/authoring-recipes/refaster-recipes" />
</head>
...
The last step in creating a Refaster template recipe is writing tests. These tests are the same as any other recipe development so our [recipe testing guide](../testing-and-best-practices/recipe-testing.md) still applies here.
