...
[GitHub: RemoveDependency.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-javascript/src/main/java/org/openrewrite/javascript/RemoveDependency.java),
...
| --- | --- | --- | --- |
| `String` | packageName | The name of the npm package to remove (e.g., `lodash`, `@types/node`). | `lodash` |
...
displayName: Remove npm dependency example
recipeList:
  - org.openrewrite.javascript.RemoveDependency:
      packageName: lodash
      scope: dependencies
...
<RunRecipe
  recipeName="org.openrewrite.javascript.RemoveDependency"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.javascript.RemoveDependency" />
