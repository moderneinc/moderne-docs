...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.MissingMemoryRequest"}
...
<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.MissingMemoryRequest","displayName":"Ensure memory request is set","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":false}}>
