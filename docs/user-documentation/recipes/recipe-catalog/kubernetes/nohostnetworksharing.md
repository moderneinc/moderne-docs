...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.NoHostNetworkSharing"}
...
<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.NoHostNetworkSharing","displayName":"No host network sharing","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":false}}>
