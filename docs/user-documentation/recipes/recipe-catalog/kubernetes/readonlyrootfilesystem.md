...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.ReadOnlyRootFilesystem"}
...
<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.ReadOnlyRootFilesystem","displayName":"Read-only root filesystem","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":false}}>
