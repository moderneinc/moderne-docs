...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.ImagePullPolicyAlways"}
...
<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.ImagePullPolicyAlways","displayName":"Ensure image pull policy is `Always`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":false}}>
