...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.NoPrivilegedContainers"}
...
<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.NoPrivilegedContainers","displayName":"No privileged containers","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":false}}>
