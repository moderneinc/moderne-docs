...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.MissingCpuRequest"}
...
<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.MissingCpuRequest","displayName":"Ensure CPU request is set","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":false}}>
