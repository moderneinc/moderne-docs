...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.MissingCpuLimits"}
...
<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.MissingCpuLimits","displayName":"Ensure CPU limits are set","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":false}}>
