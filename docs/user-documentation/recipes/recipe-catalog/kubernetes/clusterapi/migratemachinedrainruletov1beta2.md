---
title: "Migrate `MachineDrainRule` to `cluster.x-k8s.io/v1beta2`"
sidebar_label: "Migrate `MachineDrainRule` to `cluster.x-k8s.io/v1beta2`"
hide_title: true
---
...
<RecipeMeta
  displayName={"Migrate `MachineDrainRule` to `cluster.x-k8s.io/v1beta2`"}
  description={"Rewrite a `MachineDrainRule` into its `v1beta2` form."}
  fqName={"org.openrewrite.kubernetes.clusterapi.MigrateMachineDrainRuleToV1beta2"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.kubernetes.clusterapi.MigrateMachineDrainRuleToV1beta2"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/kubernetes/clusterapi/migratemachinedrainruletov1beta2.md"}
  moderneOnly
>

<RecipeHeader.Title>Migrate `MachineDrainRule` to `cluster.x-k8s.io/v1beta2`</RecipeHeader.Title>

<RecipeHeader.Description>Rewrite a `MachineDrainRule` into its `v1beta2` form.</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.clusterapi.MigrateMachineDrainRuleToV1beta2","displayName":"Migrate `MachineDrainRule` to `cluster.x-k8s.io/v1beta2`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":false}}>
