...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.MissingPodReadinessProbe"}
...
<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.MissingPodReadinessProbe","displayName":"Ensure readiness probe is configured","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":false}}>
