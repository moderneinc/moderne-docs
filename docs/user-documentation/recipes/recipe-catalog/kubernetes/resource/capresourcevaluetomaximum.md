...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.resource.CapResourceValueToMaximum"}
...
<ExampleList examples={[{"parameters":[{"parameter":"resourceValueType","value":"limits"},{"parameter":"resourceType","value":"memory"},{"parameter":"resourceLimit","value":"64Mi"},{"parameter":"fileMatcher","value":"null"}],"variants":[{"language":"yaml","before":"apiVersion: v1\nkind: Pod\nmetadata:\n  labels:\n    app: application\nspec:\n  containers:\n  - image: nginx:latest\n    resources:\n        limits:\n            cpu: \"500Mi\"\n            memory: \"256M\"\n","after":"apiVersion: v1\nkind: Pod\nmetadata:\n  labels:\n    app: application\nspec:\n  containers:\n  - image: nginx:latest\n    resources:\n        limits:\n            cpu: \"500Mi\"\n            memory: \"67M\"\n","diff":"@@ -12,1 +12,1 @@\n        limits:\n            cpu: \"500Mi\"\n-           memory: \"256M\"\n+           memory: \"67M\"\n\n","newFile":false}]}]}>
