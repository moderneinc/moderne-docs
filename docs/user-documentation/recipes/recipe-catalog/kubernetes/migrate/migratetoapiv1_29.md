...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.migrate.MigrateToAPIv1_29"}
...
<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.migrate.MigrateToAPIv1_29","displayName":"Migrate to Kubernetes API v1.29","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":false}}>
