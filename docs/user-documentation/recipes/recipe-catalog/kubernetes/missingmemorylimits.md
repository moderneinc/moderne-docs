...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.MissingMemoryLimits"}
...
<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.MissingMemoryLimits","displayName":"Ensure memory limits are set","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":false}}>
