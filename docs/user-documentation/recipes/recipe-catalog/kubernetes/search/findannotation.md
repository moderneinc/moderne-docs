...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.search.FindAnnotation"}
...
<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.search.FindAnnotation","displayName":"Find annotation","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":true,"cliOptions":" --recipe-option \"annotationName=mycompany.io/annotation\" --recipe-option \"value=value.*\" --recipe-option \"fileMatcher='**/pod-*.yml'\""}}>
