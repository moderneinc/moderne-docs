...
<RunRecipe
  recipeName="org.openrewrite.kubernetes.search.FindResourceMissingConfiguration"
  displayName="Find missing configuration"
  groupId="org.openrewrite.recipe"
  artifactId="rewrite-kubernetes"
  versionKey="VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES"
  requiresConfiguration
  cliOptions={' --recipe-option "resourceKind=Pod" --recipe-option "configurationPath=$.spec.containers.livenessProbe" --recipe-option "fileMatcher='**/pod-*.yml'"'}
  showGradle={false}
  showMaven={false}
  hasDataTables
/>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.kubernetes.search.FindResourceMissingConfiguration" />
