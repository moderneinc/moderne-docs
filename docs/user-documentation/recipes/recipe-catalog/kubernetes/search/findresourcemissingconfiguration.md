...
```shell title="shell"
mod run . --recipe FindResourceMissingConfiguration --recipe-option "resourceKind=Pod" --recipe-option "configurationPath=$.spec.containers.livenessProbe" --recipe-option "fileMatcher='**/pod-*.yml'"
```
