...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.search.FindResourceMissingConfiguration"}
...
<ExampleList examples={[{"parameters":[{"parameter":"resourceKind","value":"Pod"},{"parameter":"configurationPath","value":"$.spec.containers[*].livenessProbe"},{"parameter":"fileMatcher","value":"null"}],"variants":[{"language":"yaml","before":"apiVersion: v1\nkind: Pod\nspec:\n  containers:\n  - name: <container name>\n    image: <image>\n","after":"~~(missing: $.spec.containers[*].livenessProbe)~~>apiVersion: v1\nkind: Pod\nspec:\n  containers:\n  - name: <container name>\n    image: <image>\n","diff":"@@ -1,1 +1,1 @@\n-apiVersion: v1\n+~~(missing: $.spec.containers[*].livenessProbe)~~>apiVersion: v1\nkind: Pod\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.search.FindResourceMissingConfiguration","displayName":"Find missing configuration","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":true,"cliOptions":" --recipe-option \"resourceKind=Pod\" --recipe-option \"configurationPath=$.spec.containers.livenessProbe\" --recipe-option \"fileMatcher='**/pod-*.yml'\""}}>
