...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.search.FindHarcodedIPAddresses"}
...
<ExampleList examples={[{"variants":[{"language":"yaml","before":"foo:\n  bar: 192.168.0.1\n","after":"foo:\n  bar: ~~>192.168.0.1\n","diff":"@@ -2,1 +2,1 @@\nfoo:\n- bar: 192.168.0.1\n+ bar: ~~>192.168.0.1\n\n","newFile":false}]},{"variants":[{"language":"yaml","before":"foo:\n  bar: 192.168.0.1\n","after":"foo:\n  bar: ~~>192.168.0.1\n","diff":"@@ -2,1 +2,1 @@\nfoo:\n- bar: 192.168.0.1\n+ bar: ~~>192.168.0.1\n\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.search.FindHarcodedIPAddresses","displayName":"Find hardcoded IP addresses","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":false}}>
