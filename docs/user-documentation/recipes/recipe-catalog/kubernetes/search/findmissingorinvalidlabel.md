...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kubernetes.search.FindMissingOrInvalidLabel"}
...
<ExampleList examples={[{"parameters":[{"parameter":"labelName","value":"mylabel"},{"parameter":"value","value":"null"},{"parameter":"fileMatcher","value":"null"}],"variants":[{"language":"yaml","before":"apiVersion: v1\nkind: Pod\nmetadata:\n  name: mypod1\n  labels:\n    something: \"hasvalue\"\n---\napiVersion: v1\nkind: Pod\nmetadata:\n  name: mypod2\n  labels:\n    mylabel: \"novalue\"\n---\napiVersion: apps/v1\nkind: Deployment\nspec:\n    template:\n        spec:\n            metadata:\n                labels:\n                    something: \"hasvalue\"\n            containers:\n            - name: app\n              image: repo/app:latest\n            - name: sidecar\n              image: repo/sidecar:dev\n","after":"apiVersion: v1\nkind: Pod\nmetadata:\n  name: mypod1\n  ~~(missing:mylabel)~~>labels:\n    something: \"hasvalue\"\n---\napiVersion: v1\nkind: Pod\nmetadata:\n  name: mypod2\n  labels:\n    mylabel: \"novalue\"\n---\napiVersion: apps/v1\nkind: Deployment\nspec:\n    template:\n        spec:\n            metadata:\n                ~~(missing:mylabel)~~>labels:\n                    something: \"hasvalue\"\n            containers:\n            - name: app\n              image: repo/app:latest\n            - name: sidecar\n              image: repo/sidecar:dev\n","diff":"@@ -5,1 +5,1 @@\nmetadata:\n  name: mypod1\n- labels:\n+ ~~(missing:mylabel)~~>labels:\n    something: \"hasvalue\"\n@@ -21,1 +21,1 @@\n        spec:\n            metadata:\n-               labels:\n+               ~~(missing:mylabel)~~>labels:\n                    something: \"hasvalue\"\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.kubernetes.search.FindMissingOrInvalidLabel","displayName":"Find label","groupId":"org.openrewrite.recipe","artifactId":"rewrite-kubernetes","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_KUBERNETES","requiresConfiguration":true,"cliOptions":" --recipe-option \"labelName=mylabel\" --recipe-option \"value=value(.*)\" --recipe-option \"fileMatcher='**/pod-*.yml'\""}}>
