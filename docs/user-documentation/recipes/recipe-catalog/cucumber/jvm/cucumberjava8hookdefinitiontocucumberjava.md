...
canonical_url: "https://docs.openrewrite.org/recipes/cucumber/jvm/cucumberjava8hookdefinitiontocucumberjava"
---
...
[GitHub: CucumberJava8HookDefinitionToCucumberJava.java](https://github.com/openrewrite/rewrite-cucumber-jvm/blob/main/src/main/java/org/openrewrite/cucumber/jvm/CucumberJava8HookDefinitionToCucumberJava.java),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-cucumber-jvm:RELEASE -Drewrite.activeRecipes=org.openrewrite.cucumber.jvm.CucumberJava8HookDefinitionToCucumberJava -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.cucumber.jvm.CucumberJava8HookDefinitionToCucumberJava" />
