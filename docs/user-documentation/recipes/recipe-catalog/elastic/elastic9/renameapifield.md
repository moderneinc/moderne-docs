...
<RecipeMeta
  ...
  fqName={"io.moderne.elastic.elastic9.RenameApiField"}
...
<UsageList usage={{"recipeName":"io.moderne.elastic.elastic9.RenameApiField","displayName":"Rename `Elasticsearch valueBody()` methods","groupId":"io.moderne.recipe","artifactId":"rewrite-elastic","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_ELASTIC","requiresConfiguration":true,"cliOptions":" --recipe-option \"fullyQualifiedName=co.elastic.clients.elasticsearch.snapshot.RepositoryVerifyIntegrityResponse\" --recipe-option \"field=valueBody\" --recipe-option \"newField=result\""}}>
