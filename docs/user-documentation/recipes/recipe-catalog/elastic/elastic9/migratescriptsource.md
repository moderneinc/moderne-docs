...
<RecipeMeta
  ...
  fqName={"io.moderne.elastic.elastic9.MigrateScriptSource"}
...
<UsageList usage={{"recipeName":"io.moderne.elastic.elastic9.MigrateScriptSource","displayName":"Migrate script source from String to Script/ScriptSource","groupId":"io.moderne.recipe","artifactId":"rewrite-elastic","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_ELASTIC","requiresConfiguration":false}}>
