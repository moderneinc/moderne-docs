...
_In Elasticsearch 9, `SpanTermQuery.value()` returns a `FieldValue` instead of `String`. This recipe updates calls to handle the new return type by checking if it's a string and extracting the string value._
...
<RunRecipe
  recipeName="io.moderne.elastic.elastic9.MigrateSpanTermQueryValue"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.elastic.elastic9.MigrateSpanTermQueryValue" />
