...
<RecipeMeta
  ...
  fqName={"io.moderne.elastic.elastic9.MigrateMatchedQueries"}
...
<UsageList usage={{"recipeName":"io.moderne.elastic.elastic9.MigrateMatchedQueries","displayName":"Migrate `matchedQueries` from List to Map","groupId":"io.moderne.recipe","artifactId":"rewrite-elastic","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_ELASTIC","requiresConfiguration":false}}>
