...
## Examples
##### Example 1
`RenameApiFieldTest#renameMultipleResponseTypesInSameFile`
...
<RunRecipe
  recipeName="io.moderne.elastic.elastic9.RenameApiFields"
  displayName="Rename API fields for Elasticsearch 9"
