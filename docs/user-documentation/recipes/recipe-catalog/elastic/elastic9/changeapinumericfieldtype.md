...
name: com.yourorg.ChangeApiNumericFieldTypeExample
displayName: Change numeric field type with conversion example
recipeList:
  - io.moderne.elastic.elastic9.ChangeApiNumericFieldType:
      fullyQualifiedName: co.elastic.clients.elasticsearch.core.MsearchRequest
      field: maxConcurrentSearches
      targetType: java.lang.Integer
```

<RunRecipe
  recipeName="io.moderne.elastic.elastic9.ChangeApiNumericFieldType"
  ...
  cliOptions={' --recipe-option "fullyQualifiedName=co.elastic.clients.elasticsearch.core.MsearchRequest" --recipe-option "field=maxConcurrentSearches" --recipe-option "targetType=java.lang.Integer"'}
  showGradle={false}
  showMaven={false}
  hasDataTables
/>
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.elastic.elastic9.ChangeApiNumericFieldType" />
