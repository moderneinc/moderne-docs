...
<RecipeMeta
  ...
  fqName={"io.moderne.elastic.elastic9.ChangeApiNumericFieldType"}
...
<UsageList usage={{"recipeName":"io.moderne.elastic.elastic9.ChangeApiNumericFieldType","displayName":"Change numeric field type with conversion","groupId":"io.moderne.recipe","artifactId":"rewrite-elastic","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_ELASTIC","requiresConfiguration":true,"cliOptions":" --recipe-option \"fullyQualifiedName=co.elastic.clients.elasticsearch.core.MsearchRequest\" --recipe-option \"field=maxConcurrentSearches\" --recipe-option \"targetType=java.lang.Integer\""}}>
