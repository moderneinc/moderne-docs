---
sidebar_label: "`ImmutableTableRules` Refaster recipes"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/tech/picnic/errorprone/refasterrules/immutabletablerulesrecipes" />
</head>
...
_Refaster rules related to expressions dealing with `ImmutableTable`s. [Source](https://error-prone.picnic.tech/refasterrules/ImmutableTableRules)._

## Recipe source

[GitHub: search?type=code&q=tech.picnic.errorprone.refasterrules.ImmutableTableRulesRecipes](https://github.com/search?type=code&q=tech.picnic.errorprone.refasterrules.ImmutableTableRulesRecipes),
...
* [Refaster template `ImmutableTableRules.ImmutableTableBuilder`](../../../../tech/picnic/errorprone/refasterrules/immutabletablerulesrecipes$immutabletablebuilderrecipe)
...
name: tech.picnic.errorprone.refasterrules.ImmutableTableRulesRecipes
...
rewrite {
    activeRecipe("tech.picnic.errorprone.refasterrules.ImmutableTableRulesRecipes")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>tech.picnic.errorprone.refasterrules.ImmutableTableRulesRecipes</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=tech.picnic.errorprone.refasterrules.ImmutableTableRulesRecipes -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe ImmutableTableRulesRecipes
```
...
<RecipeCallout link="https://app.moderne.io/recipes/tech.picnic.errorprone.refasterrules.ImmutableTableRulesRecipes" />
