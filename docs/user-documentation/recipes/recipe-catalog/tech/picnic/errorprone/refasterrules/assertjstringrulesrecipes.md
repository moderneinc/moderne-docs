...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/tech/picnic/errorprone/refasterrules/assertjstringrulesrecipes" />
</head>
...
[GitHub: search?type=code&q=tech.picnic.errorprone.refasterrules.AssertJStringRulesRecipes](https://github.com/search?type=code&q=tech.picnic.errorprone.refasterrules.AssertJStringRulesRecipes),
...
<RunRecipe
  recipeName="tech.picnic.errorprone.refasterrules.AssertJStringRulesRecipes"
  displayName="`AssertJStringRules` Refaster recipes"
