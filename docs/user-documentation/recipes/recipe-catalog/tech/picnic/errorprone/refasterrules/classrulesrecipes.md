...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/tech/picnic/errorprone/refasterrules/classrulesrecipes" />
</head>
...
[GitHub: search?type=code&q=tech.picnic.errorprone.refasterrules.ClassRulesRecipes](https://github.com/search?type=code&q=tech.picnic.errorprone.refasterrules.ClassRulesRecipes),
...
rewrite {
    activeRecipe("tech.picnic.errorprone.refasterrules.ClassRulesRecipes")
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=tech.picnic.errorprone.refasterrules.ClassRulesRecipes -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe ClassRulesRecipes
```
...
<RecipeCallout link="https://app.moderne.io/recipes/tech.picnic.errorprone.refasterrules.ClassRulesRecipes" />
