...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/tech/picnic/errorprone/refasterrules/collectionrulesrecipes" />
</head>
...
[GitHub: search?type=code&q=tech.picnic.errorprone.refasterrules.CollectionRulesRecipes](https://github.com/search?type=code&q=tech.picnic.errorprone.refasterrules.CollectionRulesRecipes),
...
<RunRecipe
  recipeName="tech.picnic.errorprone.refasterrules.CollectionRulesRecipes"
  displayName="`CollectionRules` Refaster recipes"
