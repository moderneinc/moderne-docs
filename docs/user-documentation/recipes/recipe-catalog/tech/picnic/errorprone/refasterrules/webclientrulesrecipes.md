...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/tech/picnic/errorprone/refasterrules/webclientrulesrecipes" />
</head>
...
* [Refaster template `WebClientRules.BodyValue`](../../../../tech/picnic/errorprone/refasterrules/webclientrulesrecipes$bodyvaluerecipe)
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=tech.picnic.errorprone.refasterrules.WebClientRulesRecipes -Drewrite.exportDatatables=true
```
</TabItem>
