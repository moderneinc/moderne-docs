...
<RecipeMeta
  ...
  fqName={"software.amazon.awssdk.v2migration.TransferManagerMethodsToV2"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=software.amazon.awssdk.v2migration.TransferManagerMethodsToV2"}
/>
