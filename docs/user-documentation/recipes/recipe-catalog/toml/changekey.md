...
_Change a TOML key, while leaving the value intact._
...
displayName: Change TOML key example
recipeList:
  - org.openrewrite.toml.ChangeKey:
      oldKeyPath: package.name
      newKey: project-name
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.toml.ChangeKey" />
