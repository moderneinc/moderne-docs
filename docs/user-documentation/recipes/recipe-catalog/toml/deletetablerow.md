...
canonical_url: "https://docs.openrewrite.org/recipes/toml/deletetablerow"
---
...
_Delete a TOML table row when one of its values matches the specified matcher._

## Recipe source

[GitHub: DeleteTableRow.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-toml/src/main/java/org/openrewrite/toml/DeleteTableRow.java),
...
This recipe has required configuration parameters. Recipes with required configuration parameters cannot be activated directly (unless you are running them via the Moderne CLI). To activate this recipe you must create a new recipe which fills in the required parameters. In your `rewrite.yml` create a new recipe with a unique name. For example: `com.yourorg.DeleteTableRowExample`.
Here's how you can define and customize such a recipe within your rewrite.yml:
```yaml title="rewrite.yml"
---
type: specs.openrewrite.org/v1beta/recipe
name: com.yourorg.DeleteTableRowExample
displayName: Delete TOML table row example
recipeList:
  - org.openrewrite.toml.DeleteTableRow:
      tableName: package.contributors
      identifyingKey: name
...
Now that `com.yourorg.DeleteTableRowExample` has been defined, activate it in your build file:
...
rewrite {
    activeRecipe("com.yourorg.DeleteTableRowExample")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.yourorg.DeleteTableRowExample</recipe>
          </activeRecipes>
        </configuration>
      </plugin>
    </plugins>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.toml.DeleteTableRow" />
