...
* [Find `NgStyle` usage](./find-ng-style-usage.md)
* [Find `RESOURCE_CACHE_PROVIDER` usage](./find-resource-cache-provider-usage.md)
* [Find `ReflectiveInjector` usage](./find-reflective-injector-usage.md)
* [Find RxJS 5-style imports requiring `rxjs-compat`](./find-rxjs-compat-usage.md)
* [Find `ServerTransferStateModule` usage](./find-server-transfer-state-module-usage.md)
* [Find View Engine API usage](./find-compiler-factory-usage.md)
* [Find classes with DI dependencies but missing `@Injectable()`](./find-missing-injectable.md)
* [Find `createComponent` calls with empty `projectableNodes`](./find-empty-projectable-nodes.md)
* [Find deprecated `ANALYZE_FOR_ENTRY_COMPONENTS` usage](./find-analyze-for-entry-components-usage.md)
* [Find deprecated `RenderComponentType` usage](./find-render-component-type-usage.md)
* [Find deprecated `Renderer` usage](./find-renderer-usage.md)
* [Find deprecated `RootRenderer` usage](./find-root-renderer-usage.md)
* [Find deprecated `WrappedValue` usage](./find-wrapped-value-usage.md)
* [Find deprecated `async` test helper usage](./find-async-test-helper-usage.md)
* [Find deprecated `preserveFragment` usage](./find-preserve-fragment-usage.md)
* [Find deprecated `preserveQueryParams` usage](./find-preserve-query-params-usage.md)
* [Find deprecated `providedIn` values](./find-provided-in-deprecated-usage.md)
* [Find deprecated string-based `loadChildren` usage](./find-load-children-string-usage.md)
* [Find `effect()` usage affected by Angular 19 timing changes](./find-effect-timing-usage.md)
...
* [Find zone.js-dependent test helper usage](./find-fake-async-usage.md)
