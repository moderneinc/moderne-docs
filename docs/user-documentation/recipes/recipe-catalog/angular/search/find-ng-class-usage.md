...
<RecipeHeader.Title>Find `NgClass` usage</RecipeHeader.Title>

<RecipeHeader.Description>Finds imports of `NgClass` from `@angular/common`. The `ngClass` directive is soft deprecated in Angular 21 in favor of native `[class.*]` bindings.</RecipeHeader.Description>
