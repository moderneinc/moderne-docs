...
<RecipeList recipes={[{"name":"Upgrade to Angular 8","href":"angular/upgradetoangular8"},{"name":"Remove `static: false` from view queries","href":"angular/migration/remove-static-false"},{"name":"Enable AOT compilation in `angular.json`","href":"angular/migration/enable-aot-build"},{"name":"Update `tsconfig.json` module settings for Ivy","href":"angular/migration/update-tsconfig-module"},{"name":"Replace `TestBed.get()` with `TestBed.inject()`","href":"angular/migration/replace-testbed-get-with-inject"},{"name":"Add generic type to `ModuleWithProviders`","href":"angular/migration/add-module-with-providers-generic"},{"name":"Find deprecated `Renderer` usage","href":"angular/search/find-renderer-usage"},{"name":"Find deprecated `RenderComponentType` usage","href":"angular/search/find-render-component-type-usage"},{"name":"Find deprecated `RootRenderer` usage","href":"angular/search/find-root-renderer-usage"},{"name":"Find HammerJS usage","href":"angular/search/find-hammer-js-usage"},{"name":"Find deprecated string-based `loadChildren` usage","href":"angular/search/find-load-children-string-usage"},{"name":"Find undecorated classes with Angular features","href":"angular/search/find-undecorated-angular-class"},{"name":"Find classes with DI dependencies but missing `@Injectable()`","href":"angular/search/find-missing-injectable"},{"name":"Find deprecated `ANALYZE_FOR_ENTRY_COMPONENTS` usage","href":"angular/search/find-analyze-for-entry-components-usage"},{"name":"Upgrade npm dependency version","href":"javascript/upgradedependencyversion"},{"name":"Upgrade npm dependency version","href":"javascript/upgradedependencyversion"},{"name":"Upgrade npm dependency version","href":"javascript/upgradedependencyversion"},{"name":"Upgrade npm dependency version","href":"javascript/upgradedependencyversion"},{"name":"Upgrade npm dependency version","href":"javascript/upgradedependencyversion"},{"name":"Upgrade npm dependency version","href":"javascript/upgradedependencyversion"},{"name":"Upgrade npm dependency version","href":"javascript/upgradedependencyversion"}]}>
