...
<RecipeMeta
  ...
  fqName={"io.moderne.hibernate.update66.MigrateCascadeTypes"}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"import org.hibernate.annotations.CascadeType;\nimport org.hibernate.annotations.Cascade;\npublic class SomeClass {\n    @Cascade(CascadeType.SAVE_UPDATE)\n    private Object entity;\n}\n","after":"import org.hibernate.annotations.CascadeType;\nimport org.hibernate.annotations.Cascade;\npublic class SomeClass {\n    @Cascade({CascadeType.PERSIST, CascadeType.MERGE})\n    private Object entity;\n}\n","diff":"@@ -4,1 +4,1 @@\nimport org.hibernate.annotations.Cascade;\npublic class SomeClass {\n-   @Cascade(CascadeType.SAVE_UPDATE)\n+   @Cascade({CascadeType.PERSIST, CascadeType.MERGE})\n    private Object entity;\n","newFile":false}]},{"variants":[{"language":"java","before":"import org.hibernate.annotations.CascadeType;\nimport org.hibernate.annotations.Cascade;\npublic class SomeClass {\n    @Cascade(CascadeType.SAVE_UPDATE)\n    private Object entity;\n}\n","after":"import org.hibernate.annotations.CascadeType;\nimport org.hibernate.annotations.Cascade;\npublic class SomeClass {\n    @Cascade({CascadeType.PERSIST, CascadeType.MERGE})\n    private Object entity;\n}\n","diff":"@@ -4,1 +4,1 @@\nimport org.hibernate.annotations.Cascade;\npublic class SomeClass {\n-   @Cascade(CascadeType.SAVE_UPDATE)\n+   @Cascade({CascadeType.PERSIST, CascadeType.MERGE})\n    private Object entity;\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"io.moderne.hibernate.update66.MigrateCascadeTypes","displayName":"Migrate Hibernate CascadeType constants","groupId":"io.moderne.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
