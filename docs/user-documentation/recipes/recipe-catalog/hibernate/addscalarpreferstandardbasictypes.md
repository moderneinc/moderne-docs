...
[GitHub: AddScalarPreferStandardBasicTypes.java](https://github.com/openrewrite/rewrite-hibernate/blob/main/src/main/java/org/openrewrite/hibernate/AddScalarPreferStandardBasicTypes.java),
