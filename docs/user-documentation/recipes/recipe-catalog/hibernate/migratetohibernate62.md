---
title: "Migrate to Hibernate 6.2.x"
...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/hibernate/migratetohibernate62" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.hibernate.MigrateToHibernate62"}
...
<UsageList usage={{"recipeName":"org.openrewrite.hibernate.MigrateToHibernate62","displayName":"Migrate to Hibernate 6.2.x","groupId":"org.openrewrite.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
