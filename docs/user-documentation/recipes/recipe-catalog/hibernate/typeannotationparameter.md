...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/hibernate/typeannotationparameter" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.hibernate.TypeAnnotationParameter"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-hibernate/blob/main/src/main/java/org/openrewrite/hibernate/TypeAnnotationParameter.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.hibernate.TypeAnnotationParameter","displayName":"`@Type` annotation type parameter migration","groupId":"org.openrewrite.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
