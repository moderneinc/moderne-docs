...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/hibernate/removeinvalidhibernategeneratedvalueannotation" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.hibernate.RemoveInvalidHibernateGeneratedValueAnnotation"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-hibernate/blob/main/src/main/java/org/openrewrite/hibernate/RemoveInvalidHibernateGeneratedValueAnnotation.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.hibernate.RemoveInvalidHibernateGeneratedValueAnnotation","displayName":"Remove invalid `@GeneratedValue` annotation","groupId":"org.openrewrite.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
