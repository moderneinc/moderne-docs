...
<RecipeMeta
  ...
  fqName={"io.moderne.hibernate.update70.ReplaceSessionLockRequest"}
...
<UsageList usage={{"recipeName":"io.moderne.hibernate.update70.ReplaceSessionLockRequest","displayName":"Replace Session.buildLockRequest with LockOptions","groupId":"io.moderne.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
