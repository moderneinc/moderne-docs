...
<RecipeMeta
  ...
  fqName={"io.moderne.hibernate.update70.CompositeUserTypeSessionFactoryImplementor"}
...
<UsageList usage={{"recipeName":"io.moderne.hibernate.update70.CompositeUserTypeSessionFactoryImplementor","displayName":"Remove leaking of SessionFactoryImplementor from `org.hibernate.usertype.CompositeUserType` invocations and implementations","groupId":"io.moderne.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
