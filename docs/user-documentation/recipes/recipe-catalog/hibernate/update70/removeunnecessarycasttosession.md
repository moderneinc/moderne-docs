...
_In Hibernate 7.0, `SessionFactory.createEntityManager()` explicitly returns Session, making casts to Session unnecessary._
...
<RunRecipe
  recipeName="io.moderne.hibernate.update70.RemoveUnnecessaryCastToSession"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.hibernate.update70.RemoveUnnecessaryCastToSession" />
