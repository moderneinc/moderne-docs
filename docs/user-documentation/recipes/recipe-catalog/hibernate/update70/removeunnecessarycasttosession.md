...
<RecipeMeta
  ...
  fqName={"io.moderne.hibernate.update70.RemoveUnnecessaryCastToSession"}
...
<UsageList usage={{"recipeName":"io.moderne.hibernate.update70.RemoveUnnecessaryCastToSession","displayName":"Remove unnecessary cast to `Session` for `SessionFactory.createEntityManager()`","groupId":"io.moderne.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
