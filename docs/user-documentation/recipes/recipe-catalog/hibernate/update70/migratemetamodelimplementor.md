...
<RecipeMeta
  ...
  fqName={"io.moderne.hibernate.update70.MigrateMetamodelImplementor"}
...
<UsageList usage={{"recipeName":"io.moderne.hibernate.update70.MigrateMetamodelImplementor","displayName":"Migrate `MetamodelImplementor` to Hibernate 7.0","groupId":"io.moderne.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
