...
<RecipeMeta
  ...
  fqName={"io.moderne.hibernate.update70.MigrateSessionToDeferToJPA"}
...
<UsageList usage={{"recipeName":"io.moderne.hibernate.update70.MigrateSessionToDeferToJPA","displayName":"Migrate Session save/update/delete method calls","groupId":"io.moderne.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
