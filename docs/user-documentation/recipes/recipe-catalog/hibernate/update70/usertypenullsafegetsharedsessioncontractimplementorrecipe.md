---
title: "Remove leaking of SharedSessionContractImplementor from `org.hibernate.usertype.UserType` invocations"
...
<RecipeMeta
  ...
  fqName={"io.moderne.hibernate.update70.UserTypeNullSafeGetSharedSessionContractImplementorRecipe"}
...
<UsageList usage={{"recipeName":"io.moderne.hibernate.update70.UserTypeNullSafeGetSharedSessionContractImplementorRecipe","displayName":"Remove leaking of SharedSessionContractImplementor from `org.hibernate.usertype.UserType` invocations","groupId":"io.moderne.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
