...
<RecipeMeta
  ...
  fqName={"io.moderne.hibernate.update70.MigrateQueryToNativeQuery"}
...
<UsageList usage={{"recipeName":"io.moderne.hibernate.update70.MigrateQueryToNativeQuery","displayName":"Migrate @Query to @NativeQuery for unsupported JPQL","groupId":"io.moderne.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
