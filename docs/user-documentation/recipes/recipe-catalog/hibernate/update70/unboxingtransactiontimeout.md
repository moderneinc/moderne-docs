...
<RecipeMeta
  ...
  fqName={"io.moderne.hibernate.update70.UnboxingTransactionTimeout"}
...
<UsageList usage={{"recipeName":"io.moderne.hibernate.update70.UnboxingTransactionTimeout","displayName":"Null safe Transaction#getTimeout()","groupId":"io.moderne.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
