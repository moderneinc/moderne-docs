...
<RecipeMeta
  ...
  fqName={"io.moderne.hibernate.update70.FindNativeQueryRawEnumParameters"}
...
<UsageList usage={{"recipeName":"io.moderne.hibernate.update70.FindNativeQueryRawEnumParameters","displayName":"Find native queries with enum parameters requiring SpEL conversion","groupId":"io.moderne.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
