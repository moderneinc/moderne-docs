...
<RecipeMeta
  ...
  fqName={"io.moderne.hibernate.update70.MigrateSessionInterface"}
...
<UsageList usage={{"recipeName":"io.moderne.hibernate.update70.MigrateSessionInterface","displayName":"Migrate Session interface method calls","groupId":"io.moderne.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
