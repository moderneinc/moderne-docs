...
<RecipeMeta
  ...
  fqName={"io.moderne.hibernate.update70.MigrateLockOptionsToDirectParameters"}
...
<UsageList usage={{"recipeName":"io.moderne.hibernate.update70.MigrateLockOptionsToDirectParameters","displayName":"Migrate LockOptions to direct parameters","groupId":"io.moderne.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
