...
<RecipeList recipes={[{"name":"Migrate to Hibernate 4.0.x","href":"hibernate/migratetohibernate40"},{"name":"Migrate to Hibernate 6.0.x","href":"hibernate/migratetohibernate60-community-edition"},{"name":"Upgrade Gradle or Maven dependency versions","href":"java/dependencies/upgradedependencyversion"},{"name":"Upgrade Gradle or Maven dependency versions","href":"java/dependencies/upgradedependencyversion"},{"name":"Change Gradle or Maven dependency","href":"java/dependencies/changedependency"},{"name":"Change Gradle or Maven dependency","href":"java/dependencies/changedependency"},{"name":"Change Gradle or Maven dependency","href":"java/dependencies/changedependency"},{"name":"Change Gradle or Maven dependency","href":"java/dependencies/changedependency"},{"name":"Migrate Hibernate Criteria API to JPA Criteria API","href":"hibernate/update60/migratehibernatecriteriatojpacriteria"},{"name":"Migrate removed Hibernate UUID `@Type` to `@JdbcTypeCode`","href":"hibernate/update60/migrateremoveduuidtypes"},{"name":"Change type","href":"java/changetype"},{"name":"Change method name","href":"java/changemethodname"}]} preconditions={[{"name":"Singleton","href":"core/singleton"}]}>
