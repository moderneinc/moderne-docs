...
_This recipe will apply changes commonly needed when migrating to Hibernate 6.0.x._
...
## Examples
##### Example 1
`MigrateToHibernate60Test#migrateJacksonDatatypeHibernate5`
...
<RunRecipe
  recipeName="io.moderne.hibernate.MigrateToHibernate60"
  displayName="Migrate to Hibernate 6.0.x (Moderne Edition)"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.hibernate.MigrateToHibernate60" />
