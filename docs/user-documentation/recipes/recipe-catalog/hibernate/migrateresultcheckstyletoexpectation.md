...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/hibernate/migrateresultcheckstyletoexpectation" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.hibernate.MigrateResultCheckStyleToExpectation"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-hibernate/blob/main/src/main/java/org/openrewrite/hibernate/MigrateResultCheckStyleToExpectation.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.hibernate.MigrateResultCheckStyleToExpectation","displayName":"Migration of `ResultCheckStyle` to `Expectation`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
