...
[GitHub: hibernate-6.5.yml](https://github.com/openrewrite/rewrite-hibernate/blob/main/src/main/resources/META-INF/rewrite/hibernate-6.5.yml),
...
<RunRecipe
  recipeName="org.openrewrite.hibernate.MigrateToHibernate65"
  displayName="Migrate to Hibernate 6.5.x"
