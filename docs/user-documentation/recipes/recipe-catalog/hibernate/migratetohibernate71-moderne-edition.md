...
<RunRecipe
  recipeName="io.moderne.hibernate.MigrateToHibernate71"
  displayName="Migrate to Hibernate 7.1.x (Moderne Edition)"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.hibernate.MigrateToHibernate71" />
