...
<RecipeMeta
  ...
  fqName={"io.moderne.hibernate.update40.MigrateJoinTableToCollectionTable"}
...
<UsageList usage={{"recipeName":"io.moderne.hibernate.update40.MigrateJoinTableToCollectionTable","displayName":"Migrate `@JoinTable` to `@CollectionTable` for element collections","groupId":"io.moderne.recipe","artifactId":"rewrite-hibernate","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_HIBERNATE","requiresConfiguration":false}}>
