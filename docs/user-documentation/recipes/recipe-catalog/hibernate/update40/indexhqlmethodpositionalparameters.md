...
_Replaces unindexed `?` positional parameters with indexed `?1`, `?2`, etc. in an HQL/JPQL query string passed as the first argument of a method matching the given pattern._
...
| --- | --- | --- | --- |
| `String` | methodPattern | A method pattern whose first argument is an HQL/JPQL query string. Example: `org.hibernate.Session createQuery(String,..)`. | `org.hibernate.Session createQuery(String,..)` |
...
name: com.yourorg.IndexHqlMethodPositionalParametersExample
displayName: Index HQL/JPQL positional parameters in method calls example
recipeList:
  - io.moderne.hibernate.update40.IndexHqlMethodPositionalParameters:
      methodPattern: org.hibernate.Session createQuery(String,..)
```
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.hibernate.update40.IndexHqlMethodPositionalParameters" />
