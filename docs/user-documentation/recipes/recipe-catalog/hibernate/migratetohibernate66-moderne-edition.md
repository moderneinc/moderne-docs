...
<RunRecipe
  recipeName="io.moderne.hibernate.MigrateToHibernate66"
  displayName="Migrate to Hibernate 6.6.x (Moderne Edition)"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.hibernate.MigrateToHibernate66" />
