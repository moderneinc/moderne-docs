...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/uselangwordinxmlcommentma0154" />
</head>
...
[GitHub: UseLangwordInXmlCommentMA0154.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/UseLangwordInXmlCommentMA0154.java),
...
```shell title="shell"
mod run . --recipe UseLangwordInXmlCommentMA0154
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.UseLangwordInXmlCommentMA0154" />
