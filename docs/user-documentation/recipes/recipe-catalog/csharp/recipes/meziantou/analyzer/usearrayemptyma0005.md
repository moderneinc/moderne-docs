...
[GitHub: UseArrayEmptyMA0005.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/UseArrayEmptyMA0005.java),
...
```shell title="shell"
mod run . --recipe UseArrayEmptyMA0005
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.UseArrayEmptyMA0005" />
