---
sidebar_label: "Avoid implicit culture-sensitive methods"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/usestringcomparisonma0074" />
</head>
...
[GitHub: UseStringComparisonMA0074.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/UseStringComparisonMA0074.java),
...
```shell title="shell"
mod run . --recipe UseStringComparisonMA0074
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.UseStringComparisonMA0074" />
