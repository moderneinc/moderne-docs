...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/usestringcomparerma0002" />
</head>
...
[GitHub: UseStringComparerMA0002.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/UseStringComparerMA0002.java),
...
```shell title="shell"
mod run . --recipe UseStringComparerMA0002
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.UseStringComparerMA0002" />
