...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/makeclassstaticma0036" />
</head>
...
[GitHub: MakeClassStaticMA0036.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/MakeClassStaticMA0036.java),
...
```shell title="shell"
mod run . --recipe MakeClassStaticMA0036
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.MakeClassStaticMA0036" />
