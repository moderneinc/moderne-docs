...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/useispatterninsteadofsequenceequalma0128" />
</head>
...
[GitHub: UseIsPatternInsteadOfSequenceEqualMA0128.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/UseIsPatternInsteadOfSequenceEqualMA0128.java),
...
```shell title="shell"
mod run . --recipe UseIsPatternInsteadOfSequenceEqualMA0128
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.UseIsPatternInsteadOfSequenceEqualMA0128" />
