...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/removeemptystatementma0037"
---
...
[GitHub: RemoveEmptyStatementMA0037.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/RemoveEmptyStatementMA0037.java),
...
```shell title="shell"
mod run . --recipe RemoveEmptyStatementMA0037
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.RemoveEmptyStatementMA0037" />
