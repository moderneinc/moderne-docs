...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/usestringequalsma0006" />
</head>
...
[GitHub: UseStringEqualsMA0006.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/UseStringEqualsMA0006.java),
...
```shell title="shell"
mod run . --recipe UseStringEqualsMA0006
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.UseStringEqualsMA0006" />
