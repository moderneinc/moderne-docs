...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/methodoverridesshouldnotchangeparameterdefaultsma0061" />
</head>
...
[GitHub: MethodOverridesShouldNotChangeParameterDefaultsMA0061.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/MethodOverridesShouldNotChangeParameterDefaultsMA0061.java),
...
```shell title="shell"
mod run . --recipe MethodOverridesShouldNotChangeParameterDefaultsMA0061
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.MethodOverridesShouldNotChangeParameterDefaultsMA0061" />
