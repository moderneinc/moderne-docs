...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/optimizestartswithma0089" />
</head>
...
[GitHub: OptimizeStartsWithMA0089.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/OptimizeStartsWithMA0089.java),
...
```shell title="shell"
mod run . --recipe OptimizeStartsWithMA0089
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.OptimizeStartsWithMA0089" />
