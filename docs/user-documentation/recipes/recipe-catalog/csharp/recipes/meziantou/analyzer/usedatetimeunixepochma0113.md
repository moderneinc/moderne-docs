...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/usedatetimeunixepochma0113" />
</head>
...
[GitHub: UseDateTimeUnixEpochMA0113.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/UseDateTimeUnixEpochMA0113.java),
...
```shell title="shell"
mod run . --recipe UseDateTimeUnixEpochMA0113
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.UseDateTimeUnixEpochMA0113" />
