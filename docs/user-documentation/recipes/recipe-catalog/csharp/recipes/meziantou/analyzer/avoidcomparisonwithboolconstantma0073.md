...
[GitHub: AvoidComparisonWithBoolConstantMA0073.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/AvoidComparisonWithBoolConstantMA0073.java),
...
```shell title="shell"
mod run . --recipe AvoidComparisonWithBoolConstantMA0073
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.AvoidComparisonWithBoolConstantMA0073" />
