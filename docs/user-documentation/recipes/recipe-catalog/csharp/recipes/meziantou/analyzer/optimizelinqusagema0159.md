...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/optimizelinqusagema0159" />
</head>
...
[GitHub: OptimizeLinqUsageMA0159.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/OptimizeLinqUsageMA0159.java),
...
```shell title="shell"
mod run . --recipe OptimizeLinqUsageMA0159
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.OptimizeLinqUsageMA0159" />
