---
sidebar_label: "Make property static (deprecated, use CA1822 instead)"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/makemethodstaticma0041" />
</head>
...
[GitHub: MakeMethodStaticMA0041.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/MakeMethodStaticMA0041.java),
...
```shell title="shell"
mod run . --recipe MakeMethodStaticMA0041
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.MakeMethodStaticMA0041" />
