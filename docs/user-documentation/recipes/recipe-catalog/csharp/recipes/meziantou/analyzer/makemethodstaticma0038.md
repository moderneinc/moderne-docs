...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/makemethodstaticma0038" />
</head>
...
[GitHub: MakeMethodStaticMA0038.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/MakeMethodStaticMA0038.java),
...
```shell title="shell"
mod run . --recipe MakeMethodStaticMA0038
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.MakeMethodStaticMA0038" />
