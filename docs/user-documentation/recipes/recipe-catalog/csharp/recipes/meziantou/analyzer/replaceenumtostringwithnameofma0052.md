...
[GitHub: ReplaceEnumToStringWithNameofMA0052.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/ReplaceEnumToStringWithNameofMA0052.java),
...
```shell title="shell"
mod run . --recipe ReplaceEnumToStringWithNameofMA0052
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.ReplaceEnumToStringWithNameofMA0052" />
