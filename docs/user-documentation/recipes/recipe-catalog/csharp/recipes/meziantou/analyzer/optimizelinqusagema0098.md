---
sidebar_label: "Use indexer instead of LINQ methods"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/optimizelinqusagema0098" />
</head>
...
[GitHub: OptimizeLinqUsageMA0098.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/OptimizeLinqUsageMA0098.java),
...
```shell title="shell"
mod run . --recipe OptimizeLinqUsageMA0098
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.OptimizeLinqUsageMA0098" />
