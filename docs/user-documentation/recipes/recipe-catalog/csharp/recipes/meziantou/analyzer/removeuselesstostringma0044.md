...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/removeuselesstostringma0044" />
</head>
...
[GitHub: RemoveUselessToStringMA0044.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/RemoveUselessToStringMA0044.java),
...
```shell title="shell"
mod run . --recipe RemoveUselessToStringMA0044
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.RemoveUselessToStringMA0044" />
