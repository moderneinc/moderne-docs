...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/usejsruntimeinvokevoidasyncwhenreturnvalueisnotusedma0120"
---
...
[GitHub: UseJSRuntimeInvokeVoidAsyncWhenReturnValueIsNotUsedMA0120.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/UseJSRuntimeInvokeVoidAsyncWhenReturnValueIsNotUsedMA0120.java),
...
```shell title="shell"
mod run . --recipe UseJSRuntimeInvokeVoidAsyncWhenReturnValueIsNotUsedMA0120
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.UseJSRuntimeInvokeVoidAsyncWhenReturnValueIsNotUsedMA0120" />
