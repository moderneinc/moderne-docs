...
[GitHub: MarkAttributesWithAttributeUsageAttributeMA0010.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/MarkAttributesWithAttributeUsageAttributeMA0010.java),
...
```shell title="shell"
mod run . --recipe MarkAttributesWithAttributeUsageAttributeMA0010
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.MarkAttributesWithAttributeUsageAttributeMA0010" />
