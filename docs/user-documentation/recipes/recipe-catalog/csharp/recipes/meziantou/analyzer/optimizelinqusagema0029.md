...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/optimizelinqusagema0029" />
</head>
...
[GitHub: OptimizeLinqUsageMA0029.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/OptimizeLinqUsageMA0029.java),
...
```shell title="shell"
mod run . --recipe OptimizeLinqUsageMA0029
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.OptimizeLinqUsageMA0029" />
