...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/meziantou/analyzer/notpatternshouldbeparenthesizedcodema0164" />
</head>
...
[GitHub: NotPatternShouldBeParenthesizedCodeMA0164.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/meziantou/analyzer/NotPatternShouldBeParenthesizedCodeMA0164.java),
...
```shell title="shell"
mod run . --recipe NotPatternShouldBeParenthesizedCodeMA0164
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.meziantou.analyzer.NotPatternShouldBeParenthesizedCodeMA0164" />
