...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/unnecessaryexplicituseofenumeratorrcs1230" />
</head>
...
[GitHub: UnnecessaryExplicitUseOfEnumeratorRCS1230.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/UnnecessaryExplicitUseOfEnumeratorRCS1230.java),
...
```shell title="shell"
mod run . --recipe UnnecessaryExplicitUseOfEnumeratorRCS1230
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.UnnecessaryExplicitUseOfEnumeratorRCS1230" />
