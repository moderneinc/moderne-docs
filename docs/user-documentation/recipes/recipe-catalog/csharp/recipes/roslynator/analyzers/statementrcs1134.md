---
sidebar_label: "Remove redundant statement"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/statementrcs1134" />
</head>
...
[GitHub: StatementRCS1134.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/StatementRCS1134.java),
...
```shell title="shell"
mod run . --recipe StatementRCS1134
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.StatementRCS1134" />
