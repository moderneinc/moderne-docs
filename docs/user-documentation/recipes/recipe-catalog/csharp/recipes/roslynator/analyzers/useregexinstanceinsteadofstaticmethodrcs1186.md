...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/useregexinstanceinsteadofstaticmethodrcs1186" />
</head>
...
[GitHub: UseRegexInstanceInsteadOfStaticMethodRCS1186.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/UseRegexInstanceInsteadOfStaticMethodRCS1186.java),
...
```shell title="shell"
mod run . --recipe UseRegexInstanceInsteadOfStaticMethodRCS1186
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.UseRegexInstanceInsteadOfStaticMethodRCS1186" />
