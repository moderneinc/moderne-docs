...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/parenthesizedexpressionrcs1032" />
</head>
...
[GitHub: ParenthesizedExpressionRCS1032.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ParenthesizedExpressionRCS1032.java),
...
```shell title="shell"
mod run . --recipe ParenthesizedExpressionRCS1032
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ParenthesizedExpressionRCS1032" />
