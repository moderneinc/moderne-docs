...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/whitespacetriviarcs1037" />
</head>
...
[GitHub: WhitespaceTriviaRCS1037.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/WhitespaceTriviaRCS1037.java),
...
```shell title="shell"
mod run . --recipe WhitespaceTriviaRCS1037
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.WhitespaceTriviaRCS1037" />
