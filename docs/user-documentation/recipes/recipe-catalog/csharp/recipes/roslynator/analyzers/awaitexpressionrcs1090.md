...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/awaitexpressionrcs1090" />
</head>
...
[GitHub: AwaitExpressionRCS1090.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/AwaitExpressionRCS1090.java),
...
```shell title="shell"
mod run . --recipe AwaitExpressionRCS1090
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.AwaitExpressionRCS1090" />
