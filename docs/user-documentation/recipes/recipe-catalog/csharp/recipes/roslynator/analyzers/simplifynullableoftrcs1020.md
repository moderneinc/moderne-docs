...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/simplifynullableoftrcs1020" />
</head>
...
[GitHub: SimplifyNullableOfTRCS1020.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/SimplifyNullableOfTRCS1020.java),
...
```shell title="shell"
mod run . --recipe SimplifyNullableOfTRCS1020
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.SimplifyNullableOfTRCS1020" />
