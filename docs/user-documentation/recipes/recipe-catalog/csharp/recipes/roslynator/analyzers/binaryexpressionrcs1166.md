...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/binaryexpressionrcs1166" />
</head>
...
[GitHub: BinaryExpressionRCS1166.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/BinaryExpressionRCS1166.java),
...
```shell title="shell"
mod run . --recipe BinaryExpressionRCS1166
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.BinaryExpressionRCS1166" />
