...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/switchsectionrcs1111" />
</head>
...
[GitHub: SwitchSectionRCS1111.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/SwitchSectionRCS1111.java),
...
```shell title="shell"
mod run . --recipe SwitchSectionRCS1111
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.SwitchSectionRCS1111" />
