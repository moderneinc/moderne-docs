...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/enumdeclarationrcs1161" />
</head>
...
[GitHub: EnumDeclarationRCS1161.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/EnumDeclarationRCS1161.java),
...
```shell title="shell"
mod run . --recipe EnumDeclarationRCS1161
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.EnumDeclarationRCS1161" />
