...
[GitHub: MarkTypeWithDebuggerDisplayAttributeRCS1223.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/MarkTypeWithDebuggerDisplayAttributeRCS1223.java),
...
```shell title="shell"
mod run . --recipe MarkTypeWithDebuggerDisplayAttributeRCS1223
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.MarkTypeWithDebuggerDisplayAttributeRCS1223" />
