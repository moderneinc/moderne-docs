---
sidebar_label: "Optimize method call"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/optimizemethodcallrcs1235" />
</head>
...
[GitHub: OptimizeMethodCallRCS1235.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/OptimizeMethodCallRCS1235.java),
...
```shell title="shell"
mod run . --recipe OptimizeMethodCallRCS1235
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.OptimizeMethodCallRCS1235" />
