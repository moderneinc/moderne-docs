...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/compositeenumvaluecontainsundefinedflagrcs1157" />
</head>
...
[GitHub: CompositeEnumValueContainsUndefinedFlagRCS1157.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/CompositeEnumValueContainsUndefinedFlagRCS1157.java),
...
```shell title="shell"
mod run . --recipe CompositeEnumValueContainsUndefinedFlagRCS1157
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.CompositeEnumValueContainsUndefinedFlagRCS1157" />
