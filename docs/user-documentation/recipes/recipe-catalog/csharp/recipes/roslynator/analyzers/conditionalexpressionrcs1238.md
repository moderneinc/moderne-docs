...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/conditionalexpressionrcs1238" />
</head>
...
[GitHub: ConditionalExpressionRCS1238.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ConditionalExpressionRCS1238.java),
...
```shell title="shell"
mod run . --recipe ConditionalExpressionRCS1238
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ConditionalExpressionRCS1238" />
