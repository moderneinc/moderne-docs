...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/returncompletedtaskinsteadofnullrcs1210" />
</head>
...
[GitHub: ReturnCompletedTaskInsteadOfNullRCS1210.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ReturnCompletedTaskInsteadOfNullRCS1210.java),
...
```shell title="shell"
mod run . --recipe ReturnCompletedTaskInsteadOfNullRCS1210
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ReturnCompletedTaskInsteadOfNullRCS1210" />
