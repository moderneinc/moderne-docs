...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/propertydeclarationrcs1188" />
</head>
...
[GitHub: PropertyDeclarationRCS1188.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/PropertyDeclarationRCS1188.java),
...
```shell title="shell"
mod run . --recipe PropertyDeclarationRCS1188
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.PropertyDeclarationRCS1188" />
