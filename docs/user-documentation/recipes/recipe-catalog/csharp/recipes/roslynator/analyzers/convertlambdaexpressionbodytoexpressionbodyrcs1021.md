...
[GitHub: ConvertLambdaExpressionBodyToExpressionBodyRCS1021.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ConvertLambdaExpressionBodyToExpressionBodyRCS1021.java),
...
```shell title="shell"
mod run . --recipe ConvertLambdaExpressionBodyToExpressionBodyRCS1021
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ConvertLambdaExpressionBodyToExpressionBodyRCS1021" />
