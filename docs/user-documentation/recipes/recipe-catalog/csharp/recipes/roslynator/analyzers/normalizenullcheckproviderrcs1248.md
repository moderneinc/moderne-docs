---
sidebar_label: "Normalize null check"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/normalizenullcheckproviderrcs1248" />
</head>
...
[GitHub: NormalizeNullCheckProviderRCS1248.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/NormalizeNullCheckProviderRCS1248.java),
...
```shell title="shell"
mod run . --recipe NormalizeNullCheckProviderRCS1248
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.NormalizeNullCheckProviderRCS1248" />
