...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/assignmentexpressionrcs1089" />
</head>
...
[GitHub: AssignmentExpressionRCS1089.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/AssignmentExpressionRCS1089.java),
...
```shell title="shell"
mod run . --recipe AssignmentExpressionRCS1089
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.AssignmentExpressionRCS1089" />
