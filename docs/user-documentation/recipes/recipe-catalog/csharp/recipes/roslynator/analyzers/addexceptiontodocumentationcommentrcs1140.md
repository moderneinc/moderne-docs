...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/addexceptiontodocumentationcommentrcs1140" />
</head>
...
[GitHub: AddExceptionToDocumentationCommentRCS1140.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/AddExceptionToDocumentationCommentRCS1140.java),
...
```shell title="shell"
mod run . --recipe AddExceptionToDocumentationCommentRCS1140
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.AddExceptionToDocumentationCommentRCS1140" />
