...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/removeenumdefaultbasetypercs1042" />
</head>
...
[GitHub: RemoveEnumDefaultBaseTypeRCS1042.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/RemoveEnumDefaultBaseTypeRCS1042.java),
...
```shell title="shell"
mod run . --recipe RemoveEnumDefaultBaseTypeRCS1042
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.RemoveEnumDefaultBaseTypeRCS1042" />
