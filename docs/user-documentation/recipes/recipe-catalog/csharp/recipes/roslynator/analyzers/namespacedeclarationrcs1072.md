...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/namespacedeclarationrcs1072" />
</head>
...
[GitHub: NamespaceDeclarationRCS1072.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/NamespaceDeclarationRCS1072.java),
...
```shell title="shell"
mod run . --recipe NamespaceDeclarationRCS1072
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.NamespaceDeclarationRCS1072" />
