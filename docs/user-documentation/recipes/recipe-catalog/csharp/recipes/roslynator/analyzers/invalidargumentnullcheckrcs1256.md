...
[GitHub: InvalidArgumentNullCheckRCS1256.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/InvalidArgumentNullCheckRCS1256.java),
...
```shell title="shell"
mod run . --recipe InvalidArgumentNullCheckRCS1256
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.InvalidArgumentNullCheckRCS1256" />
