...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/binaryexpressionrcs1113" />
</head>
...
[GitHub: BinaryExpressionRCS1113.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/BinaryExpressionRCS1113.java),
...
```shell title="shell"
mod run . --recipe BinaryExpressionRCS1113
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.BinaryExpressionRCS1113" />
