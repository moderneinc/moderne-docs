...
[GitHub: UseBlockBodyOrExpressionBodyRCS1016.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/UseBlockBodyOrExpressionBodyRCS1016.java),
...
```shell title="shell"
mod run . --recipe UseBlockBodyOrExpressionBodyRCS1016
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.UseBlockBodyOrExpressionBodyRCS1016" />
