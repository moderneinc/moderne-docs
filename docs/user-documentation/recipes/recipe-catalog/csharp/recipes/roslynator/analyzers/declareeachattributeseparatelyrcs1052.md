...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/declareeachattributeseparatelyrcs1052" />
</head>
...
[GitHub: DeclareEachAttributeSeparatelyRCS1052.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/DeclareEachAttributeSeparatelyRCS1052.java),
...
```shell title="shell"
mod run . --recipe DeclareEachAttributeSeparatelyRCS1052
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.DeclareEachAttributeSeparatelyRCS1052" />
