...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/removebracesfromifelsercs1004" />
</head>
...
[GitHub: RemoveBracesFromIfElseRCS1004.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/RemoveBracesFromIfElseRCS1004.java),
...
```shell title="shell"
mod run . --recipe RemoveBracesFromIfElseRCS1004
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.RemoveBracesFromIfElseRCS1004" />
