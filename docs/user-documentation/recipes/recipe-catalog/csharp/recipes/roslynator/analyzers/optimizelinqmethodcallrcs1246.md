...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/optimizelinqmethodcallrcs1246" />
</head>
...
[GitHub: OptimizeLinqMethodCallRCS1246.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/OptimizeLinqMethodCallRCS1246.java),
...
```shell title="shell"
mod run . --recipe OptimizeLinqMethodCallRCS1246
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.OptimizeLinqMethodCallRCS1246" />
