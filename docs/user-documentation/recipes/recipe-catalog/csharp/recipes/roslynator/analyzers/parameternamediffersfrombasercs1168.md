...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/parameternamediffersfrombasercs1168"
---
...
[GitHub: ParameterNameDiffersFromBaseRCS1168.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ParameterNameDiffersFromBaseRCS1168.java),
...
```shell title="shell"
mod run . --recipe ParameterNameDiffersFromBaseRCS1168
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ParameterNameDiffersFromBaseRCS1168" />
