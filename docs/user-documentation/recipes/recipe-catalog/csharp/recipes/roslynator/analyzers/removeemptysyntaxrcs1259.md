---
sidebar_label: "Remove empty syntax"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/removeemptysyntaxrcs1259" />
</head>
...
[GitHub: RemoveEmptySyntaxRCS1259.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/RemoveEmptySyntaxRCS1259.java),
...
```shell title="shell"
mod run . --recipe RemoveEmptySyntaxRCS1259
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.RemoveEmptySyntaxRCS1259" />
