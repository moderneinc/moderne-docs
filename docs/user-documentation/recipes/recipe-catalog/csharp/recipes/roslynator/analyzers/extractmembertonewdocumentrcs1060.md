...
[GitHub: ExtractMemberToNewDocumentRCS1060.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ExtractMemberToNewDocumentRCS1060.java),
...
```shell title="shell"
mod run . --recipe ExtractMemberToNewDocumentRCS1060
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ExtractMemberToNewDocumentRCS1060" />
