...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/removeoriginalexceptionrcs1044" />
</head>
...
[GitHub: RemoveOriginalExceptionRCS1044.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/RemoveOriginalExceptionRCS1044.java),
...
```shell title="shell"
mod run . --recipe RemoveOriginalExceptionRCS1044
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.RemoveOriginalExceptionRCS1044" />
