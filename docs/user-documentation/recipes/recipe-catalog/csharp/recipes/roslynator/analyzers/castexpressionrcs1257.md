...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/castexpressionrcs1257" />
</head>
...
[GitHub: CastExpressionRCS1257.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/CastExpressionRCS1257.java),
...
```shell title="shell"
mod run . --recipe CastExpressionRCS1257
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.CastExpressionRCS1257" />
