---
sidebar_label: "Inline lazy initialization"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/statementrcs1180" />
</head>
...
[GitHub: StatementRCS1180.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/StatementRCS1180.java),
...
```shell title="shell"
mod run . --recipe StatementRCS1180
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.StatementRCS1180" />
