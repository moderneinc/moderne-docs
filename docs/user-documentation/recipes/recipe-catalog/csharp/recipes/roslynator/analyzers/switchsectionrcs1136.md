...
[GitHub: SwitchSectionRCS1136.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/SwitchSectionRCS1136.java),
...
```shell title="shell"
mod run . --recipe SwitchSectionRCS1136
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.SwitchSectionRCS1136" />
