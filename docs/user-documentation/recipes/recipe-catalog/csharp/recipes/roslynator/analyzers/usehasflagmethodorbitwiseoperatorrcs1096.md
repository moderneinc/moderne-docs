...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/usehasflagmethodorbitwiseoperatorrcs1096"
---
...
[GitHub: UseHasFlagMethodOrBitwiseOperatorRCS1096.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/UseHasFlagMethodOrBitwiseOperatorRCS1096.java),
...
```shell title="shell"
mod run . --recipe UseHasFlagMethodOrBitwiseOperatorRCS1096
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.UseHasFlagMethodOrBitwiseOperatorRCS1096" />
