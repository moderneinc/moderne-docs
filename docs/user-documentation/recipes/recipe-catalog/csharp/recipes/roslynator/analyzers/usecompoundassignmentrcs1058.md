...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/usecompoundassignmentrcs1058" />
</head>
...
[GitHub: UseCompoundAssignmentRCS1058.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/UseCompoundAssignmentRCS1058.java),
...
```shell title="shell"
mod run . --recipe UseCompoundAssignmentRCS1058
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.UseCompoundAssignmentRCS1058" />
