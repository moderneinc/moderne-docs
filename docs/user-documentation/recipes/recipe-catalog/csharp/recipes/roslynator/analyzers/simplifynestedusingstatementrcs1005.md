...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/simplifynestedusingstatementrcs1005" />
</head>
...
[GitHub: SimplifyNestedUsingStatementRCS1005.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/SimplifyNestedUsingStatementRCS1005.java),
...
```shell title="shell"
mod run . --recipe SimplifyNestedUsingStatementRCS1005
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.SimplifyNestedUsingStatementRCS1005" />
