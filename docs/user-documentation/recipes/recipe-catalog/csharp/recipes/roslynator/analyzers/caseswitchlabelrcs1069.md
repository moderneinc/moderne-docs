...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/caseswitchlabelrcs1069" />
</head>
...
[GitHub: CaseSwitchLabelRCS1069.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/CaseSwitchLabelRCS1069.java),
...
```shell title="shell"
mod run . --recipe CaseSwitchLabelRCS1069
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.CaseSwitchLabelRCS1069" />
