...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/enummemberdeclarationrcs1191" />
</head>
...
[GitHub: EnumMemberDeclarationRCS1191.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/EnumMemberDeclarationRCS1191.java),
...
```shell title="shell"
mod run . --recipe EnumMemberDeclarationRCS1191
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.EnumMemberDeclarationRCS1191" />
