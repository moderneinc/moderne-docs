...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/elseclausercs1006" />
</head>
...
[GitHub: ElseClauseRCS1006.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ElseClauseRCS1006.java),
...
```shell title="shell"
mod run . --recipe ElseClauseRCS1006
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ElseClauseRCS1006" />
