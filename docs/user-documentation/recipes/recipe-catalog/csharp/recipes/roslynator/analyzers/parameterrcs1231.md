...
[GitHub: ParameterRCS1231.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ParameterRCS1231.java),
...
```shell title="shell"
mod run . --recipe ParameterRCS1231
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ParameterRCS1231" />
