---
sidebar_label: "Use raw string literal"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/rawstringliteralrcs1266" />
</head>
...
[GitHub: RawStringLiteralRCS1266.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/RawStringLiteralRCS1266.java),
...
```shell title="shell"
mod run . --recipe RawStringLiteralRCS1266
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.RawStringLiteralRCS1266" />
