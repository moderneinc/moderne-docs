...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/optimizestringbuilderappendcallrcs1197" />
</head>
...
[GitHub: OptimizeStringBuilderAppendCallRCS1197.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/OptimizeStringBuilderAppendCallRCS1197.java),
...
```shell title="shell"
mod run . --recipe OptimizeStringBuilderAppendCallRCS1197
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.OptimizeStringBuilderAppendCallRCS1197" />
