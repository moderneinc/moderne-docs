...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/addorremoveparentheseswhencreatingnewobjectrcs1050" />
</head>
...
[GitHub: AddOrRemoveParenthesesWhenCreatingNewObjectRCS1050.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/AddOrRemoveParenthesesWhenCreatingNewObjectRCS1050.java),
...
```shell title="shell"
mod run . --recipe AddOrRemoveParenthesesWhenCreatingNewObjectRCS1050
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.AddOrRemoveParenthesesWhenCreatingNewObjectRCS1050" />
