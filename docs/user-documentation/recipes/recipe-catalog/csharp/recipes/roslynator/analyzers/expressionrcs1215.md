...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/expressionrcs1215" />
</head>
...
[GitHub: ExpressionRCS1215.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ExpressionRCS1215.java),
...
```shell title="shell"
mod run . --recipe ExpressionRCS1215
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ExpressionRCS1215" />
