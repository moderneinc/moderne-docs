...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/useautopropertyrcs1085" />
</head>
...
[GitHub: UseAutoPropertyRCS1085.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/UseAutoPropertyRCS1085.java),
...
```shell title="shell"
mod run . --recipe UseAutoPropertyRCS1085
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.UseAutoPropertyRCS1085" />
