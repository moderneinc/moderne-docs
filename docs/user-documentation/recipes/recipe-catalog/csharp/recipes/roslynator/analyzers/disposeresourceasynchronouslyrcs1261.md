...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/disposeresourceasynchronouslyrcs1261" />
</head>
...
[GitHub: DisposeResourceAsynchronouslyRCS1261.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/DisposeResourceAsynchronouslyRCS1261.java),
...
```shell title="shell"
mod run . --recipe DisposeResourceAsynchronouslyRCS1261
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.DisposeResourceAsynchronouslyRCS1261" />
