...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/removepartialmodifierfromtypewithsinglepartrcs1043" />
</head>
...
[GitHub: RemovePartialModifierFromTypeWithSinglePartRCS1043.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/RemovePartialModifierFromTypeWithSinglePartRCS1043.java),
...
```shell title="shell"
mod run . --recipe RemovePartialModifierFromTypeWithSinglePartRCS1043
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.RemovePartialModifierFromTypeWithSinglePartRCS1043" />
