---
sidebar_label: "Convert 'if' to assignment"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/ifstatementrcs1103" />
</head>
...
[GitHub: IfStatementRCS1103.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/IfStatementRCS1103.java),
...
```shell title="shell"
mod run . --recipe IfStatementRCS1103
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.IfStatementRCS1103" />
