...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/declaretypeinsidenamespacercs1110" />
</head>
...
[GitHub: DeclareTypeInsideNamespaceRCS1110.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/DeclareTypeInsideNamespaceRCS1110.java),
...
```shell title="shell"
mod run . --recipe DeclareTypeInsideNamespaceRCS1110
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.DeclareTypeInsideNamespaceRCS1110" />
