...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/classdeclarationrcs1194" />
</head>
...
[GitHub: ClassDeclarationRCS1194.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ClassDeclarationRCS1194.java),
...
```shell title="shell"
mod run . --recipe ClassDeclarationRCS1194
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ClassDeclarationRCS1194" />
