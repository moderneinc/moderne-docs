...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/documentationcommentrcs1139"
---
...
[GitHub: DocumentationCommentRCS1139.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/DocumentationCommentRCS1139.java),
...
```shell title="shell"
mod run . --recipe DocumentationCommentRCS1139
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.DocumentationCommentRCS1139" />
