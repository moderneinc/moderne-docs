...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/whilestatementrcs1239" />
</head>
...
[GitHub: WhileStatementRCS1239.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/WhileStatementRCS1239.java),
...
```shell title="shell"
mod run . --recipe WhileStatementRCS1239
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.WhileStatementRCS1239" />
