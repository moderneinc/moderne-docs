...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/usingdirectivercs1056" />
</head>
...
[GitHub: UsingDirectiveRCS1056.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/UsingDirectiveRCS1056.java),
...
```shell title="shell"
mod run . --recipe UsingDirectiveRCS1056
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.UsingDirectiveRCS1056" />
