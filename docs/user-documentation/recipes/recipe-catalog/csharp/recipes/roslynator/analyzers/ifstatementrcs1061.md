...
[GitHub: IfStatementRCS1061.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/IfStatementRCS1061.java),
...
```shell title="shell"
mod run . --recipe IfStatementRCS1061
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.IfStatementRCS1061" />
