...
[GitHub: WhileStatementRCS1065.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/WhileStatementRCS1065.java),
...
```shell title="shell"
mod run . --recipe WhileStatementRCS1065
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.WhileStatementRCS1065" />
