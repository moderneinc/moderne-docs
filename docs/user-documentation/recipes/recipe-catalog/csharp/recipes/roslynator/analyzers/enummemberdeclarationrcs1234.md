---
sidebar_label: "Duplicate enum value"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/enummemberdeclarationrcs1234" />
</head>
...
[GitHub: EnumMemberDeclarationRCS1234.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/EnumMemberDeclarationRCS1234.java),
...
```shell title="shell"
mod run . --recipe EnumMemberDeclarationRCS1234
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.EnumMemberDeclarationRCS1234" />
