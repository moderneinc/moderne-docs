...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/addparagraphtodocumentationcommentrcs1226"
---
...
[GitHub: AddParagraphToDocumentationCommentRCS1226.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/AddParagraphToDocumentationCommentRCS1226.java),
...
```shell title="shell"
mod run . --recipe AddParagraphToDocumentationCommentRCS1226
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.AddParagraphToDocumentationCommentRCS1226" />
