...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/addbracestoifelsercs1003"
---
...
[GitHub: AddBracesToIfElseRCS1003.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/AddBracesToIfElseRCS1003.java),
...
```shell title="shell"
mod run . --recipe AddBracesToIfElseRCS1003
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.AddBracesToIfElseRCS1003" />
