...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/removeelementindocumentationcommentrcs1263" />
</head>
...
[GitHub: RemoveElementInDocumentationCommentRCS1263.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/RemoveElementInDocumentationCommentRCS1263.java),
...
```shell title="shell"
mod run . --recipe RemoveElementInDocumentationCommentRCS1263
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.RemoveElementInDocumentationCommentRCS1263" />
