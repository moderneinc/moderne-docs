...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/constructordeclarationrcs1071" />
</head>
...
[GitHub: ConstructorDeclarationRCS1071.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ConstructorDeclarationRCS1071.java),
...
```shell title="shell"
mod run . --recipe ConstructorDeclarationRCS1071
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ConstructorDeclarationRCS1071" />
