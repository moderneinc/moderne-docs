---
sidebar_label: "Remove redundant Dispose/Close call"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/statementrcs1133" />
</head>
...
[GitHub: StatementRCS1133.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/StatementRCS1133.java),
...
```shell title="shell"
mod run . --recipe StatementRCS1133
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.StatementRCS1133" />
