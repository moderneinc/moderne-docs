...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/parameterrcs1242" />
</head>
...
[GitHub: ParameterRCS1242.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ParameterRCS1242.java),
...
```shell title="shell"
mod run . --recipe ParameterRCS1242
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ParameterRCS1242" />
