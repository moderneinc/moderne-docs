...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/avoidnullreferenceexceptionrcs1202" />
</head>
...
[GitHub: AvoidNullReferenceExceptionRCS1202.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/AvoidNullReferenceExceptionRCS1202.java),
...
```shell title="shell"
mod run . --recipe AvoidNullReferenceExceptionRCS1202
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.AvoidNullReferenceExceptionRCS1202" />
