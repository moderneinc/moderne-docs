...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/rawstringliteralrcs1262" />
</head>
...
[GitHub: RawStringLiteralRCS1262.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/RawStringLiteralRCS1262.java),
...
```shell title="shell"
mod run . --recipe RawStringLiteralRCS1262
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.RawStringLiteralRCS1262" />
