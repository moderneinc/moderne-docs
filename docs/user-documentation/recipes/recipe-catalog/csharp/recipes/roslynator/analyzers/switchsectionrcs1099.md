...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/switchsectionrcs1099" />
</head>
...
[GitHub: SwitchSectionRCS1099.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/SwitchSectionRCS1099.java),
...
```shell title="shell"
mod run . --recipe SwitchSectionRCS1099
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.SwitchSectionRCS1099" />
