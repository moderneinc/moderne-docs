...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/finallyclausercs1066" />
</head>
...
[GitHub: FinallyClauseRCS1066.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/FinallyClauseRCS1066.java),
...
```shell title="shell"
mod run . --recipe FinallyClauseRCS1066
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.FinallyClauseRCS1066" />
