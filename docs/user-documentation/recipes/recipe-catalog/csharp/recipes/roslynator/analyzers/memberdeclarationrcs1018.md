...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/memberdeclarationrcs1018" />
</head>
...
[GitHub: MemberDeclarationRCS1018.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/MemberDeclarationRCS1018.java),
...
```shell title="shell"
mod run . --recipe MemberDeclarationRCS1018
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.MemberDeclarationRCS1018" />
