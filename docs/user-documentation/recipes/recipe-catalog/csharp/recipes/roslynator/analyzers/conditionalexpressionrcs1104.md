...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/conditionalexpressionrcs1104" />
</head>
...
[GitHub: ConditionalExpressionRCS1104.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ConditionalExpressionRCS1104.java),
...
```shell title="shell"
mod run . --recipe ConditionalExpressionRCS1104
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ConditionalExpressionRCS1104" />
