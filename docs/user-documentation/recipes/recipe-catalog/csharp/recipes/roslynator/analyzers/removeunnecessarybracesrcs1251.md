...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/removeunnecessarybracesrcs1251" />
</head>
...
[GitHub: RemoveUnnecessaryBracesRCS1251.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/RemoveUnnecessaryBracesRCS1251.java),
...
```shell title="shell"
mod run . --recipe RemoveUnnecessaryBracesRCS1251
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.RemoveUnnecessaryBracesRCS1251" />
