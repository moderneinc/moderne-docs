...
[GitHub: UseImplicitOrExplicitObjectCreationRCS1250.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/UseImplicitOrExplicitObjectCreationRCS1250.java),
...
```shell title="shell"
mod run . --recipe UseImplicitOrExplicitObjectCreationRCS1250
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.UseImplicitOrExplicitObjectCreationRCS1250" />
