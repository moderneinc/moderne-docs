...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/attributeargumentlistrcs1039" />
</head>
...
[GitHub: AttributeArgumentListRCS1039.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/AttributeArgumentListRCS1039.java),
...
```shell title="shell"
mod run . --recipe AttributeArgumentListRCS1039
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.AttributeArgumentListRCS1039" />
