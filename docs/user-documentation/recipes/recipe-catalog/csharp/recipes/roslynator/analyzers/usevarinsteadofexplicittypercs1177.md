---
sidebar_label: "[deprecated] Use 'var' instead of explicit type (in foreach)"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/usevarinsteadofexplicittypercs1177" />
</head>
...
[GitHub: UseVarInsteadOfExplicitTypeRCS1177.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/UseVarInsteadOfExplicitTypeRCS1177.java),
...
```shell title="shell"
mod run . --recipe UseVarInsteadOfExplicitTypeRCS1177
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.UseVarInsteadOfExplicitTypeRCS1177" />
