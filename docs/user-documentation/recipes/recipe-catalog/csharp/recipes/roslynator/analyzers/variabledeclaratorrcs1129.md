...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/variabledeclaratorrcs1129" />
</head>
...
[GitHub: VariableDeclaratorRCS1129.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/VariableDeclaratorRCS1129.java),
...
```shell title="shell"
mod run . --recipe VariableDeclaratorRCS1129
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.VariableDeclaratorRCS1129" />
