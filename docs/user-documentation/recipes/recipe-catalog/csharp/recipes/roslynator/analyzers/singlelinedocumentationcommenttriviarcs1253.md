...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/singlelinedocumentationcommenttriviarcs1253" />
</head>
...
[GitHub: SingleLineDocumentationCommentTriviaRCS1253.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/SingleLineDocumentationCommentTriviaRCS1253.java),
...
```shell title="shell"
mod run . --recipe SingleLineDocumentationCommentTriviaRCS1253
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.SingleLineDocumentationCommentTriviaRCS1253" />
