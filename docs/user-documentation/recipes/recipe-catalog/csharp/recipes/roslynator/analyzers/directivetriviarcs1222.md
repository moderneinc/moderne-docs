---
sidebar_label: "Merge preprocessor directives"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/directivetriviarcs1222" />
</head>
...
[GitHub: DirectiveTriviaRCS1222.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/DirectiveTriviaRCS1222.java),
...
```shell title="shell"
mod run . --recipe DirectiveTriviaRCS1222
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.DirectiveTriviaRCS1222" />
