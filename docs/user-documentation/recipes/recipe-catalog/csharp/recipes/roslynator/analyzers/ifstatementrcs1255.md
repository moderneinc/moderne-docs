...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/ifstatementrcs1255" />
</head>
...
[GitHub: IfStatementRCS1255.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/IfStatementRCS1255.java),
...
```shell title="shell"
mod run . --recipe IfStatementRCS1255
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.IfStatementRCS1255" />
