...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/ifstatementrcs1236" />
</head>
...
[GitHub: IfStatementRCS1236.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/IfStatementRCS1236.java),
...
```shell title="shell"
mod run . --recipe IfStatementRCS1236
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.IfStatementRCS1236" />
