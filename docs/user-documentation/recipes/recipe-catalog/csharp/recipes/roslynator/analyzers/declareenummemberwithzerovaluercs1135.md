...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/declareenummemberwithzerovaluercs1135"
---
...
[GitHub: DeclareEnumMemberWithZeroValueRCS1135.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/DeclareEnumMemberWithZeroValueRCS1135.java),
...
```shell title="shell"
mod run . --recipe DeclareEnumMemberWithZeroValueRCS1135
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.DeclareEnumMemberWithZeroValueRCS1135" />
