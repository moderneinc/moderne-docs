...
[GitHub: ClassDeclarationRCS1102.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ClassDeclarationRCS1102.java),
...
```shell title="shell"
mod run . --recipe ClassDeclarationRCS1102
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ClassDeclarationRCS1102" />
