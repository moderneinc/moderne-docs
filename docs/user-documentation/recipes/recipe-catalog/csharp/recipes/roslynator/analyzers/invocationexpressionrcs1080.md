---
sidebar_label: "Use 'Count/Length' property instead of 'Any' method"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/invocationexpressionrcs1080" />
</head>
...
[GitHub: InvocationExpressionRCS1080.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/InvocationExpressionRCS1080.java),
...
```shell title="shell"
mod run . --recipe InvocationExpressionRCS1080
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.InvocationExpressionRCS1080" />
