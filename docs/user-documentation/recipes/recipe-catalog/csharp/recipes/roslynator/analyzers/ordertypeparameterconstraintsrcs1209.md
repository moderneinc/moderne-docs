...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/ordertypeparameterconstraintsrcs1209" />
</head>
...
[GitHub: OrderTypeParameterConstraintsRCS1209.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/OrderTypeParameterConstraintsRCS1209.java),
...
```shell title="shell"
mod run . --recipe OrderTypeParameterConstraintsRCS1209
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.OrderTypeParameterConstraintsRCS1209" />
