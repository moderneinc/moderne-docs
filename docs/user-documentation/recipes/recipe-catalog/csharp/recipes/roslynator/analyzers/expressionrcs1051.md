...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/expressionrcs1051"
---
...
[GitHub: ExpressionRCS1051.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ExpressionRCS1051.java),
...
```shell title="shell"
mod run . --recipe ExpressionRCS1051
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ExpressionRCS1051" />
