...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/forstatementrcs1064"
---
...
[GitHub: ForStatementRCS1064.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/ForStatementRCS1064.java),
...
```shell title="shell"
mod run . --recipe ForStatementRCS1064
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.ForStatementRCS1064" />
