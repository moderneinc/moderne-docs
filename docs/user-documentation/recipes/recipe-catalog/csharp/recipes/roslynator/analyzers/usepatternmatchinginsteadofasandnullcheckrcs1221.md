...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/usepatternmatchinginsteadofasandnullcheckrcs1221" />
</head>
...
[GitHub: UsePatternMatchingInsteadOfAsAndNullCheckRCS1221.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/UsePatternMatchingInsteadOfAsAndNullCheckRCS1221.java),
...
```shell title="shell"
mod run . --recipe UsePatternMatchingInsteadOfAsAndNullCheckRCS1221
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.UsePatternMatchingInsteadOfAsAndNullCheckRCS1221" />
