...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/invocationexpressionrcs1267" />
</head>
...
[GitHub: InvocationExpressionRCS1267.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/InvocationExpressionRCS1267.java),
...
```shell title="shell"
mod run . --recipe InvocationExpressionRCS1267
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.InvocationExpressionRCS1267" />
