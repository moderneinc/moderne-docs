...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/roslynator/analyzers/dostatementrcs1063" />
</head>
...
[GitHub: DoStatementRCS1063.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/roslynator/analyzers/DoStatementRCS1063.java),
...
```shell title="shell"
mod run . --recipe DoStatementRCS1063
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.roslynator.analyzers.DoStatementRCS1063" />
