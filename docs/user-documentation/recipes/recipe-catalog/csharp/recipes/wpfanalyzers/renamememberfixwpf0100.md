---
sidebar_label: "Backing field for a RoutedEvent should match registered name"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/wpfanalyzers/renamememberfixwpf0100" />
</head>
...
_A routed event's backing field should be named with the name it is registered with suffixed by 'Event'._
...
```shell title="shell"
mod run . --recipe RenameMemberFixWPF0100
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.RenameMemberFixWPF0100" />
