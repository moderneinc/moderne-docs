...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/wpfanalyzers/usesetcurrentvaluefixwpf0041"
---
...
_Prefer setting mutable dependency properties using SetCurrentValue._

## Recipe source

[GitHub: UseSetCurrentValueFixWPF0041.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/UseSetCurrentValueFixWPF0041.java),
...
```shell title="shell"
mod run . --recipe UseSetCurrentValueFixWPF0041
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.UseSetCurrentValueFixWPF0041" />
