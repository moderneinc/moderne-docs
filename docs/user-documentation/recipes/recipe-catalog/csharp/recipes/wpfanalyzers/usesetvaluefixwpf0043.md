...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/wpfanalyzers/usesetvaluefixwpf0043"
---
...
_Set DataContext and Style using SetValue._

## Recipe source

[GitHub: UseSetValueFixWPF0043.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/UseSetValueFixWPF0043.java),
...
```shell title="shell"
mod run . --recipe UseSetValueFixWPF0043
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.UseSetValueFixWPF0043" />
