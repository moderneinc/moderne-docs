...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/wpfanalyzers/registerroutedcommandfixwpf0122"
---
...
_Register containing type as owner for routed command._

## Recipe source

[GitHub: RegisterRoutedCommandFixWPF0122.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/RegisterRoutedCommandFixWPF0122.java),
...
```shell title="shell"
mod run . --recipe RegisterRoutedCommandFixWPF0122
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.RegisterRoutedCommandFixWPF0122" />
