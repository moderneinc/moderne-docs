...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/wpfanalyzers/xmlnsdefinitionfixwpf0052" />
</head>
...
_XmlnsDefinitions does not map all namespaces with public types._

## Recipe source

[GitHub: XmlnsDefinitionFixWPF0052.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/XmlnsDefinitionFixWPF0052.java),
...
```shell title="shell"
mod run . --recipe XmlnsDefinitionFixWPF0052
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.XmlnsDefinitionFixWPF0052" />
