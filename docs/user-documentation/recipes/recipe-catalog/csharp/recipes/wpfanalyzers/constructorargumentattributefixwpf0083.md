...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/wpfanalyzers/constructorargumentattributefixwpf0083" />
</head>
...
_Add [ConstructorArgument] for the property._

## Recipe source

[GitHub: ConstructorArgumentAttributeFixWPF0083.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/ConstructorArgumentAttributeFixWPF0083.java),
...
```shell title="shell"
mod run . --recipe ConstructorArgumentAttributeFixWPF0083
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.ConstructorArgumentAttributeFixWPF0083" />
