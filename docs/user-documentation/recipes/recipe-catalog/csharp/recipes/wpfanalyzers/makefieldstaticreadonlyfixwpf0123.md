...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/wpfanalyzers/makefieldstaticreadonlyfixwpf0123"
---
...
_Backing field for a RoutedCommand should be static and readonly._

## Recipe source

[GitHub: MakeFieldStaticReadonlyFixWPF0123.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/MakeFieldStaticReadonlyFixWPF0123.java),
...
```shell title="shell"
mod run . --recipe MakeFieldStaticReadonlyFixWPF0123
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.MakeFieldStaticReadonlyFixWPF0123" />
