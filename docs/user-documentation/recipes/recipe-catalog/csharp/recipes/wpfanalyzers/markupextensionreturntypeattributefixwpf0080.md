...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/wpfanalyzers/markupextensionreturntypeattributefixwpf0080"
---
...
_Add MarkupExtensionReturnType attribute._

## Recipe source

[GitHub: MarkupExtensionReturnTypeAttributeFixWPF0080.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/MarkupExtensionReturnTypeAttributeFixWPF0080.java),
...
```shell title="shell"
mod run . --recipe MarkupExtensionReturnTypeAttributeFixWPF0080
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.MarkupExtensionReturnTypeAttributeFixWPF0080" />
