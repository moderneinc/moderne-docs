...
_Property changed callback should have standard documentation text._

## Recipe source

[GitHub: DocumentationFixWPF0062.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/DocumentationFixWPF0062.java),
...
```shell title="shell"
mod run . --recipe DocumentationFixWPF0062
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.DocumentationFixWPF0062" />
