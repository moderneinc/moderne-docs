...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/wpfanalyzers/renamememberfixwpf0007"
---
...
_Name of ValidateValueCallback should match registered name._

## Recipe source

[GitHub: RenameMemberFixWPF0007.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/RenameMemberFixWPF0007.java),
...
```shell title="shell"
mod run . --recipe RenameMemberFixWPF0007
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.RenameMemberFixWPF0007" />
