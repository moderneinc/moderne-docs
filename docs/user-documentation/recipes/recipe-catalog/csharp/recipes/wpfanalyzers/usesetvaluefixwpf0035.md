...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/wpfanalyzers/usesetvaluefixwpf0035" />
</head>
...
_Use SetValue in setter._

## Recipe source

[GitHub: UseSetValueFixWPF0035.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/UseSetValueFixWPF0035.java),
...
```shell title="shell"
mod run . --recipe UseSetValueFixWPF0035
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.UseSetValueFixWPF0035" />
