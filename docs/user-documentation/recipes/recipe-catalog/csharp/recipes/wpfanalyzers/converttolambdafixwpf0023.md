...
_The callback is trivial, convert to lambda for better locality._

## Recipe source

[GitHub: ConvertToLambdaFixWPF0023.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/ConvertToLambdaFixWPF0023.java),
...
```shell title="shell"
mod run . --recipe ConvertToLambdaFixWPF0023
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.ConvertToLambdaFixWPF0023" />
