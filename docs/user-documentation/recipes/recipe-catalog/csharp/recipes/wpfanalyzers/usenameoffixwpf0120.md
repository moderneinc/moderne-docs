...
_Register containing member name as name for routed command._

## Recipe source

[GitHub: UseNameofFixWPF0120.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/UseNameofFixWPF0120.java),
...
```shell title="shell"
mod run . --recipe UseNameofFixWPF0120
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.UseNameofFixWPF0120" />
