...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/wpfanalyzers/usenameoffixwpf0151"
---
...
_Use nameof() as it is less fragile than constant._

## Recipe source

[GitHub: UseNameofFixWPF0151.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/UseNameofFixWPF0151.java),
...
```shell title="shell"
mod run . --recipe UseNameofFixWPF0151
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.UseNameofFixWPF0151" />
