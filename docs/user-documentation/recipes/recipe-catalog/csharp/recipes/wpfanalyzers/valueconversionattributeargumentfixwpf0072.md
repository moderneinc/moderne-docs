...
_ValueConversion must use correct types._

## Recipe source

[GitHub: ValueConversionAttributeArgumentFixWPF0072.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/wpfanalyzers/ValueConversionAttributeArgumentFixWPF0072.java),
...
```shell title="shell"
mod run . --recipe ValueConversionAttributeArgumentFixWPF0072
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.wpfanalyzers.ValueConversionAttributeArgumentFixWPF0072" />
