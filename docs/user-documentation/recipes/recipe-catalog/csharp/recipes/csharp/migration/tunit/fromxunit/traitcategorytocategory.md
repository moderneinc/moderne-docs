---
title: "Replace `[Trait(&quot;Category&quot;, ...)]` with `[Category]`"
sidebar_label: "Replace `[Trait(&quot;Category&quot;, ...)]` with `[Category]`"
---
...
**OpenRewrite.Recipes.CSharp.Migration.TUnit.FromXUnit.TraitCategoryToCategory**

_Replace xUnit `[Trait("Category", "X")]` with TUnit's dedicated `[Category("X")]` attribute._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.Migration.TUnit.FromXUnit.TraitCategoryToCategory"
  displayName="Replace `[Trait(&quot;Category&quot;, ...)]` with `[Category]`"
