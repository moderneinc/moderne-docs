...
**OpenRewrite.Recipes.CSharp.Migration.Dotnet.Net3\_0.FindObsoleteLocalizationApis**

_Finds usages of `ResourceManagerWithCultureStringLocalizer` and `WithCulture()` which are obsolete in ASP.NET Core 3.0._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.Migration.Dotnet.Net3_0.FindObsoleteLocalizationApis"
