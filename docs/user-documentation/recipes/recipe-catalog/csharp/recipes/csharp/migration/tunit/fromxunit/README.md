...
* [Add `async Task` to methods containing `await`](./addasynctotestmethods.md)
...
* [Replace `ICollectionFixture&lt;T&gt;` with `[ClassDataSource&lt;T&gt;]`](./collectionfixturetoclassdatasource.md)
