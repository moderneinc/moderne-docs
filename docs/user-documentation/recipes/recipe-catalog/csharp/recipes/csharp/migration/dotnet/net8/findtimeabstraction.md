...
**OpenRewrite.Recipes.CSharp.Migration.Dotnet.Net8.FindTimeAbstraction**

_Finds usages of `DateTime.Now`, `DateTime.UtcNow`, `DateTimeOffset.Now`, and `DateTimeOffset.UtcNow`. In .NET 8+, `TimeProvider` is the recommended abstraction for time._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.Migration.Dotnet.Net8.FindTimeAbstraction"
  displayName="Find DateTime.Now/UtcNow usage (TimeProvider in .NET 8)"
