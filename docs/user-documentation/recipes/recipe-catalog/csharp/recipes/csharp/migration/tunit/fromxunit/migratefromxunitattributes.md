...
**OpenRewrite.Recipes.CSharp.Migration.TUnit.FromXUnit.MigrateFromXUnitAttributes**

_Replace xUnit test attributes ([Fact], [Theory], [InlineData], etc.) with their TUnit equivalents._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.Migration.TUnit.FromXUnit.MigrateFromXUnitAttributes"
