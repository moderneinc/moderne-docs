---
title: "Replace `[InlineData]` with `[Arguments]`"
sidebar_label: "Replace `[InlineData]` with `[Arguments]`"
---
...
**OpenRewrite.Recipes.CSharp.Migration.TUnit.FromXUnit.InlineDataToArguments**

_Replace the xUnit `[InlineData]` attribute with the TUnit `[Arguments]` attribute._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.Migration.TUnit.FromXUnit.InlineDataToArguments"
  displayName="Replace `[InlineData]` with `[Arguments]`"
