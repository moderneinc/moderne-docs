---
title: "Replace `[Fact]` with `[Test]`"
sidebar_label: "Replace `[Fact]` with `[Test]`"
---
...
**OpenRewrite.Recipes.CSharp.Migration.TUnit.FromXUnit.FactToTest**

_Replace the xUnit `[Fact]` attribute with the TUnit `[Test]` attribute._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.Migration.TUnit.FromXUnit.FactToTest"
  displayName="Replace `[Fact]` with `[Test]`"
