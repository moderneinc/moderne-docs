...
**OpenRewrite.Recipes.CSharp.Migration.Dotnet.Net8.UseThrowIfZero**

_Replace `if (value == 0) throw new ArgumentOutOfRangeException(nameof(value))` guard clauses with `ArgumentOutOfRangeException.ThrowIfZero(value)`. Also handles reversed `0 == value`. Available since .NET 8._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.Migration.Dotnet.Net8.UseThrowIfZero"
