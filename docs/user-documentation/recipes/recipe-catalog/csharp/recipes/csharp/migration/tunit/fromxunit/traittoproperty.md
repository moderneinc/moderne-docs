---
title: "Replace `[Trait]` with `[Property]`"
sidebar_label: "Replace `[Trait]` with `[Property]`"
---
...
**OpenRewrite.Recipes.CSharp.Migration.TUnit.FromXUnit.TraitToProperty**

_Replace the xUnit `[Trait]` attribute with the TUnit `[Property]` attribute._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.Migration.TUnit.FromXUnit.TraitToProperty"
  displayName="Replace `[Trait]` with `[Property]`"
