---
title: "Replace `[Theory]` with `[Test]`"
sidebar_label: "Replace `[Theory]` with `[Test]`"
---
...
**OpenRewrite.Recipes.CSharp.Migration.TUnit.FromXUnit.TheoryToTest**

_Replace the xUnit `[Theory]` attribute with the TUnit `[Test]` attribute._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.Migration.TUnit.FromXUnit.TheoryToTest"
  displayName="Replace `[Theory]` with `[Test]`"
