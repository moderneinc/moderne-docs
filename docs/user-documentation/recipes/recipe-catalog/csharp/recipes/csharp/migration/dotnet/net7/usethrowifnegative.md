...
**OpenRewrite.Recipes.CSharp.Migration.Dotnet.Net7.UseThrowIfNegative**

_Replace `if (value < 0) throw new ArgumentOutOfRangeException(nameof(value))` guard clauses with `ArgumentOutOfRangeException.ThrowIfNegative(value)`. Also handles reversed `0 > value`. Available since .NET 7._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.Migration.Dotnet.Net7.UseThrowIfNegative"
