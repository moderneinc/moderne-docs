...
**OpenRewrite.Recipes.CSharp.Migration.Dotnet.Net9.UseLinqIndex**

_Replace `collection.Select((item, index) => (index, item))` with `collection.Index()`. Available since .NET 9._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.Migration.Dotnet.Net9.UseLinqIndex"
  displayName="Use LINQ Index()"
