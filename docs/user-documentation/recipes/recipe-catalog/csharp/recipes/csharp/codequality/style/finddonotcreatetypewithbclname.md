---
title: "Find type with BCL name"
sidebar_label: "Find type with BCL name"
---
...
_Detect class declarations that use names from well-known BCL types like `Task`, `Action`, `String`, which can cause confusion._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Style.FindDoNotCreateTypeWithBCLName"
