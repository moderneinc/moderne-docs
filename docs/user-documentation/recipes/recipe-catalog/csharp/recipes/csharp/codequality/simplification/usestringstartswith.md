---
title: "Use string.StartsWith instead of IndexOf comparison"
sidebar_label: "Use string.StartsWith instead of IndexOf comparison"
---
...
_Replace `s.IndexOf(x) == 0` with `s.StartsWith(x)`._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Simplification.UseStringStartsWith"
