...
_Use indexer instead of First()/Last()/ElementAt() when the collection supports indexer access._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Style.UseElementAccess"
