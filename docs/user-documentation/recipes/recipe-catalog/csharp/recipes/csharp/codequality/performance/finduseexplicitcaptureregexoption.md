...
_Use `RegexOptions.ExplicitCapture` to avoid capturing unnamed groups, which improves performance._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Performance.FindUseExplicitCaptureRegexOption"
