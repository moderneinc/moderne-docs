...
<RecipeHeader.Title>Find CompareTo without IComparable</RecipeHeader.Title>

<RecipeHeader.Description>Detect classes that provide a `CompareTo` method but do not implement `IComparable<T>`.</RecipeHeader.Description>
