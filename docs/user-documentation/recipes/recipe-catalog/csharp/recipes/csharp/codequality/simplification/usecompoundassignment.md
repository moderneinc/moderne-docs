...
_Replace `x = x op y` with `x op= y` for arithmetic, bitwise, shift, and null-coalescing operators._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Simplification.UseCompoundAssignment"
