...
_Detect static event invocations that pass `this` as the sender. Static events should use `null` as the sender._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Style.FindSenderNullForStaticEvents"
