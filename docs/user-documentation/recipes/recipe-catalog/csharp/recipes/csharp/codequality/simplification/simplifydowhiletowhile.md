---
title: "Simplify do-while(true) to while(true)"
sidebar_label: "Simplify do-while(true) to while(true)"
---
...
_Convert `do { ... } while (true)` to `while (true) { ... }`._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Simplification.SimplifyDoWhileToWhile"
