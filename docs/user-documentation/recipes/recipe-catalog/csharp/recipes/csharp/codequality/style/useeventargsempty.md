...
_Replace `new EventArgs()` with `EventArgs.Empty`. The static `EventArgs.Empty` field avoids unnecessary allocations._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Style.UseEventArgsEmpty"
