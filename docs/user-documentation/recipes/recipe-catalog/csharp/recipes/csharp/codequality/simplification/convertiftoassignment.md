...
_Convert 'if' statement that assigns boolean literals to a simple assignment with the condition expression._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Simplification.ConvertIfToAssignment"
