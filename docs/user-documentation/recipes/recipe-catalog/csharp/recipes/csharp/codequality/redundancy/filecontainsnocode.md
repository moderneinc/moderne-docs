...
_Find files that contain no code, only using directives, comments, or whitespace._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Redundancy.FileContainsNoCode"
