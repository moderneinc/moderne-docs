...
_Detect `.GetType()` called on an object that is already a `System.Type`. Use `typeof()` directly._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Style.FindDoNotUseGetHashCodeForString"
