---
title: "Find Regex without ExplicitCapture option"
sidebar_label: "Find Regex without ExplicitCapture option"
---
...
_Detect `new Regex()` or `Regex.IsMatch()` without `RegexOptions.ExplicitCapture`. Using this option avoids unnecessary unnamed captures._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Style.FindUseRegexOptions"
