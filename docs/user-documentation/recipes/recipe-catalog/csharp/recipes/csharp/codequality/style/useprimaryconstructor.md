...
_Convert classes with a single constructor into primary constructor syntax (C# 12)._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Style.UsePrimaryConstructor"
