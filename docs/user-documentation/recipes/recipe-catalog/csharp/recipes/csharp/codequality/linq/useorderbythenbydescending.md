---
title: "Use OrderBy().ThenByDescending()"
sidebar_label: "Use OrderBy().ThenByDescending()"
---
...
_Replace `.OrderBy(a).OrderByDescending(b)` with `.OrderBy(a).ThenByDescending(b)`._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Linq.UseOrderByThenByDescending"
