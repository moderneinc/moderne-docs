...
_Detect `.ToString()` calls without format arguments. On numeric and DateTime types, these use the current thread culture._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Performance.FindImplicitCultureSensitiveToString"
