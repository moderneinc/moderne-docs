---
title: "Remove empty while body"
sidebar_label: "Remove empty while body"
---
...
_Remove `while (cond) { }` loops with empty bodies as they serve no purpose._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Redundancy.RemoveEmptyWhileBody"
