...
_`[ThreadStatic]` only works on static fields. Using it on instance fields has no effect._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Style.FindThreadStaticOnInstanceField"
