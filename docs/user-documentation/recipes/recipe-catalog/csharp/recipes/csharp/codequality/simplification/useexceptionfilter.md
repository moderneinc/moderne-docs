...
_Detect catch blocks with if/throw pattern that could use a when clause._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Simplification.UseExceptionFilter"
