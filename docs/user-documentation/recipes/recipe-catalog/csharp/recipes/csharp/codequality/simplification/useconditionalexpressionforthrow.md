...
_Detect `if (x == null) throw ...` patterns that could use `x ?? throw ...`._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Simplification.UseConditionalExpressionForThrow"
