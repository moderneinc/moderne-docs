...
sidebar_label: "Use Regex.IsMatch"
---
...
_Replace Regex.Match(s, p).Success with Regex.IsMatch(s, p)._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Performance.UseRegexIsMatch"
