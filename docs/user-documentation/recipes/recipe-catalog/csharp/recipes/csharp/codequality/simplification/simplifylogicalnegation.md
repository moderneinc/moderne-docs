...
_Simplify negated comparison expressions. For example, `!(x == y)` becomes `x != y`._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Simplification.SimplifyLogicalNegation"
