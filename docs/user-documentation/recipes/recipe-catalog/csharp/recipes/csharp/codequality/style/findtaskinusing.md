---
title: "Find unawaited task in using statement"
sidebar_label: "Find unawaited task in using statement"
---
...
_Detect `using` statements where a Task is not awaited, which can cause premature disposal before the task completes._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Style.FindTaskInUsing"
