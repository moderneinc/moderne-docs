---
title: "Find non-constant string.Format format string"
sidebar_label: "Find non-constant string.Format format string"
---
...
_Detect non-constant format strings passed to `string.Format`. Use a constant to prevent format string injection._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Style.FindStringFormatConstant"
