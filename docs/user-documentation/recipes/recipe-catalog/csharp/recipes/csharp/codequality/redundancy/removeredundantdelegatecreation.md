...
_Remove unnecessary `new EventHandler(M)` when `M` can be used directly._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Redundancy.RemoveRedundantDelegateCreation"
