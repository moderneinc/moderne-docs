---
title: "Optimize LINQ Select().Average()"
sidebar_label: "Optimize LINQ Select().Average()"
---
...
_Replace `items.Select(selector).Average()` with `items.Average(selector)`._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Linq.OptimizeLinqSelectAverage"
