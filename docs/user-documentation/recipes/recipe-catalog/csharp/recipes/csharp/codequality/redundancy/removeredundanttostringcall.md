...
_Remove `ToString()` calls on expressions that are already strings._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Redundancy.RemoveRedundantToStringCall"
