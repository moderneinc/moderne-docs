...
sidebar_label: "Use explicit type instead of var"
---
...
_Use explicit type instead of `var` when the type is not evident._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Style.UseExplicitTypeInsteadOfVar"
