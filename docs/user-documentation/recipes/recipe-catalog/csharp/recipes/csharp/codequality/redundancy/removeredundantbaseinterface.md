...
_Remove interface that is already inherited by another implemented interface._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Redundancy.RemoveRedundantBaseInterface"
