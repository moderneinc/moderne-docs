...
_Detect `Thread.Sleep()` which blocks the thread. Use `await Task.Delay()` in async contexts instead._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Style.FindDoNotUseSleep"
