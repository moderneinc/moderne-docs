...
_Detect `==` comparisons on reference types that override `Equals`. Using `==` may compare references instead of values._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Style.FindUseEqualsMethodInsteadOfOperator"
