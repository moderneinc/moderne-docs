...
_Replace `items.Where(predicate).SingleOrDefault()` with `items.SingleOrDefault(predicate)`._
...
<RunRecipe
  recipeName="OpenRewrite.Recipes.CSharp.CodeQuality.Linq.OptimizeLinqWhereSingleOrDefault"
