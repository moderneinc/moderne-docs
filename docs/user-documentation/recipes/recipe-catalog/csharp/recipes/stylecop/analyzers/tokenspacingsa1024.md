...
_A colon within a C# element is not spaced correctly._

## Recipe source

[GitHub: TokenSpacingSA1024.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/TokenSpacingSA1024.java),
...
```shell title="shell"
mod run . --recipe TokenSpacingSA1024
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.TokenSpacingSA1024" />
