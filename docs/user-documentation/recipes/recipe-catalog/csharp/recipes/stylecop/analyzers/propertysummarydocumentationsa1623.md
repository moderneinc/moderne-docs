...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/stylecop/analyzers/propertysummarydocumentationsa1623" />
</head>
...
[GitHub: PropertySummaryDocumentationSA1623.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/PropertySummaryDocumentationSA1623.java),
...
```shell title="shell"
mod run . --recipe PropertySummaryDocumentationSA1623
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.PropertySummaryDocumentationSA1623" />
