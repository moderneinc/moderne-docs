...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/stylecop/analyzers/renametolowercasesa1306"
---
...
_The name of a field in C# does not begin with a lower-case letter._

## Recipe source

[GitHub: RenameToLowerCaseSA1306.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/RenameToLowerCaseSA1306.java),
...
```shell title="shell"
mod run . --recipe RenameToLowerCaseSA1306
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.RenameToLowerCaseSA1306" />
