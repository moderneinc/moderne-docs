---
sidebar_label: "Commas should be spaced correctly"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/stylecop/analyzers/tokenspacingsa1001" />
</head>
...
_The spacing around a comma is incorrect, within a C# code file._

## Recipe source

[GitHub: TokenSpacingSA1001.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/TokenSpacingSA1001.java),
...
```shell title="shell"
mod run . --recipe TokenSpacingSA1001
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.TokenSpacingSA1001" />
