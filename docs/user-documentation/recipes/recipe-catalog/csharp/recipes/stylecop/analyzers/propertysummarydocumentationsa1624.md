...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/stylecop/analyzers/propertysummarydocumentationsa1624" />
</head>
...
[GitHub: PropertySummaryDocumentationSA1624.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/PropertySummaryDocumentationSA1624.java),
...
```shell title="shell"
mod run . --recipe PropertySummaryDocumentationSA1624
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.PropertySummaryDocumentationSA1624" />
