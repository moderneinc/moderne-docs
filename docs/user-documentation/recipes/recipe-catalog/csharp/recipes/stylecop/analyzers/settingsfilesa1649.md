...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/stylecop/analyzers/settingsfilesa1649" />
</head>
...
_The file name of a C# code file does not match the first type declared in the file._

## Recipe source

[GitHub: SettingsFileSA1649.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/SettingsFileSA1649.java),
...
```shell title="shell"
mod run . --recipe SettingsFileSA1649
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.SettingsFileSA1649" />
