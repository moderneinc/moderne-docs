...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/stylecop/analyzers/settingsfilesa1637"
---
...
_The file header at the top of a C# code file is missing the file name._

## Recipe source

[GitHub: SettingsFileSA1637.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/SettingsFileSA1637.java),
...
```shell title="shell"
mod run . --recipe SettingsFileSA1637
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.SettingsFileSA1637" />
