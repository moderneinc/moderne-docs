...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/stylecop/analyzers/settingsfilesa1634" />
</head>
...
_The file header at the top of a C# code file is missing a copyright tag._

## Recipe source

[GitHub: SettingsFileSA1634.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/SettingsFileSA1634.java),
...
```shell title="shell"
mod run . --recipe SettingsFileSA1634
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.SettingsFileSA1634" />
