...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/stylecop/analyzers/renametolowercasesa1312" />
</head>
...
_The name of a variable in C# does not begin with a lower-case letter._

## Recipe source

[GitHub: RenameToLowerCaseSA1312.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/RenameToLowerCaseSA1312.java),
...
```shell title="shell"
mod run . --recipe RenameToLowerCaseSA1312
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.RenameToLowerCaseSA1312" />
