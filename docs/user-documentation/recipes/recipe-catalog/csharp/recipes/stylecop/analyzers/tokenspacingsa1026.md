...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/stylecop/analyzers/tokenspacingsa1026"
---
...
_An implicitly typed array allocation within a C# code file is not spaced correctly._

## Recipe source

[GitHub: TokenSpacingSA1026.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/TokenSpacingSA1026.java),
...
```shell title="shell"
mod run . --recipe TokenSpacingSA1026
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.TokenSpacingSA1026" />
