...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/stylecop/analyzers/indentationsa1137" />
</head>
...
_Elements at the same level in the syntax tree should have the same indentation._

## Recipe source

[GitHub: IndentationSA1137.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/IndentationSA1137.java),
...
```shell title="shell"
mod run . --recipe IndentationSA1137
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.IndentationSA1137" />
