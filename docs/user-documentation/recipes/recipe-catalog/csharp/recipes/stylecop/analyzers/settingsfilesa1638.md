...
canonical_url: "https://docs.openrewrite.org/recipes/csharp/recipes/stylecop/analyzers/settingsfilesa1638"
---
...
_The file attribute within copyright tag of the file header at the top of a C# code file does not contain the name of the file._

## Recipe source

[GitHub: SettingsFileSA1638.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/SettingsFileSA1638.java),
...
```shell title="shell"
mod run . --recipe SettingsFileSA1638
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.SettingsFileSA1638" />
