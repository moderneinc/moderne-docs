...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/stylecop/analyzers/settingsfilesa1641" />
</head>
...
_The file header at the top of a C# code file does not contain the appropriate company name text._

## Recipe source

[GitHub: SettingsFileSA1641.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/SettingsFileSA1641.java),
...
```shell title="shell"
mod run . --recipe SettingsFileSA1641
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.SettingsFileSA1641" />
