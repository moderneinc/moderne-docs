...
_A positive sign within a C# element is not spaced correctly._

## Recipe source

[GitHub: TokenSpacingSA1022.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/TokenSpacingSA1022.java),
...
```shell title="shell"
mod run . --recipe TokenSpacingSA1022
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.TokenSpacingSA1022" />
