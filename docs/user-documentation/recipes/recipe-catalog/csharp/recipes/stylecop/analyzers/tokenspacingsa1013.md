---
sidebar_label: "Closing braces should be spaced correctly"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/csharp/recipes/stylecop/analyzers/tokenspacingsa1013" />
</head>
...
_A closing brace within a C# element is not spaced correctly._

## Recipe source

[GitHub: TokenSpacingSA1013.java](https://github.com/openrewrite/rewrite-csharp/blob/main/rewrite-csharp/src/main/java/org/openrewrite/csharp/recipes/stylecop/analyzers/TokenSpacingSA1013.java),
...
```shell title="shell"
mod run . --recipe TokenSpacingSA1013
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.csharp.recipes.stylecop.analyzers.TokenSpacingSA1013" />
