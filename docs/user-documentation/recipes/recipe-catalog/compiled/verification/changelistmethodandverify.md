...
<RecipeList recipes={[{"name":"Change method name","href":"/user-documentation/recipes/recipe-catalog/java/changemethodname/"},{"name":"Verify compilation of changes made earlier in the same run","href":"/user-documentation/recipes/recipe-catalog/compiled/verification/verifycompilation/"}]}>
