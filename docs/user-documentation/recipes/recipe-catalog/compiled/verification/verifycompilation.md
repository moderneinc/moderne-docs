...
_This is a task that runs after another recipe to verify that the changes made by that recipe would result in a successful compilation._
...
<RunRecipe
  recipeName="io.moderne.compiled.verification.VerifyCompilation"
  displayName="Verify compilation"
  groupId="org.openrewrite.recipe"
  artifactId="rewrite-compiled-analysis"
  versionKey="VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_COMPILED_ANALYSIS"
  showGradle={false}
  showMaven={false}
  hasDataTables
/>
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.compiled.verification.VerifyCompilation" />
