...
<UsageList usage={{"recipeName":"tech.picnic.errorprone.refasterrules.AssertJInstantRulesRecipes","displayName":"Refaster rules related to AssertJ assertions over `Instant`s","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
