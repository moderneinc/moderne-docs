...
<RecipeMeta
  ...
  description={"Prefer `AbstractFileAssert#isDirectory()` over more verbose alternatives."}
  fqName={"tech.picnic.errorprone.refasterrules.AssertJFileRulesRecipes$AssertThatIsDirectoryRecipe"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=tech.picnic.errorprone.refasterrules.AssertJFileRulesRecipes$AssertThatIsDirectoryRecipe"}
/>
...
<RecipeHeader.Description>Prefer `AbstractFileAssert#isDirectory()` over more verbose alternatives.</RecipeHeader.Description>
