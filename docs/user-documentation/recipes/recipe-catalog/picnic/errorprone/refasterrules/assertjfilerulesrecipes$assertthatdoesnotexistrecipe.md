...
<RecipeMeta
  ...
  description={"Prefer `AbstractFileAssert#doesNotExist()` over more verbose alternatives."}
  fqName={"tech.picnic.errorprone.refasterrules.AssertJFileRulesRecipes$AssertThatDoesNotExistRecipe"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=tech.picnic.errorprone.refasterrules.AssertJFileRulesRecipes$AssertThatDoesNotExistRecipe"}
/>
...
<RecipeHeader.Description>Prefer `AbstractFileAssert#doesNotExist()` over more verbose alternatives.</RecipeHeader.Description>
