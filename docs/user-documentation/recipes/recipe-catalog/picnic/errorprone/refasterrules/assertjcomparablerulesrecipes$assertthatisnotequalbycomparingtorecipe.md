...
<RecipeMeta
  ...
  description={"Prefer `AbstractComparableAssert#isNotEqualByComparingTo(Comparable)` over more contrived alternatives."}
  fqName={"tech.picnic.errorprone.refasterrules.AssertJComparableRulesRecipes$AssertThatIsNotEqualByComparingToRecipe"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=tech.picnic.errorprone.refasterrules.AssertJComparableRulesRecipes$AssertThatIsNotEqualByComparingToRecipe"}
/>
...
<RecipeHeader.Description>Prefer `AbstractComparableAssert#isNotEqualByComparingTo(Comparable)` over more contrived alternatives.</RecipeHeader.Description>
