...
[GitHub: gradle.yml](https://github.com/openrewrite/rewrite-github-actions/blob/main/src/main/resources/META-INF/rewrite/gradle.yml),
...
<RunRecipe
  recipeName="org.openrewrite.github.gradle.RenameGradleBuildActionToSetupGradle"
  displayName="Rename `gradle/gradle-build-action` to `gradle/actions/setup-gradle`"
