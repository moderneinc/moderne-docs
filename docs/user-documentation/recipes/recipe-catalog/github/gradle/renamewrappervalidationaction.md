...
<RecipeMeta
  ...
  fqName={"org.openrewrite.github.gradle.RenameWrapperValidationAction"}
...
<UsageList usage={{"recipeName":"org.openrewrite.github.gradle.RenameWrapperValidationAction","displayName":"Rename `gradle/wrapper-validation-action` to `gradle/actions/wrapper-validation`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-github-actions","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_GITHUB_ACTIONS","requiresConfiguration":false}}>
