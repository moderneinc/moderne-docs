...
* [Gradle](/user-documentation/recipes/recipe-catalog/github/gradle)
* [Security](/user-documentation/recipes/recipe-catalog/github/security)
...
* [Replace Dependabot `reviewers` with `CODEOWNERS`](./replacedependabotreviewerswithcodeowners.md)
...
* [Replace `always()` with `success() || failure()`](./replacealwayswithsuccessorfailure.md)
...
* [Upgrade `actions/setup-python` `python-version`](./setuppythonupgradepythonversion.md)
