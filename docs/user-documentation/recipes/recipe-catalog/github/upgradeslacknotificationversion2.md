...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/github/upgradeslacknotificationversion2" />
</head>
...
_Update the Slack GitHub Action to use version 2.0._
...
rewrite {
    activeRecipe("org.openrewrite.github.UpgradeSlackNotificationVersion2")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.github.UpgradeSlackNotificationVersion2</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-github-actions:RELEASE -Drewrite.activeRecipes=org.openrewrite.github.UpgradeSlackNotificationVersion2 -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe UpgradeSlackNotificationVersion2
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.github.UpgradeSlackNotificationVersion2" />
