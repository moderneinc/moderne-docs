...
canonical_url: "https://docs.openrewrite.org/recipes/github/replacesecretkeys"
---
...
_Replace key names used for secrets in GitHub Actions workflow files._

## Recipe source

[GitHub: ReplaceSecretKeys.java](https://github.com/openrewrite/rewrite-github-actions/blob/main/src/main/java/org/openrewrite/github/ReplaceSecretKeys.java),
...
* [Replace OSSRH secrets with Sonatype secrets](/user-documentation/recipes/recipe-catalog/github/replaceossrhsecretswithsonatype.md)
...
name: com.yourorg.ReplaceSecretKeysExample
displayName: Replace secret key names in GitHub Actions example
recipeList:
  - org.openrewrite.github.ReplaceSecretKeys:
...
rewrite {
    activeRecipe("com.yourorg.ReplaceSecretKeysExample")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.yourorg.ReplaceSecretKeysExample</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.github.ReplaceSecretKeys" />
