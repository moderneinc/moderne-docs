...
<RecipeHeader.Title>Upgrade `actions/setup-node` `node-version`</RecipeHeader.Title>

<RecipeHeader.Description>Update the Node.js version used by `actions/setup-node` if it is below the expected version number.</RecipeHeader.Description>
