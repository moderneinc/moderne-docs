...
* [nodejs](/user-documentation/recipes/lists/recipes-by-tag#nodejs)
...
rewrite {
    activeRecipe("org.openrewrite.github.SetupNodeUpgradeNodeVersion")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.github.SetupNodeUpgradeNodeVersion</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-github-actions:RELEASE -Drewrite.activeRecipes=org.openrewrite.github.SetupNodeUpgradeNodeVersion -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SetupNodeUpgradeNodeVersion
```
