...
canonical_url: "https://docs.openrewrite.org/recipes/github/removeallcrontriggers"
---
...
[GitHub: RemoveAllCronTriggers.java](https://github.com/openrewrite/rewrite-github-actions/blob/main/src/main/java/org/openrewrite/github/RemoveAllCronTriggers.java),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-github-actions:RELEASE -Drewrite.activeRecipes=org.openrewrite.github.RemoveAllCronTriggers -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe RemoveAllCronTriggers
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.github.RemoveAllCronTriggers" />
