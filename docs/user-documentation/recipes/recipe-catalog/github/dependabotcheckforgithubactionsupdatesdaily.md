...
* [demo](/user-documentation/recipes/lists/recipes-by-tag#demo)
* [dependabot](/user-documentation/recipes/lists/recipes-by-tag#dependabot)
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-github-actions:RELEASE -Drewrite.activeRecipes=org.openrewrite.github.DependabotCheckForGithubActionsUpdatesDaily -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.github.DependabotCheckForGithubActionsUpdatesDaily" />
