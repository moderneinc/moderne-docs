...
canonical_url: "https://docs.openrewrite.org/recipes/github/migratetibdexgithubapptokentoactions"
---
...
rewrite {
    activeRecipe("org.openrewrite.github.MigrateTibdexGitHubAppTokenToActions")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.github.MigrateTibdexGitHubAppTokenToActions</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-github-actions:RELEASE -Drewrite.activeRecipes=org.openrewrite.github.MigrateTibdexGitHubAppTokenToActions -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe MigrateTibdexGitHubAppTokenToActions
```
