...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/github/findgithubactionsecretreferences" />
</head>
...
rewrite {
    activeRecipe("org.openrewrite.github.FindGitHubActionSecretReferences")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.github.FindGitHubActionSecretReferences</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-github-actions:RELEASE -Drewrite.activeRecipes=org.openrewrite.github.FindGitHubActionSecretReferences -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe FindGitHubActionSecretReferences
```
