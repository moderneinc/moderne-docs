...
canonical_url: "https://docs.openrewrite.org/recipes/github/setupjavaadoptopenj9tosemeru"
---
...
[GitHub: SetupJavaAdoptOpenj9ToSemeru.java](https://github.com/openrewrite/rewrite-github-actions/blob/main/src/main/java/org/openrewrite/github/SetupJavaAdoptOpenj9ToSemeru.java),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-github-actions:RELEASE -Drewrite.activeRecipes=org.openrewrite.github.SetupJavaAdoptOpenj9ToSemeru -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.github.SetupJavaAdoptOpenj9ToSemeru" />
