...
<RecipeMeta
  ...
  fqName={"org.openrewrite.github.MigrateSetupUvV6ToV7"}
...
<UsageList usage={{"recipeName":"org.openrewrite.github.MigrateSetupUvV6ToV7","displayName":"Migrate `astral-sh/setup-uv` from v6 to v7","groupId":"org.openrewrite.recipe","artifactId":"rewrite-github-actions","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_GITHUB_ACTIONS","requiresConfiguration":false}}>
