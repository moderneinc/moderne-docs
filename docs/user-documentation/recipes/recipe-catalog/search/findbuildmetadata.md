...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/search/findbuildmetadata" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.search.FindBuildMetadata"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-core/src/main/java/org/openrewrite/search/FindBuildMetadata.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.search.FindBuildMetadata","displayName":"Find build metadata","groupId":"org.openrewrite","artifactId":"rewrite-core","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_CORE","requiresConfiguration":true,"cliOptions":" --recipe-option \"key=lstFormatVersion\" --recipe-option \"value=2\""}}>
