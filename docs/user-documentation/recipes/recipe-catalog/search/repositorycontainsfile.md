...
<RecipeMeta
  ...
  fqName={"org.openrewrite.search.RepositoryContainsFile"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-core/src/main/java/org/openrewrite/search/RepositoryContainsFile.java"}
/>
