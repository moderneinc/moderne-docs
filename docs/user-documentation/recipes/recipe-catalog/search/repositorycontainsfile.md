---
sidebar_label: "Repository contains file"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/search/repositorycontainsfile" />
</head>
...
[GitHub: RepositoryContainsFile.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-core/src/main/java/org/openrewrite/search/RepositoryContainsFile.java),
...
rewrite {
    activeRecipe("org.openrewrite.search.RepositoryContainsFile")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.search.RepositoryContainsFile</recipe>
          </activeRecipes>
        </configuration>
      </plugin>
    </plugins>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.search.RepositoryContainsFile -Drewrite.exportDatatables=true
```
...
```shell title="shell"
mod run . --recipe RepositoryContainsFile
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.search.RepositoryContainsFile" />
