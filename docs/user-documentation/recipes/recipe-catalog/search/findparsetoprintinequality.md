...
[GitHub: FindParseToPrintInequality.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-core/src/main/java/org/openrewrite/search/FindParseToPrintInequality.java),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.search.FindParseToPrintInequality -Drewrite.exportDatatables=true
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.search.FindParseToPrintInequality" />
...
<TabItem value="org.openrewrite.table.ParseToPrintInequalities" label="ParseToPrintInequalities">
