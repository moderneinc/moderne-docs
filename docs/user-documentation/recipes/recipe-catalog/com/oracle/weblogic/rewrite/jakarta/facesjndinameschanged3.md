...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/com/oracle/weblogic/rewrite/jakarta/facesjndinameschanged3" />
</head>
...
rewrite {
    activeRecipe("com.oracle.weblogic.rewrite.jakarta.FacesJNDINamesChanged3")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.oracle.weblogic.rewrite.jakarta.FacesJNDINamesChanged3</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=com.oracle.weblogic.rewrite.jakarta.FacesJNDINamesChanged3 -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe FacesJNDINamesChanged3
```
...
<RecipeCallout link="https://app.moderne.io/recipes/com.oracle.weblogic.rewrite.jakarta.FacesJNDINamesChanged3" />
