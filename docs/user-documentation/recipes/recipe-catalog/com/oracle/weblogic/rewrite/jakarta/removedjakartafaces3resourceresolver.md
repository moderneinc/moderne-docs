...
[GitHub: search?type=code&q=com.oracle.weblogic.rewrite.jakarta.RemovedJakartaFaces3ResourceResolver](https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.jakarta.RemovedJakartaFaces3ResourceResolver),
...
rewrite {
    activeRecipe("com.oracle.weblogic.rewrite.jakarta.RemovedJakartaFaces3ResourceResolver")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.oracle.weblogic.rewrite.jakarta.RemovedJakartaFaces3ResourceResolver</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=com.oracle.weblogic.rewrite.jakarta.RemovedJakartaFaces3ResourceResolver -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe RemovedJakartaFaces3ResourceResolver
```
...
<RecipeCallout link="https://app.moderne.io/recipes/com.oracle.weblogic.rewrite.jakarta.RemovedJakartaFaces3ResourceResolver" />
