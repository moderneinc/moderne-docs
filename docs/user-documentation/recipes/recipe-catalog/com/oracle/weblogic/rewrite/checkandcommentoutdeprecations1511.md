...
canonical_url: "https://docs.openrewrite.org/recipes/com/oracle/weblogic/rewrite/checkandcommentoutdeprecations1511"
---
...
[GitHub: search?type=code&q=com.oracle.weblogic.rewrite.CheckAndCommentOutDeprecations1511](https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.CheckAndCommentOutDeprecations1511),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=com.oracle.weblogic.rewrite.CheckAndCommentOutDeprecations1511 -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe CheckAndCommentOutDeprecations1511
```
...
<RecipeCallout link="https://app.moderne.io/recipes/com.oracle.weblogic.rewrite.CheckAndCommentOutDeprecations1511" />
