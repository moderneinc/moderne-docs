...
<RecipeHeader.Title>Rename `OverlayPanel` to `Popover`</RecipeHeader.Title>

<RecipeHeader.Description>Renames `OverlayPanel` and `OverlayPanelModule` imports from `primeng/overlaypanel` to `Popover` and `PopoverModule` from `primeng/popover`, and updates all identifier usages. The old names are deprecated in PrimeNG 18.</RecipeHeader.Description>

</RecipeHeader>

<RecipeList recipes={[{"name":"Rename `OverlayPanel` identifiers to `Popover`","href":""},{"name":"Change import","href":"/user-documentation/recipes/recipe-catalog/javascript/change-import/"},{"name":"Change import","href":"/user-documentation/recipes/recipe-catalog/javascript/change-import/"}]}>
