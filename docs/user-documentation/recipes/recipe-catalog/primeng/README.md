---
description: Primeng OpenRewrite recipes.
---
...
* [Migrate `.p-fluid` to `&lt;p-fluid&gt;` wrapper](./migratepfluidtowrapper.md)
* [Migrate `PrimeNGConfig` to `PrimeNG`](./migrateprimengconfigtoprimeng.md)
...
* [Add `providePrimeNG` with a detected theme preset to the root NgModule](./addprimengprovider.md)
* [Mark `&lt;p-drawer&gt;` / `&lt;p-sidebar&gt;` `size` usages with TODO comments](./markdrawersize.md)
* [Mark deprecated PrimeNG CSS classes with TODO comments](./markdeprecatedprimengcssclasses.md)
* [Mark deprecated PrimeNG components with TODO comments](./markdeprecatedprimengcomponents.md)
