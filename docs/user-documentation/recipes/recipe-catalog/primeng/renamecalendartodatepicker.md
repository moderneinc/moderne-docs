...
<RecipeMeta
  ...
  fqName={"org.openrewrite.primeng.RenameCalendarToDatePicker"}
...
<UsageList usage={{"recipeName":"org.openrewrite.primeng.RenameCalendarToDatePicker","displayName":"Rename `Calendar` to `DatePicker`","npmPackage":"@openrewrite/recipes-angular"}}>
