...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/axonframework/migration/axon4toaxon5messaging" />
</head>
...
* [Rename package name](../../java/changepackage)
  ...
  * recursive: `true`
* [Migrate SequencingPolicy lambdas to the AF5 two-arg, Optional-returning shape](../../axonframework/migration/migratesequencingpolicylambda)
* [Change type](../../java/changetype)
...
* [Unwrap ResponseTypes wrappers on AF5-shape QueryGateway.query(...) calls](../../axonframework/migration/axon4toaxon5queryresponsetypes)
...
* [Migrate MessageHandlerInterceptor / MessageDispatchInterceptor signatures to AF5](../../axonframework/migration/migratemessageinterceptorsignatures)
* [Change method name](../../java/changemethodname)
...
* [Change method name](../../java/changemethodname)
  ...
  * newMethodName: `timestamp`
  * matchOverrides: `true`
* [Replace class-level CommandGateway with method-parameter CommandDispatcher in @EventHandler methods](../../axonframework/migration/migratecommandgatewayineventhandler)
