---
title: "Upgrade to Axonframework 4.x Javax"
...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/axonframework/migration/upgradeaxonframework_4_javax" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.axonframework.migration.UpgradeAxonFramework_4_Javax"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=org.axonframework.migration.UpgradeAxonFramework_4_Javax"}
/>
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.axonframework.migration.UpgradeAxonFramework_4_Javax"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/axonframework/migration/upgradeaxonframework_4_javax.md"}
>

<RecipeHeader.Title>Upgrade to Axonframework 4.x Javax</RecipeHeader.Title>

<RecipeHeader.Description>Migration file to upgrade an Axon Framework Javax-specific project and remain on Javax.</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.axonframework.migration.UpgradeAxonFramework_4_Javax","displayName":"Upgrade to Axonframework 4.x Javax","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
