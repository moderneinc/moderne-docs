...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.SimplifyElseBranch"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/SimplifyElseBranch.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.SimplifyElseBranch","displayName":"Simplify `else` branch if it only has a single `if`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
