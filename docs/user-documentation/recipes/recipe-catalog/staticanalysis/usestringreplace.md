---
title: "Use `String::replace()` when first parameter is not a real regular expression"
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.UseStringReplace"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/UseStringReplace.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.UseStringReplace","displayName":"Use `String::replace()` when first parameter is not a real regular expression","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
