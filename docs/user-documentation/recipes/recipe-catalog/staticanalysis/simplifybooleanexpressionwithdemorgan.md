...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.SimplifyBooleanExpressionWithDeMorgan"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/SimplifyBooleanExpressionWithDeMorgan.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.SimplifyBooleanExpressionWithDeMorgan","displayName":"Simplify boolean expressions using De Morgan's laws","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
