...
[GitHub: TypecastParenPad.java](https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/TypecastParenPad.java),
...
rewrite {
    activeRecipe("org.openrewrite.staticanalysis.TypecastParenPad")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.staticanalysis.TypecastParenPad</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-static-analysis:RELEASE -Drewrite.activeRecipes=org.openrewrite.staticanalysis.TypecastParenPad -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe TypecastParenPad
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.staticanalysis.TypecastParenPad" />
