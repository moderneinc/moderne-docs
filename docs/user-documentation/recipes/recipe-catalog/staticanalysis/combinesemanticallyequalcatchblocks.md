...
_Combine catches in a try that contain semantically equivalent blocks. No change will be made when a caught exception exists if combining catches may change application behavior or type attribution is missing. Merging duplicate catch bodies into multi-catch blocks reduces repetition and makes the exception handling strategy easier to follow._

### Tags

* [RSPEC-S2147](https://next.sonarqube.com/sonarqube/coding_rules?languages=java&q=S2147&open=java%3AS2147)
