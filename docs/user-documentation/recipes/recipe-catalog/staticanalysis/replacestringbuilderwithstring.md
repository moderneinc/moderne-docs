...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.ReplaceStringBuilderWithString"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/ReplaceStringBuilderWithString.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.ReplaceStringBuilderWithString","displayName":"Replace `StringBuilder#append` with `String`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
