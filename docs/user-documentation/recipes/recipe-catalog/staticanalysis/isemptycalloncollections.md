...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.IsEmptyCallOnCollections"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/IsEmptyCallOnCollections.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.IsEmptyCallOnCollections","displayName":"Use `Collection#isEmpty()` instead of comparing `size()`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
