...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.RemoveInstanceOfPatternMatch"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/RemoveInstanceOfPatternMatch.java"}
/>
