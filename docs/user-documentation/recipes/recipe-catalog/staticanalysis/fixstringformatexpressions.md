...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.FixStringFormatExpressions"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/FixStringFormatExpressions.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.FixStringFormatExpressions","displayName":"Fix `String#format` and `String#formatted` expressions","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
