...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.AbstractClassPublicConstructor"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/AbstractClassPublicConstructor.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.AbstractClassPublicConstructor","displayName":"Constructors of an `abstract` class should not be declared `public`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
