...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.MoveConditionsToWhile"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/MoveConditionsToWhile.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.MoveConditionsToWhile","displayName":"Convert `while (true)` with initial `if` break to loop condition","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
