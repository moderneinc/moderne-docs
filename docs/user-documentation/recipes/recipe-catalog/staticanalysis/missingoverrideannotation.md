...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.MissingOverrideAnnotation"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/MissingOverrideAnnotation.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"ignoreAnonymousClassMethods","value":"false"}],"variants":[{"language":"java","before":"package com.example;\n\nclass Test {\n    public void method() {\n        //noinspection all\n        Runnable t = new Runnable() {\n            public void run() {\n            }\n        };\n    }\n}\n","after":"package com.example;\n\nclass Test {\n    public void method() {\n        //noinspection all\n        Runnable t = new Runnable() {\n            @Override\n            public void run() {\n            }\n        };\n    }\n}\n","diff":"@@ -7,0 +7,1 @@\n        //noinspection all\n        Runnable t = new Runnable() {\n+           @Override\n            public void run() {\n","newFile":false}]}]}>
