...
* [Java](/user-documentation/recipes/recipe-catalog/staticanalysis/java)
* [Maven](/user-documentation/recipes/recipe-catalog/staticanalysis/maven)
...
* [Modernize collections](./modernizecollections.md)
...
* [Add space after // in single-line comments](./singlelinecommentspacing.md)
* [All branches in a conditional should not have the same implementation](./allbranchesidentical.md)
...
* [Branches with identical implementations should be merged](./mergeidenticalbranches.md)
...
* [Identical expressions used with logical operators should be simplified](./simplifyredundantlogicalexpression.md)
* [Inline variable](./inlinevariable.md)
* [Iterate a `Map`'s `entrySet()` rather than its `keySet()`](./usemapentrysetiteration.md)
* [Java API best practices](./javaapibestpractices.md)
* [Jump statements should not be redundant](./noredundantjumpstatements.md)
* [Map values should not be replaced unconditionally](./removeunconditionalvalueoverwrite.md)
* [Mask credit card numbers](./maskcreditcardnumbers.md)
* [Members should not have names differing only by capitalization](./membernamecaseinsensitiveduplicates.md)
* [Mergeable &quot;if&quot; statements should be combined](./collapsibleifstatements.md)
...
* [Related &quot;if/else if&quot; conditions should not be the same](./removeduplicateconditions.md)
...
* [Remove duplicate annotations](./removeduplicateannotations.md)
...
* [Remove methods that only call super](./removemethodsonlycallsuper.md)
* [Remove no argument `super()` constructor calls](./removenoargumentsuperconstructorcall.md)
...
* [Remove unreachable `catch` alternatives shadowed by earlier `catch` clauses](./removeunreachablemulticatchalternative.md)
* [Remove unused labels](./removeunusedlabels.md)
...
* [Replace `java.lang.StringBuffer` with `java.lang.StringBuilder`](./replacestringbufferwithstringbuilder.md)
* [Replace `java.util.Hashtable` with `java.util.HashMap`](./replacehashtablewithhashmap.md)
...
* [Replace `java.util.Vector` with `java.util.ArrayList`](./replacevectorwitharraylist.md)
...
* [Restore interrupted state in catch blocks](./interruptedexceptionhandling.md)
* [Set charset encoding explicitly when calling `String#getBytes`](./explicitcharsetonstringgetbytes.md)
* [Silly equality checks should not be made](./sillyequalscheck.md)
...
* [Simplify for loop boundary comparisons](./simplifyforloopboundarycomparison.md)
...
* [Static members should be accessed via the class name](./staticaccessviainstance.md)
...
* [Use explicit `this.field` and `this.method()`](./explicitthis.md)
...
* [Use try-with-resources](./usetrywithresources.md)
* [Variables should not be self-assigned](./removeselfassignment.md)
