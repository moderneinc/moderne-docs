...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/staticanalysis/javaapibestpractices" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.JavaApiBestPractices"}
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.JavaApiBestPractices","displayName":"Java API best practices","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
