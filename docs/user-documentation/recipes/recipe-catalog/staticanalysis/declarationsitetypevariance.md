...
canonical_url: "https://docs.openrewrite.org/recipes/staticanalysis/declarationsitetypevariance"
---
...
* [Properly use declaration-site type variance for well-known types](/user-documentation/recipes/recipe-catalog/staticanalysis/commondeclarationsitetypevariances.md)
