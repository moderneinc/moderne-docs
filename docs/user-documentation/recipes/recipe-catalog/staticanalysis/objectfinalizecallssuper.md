...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.ObjectFinalizeCallsSuper"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/ObjectFinalizeCallsSuper.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.ObjectFinalizeCallsSuper","displayName":"`finalize()` calls super","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
