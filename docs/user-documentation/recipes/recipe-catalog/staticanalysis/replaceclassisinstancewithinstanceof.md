...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.ReplaceClassIsInstanceWithInstanceof"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/ReplaceClassIsInstanceWithInstanceof.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.ReplaceClassIsInstanceWithInstanceof","displayName":"Replace `A.class.isInstance(a)` with `a instanceof A`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
