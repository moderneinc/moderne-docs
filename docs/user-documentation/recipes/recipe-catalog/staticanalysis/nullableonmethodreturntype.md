...
<RecipeMeta
  ...
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/NullableOnMethodReturnType.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.NullableOnMethodReturnType","displayName":"Move `@Nullable` method annotations to the return type","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
