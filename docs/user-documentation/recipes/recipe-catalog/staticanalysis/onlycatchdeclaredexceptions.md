...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/staticanalysis/onlycatchdeclaredexceptions" />
</head>
...
* [CWE-396](/user-documentation/recipes/lists/recipes-by-tag#cwe)

## Recipe source

[GitHub: OnlyCatchDeclaredExceptions.java](https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/OnlyCatchDeclaredExceptions.java),
...
rewrite {
    activeRecipe("org.openrewrite.staticanalysis.OnlyCatchDeclaredExceptions")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.staticanalysis.OnlyCatchDeclaredExceptions</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-static-analysis:RELEASE -Drewrite.activeRecipes=org.openrewrite.staticanalysis.OnlyCatchDeclaredExceptions -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe OnlyCatchDeclaredExceptions
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.staticanalysis.OnlyCatchDeclaredExceptions" />
