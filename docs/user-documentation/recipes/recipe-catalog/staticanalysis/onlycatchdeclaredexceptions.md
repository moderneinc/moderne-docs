...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.OnlyCatchDeclaredExceptions"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/OnlyCatchDeclaredExceptions.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.OnlyCatchDeclaredExceptions","displayName":"Replace `catch(Exception)` with specific declared exceptions thrown in the try block","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
