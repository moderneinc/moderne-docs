...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.AddSerialVersionUidToSerializable"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/AddSerialVersionUidToSerializable.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"uid","value":"null"}],"variants":[{"language":"java","before":"import java.io.Serializable;\n\npublic class Example implements Serializable {\n    private String fred;\n    private int numberOfFreds;\n}\n","after":"import java.io.Serializable;\n\npublic class Example implements Serializable {\n    private static final long serialVersionUID = 1;\n    private String fred;\n    private int numberOfFreds;\n}\n","diff":"@@ -4,0 +4,1 @@\n\npublic class Example implements Serializable {\n+   private static final long serialVersionUID = 1;\n    private String fred;\n","newFile":false}]}]}>
