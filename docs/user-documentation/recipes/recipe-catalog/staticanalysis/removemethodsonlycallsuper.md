...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/staticanalysis/removemethodsonlycallsuper" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.RemoveMethodsOnlyCallSuper"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/RemoveMethodsOnlyCallSuper.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.RemoveMethodsOnlyCallSuper","displayName":"Remove methods that only call super","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
