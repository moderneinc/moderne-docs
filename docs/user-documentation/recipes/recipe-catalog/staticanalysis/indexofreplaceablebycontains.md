...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/staticanalysis/indexofreplaceablebycontains" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.staticanalysis.IndexOfReplaceableByContains"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/IndexOfReplaceableByContains.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.staticanalysis.IndexOfReplaceableByContains","displayName":"`indexOf()` replaceable by `contains()`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-static-analysis","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STATIC_ANALYSIS","requiresConfiguration":false}}>
