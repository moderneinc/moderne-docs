...
* [RSPEC-S1301](https://next.sonarqube.com/sonarqube/coding_rules?languages=java&q=S1301&open=java%3AS1301)

## Recipe source

[GitHub: MinimumSwitchCases.java](https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/MinimumSwitchCases.java),
...
## Examples
##### Example 1
`MinimumSwitchCasesTest#caseWithReturnInsteadOfBreak`
...
##### Example 2
`MinimumSwitchCasesTest#twoCases`
