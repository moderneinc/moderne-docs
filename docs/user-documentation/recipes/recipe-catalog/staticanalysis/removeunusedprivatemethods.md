...
* [RSPEC-S1144](https://next.sonarqube.com/sonarqube/coding_rules?languages=java&q=S1144&open=java%3AS1144)

## Recipe source

[GitHub: RemoveUnusedPrivateMethods.java](https://github.com/openrewrite/rewrite-static-analysis/blob/main/src/main/java/org/openrewrite/staticanalysis/RemoveUnusedPrivateMethods.java),
...
```shell title="shell"
mod run . --recipe RemoveUnusedPrivateMethods
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.staticanalysis.RemoveUnusedPrivateMethods" />
