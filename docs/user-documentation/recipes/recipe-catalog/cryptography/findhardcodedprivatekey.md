...
<RecipeMeta
  ...
  fqName={"io.moderne.cryptography.FindHardcodedPrivateKey"}
...
<UsageList usage={{"recipeName":"io.moderne.cryptography.FindHardcodedPrivateKey","displayName":"Find hardcoded private keys","groupId":"io.moderne.recipe","artifactId":"rewrite-cryptography","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_CRYPTOGRAPHY","requiresConfiguration":false}}>
