...
<RecipeMeta
  ...
  fqName={"io.moderne.cryptography.FindHardcodedProviderName"}
...
<UsageList usage={{"recipeName":"io.moderne.cryptography.FindHardcodedProviderName","displayName":"Find hardcoded cryptographic provider names","groupId":"io.moderne.recipe","artifactId":"rewrite-cryptography","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_CRYPTOGRAPHY","requiresConfiguration":false}}>
