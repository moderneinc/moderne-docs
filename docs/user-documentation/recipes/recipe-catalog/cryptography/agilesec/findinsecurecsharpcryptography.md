---
title: "Find insecure C# cryptography"
sidebar_label: "Find insecure C# cryptography"
hide_title: true
---
...
<RecipeMeta
  displayName={"Find insecure C# cryptography"}
  description={"Detects insecure .NET (System.Security.Cryptography) algorithm usages and records them in a cipher inventory data table."}
  fqName={"io.moderne.cryptography.agilesec.FindInsecureCSharpCryptography"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.cryptography.agilesec.FindInsecureCSharpCryptography"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/cryptography/agilesec/findinsecurecsharpcryptography.md"}
  moderneOnly
>

<RecipeHeader.Title>Find insecure C# cryptography</RecipeHeader.Title>

<RecipeHeader.Description>Detects insecure .NET (System.Security.Cryptography) algorithm usages and records them in a cipher inventory data table.</RecipeHeader.Description>

</RecipeHeader>

<ExampleList examples={[{"variants":[{"language":"csharp","before":"using System.Security.Cryptography;\n\nclass Ciphers {\n    void Configure() {\n        var des = DES.Create();\n        var md5 = MD5.Create();\n        var mac = new HMACSHA1();\n        var aes = Aes.Create();\n    }\n}\n","after":"using System.Security.Cryptography;\n\nclass Ciphers {\n    void Configure() {\n        var des = /*~~>*/DES.Create();\n        var md5 = /*~~>*/MD5.Create();\n        var mac = /*~~>*/new HMACSHA1();\n        var aes = Aes.Create();\n    }\n}\n","diff":"--- InsecureCrypto.cs\n+++ InsecureCrypto.cs\n@@ -5,3 +5,3 @@\nclass Ciphers {\n    void Configure() {\n-       var des = DES.Create();\n-       var md5 = MD5.Create();\n-       var mac = new HMACSHA1();\n+       var des = /*~~>*/DES.Create();\n+       var md5 = /*~~>*/MD5.Create();\n+       var mac = /*~~>*/new HMACSHA1();\n        var aes = Aes.Create();\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"io.moderne.cryptography.agilesec.FindInsecureCSharpCryptography","displayName":"Find insecure C# cryptography","groupId":"io.moderne.recipe","artifactId":"rewrite-cryptography","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_CRYPTOGRAPHY","requiresConfiguration":false}}>
