---
title: "Find insecure Java cryptography"
sidebar_label: "Find insecure Java cryptography"
hide_title: true
---
...
<RecipeMeta
  displayName={"Find insecure Java cryptography"}
  description={"Detects insecure JCA/JCE and BouncyCastle cryptographic algorithm usages and records them in a cipher inventory data table."}
  fqName={"io.moderne.cryptography.agilesec.FindInsecureJavaCryptography"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.cryptography.agilesec.FindInsecureJavaCryptography"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/cryptography/agilesec/findinsecurejavacryptography.md"}
  moderneOnly
>

<RecipeHeader.Title>Find insecure Java cryptography</RecipeHeader.Title>

<RecipeHeader.Description>Detects insecure JCA/JCE and BouncyCastle cryptographic algorithm usages and records them in a cipher inventory data table.</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"io.moderne.cryptography.agilesec.FindInsecureJavaCryptography","displayName":"Find insecure Java cryptography","groupId":"io.moderne.recipe","artifactId":"rewrite-cryptography","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_CRYPTOGRAPHY","requiresConfiguration":false}}>
