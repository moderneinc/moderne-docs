...
<RecipeMeta
  ...
  fqName={"io.moderne.cryptography.FindHardcodedCiphersuiteChoice"}
...
<UsageList usage={{"recipeName":"io.moderne.cryptography.FindHardcodedCiphersuiteChoice","displayName":"Find hardcoded cipher suite choices","groupId":"io.moderne.recipe","artifactId":"rewrite-cryptography","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_CRYPTOGRAPHY","requiresConfiguration":false}}>
