...
<RecipeMeta
  ...
  fqName={"io.moderne.cryptography.FindDirectSSLConfigurationEditing"}
...
<UsageList usage={{"recipeName":"io.moderne.cryptography.FindDirectSSLConfigurationEditing","displayName":"Find direct SSL configuration editing","groupId":"io.moderne.recipe","artifactId":"rewrite-cryptography","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_CRYPTOGRAPHY","requiresConfiguration":false}}>
