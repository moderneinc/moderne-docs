...
_Detects hardcoded SSL/TLS protocol choices like 'TLSv1.2', 'SSLv3' used in SSLContext.getInstance() and setProtocols() calls. Hardcoded protocols prevent easy updates when protocols become obsolete or insecure._
...
<RunRecipe
  recipeName="io.moderne.cryptography.FindHardcodedProtocolChoice"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.cryptography.FindHardcodedProtocolChoice" />
