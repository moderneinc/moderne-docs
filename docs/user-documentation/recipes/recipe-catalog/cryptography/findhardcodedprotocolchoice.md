...
<RecipeMeta
  ...
  fqName={"io.moderne.cryptography.FindHardcodedProtocolChoice"}
...
<UsageList usage={{"recipeName":"io.moderne.cryptography.FindHardcodedProtocolChoice","displayName":"Find hardcoded SSL/TLS protocol choices","groupId":"io.moderne.recipe","artifactId":"rewrite-cryptography","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_CRYPTOGRAPHY","requiresConfiguration":false}}>
