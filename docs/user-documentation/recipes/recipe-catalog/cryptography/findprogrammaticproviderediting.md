...
<RecipeMeta
  ...
  fqName={"io.moderne.cryptography.FindProgrammaticProviderEditing"}
...
<UsageList usage={{"recipeName":"io.moderne.cryptography.FindProgrammaticProviderEditing","displayName":"Find programmatic security provider editing","groupId":"io.moderne.recipe","artifactId":"rewrite-cryptography","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_CRYPTOGRAPHY","requiresConfiguration":false}}>
