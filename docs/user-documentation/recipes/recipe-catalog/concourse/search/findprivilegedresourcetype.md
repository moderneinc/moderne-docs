...
<RecipeMeta
  ...
  fqName={"org.openrewrite.concourse.search.FindPrivilegedResourceType"}
...
<UsageList usage={{"recipeName":"org.openrewrite.concourse.search.FindPrivilegedResourceType","displayName":"Find privileged `resource_type` definitions","groupId":"org.openrewrite.recipe","artifactId":"rewrite-concourse","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CONCOURSE","requiresConfiguration":false}}>
