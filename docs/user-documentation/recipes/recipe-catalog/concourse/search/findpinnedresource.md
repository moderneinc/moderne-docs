...
<RecipeMeta
  ...
  fqName={"org.openrewrite.concourse.search.FindPinnedResource"}
...
<OptionsTable options={[{"type":"String","name":"resourceType","required":false,"description":"The resource type to search for. Leave empty to find all pins.","example":"git"}]}>

## Options

</OptionsTable>

<ExampleList examples={[{"parameters":[{"parameter":"resourceType","value":"git"}],"variants":[{"language":"yaml","before":"resources:\n- name: git-repo\n  type: git\n  version: 1.0\n- name: git-repo2\n  type: git\n  version: 2.0\n- name: git-repo3\n  type: git\n","after":"resources:\n- name: git-repo\n  type: git\n  ~~>version: 1.0\n- name: git-repo2\n  type: git\n  ~~>version: 2.0\n- name: git-repo3\n  type: git\n","diff":"@@ -4,1 +4,1 @@\n- name: git-repo\n  type: git\n- version: 1.0\n+ ~~>version: 1.0\n- name: git-repo2\n@@ -7,1 +7,1 @@\n- name: git-repo2\n  type: git\n- version: 2.0\n+ ~~>version: 2.0\n- name: git-repo3\n","newFile":false}]}]}>
