---
title: "Add `@Nullable` to a functional-interface return type argument fed a null-returning lambda"
sidebar_label: "Add `@Nullable` to a functional-interface return type argument fed a null-returning lambda"
hide_title: true
---
...
<RecipeMeta
  ...
  fqName={"io.moderne.nullability.AddNullableToFunctionalReturnArgument"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.nullability.AddNullableToFunctionalReturnArgument"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/nullability/addnullabletofunctionalreturnargument.md"}
  moderneOnly
>
