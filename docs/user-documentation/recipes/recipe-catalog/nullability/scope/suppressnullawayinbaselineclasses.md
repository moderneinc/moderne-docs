...
<RecipeMeta
  ...
  fqName={"io.moderne.nullability.scope.SuppressNullAwayInBaselineClasses"}
...
<UsageList usage={{"recipeName":"io.moderne.nullability.scope.SuppressNullAwayInBaselineClasses","displayName":"Suppress NullAway in baseline classes","groupId":"io.moderne.recipe","artifactId":"rewrite-nullability","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_NULLABILITY","requiresConfiguration":true,"cliOptions":" --recipe-option \"baselineClassesFile=/tmp/nullaway-baseline-classes.txt\""}}>
