---
title: "Add a `@Nullable` upper bound to a pass-through type parameter fed a null-returning lambda"
sidebar_label: "Add a `@Nullable` upper bound to a pass-through type parameter fed a null-returning lambda"
---
...
<RunRecipe
  recipeName="io.moderne.nullability.infer.AddNullableBoundToPassthroughTypeParameter"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.nullability.infer.AddNullableBoundToPassthroughTypeParameter" />
