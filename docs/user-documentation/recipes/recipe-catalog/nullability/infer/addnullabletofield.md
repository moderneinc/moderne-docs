...
<RecipeMeta
  ...
  fqName={"io.moderne.nullability.infer.AddNullableToField"}
...
<UsageList usage={{"recipeName":"io.moderne.nullability.infer.AddNullableToField","displayName":"Add `@Nullable` to fields that can hold null","groupId":"io.moderne.recipe","artifactId":"rewrite-nullability","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_NULLABILITY","requiresConfiguration":false}}>
