...
<RecipeMeta
  ...
  fqName={"io.moderne.nullability.infer.AddNullableToArrayElementType"}
...
<UsageList usage={{"recipeName":"io.moderne.nullability.infer.AddNullableToArrayElementType","displayName":"Add `@Nullable` to array element types that can hold null","groupId":"io.moderne.recipe","artifactId":"rewrite-nullability","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_NULLABILITY","requiresConfiguration":false}}>
