...
<RecipeMeta
  ...
  fqName={"io.moderne.nullability.infer.AddNullableToReturnType"}
...
<UsageList usage={{"recipeName":"io.moderne.nullability.infer.AddNullableToReturnType","displayName":"Add `@Nullable` to methods that can return null","groupId":"io.moderne.recipe","artifactId":"rewrite-nullability","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_NULLABILITY","requiresConfiguration":false}}>
