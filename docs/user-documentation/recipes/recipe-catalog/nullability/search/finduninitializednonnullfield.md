...
<RecipeMeta
  ...
  fqName={"io.moderne.nullability.search.FindUninitializedNonNullField"}
...
<UsageList usage={{"recipeName":"io.moderne.nullability.search.FindUninitializedNonNullField","displayName":"Find uninitialized `@NonNull` fields (NullAway field-init)","groupId":"io.moderne.recipe","artifactId":"rewrite-nullability","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_NULLABILITY","requiresConfiguration":false}}>
