---
title: "Add `@Nullable` to a field assigned a nullable value"
sidebar_label: "Add `@Nullable` to a field assigned a nullable value"
hide_title: true
---
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.nullability.AddNullableToNullAssignedField"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/nullability/addnullabletonullassignedfield.md"}
  moderneOnly
>

<RecipeHeader.Title>Add `@Nullable` to a field assigned a nullable value</RecipeHeader.Title>
