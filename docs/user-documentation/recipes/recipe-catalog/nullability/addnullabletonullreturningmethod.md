---
title: "Add `@Nullable` to a method that can return null"
sidebar_label: "Add `@Nullable` to a method that can return null"
hide_title: true
---
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.nullability.AddNullableToNullReturningMethod"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/nullability/addnullabletonullreturningmethod.md"}
  moderneOnly
>

<RecipeHeader.Title>Add `@Nullable` to a method that can return null</RecipeHeader.Title>
