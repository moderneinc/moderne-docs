---
title: "Move a leading `@Nullable` to the type-use position"
sidebar_label: "Move a leading `@Nullable` to the type-use position"
hide_title: true
---
...
<RecipeMeta
  ...
  fqName={"io.moderne.nullability.MoveNullableToTypeUsePosition"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.nullability.MoveNullableToTypeUsePosition"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/nullability/movenullabletotypeuseposition.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"io.moderne.nullability.MoveNullableToTypeUsePosition","displayName":"Move a leading `@Nullable` to the type-use position","groupId":"io.moderne.recipe","artifactId":"rewrite-nullability","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_NULLABILITY","requiresConfiguration":false}}>
