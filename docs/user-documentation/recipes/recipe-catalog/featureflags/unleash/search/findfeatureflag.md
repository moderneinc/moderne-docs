...
_Find an Unleash feature flag._

## Recipe source

[GitHub: FindFeatureFlag.java](https://github.com/openrewrite/rewrite-feature-flags/blob/main/src/main/java/org/openrewrite/featureflags/unleash/search/FindFeatureFlag.java),
...
rewrite {
    activeRecipe("org.openrewrite.featureflags.unleash.search.FindFeatureFlag")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.featureflags.unleash.search.FindFeatureFlag</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-feature-flags:RELEASE -Drewrite.activeRecipes=org.openrewrite.featureflags.unleash.search.FindFeatureFlag -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.featureflags.unleash.search.FindFeatureFlag" />
