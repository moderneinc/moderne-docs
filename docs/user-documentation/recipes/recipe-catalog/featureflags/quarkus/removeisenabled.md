...
name: org.openrewrite.featureflags.quarkus.RemoveIsEnabled
...
displayName: Remove Quarkus feature flag's `isEnabled` for feature key example
recipeList:
  - org.openrewrite.featureflags.quarkus.RemoveIsEnabled:
      featureKey: flag-key-123abc
      replacementValue: true
...
<RunRecipe
  recipeName="org.openrewrite.featureflags.quarkus.RemoveIsEnabled"
  displayName="Remove Quarkus feature flag's `isEnabled` for feature key"
  groupId="org.openrewrite.recipe"
  artifactId="rewrite-feature-flags"
  versionKey="VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_FEATURE_FLAGS"
  requiresConfiguration
  cliOptions={' --recipe-option "featureKey=flag-key-123abc" --recipe-option "replacementValue=true"'}
  showGradle={false}
  showMaven={false}
  hasDataTables
/>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.featureflags.quarkus.RemoveIsEnabled" />
