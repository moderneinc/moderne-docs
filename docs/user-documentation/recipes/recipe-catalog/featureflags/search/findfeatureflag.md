...
<RecipeMeta
  ...
  fqName={"org.openrewrite.featureflags.search.FindFeatureFlag"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-feature-flags/blob/main/src/main/java/org/openrewrite/featureflags/search/FindFeatureFlag.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"methodPattern","value":"com.acme.FeatureFlag isEnabled(String)"},{"parameter":"featureKey","value":"null"}],"variants":[{"language":"java","before":"import com.acme.FeatureFlag;\n\nclass Test {\n    public void a() {\n        FeatureFlag client = new FeatureFlag();\n        boolean flagValue = client.isEnabled(\"flag-key-123abc\");\n        if (flagValue) {\n            // Application code to show the feature\n        } else {\n            // The code to run if the feature is off\n        }\n    }\n}\n","after":"import com.acme.FeatureFlag;\n\nclass Test {\n    public void a() {\n        FeatureFlag client = new FeatureFlag();\n        boolean flagValue = /*~~>*/client.isEnabled(\"flag-key-123abc\");\n        if (flagValue) {\n            // Application code to show the feature\n        } else {\n            // The code to run if the feature is off\n        }\n    }\n}\n","diff":"@@ -6,1 +6,1 @@\n    public void a() {\n        FeatureFlag client = new FeatureFlag();\n-       boolean flagValue = client.isEnabled(\"flag-key-123abc\");\n+       boolean flagValue = /*~~>*/client.isEnabled(\"flag-key-123abc\");\n        if (flagValue) {\n","newFile":false}]}]}>
