...
[GitHub: ChangeVariationDefault.java](https://github.com/openrewrite/rewrite-feature-flags/blob/main/src/main/java/org/openrewrite/featureflags/launchdarkly/ChangeVariationDefault.java),
...
<RunRecipe
  ...
  cliOptions={' --recipe-option "featureKey=flag-key-123abc" --recipe-option "defaultValue=true"'}
  showGradle={false}
  showMaven={false}
  hasDataTables
/>
