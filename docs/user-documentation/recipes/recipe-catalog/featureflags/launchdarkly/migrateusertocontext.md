...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/featureflags/launchdarkly/migrateusertocontext" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.featureflags.launchdarkly.MigrateUserToContext"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-feature-flags/blob/main/src/main/java/org/openrewrite/featureflags/launchdarkly/MigrateUserToContext.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.featureflags.launchdarkly.MigrateUserToContext","displayName":"Migrate `LDUser` to `LDContext`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-feature-flags","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_FEATURE_FLAGS","requiresConfiguration":false}}>
