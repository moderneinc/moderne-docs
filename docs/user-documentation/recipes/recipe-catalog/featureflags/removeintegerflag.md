...
[GitHub: RemoveIntegerFlag.java](https://github.com/openrewrite/rewrite-feature-flags/blob/main/src/main/java/org/openrewrite/featureflags/RemoveIntegerFlag.java),
...
* [Remove LaunchDarkly's `intVariation` for feature key](/user-documentation/recipes/recipe-catalog/featureflags/launchdarkly/removeintvariation.md)
* [Remove OpenFeature's `getIntegerValue` for feature key](/user-documentation/recipes/recipe-catalog/featureflags/openfeature/removegetintegervalue.md)
* [Remove Quarkus feature flag's `getInt` for feature key](/user-documentation/recipes/recipe-catalog/featureflags/quarkus/removegetint.md)
...
<RunRecipe
  ...
  cliOptions={' --recipe-option "methodPattern=dev.openfeature.sdk.Client getIntegerValue(String, Integer)" --recipe-option "featureKey=flag-key-123abc" --recipe-option "replacementValue=42"'}
  showGradle={false}
  showMaven={false}
  hasDataTables
/>
