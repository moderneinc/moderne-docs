...
[GitHub: RemoveStringFlag.java](https://github.com/openrewrite/rewrite-feature-flags/blob/main/src/main/java/org/openrewrite/featureflags/RemoveStringFlag.java),
...
| Parameter | Value |
| --- | --- |
|methodPattern|`com.acme.bank.InHouseFF getStringFeatureFlagValue(String, String)`|
...
Now that `com.yourorg.RemoveStringFlagExample` has been defined, activate it and take a dependency on `org.openrewrite.recipe:rewrite-feature-flags:{{VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_FEATURE_FLAGS}}` in your build file:
...
rewrite {
    activeRecipe("com.yourorg.RemoveStringFlagExample")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.yourorg.RemoveStringFlagExample</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.featureflags.RemoveStringFlag" />
