...
<RecipeMeta
  ...
  fqName={"org.openrewrite.featureflags.openfeature.RemoveGetIntegerValue"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-feature-flags/blob/main/src/main/java/org/openrewrite/featureflags/openfeature/RemoveGetIntegerValue.java"}
/>
