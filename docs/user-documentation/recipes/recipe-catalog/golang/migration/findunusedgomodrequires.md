...
<UsageList usage={{"recipeName":"org.openrewrite.golang.migration.FindUnusedGoModRequires","displayName":"Find unused go.mod requirements","goPackage":"github.com/moderneinc/recipes-go","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_RECIPES_GO"}}>
