...
<UsageList usage={{"recipeName":"org.openrewrite.golang.codequality.FindDeprecatedAtomicFunctions","displayName":"Find deprecated `sync/atomic` functions","goPackage":"github.com/moderneinc/recipes-go","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_RECIPES_GO"}}>
