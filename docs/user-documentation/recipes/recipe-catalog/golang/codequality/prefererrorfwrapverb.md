...
<UsageList usage={{"recipeName":"org.openrewrite.golang.codequality.PreferErrorfWrapVerb","displayName":"Prefer %w over %s in fmt.Errorf for error wrapping","goPackage":"github.com/moderneinc/recipes-go","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_RECIPES_GO"}}>
