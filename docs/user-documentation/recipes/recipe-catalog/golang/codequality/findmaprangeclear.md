...
<UsageList usage={{"recipeName":"org.openrewrite.golang.codequality.FindMapRangeClear","displayName":"Replace map range-delete with clear()","goPackage":"github.com/moderneinc/recipes-go","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_RECIPES_GO"}}>
