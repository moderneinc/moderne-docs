...
<UsageList usage={{"recipeName":"org.openrewrite.golang.codequality.AuditMultipleErrorWraps","displayName":"Replace extra %w verbs with %v in fmt.Errorf","goPackage":"github.com/moderneinc/recipes-go","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_RECIPES_GO"}}>
