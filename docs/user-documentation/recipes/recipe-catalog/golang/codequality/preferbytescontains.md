...
<UsageList usage={{"recipeName":"org.openrewrite.golang.codequality.PreferBytesContains","displayName":"Prefer bytes.Contains over bytes.Index comparison","goPackage":"github.com/moderneinc/recipes-go","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_RECIPES_GO"}}>
