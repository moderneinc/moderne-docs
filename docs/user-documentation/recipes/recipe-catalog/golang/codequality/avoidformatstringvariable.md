...
<UsageList usage={{"recipeName":"org.openrewrite.golang.codequality.AvoidFormatStringVariable","displayName":"Avoid format string variable","goPackage":"github.com/moderneinc/recipes-go","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_RECIPES_GO"}}>
