...
<UsageList usage={{"recipeName":"org.openrewrite.golang.codequality.SimplifySprintfConcat","displayName":"Simplify fmt.Sprintf string concat","goPackage":"github.com/moderneinc/recipes-go","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_RECIPES_GO"}}>
