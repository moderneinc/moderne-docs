...
<UsageList usage={{"recipeName":"org.openrewrite.golang.codequality.PreferOsIsTimeout","displayName":"Prefer errors.Is for os timeout checks","goPackage":"github.com/moderneinc/recipes-go","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_RECIPES_GO"}}>
