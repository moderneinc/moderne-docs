...
<UsageList usage={{"recipeName":"org.openrewrite.golang.codequality.HandleDeferredCloseError","displayName":"Handle deferred Close() error","goPackage":"github.com/moderneinc/recipes-go","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_RECIPES_GO"}}>
