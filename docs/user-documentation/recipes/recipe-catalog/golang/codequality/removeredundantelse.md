...
<UsageList usage={{"recipeName":"org.openrewrite.golang.codequality.RemoveRedundantElse","displayName":"Remove redundant else after return","goPackage":"github.com/moderneinc/recipes-go","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_RECIPES_GO"}}>
