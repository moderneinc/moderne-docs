...
<UsageList usage={{"recipeName":"org.openrewrite.golang.codequality.AllBranchesIdentical","displayName":"Remove if/else with identical branches","goPackage":"github.com/moderneinc/recipes-go","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_RECIPES_GO"}}>
