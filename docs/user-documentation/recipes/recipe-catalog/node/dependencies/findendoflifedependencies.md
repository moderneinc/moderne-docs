---
title: "Find end-of-life npm dependencies"
sidebar_label: "Find end-of-life npm dependencies"
hide_title: true
---
...
<RecipeMeta
  displayName={"Find end-of-life npm dependencies"}
  description={"Find npm dependencies whose upstream release is end-of-life or scheduled for end-of-life soon, using a snapshot of [endoflife.date](https://endoflife.date). Direct dependencies declared in `package.json` are marked in source; all matches (direct and transitive) are reported in the data table."}
  fqName={"org.openrewrite.node.dependencies.FindEndOfLifeDependencies"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.node.dependencies.FindEndOfLifeDependencies"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/node/dependencies/findendoflifedependencies.md"}
  moderneOnly
>

<RecipeHeader.Title>Find end-of-life npm dependencies</RecipeHeader.Title>

<RecipeHeader.Description>Find npm dependencies whose upstream release is end-of-life or scheduled for end-of-life soon, using a snapshot of [endoflife.date](https://endoflife.date). Direct dependencies declared in `package.json` are marked in source; all matches (direct and transitive) are reported in the data table.</RecipeHeader.Description>
