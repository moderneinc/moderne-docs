...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/node/migrate/process/coerce-process-exit-code" />
</head>
...
[GitHub: rewrite+org.openrewrite.node.migrate.process.coerce-process-exit-code](https://github.com/search?type=code&q=repo:openrewrite/rewrite+org.openrewrite.node.migrate.process.coerce-process-exit-code),
