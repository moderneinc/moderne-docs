...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/node/migrate/tls/replace-internal-modules" />
</head>
...
[GitHub: rewrite+org.openrewrite.node.migrate.tls.replace-internal-modules](https://github.com/search?type=code&q=repo:openrewrite/rewrite+org.openrewrite.node.migrate.tls.replace-internal-modules),
