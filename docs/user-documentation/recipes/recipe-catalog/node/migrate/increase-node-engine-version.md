...
<RecipeHeader.Description>Increases the upper bound of the `engines.node` version range in package.json to allow the specified Node.js version.</RecipeHeader.Description>
