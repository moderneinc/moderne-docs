...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/node/migrate/buffer/replace-slow-buffer" />
</head>
...
[GitHub: rewrite+org.openrewrite.node.migrate.buffer.replace-slow-buffer](https://github.com/search?type=code&q=repo:openrewrite/rewrite+org.openrewrite.node.migrate.buffer.replace-slow-buffer),
