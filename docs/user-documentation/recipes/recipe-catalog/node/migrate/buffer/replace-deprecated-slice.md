...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/node/migrate/buffer/replace-deprecated-slice" />
</head>
...
[GitHub: rewrite+org.openrewrite.node.migrate.buffer.replace-deprecated-slice](https://github.com/search?type=code&q=repo:openrewrite/rewrite+org.openrewrite.node.migrate.buffer.replace-deprecated-slice),
