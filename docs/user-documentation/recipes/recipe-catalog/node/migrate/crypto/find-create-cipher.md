...
[GitHub: rewrite+org.openrewrite.node.migrate.crypto.find-create-cipher](https://github.com/search?type=code&q=repo:openrewrite/rewrite+org.openrewrite.node.migrate.crypto.find-create-cipher),
