...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/node/migrate/zlib/replace-bytes-read" />
</head>
...
[GitHub: rewrite+org.openrewrite.node.migrate.zlib.replace-bytes-read](https://github.com/search?type=code&q=repo:openrewrite/rewrite+org.openrewrite.node.migrate.zlib.replace-bytes-read),
