...
[GitHub: rewrite+org.openrewrite.node.migrate.timers.find-timers-active](https://github.com/search?type=code&q=repo:openrewrite/rewrite+org.openrewrite.node.migrate.timers.find-timers-active),
