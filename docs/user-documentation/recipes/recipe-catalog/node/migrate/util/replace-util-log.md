...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/node/migrate/util/replace-util-log" />
</head>
...
[GitHub: rewrite+org.openrewrite.node.migrate.util.replace-util-log](https://github.com/search?type=code&q=repo:openrewrite/rewrite+org.openrewrite.node.migrate.util.replace-util-log),
