...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/node/migrate/util/replace-is-webassembly-compiled-module" />
</head>
...
[GitHub: rewrite+org.openrewrite.node.migrate.util.replace-is-webassembly-compiled-module](https://github.com/search?type=code&q=repo:openrewrite/rewrite+org.openrewrite.node.migrate.util.replace-is-webassembly-compiled-module),
...
* [Upgrade to Node.js 22](/user-documentation/recipes/recipe-catalog/node/migrate/upgrade-node-22.md)
