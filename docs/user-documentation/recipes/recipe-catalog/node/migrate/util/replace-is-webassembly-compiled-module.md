...
<RecipeHeader.Title>Replace deprecated `util.types.isWebAssemblyCompiledModule()`</RecipeHeader.Title>

<RecipeHeader.Description>Replace `util.types.isWebAssemblyCompiledModule(value)` with `value instanceof WebAssembly.Module`.</RecipeHeader.Description>
