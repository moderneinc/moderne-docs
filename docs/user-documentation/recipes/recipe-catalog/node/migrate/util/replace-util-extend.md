...
<RecipeHeader.Title>Replace deprecated `util._extend()` with `Object.assign()`</RecipeHeader.Title>

<RecipeHeader.Description>Replace deprecated `util._extend(target, source)` calls with `Object.assign(target, source)` which preserves the mutation behavior.</RecipeHeader.Description>
