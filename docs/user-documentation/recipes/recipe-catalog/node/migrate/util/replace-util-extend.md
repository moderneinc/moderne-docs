...
canonical_url: "https://docs.openrewrite.org/recipes/node/migrate/util/replace-util-extend"
---
...
[GitHub: rewrite+org.openrewrite.node.migrate.util.replace-util-extend](https://github.com/search?type=code&q=repo:openrewrite/rewrite+org.openrewrite.node.migrate.util.replace-util-extend),
