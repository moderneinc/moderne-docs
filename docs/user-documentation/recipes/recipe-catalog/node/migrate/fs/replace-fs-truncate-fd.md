...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/node/migrate/fs/replace-fs-truncate-fd" />
</head>
...
[GitHub: rewrite+org.openrewrite.node.migrate.fs.replace-fs-truncate-fd](https://github.com/search?type=code&q=repo:openrewrite/rewrite+org.openrewrite.node.migrate.fs.replace-fs-truncate-fd),
