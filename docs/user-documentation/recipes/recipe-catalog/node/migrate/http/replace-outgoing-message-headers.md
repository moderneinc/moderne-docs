...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/node/migrate/http/replace-outgoing-message-headers" />
</head>
...
[GitHub: rewrite+org.openrewrite.node.migrate.http.replace-outgoing-message-headers](https://github.com/search?type=code&q=repo:openrewrite/rewrite+org.openrewrite.node.migrate.http.replace-outgoing-message-headers),
...
* [Upgrade to Node.js 24](/user-documentation/recipes/recipe-catalog/node/migrate/upgrade-node-24.md)
