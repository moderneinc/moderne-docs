...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/json/format/indents" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.json.format.Indents"}
  languages={["JSON"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-json/src/main/java/org/openrewrite/json/format/Indents.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.json.format.Indents","displayName":"JSON indent","groupId":"org.openrewrite","artifactId":"rewrite-json","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_JSON","requiresConfiguration":false}}>
