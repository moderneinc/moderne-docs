...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/json/changevalue" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.json.ChangeValue"}
  languages={["JSON"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-json/src/main/java/org/openrewrite/json/ChangeValue.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"oldKeyPath","value":"$.metadata.name"},{"parameter":"value","value":"\"monitoring\""}],"variants":[{"language":"json","before":"{\n  \"apiVersion\": \"v1\",\n  \"metadata\": {\n    \"name\": \"monitoring-tools\",\n    \"namespace\": \"monitoring-tools\"\n  }\n}\n","after":"{\n  \"apiVersion\": \"v1\",\n  \"metadata\": {\n    \"name\": \"monitoring\",\n    \"namespace\": \"monitoring-tools\"\n  }\n}\n","diff":"@@ -4,1 +4,1 @@\n  \"apiVersion\": \"v1\",\n  \"metadata\": {\n-   \"name\": \"monitoring-tools\",\n+   \"name\": \"monitoring\",\n    \"namespace\": \"monitoring-tools\"\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.json.ChangeValue","displayName":"Change value","groupId":"org.openrewrite","artifactId":"rewrite-json","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_JSON","requiresConfiguration":true,"cliOptions":" --recipe-option \"oldKeyPath=$.subjects.kind\" --recipe-option \"value='Deployment'\""}}>
