...
[GitHub: DeleteKey.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-json/src/main/java/org/openrewrite/json/DeleteKey.java),
...
```shell title="shell"
mod run . --recipe DeleteKey --recipe-option "keyPath=$.subjects.kind"
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.json.DeleteKey" />
