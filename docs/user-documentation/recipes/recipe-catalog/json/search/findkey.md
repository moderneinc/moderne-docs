...
[GitHub: FindKey.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-json/src/main/java/org/openrewrite/json/search/FindKey.java),
...
```shell title="shell"
mod run . --recipe FindKey --recipe-option "key=$.subjects.kind"
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.json.search.FindKey" />
