...
<RecipeMeta
  ...
  fqName={"org.openrewrite.dotnet.MigrateToNet7"}
...
<UsageList usage={{"recipeName":"org.openrewrite.dotnet.MigrateToNet7","displayName":"Upgrade to .NET 7.0 using upgrade-assistant","groupId":"org.openrewrite.recipe","artifactId":"rewrite-dotnet","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_DOTNET","requiresConfiguration":false}}>
