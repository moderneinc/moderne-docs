...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/ai/timefold/solver/migration/v8/nullablerecipe" />
</head>
...
[GitHub: search?type=code&q=ai.timefold.solver.migration.v8.NullableRecipe](https://github.com/search?type=code&q=ai.timefold.solver.migration.v8.NullableRecipe),
...
<RunRecipe
  recipeName="ai.timefold.solver.migration.v8.NullableRecipe"
  displayName="PlanningVariable's `nullable` is newly called `unassignedValues`"
