...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/ai/timefold/solver/migration/changeversion" />
</head>
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>ai.timefold.solver.migration.ChangeVersion</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=ai.timefold.solver.migration.ChangeVersion -Drewrite.exportDatatables=true
```
</TabItem>
