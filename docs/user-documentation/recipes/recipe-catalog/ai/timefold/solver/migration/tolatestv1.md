---
sidebar_label: "Upgrade to the latest Timefold Solver 1.x"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/ai/timefold/solver/migration/tolatestv1" />
</head>
...
[GitHub: search?type=code&q=ai.timefold.solver.migration.ToLatestV1](https://github.com/search?type=code&q=ai.timefold.solver.migration.ToLatestV1),
...
name: ai.timefold.solver.migration.ToLatestV1
displayName: Upgrade to the latest Timefold Solver 1.x
description: |
...
<RecipeCallout link="https://app.moderne.io/recipes/ai.timefold.solver.migration.ToLatestV1" />
