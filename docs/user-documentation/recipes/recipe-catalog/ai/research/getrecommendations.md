...
<RunRecipe
  recipeName="io.moderne.ai.research.GetRecommendations"
  displayName="Get recommendations"
  groupId="org.openrewrite.recipe"
  artifactId="rewrite-ai-search"
  versionKey="VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_AI_SEARCH"
  requiresConfiguration
  cliOptions={' --recipe-option "randomSampling=null" --recipe-option "numberOfCenters=3"'}
  showGradle={false}
  showMaven={false}
  hasDataTables
/>
...
<TabItem value="io.moderne.ai.table.Recommendations" label="Recommendations">
