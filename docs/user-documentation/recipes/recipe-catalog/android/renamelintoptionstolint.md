...
<RecipeMeta
  ...
  fqName={"org.openrewrite.android.RenameLintOptionsToLint"}
...
<UsageList usage={{"recipeName":"org.openrewrite.android.RenameLintOptionsToLint","displayName":"Rename `lintOptions` to `lint`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-android","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_ANDROID","requiresConfiguration":false}}>
