...
[GitHub: search?type=code&q=com.oracle.weblogic.rewrite.jakarta.RemovedJakartaFaces3ExpressionLanguageClasses](https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.jakarta.RemovedJakartaFaces3ExpressionLanguageClasses),
...
<RunRecipe
  recipeName="com.oracle.weblogic.rewrite.jakarta.RemovedJakartaFaces3ExpressionLanguageClasses"
  displayName="Use `jakarta.el` instead of `jakarta.faces.el` and `javax.faces.el`"
