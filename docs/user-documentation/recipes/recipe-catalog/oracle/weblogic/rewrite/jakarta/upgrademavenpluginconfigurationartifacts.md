...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/oracle/weblogic/rewrite/jakarta/upgrademavenpluginconfigurationartifacts" />
</head>
...
[GitHub: search?type=code&q=com.oracle.weblogic.rewrite.jakarta.UpgradeMavenPluginConfigurationArtifacts](https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.jakarta.UpgradeMavenPluginConfigurationArtifacts),
...
* [Upgrade group, artifact ID and version of an artifactItem, of a maven plugin execution configuration](../../../../oracle/weblogic/rewrite/jakarta/upgrademavenpluginartifactitems)
  * oldGroupId: `javax`
...
<RunRecipe
  recipeName="com.oracle.weblogic.rewrite.jakarta.UpgradeMavenPluginConfigurationArtifacts"
  displayName="Change artifacts for a Maven plugin configuration"
