...
<RecipeMeta
  ...
  sourceUrl={"https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.spring.framework.DefaultServletHandler"}
/>
...
<UsageList usage={{"recipeName":"com.oracle.weblogic.rewrite.spring.framework.DefaultServletHandler","displayName":"Update Default Servlet Handler for Spring Framework if empty","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
