...
<RecipeMeta
  ...
  fqName={"com.oracle.weblogic.rewrite.spring.framework.ReplaceWebLogicLoadTimeWeaver"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.spring.framework.ReplaceWebLogicLoadTimeWeaver"}
/>

<RecipeHeader
  type={"Composite recipe"}
  languages={["OpenRewrite"]}
  tags={["springframework","weblogic","LoadTimeWeaver"]}
  license={"Apache License Version 2.0"}
  fqName={"com.oracle.weblogic.rewrite.spring.framework.ReplaceWebLogicLoadTimeWeaver"}
...
<UsageList usage={{"recipeName":"com.oracle.weblogic.rewrite.spring.framework.ReplaceWebLogicLoadTimeWeaver","displayName":"Replace Removed WebLogicLoadTimeWeaver from Spring Framework 5.3.x to 6.2.x","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
