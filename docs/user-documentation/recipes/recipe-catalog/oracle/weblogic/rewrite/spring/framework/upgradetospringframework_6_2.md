...
[GitHub: search?type=code&q=com.oracle.weblogic.rewrite.spring.framework.UpgradeToSpringFramework_6_2](https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.spring.framework.UpgradeToSpringFramework_6_2),
...
* [Replace Removed WebLogicJtaTransactionManager from Spring Framework 5.3.x to 6.2.x](../../../../../oracle/weblogic/rewrite/spring/framework/replaceweblogicjtatransactionmanager)
* [Replace Removed WebLogicLoadTimeWeaver from Spring Framework 5.3.x to 6.2.x](../../../../../oracle/weblogic/rewrite/spring/framework/replaceweblogicloadtimeweaver)
* [Upgrade Spring Data BOM to 2024.1.x](../../../../../oracle/weblogic/rewrite/spring/data/upgradespringdatabom)
* [Upgrade Spring Data JPA to 3.4.6](../../../../../oracle/weblogic/rewrite/spring/data/upgradespringdatajpa)
...
<RunRecipe
  recipeName="com.oracle.weblogic.rewrite.spring.framework.UpgradeToSpringFramework_6_2"
  displayName="Migrate to Spring Framework 6.2 for WebLogic 15.1.1"
