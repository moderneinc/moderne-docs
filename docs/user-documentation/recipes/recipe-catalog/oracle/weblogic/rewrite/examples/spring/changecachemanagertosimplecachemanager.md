...
<RecipeMeta
  ...
  fqName={"com.oracle.weblogic.rewrite.examples.spring.ChangeCacheManagerToSimpleCacheManager"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.examples.spring.ChangeCacheManagerToSimpleCacheManager"}
/>

<RecipeHeader
  type={"Composite recipe"}
  languages={["OpenRewrite"]}
  tags={["springframework","examples","cacheManager"]}
  license={"Apache License Version 2.0"}
  fqName={"com.oracle.weblogic.rewrite.examples.spring.ChangeCacheManagerToSimpleCacheManager"}
...
<UsageList usage={{"recipeName":"com.oracle.weblogic.rewrite.examples.spring.ChangeCacheManagerToSimpleCacheManager","displayName":"Change cacheManager to use the SimpleCacheManager","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
