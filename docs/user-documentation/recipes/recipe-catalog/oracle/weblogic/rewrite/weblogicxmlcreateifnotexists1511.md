...
<RecipeMeta
  ...
  fqName={"com.oracle.weblogic.rewrite.WebLogicXmlCreateIfNotExists1511"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.WebLogicXmlCreateIfNotExists1511"}
/>
...
<UsageList usage={{"recipeName":"com.oracle.weblogic.rewrite.WebLogicXmlCreateIfNotExists1511","displayName":"Create `weblogic.xml` if it does not exist","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
