...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/oracle/weblogic/rewrite/hibernate/migratehibernatetojakartaee9" />
</head>
...
<RecipeMeta
  ...
  fqName={"com.oracle.weblogic.rewrite.hibernate.MigrateHibernateToJakartaEE9"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.hibernate.MigrateHibernateToJakartaEE9"}
/>
...
<UsageList usage={{"recipeName":"com.oracle.weblogic.rewrite.hibernate.MigrateHibernateToJakartaEE9","displayName":"Migrate to Hibernate for Jakarta EE 9","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
