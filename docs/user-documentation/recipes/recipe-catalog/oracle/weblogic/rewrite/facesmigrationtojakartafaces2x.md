...
<RecipeMeta
  ...
  fqName={"com.oracle.weblogic.rewrite.FacesMigrationToJakartaFaces2x"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.FacesMigrationToJakartaFaces2x"}
/>

<RecipeHeader
  type={"Composite recipe"}
  languages={["OpenRewrite"]}
  tags={["faces","jsf","javax","jakarta","jakartaee"]}
  license={"Apache License Version 2.0"}
  fqName={"com.oracle.weblogic.rewrite.FacesMigrationToJakartaFaces2x"}
...
<UsageList usage={{"recipeName":"com.oracle.weblogic.rewrite.FacesMigrationToJakartaFaces2x","displayName":"JSF 1.x to Jakarta Server Faces 2.3 on WebLogic 14.1.2 or older","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
