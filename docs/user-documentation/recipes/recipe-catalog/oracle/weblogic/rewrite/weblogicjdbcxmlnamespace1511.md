...
<RecipeMeta
  ...
  fqName={"com.oracle.weblogic.rewrite.WebLogicJdbcXmlNamespace1511"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.WebLogicJdbcXmlNamespace1511"}
/>
...
<UsageList usage={{"recipeName":"com.oracle.weblogic.rewrite.WebLogicJdbcXmlNamespace1511","displayName":"Migrate xmlns entries in `*-jdbc.xml` files to WebLogic 15.1.1","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
