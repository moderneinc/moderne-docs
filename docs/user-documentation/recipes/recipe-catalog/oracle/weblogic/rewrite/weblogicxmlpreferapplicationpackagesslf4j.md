...
<RecipeMeta
  ...
  fqName={"com.oracle.weblogic.rewrite.WebLogicXmlPreferApplicationPackagesSlf4j"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.WebLogicXmlPreferApplicationPackagesSlf4j"}
/>
...
<UsageList usage={{"recipeName":"com.oracle.weblogic.rewrite.WebLogicXmlPreferApplicationPackagesSlf4j","displayName":"Add `prefer-application-packages` for SLF4J in `weblogic.xml`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
