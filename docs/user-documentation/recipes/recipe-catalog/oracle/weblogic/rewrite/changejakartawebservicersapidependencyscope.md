...
<RecipeMeta
  ...
  fqName={"com.oracle.weblogic.rewrite.ChangeJakartaWebServiceRSAPIDependencyScope"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.ChangeJakartaWebServiceRSAPIDependencyScope"}
/>
