...
<RecipeMeta
  ...
  fqName={"com.oracle.weblogic.rewrite.WebLogicJdbcXmlNamespace1412"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=com.oracle.weblogic.rewrite.WebLogicJdbcXmlNamespace1412"}
/>

<RecipeHeader
  type={"Composite recipe"}
  languages={["OpenRewrite"]}
  tags={["weblogic","jdbc","schemas"]}
  license={"Apache License Version 2.0"}
  fqName={"com.oracle.weblogic.rewrite.WebLogicJdbcXmlNamespace1412"}
...
<UsageList usage={{"recipeName":"com.oracle.weblogic.rewrite.WebLogicJdbcXmlNamespace1412","displayName":"Migrate xmlns entries in `*-jdbc.xml` files to WebLogic 14.1.2","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
