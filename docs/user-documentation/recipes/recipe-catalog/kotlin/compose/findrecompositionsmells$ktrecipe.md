...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindRecompositionSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindRecompositionSmells$KtRecipe","displayName":"Find Compose recomposition smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
