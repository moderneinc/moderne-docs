...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindComposeLayoutIssues$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindComposeLayoutIssues$KtRecipe","displayName":"Find Compose layout hierarchy smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
