...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindComposeStabilityIssues$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindComposeStabilityIssues$KtRecipe","displayName":"Find Compose stability issues","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
