...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindUnnecessaryComposeWrappers$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindUnnecessaryComposeWrappers$KtRecipe","displayName":"Find single-child wrapper composables (Material 3)","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
