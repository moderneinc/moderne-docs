...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindLifecycleAwareFlowSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindLifecycleAwareFlowSmells$KtRecipe","displayName":"Find lifecycle-naive flow / LiveData collection in Composables","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
