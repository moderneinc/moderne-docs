...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindStateAndRememberSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindStateAndRememberSmells$KtRecipe","displayName":"Find Compose state + remember misuse","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
