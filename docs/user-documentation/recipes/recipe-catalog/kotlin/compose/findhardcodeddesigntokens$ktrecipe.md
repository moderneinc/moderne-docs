...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindHardcodedDesignTokens$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindHardcodedDesignTokens$KtRecipe","displayName":"Find hardcoded color literals inside `@Composable`","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
