...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindComposeEffectIssues$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindComposeEffectIssues$KtRecipe","displayName":"Find Compose effect handler issues","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
