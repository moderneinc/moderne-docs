...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindComposeModifierIssues$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindComposeModifierIssues$KtRecipe","displayName":"Find Compose `Modifier` smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
