...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindModifierShorthands$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindModifierShorthands$KtRecipe","displayName":"Find `Modifier.padding(...)` shorthand opportunities","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
