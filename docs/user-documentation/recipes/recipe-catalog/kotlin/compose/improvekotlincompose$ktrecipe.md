...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.ImproveKotlinCompose$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.ImproveKotlinCompose$KtRecipe","displayName":"Apply Compose autofix rewrites","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
