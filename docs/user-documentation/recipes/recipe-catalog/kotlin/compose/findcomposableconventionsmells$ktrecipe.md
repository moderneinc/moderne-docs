...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindComposableConventionSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindComposableConventionSmells$KtRecipe","displayName":"Find Compose function-naming conventions","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
