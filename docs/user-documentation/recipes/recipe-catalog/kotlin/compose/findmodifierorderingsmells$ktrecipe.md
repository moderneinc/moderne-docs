...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindModifierOrderingSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindModifierOrderingSmells$KtRecipe","displayName":"Find Compose `Modifier` ordering smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
