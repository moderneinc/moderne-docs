...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindComposeStateReadIssues$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindComposeStateReadIssues$KtRecipe","displayName":"Find Compose state read/write issues","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
