...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.UseSpecializedComposeStateContainers$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.UseSpecializedComposeStateContainers$KtRecipe","displayName":"Find `remember { mutableStateOf(emptyList/Map()) }` candidates for snapshot-aware containers","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
