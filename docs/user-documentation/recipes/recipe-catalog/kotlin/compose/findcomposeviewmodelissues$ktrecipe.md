...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindComposeViewModelIssues$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindComposeViewModelIssues$KtRecipe","displayName":"Find Compose ViewModel wiring issues","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
