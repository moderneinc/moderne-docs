...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.compose.FindComposeNavigationIssues$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.compose.FindComposeNavigationIssues$KtRecipe","displayName":"Find Compose navigation / coroutine misuse","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
