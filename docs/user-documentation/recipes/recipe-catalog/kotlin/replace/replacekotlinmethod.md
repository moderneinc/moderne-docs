...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.replace.ReplaceKotlinMethod"}
  languages={["Kotlin"]}
...
<ExampleList examples={[{"parameters":[{"parameter":"methodPattern","value":"kotlin.Char toInt()"},{"parameter":"replacement","value":"code"},{"parameter":"imports","value":"null"},{"parameter":"classpathFromResources","value":"null"}],"variants":[{"language":"kotlin","before":"fun test(c: Char): Int {\n    return c.toInt()\n}\n","after":"fun test(c: Char): Int {\n    return c.code\n}\n","diff":"@@ -2,1 +2,1 @@\nfun test(c: Char): Int {\n-   return c.toInt()\n+   return c.code\n}\n","newFile":false}]}]}>
