...
* [Replace deprecated `kotlinx-collections-immutable` methods](https://docs.moderne.io/user-documentation/recipes/recipe-catalog/jetbrains/kotlinx/replacedeprecatedkotlinxcollectionsimmutable0methods)
* [Replace deprecated `kotlinx-coroutines-core` methods](https://docs.moderne.io/user-documentation/recipes/recipe-catalog/jetbrains/kotlinx/replacedeprecatedkotlinxcoroutinescore1methods)
* [Replace deprecated `kotlinx-datetime` methods](https://docs.moderne.io/user-documentation/recipes/recipe-catalog/jetbrains/kotlinx/replacedeprecatedkotlinxdatetime0methods)
* [Replace deprecated `kotlinx-io-core` methods](https://docs.moderne.io/user-documentation/recipes/recipe-catalog/jetbrains/kotlinx/replacedeprecatedkotlinxiocore0methods)
* [Replace deprecated `kotlinx-serialization-core` methods](https://docs.moderne.io/user-documentation/recipes/recipe-catalog/jetbrains/kotlinx/replacedeprecatedkotlinxserializationcore1methods)
