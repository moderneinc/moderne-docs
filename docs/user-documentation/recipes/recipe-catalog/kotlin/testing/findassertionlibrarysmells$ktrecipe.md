...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.testing.FindAssertionLibrarySmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.testing.FindAssertionLibrarySmells$KtRecipe","displayName":"Find assertion-library smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
