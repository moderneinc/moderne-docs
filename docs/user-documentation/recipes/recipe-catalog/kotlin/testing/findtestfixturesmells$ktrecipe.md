...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.testing.FindTestFixtureSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.testing.FindTestFixtureSmells$KtRecipe","displayName":"Find test fixture / setup smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
