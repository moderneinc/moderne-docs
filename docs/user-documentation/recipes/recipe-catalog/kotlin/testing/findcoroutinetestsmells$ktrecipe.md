...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.testing.FindCoroutineTestSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.testing.FindCoroutineTestSmells$KtRecipe","displayName":"Find coroutine-test patterns","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
