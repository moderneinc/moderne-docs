...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.testing.FindMockitoSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.testing.FindMockitoSmells$KtRecipe","displayName":"Find mockito-kotlin / Mockito patterns","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
