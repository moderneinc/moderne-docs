...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.testing.Testing$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.testing.Testing$KtRecipe","displayName":"Modernize Kotlin test code","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
