...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.testing.FindKotestCandidates$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.testing.FindKotestCandidates$KtRecipe","displayName":"Find Kotest migration candidates","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
