...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.spring.FindSpringBootstrappingSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.spring.FindSpringBootstrappingSmells$KtRecipe","displayName":"Find Spring Boot bootstrapping smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
