...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.spring.FindDataAccessSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.spring.FindDataAccessSmells$KtRecipe","displayName":"Find Spring Data / repository access smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
