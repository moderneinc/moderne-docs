...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.spring.FindSpringProxiedAnnotationSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.spring.FindSpringProxiedAnnotationSmells$KtRecipe","displayName":"Find Spring proxied-annotation smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
