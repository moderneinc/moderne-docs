...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.spring.FindSpringDataSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.spring.FindSpringDataSmells$KtRecipe","displayName":"Find Spring Data smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
