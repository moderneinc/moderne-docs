...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.spring.FindSpringDependencyInjectionSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.spring.FindSpringDependencyInjectionSmells$KtRecipe","displayName":"Find Spring dependency-injection smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
