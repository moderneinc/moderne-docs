...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.spring.FindMonoFluxSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.spring.FindMonoFluxSmells$KtRecipe","displayName":"Find Mono/Flux ergonomic smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
