...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.spring.FindSpringTestingSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.spring.FindSpringTestingSmells$KtRecipe","displayName":"Find Spring testing smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
