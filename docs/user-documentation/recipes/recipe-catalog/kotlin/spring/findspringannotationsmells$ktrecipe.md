...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.spring.FindSpringAnnotationSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.spring.FindSpringAnnotationSmells$KtRecipe","displayName":"Find Spring annotation-shape smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
