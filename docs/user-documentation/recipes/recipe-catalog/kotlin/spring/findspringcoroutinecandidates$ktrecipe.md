...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.spring.FindSpringCoroutineCandidates$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.spring.FindSpringCoroutineCandidates$KtRecipe","displayName":"Find Spring coroutine-migration candidates","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
