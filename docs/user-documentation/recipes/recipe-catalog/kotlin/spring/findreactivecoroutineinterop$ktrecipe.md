...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.spring.FindReactiveCoroutineInterop$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.spring.FindReactiveCoroutineInterop$KtRecipe","displayName":"Find reactive / coroutine interop hazards","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
