...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.spring.FindSpringLegacyApiSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.spring.FindSpringLegacyApiSmells$KtRecipe","displayName":"Find Spring legacy / deprecated API smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
