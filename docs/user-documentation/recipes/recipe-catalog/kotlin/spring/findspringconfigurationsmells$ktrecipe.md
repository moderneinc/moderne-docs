...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.spring.FindSpringConfigurationSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.spring.FindSpringConfigurationSmells$KtRecipe","displayName":"Find Spring configuration smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
