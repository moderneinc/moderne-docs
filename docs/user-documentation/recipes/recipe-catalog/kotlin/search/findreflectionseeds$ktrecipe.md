...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.FindReflectionSeeds$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.FindReflectionSeeds$KtRecipe","displayName":"Find reflection seeds","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
