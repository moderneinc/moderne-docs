...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.FindDatabaseSeeds$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.FindDatabaseSeeds$KtRecipe","displayName":"Find database-query seeds","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
