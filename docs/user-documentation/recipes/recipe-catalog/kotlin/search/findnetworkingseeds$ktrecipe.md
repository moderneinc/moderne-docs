...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.FindNetworkingSeeds$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.FindNetworkingSeeds$KtRecipe","displayName":"Find outbound-networking seeds","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
