...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.FindDataFlowSinks$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.FindDataFlowSinks$KtRecipe","displayName":"Find data-flow sink positions","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
