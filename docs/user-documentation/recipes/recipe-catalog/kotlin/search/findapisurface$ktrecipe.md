...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.FindApiSurface$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.FindApiSurface$KtRecipe","displayName":"Find public-API and binary-stability surface","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
