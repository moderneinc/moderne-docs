...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.FindConcurrencySurface$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.FindConcurrencySurface$KtRecipe","displayName":"Find concurrency primitives","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
