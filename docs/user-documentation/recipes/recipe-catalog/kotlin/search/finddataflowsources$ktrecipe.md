...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.FindDataFlowSources$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.FindDataFlowSources$KtRecipe","displayName":"Find data-flow source positions","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
