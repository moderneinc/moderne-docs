...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.FindBuildHygiene$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.FindBuildHygiene$KtRecipe","displayName":"Find build- and source-hygiene smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
