...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.Search$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.Search$KtRecipe","displayName":"Surface impact-analysis findings","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
