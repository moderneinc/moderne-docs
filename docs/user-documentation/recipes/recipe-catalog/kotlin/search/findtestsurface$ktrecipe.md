...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.FindTestSurface$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.FindTestSurface$KtRecipe","displayName":"Find test-surface positions","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
