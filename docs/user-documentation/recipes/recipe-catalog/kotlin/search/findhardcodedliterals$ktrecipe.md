...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.FindHardcodedLiterals$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.FindHardcodedLiterals$KtRecipe","displayName":"Find hardcoded literals and error-handling smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
