...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.FindReflectionSurface$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.FindReflectionSurface$KtRecipe","displayName":"Find reflection and runtime introspection","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
