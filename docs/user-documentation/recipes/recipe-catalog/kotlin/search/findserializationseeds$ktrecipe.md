...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.FindSerializationSeeds$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.FindSerializationSeeds$KtRecipe","displayName":"Find serialization seeds","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
