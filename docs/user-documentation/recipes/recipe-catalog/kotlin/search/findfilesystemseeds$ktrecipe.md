...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.search.FindFileSystemSeeds$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.search.FindFileSystemSeeds$KtRecipe","displayName":"Find filesystem-operation seeds","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
