...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.security.FindSensitiveDataInLogs$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.security.FindSensitiveDataInLogs$KtRecipe","displayName":"Find sensitive data in log calls","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
