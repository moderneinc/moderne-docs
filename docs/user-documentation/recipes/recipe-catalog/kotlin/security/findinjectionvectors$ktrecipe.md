...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.security.FindInjectionVectors$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.security.FindInjectionVectors$KtRecipe","displayName":"Find injection vectors","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
