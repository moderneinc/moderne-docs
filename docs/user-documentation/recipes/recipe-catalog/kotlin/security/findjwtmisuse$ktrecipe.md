...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.security.FindJwtMisuse$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.security.FindJwtMisuse$KtRecipe","displayName":"Find JWT misuse","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
