...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.security.FindAndroidSecuritySmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.security.FindAndroidSecuritySmells$KtRecipe","displayName":"Find Android-specific security smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
