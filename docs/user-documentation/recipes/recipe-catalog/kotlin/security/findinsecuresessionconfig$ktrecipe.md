...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.security.FindInsecureSessionConfig$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.security.FindInsecureSessionConfig$KtRecipe","displayName":"Find insecure cookie / session configuration","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
