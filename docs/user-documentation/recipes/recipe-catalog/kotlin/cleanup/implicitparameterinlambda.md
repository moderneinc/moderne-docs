...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.kotlin.cleanup.ImplicitParameterInLambda -Drewrite.exportDatatables=true
```
