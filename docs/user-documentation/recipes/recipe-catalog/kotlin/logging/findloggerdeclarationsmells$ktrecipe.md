...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.logging.FindLoggerDeclarationSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.logging.FindLoggerDeclarationSmells$KtRecipe","displayName":"Find logger declaration smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
