...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.logging.FindLoggerFactoryMigrationCandidates$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.logging.FindLoggerFactoryMigrationCandidates$KtRecipe","displayName":"Find `LoggerFactory.getLogger` migration candidates","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
