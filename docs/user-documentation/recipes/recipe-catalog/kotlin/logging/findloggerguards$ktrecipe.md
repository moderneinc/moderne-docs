...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.logging.FindLoggerGuards$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.logging.FindLoggerGuards$KtRecipe","displayName":"Find redundant logger level-check guards","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
