...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.logging.FindLegacyLoggerLibraries$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.logging.FindLegacyLoggerLibraries$KtRecipe","displayName":"Find legacy logger-library usage","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
