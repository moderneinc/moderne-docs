...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.logging.FindEagerLogMessages$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.logging.FindEagerLogMessages$KtRecipe","displayName":"Find eager log-message construction","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
