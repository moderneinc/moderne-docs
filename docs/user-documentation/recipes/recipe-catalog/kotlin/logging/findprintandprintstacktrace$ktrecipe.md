...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.logging.FindPrintAndPrintStackTrace$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.logging.FindPrintAndPrintStackTrace$KtRecipe","displayName":"Find `println` / `System.err.println` / `printStackTrace`","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
