...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.logging.Logging$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.logging.Logging$KtRecipe","displayName":"Find Kotlin logging smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
