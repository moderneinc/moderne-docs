...
[GitHub: RenameTypeAlias.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-kotlin/src/main/java/org/openrewrite/kotlin/RenameTypeAlias.java),
...
|aliasName|`OldAlias`|
|newName|`NewAlias`|
|fullyQualifiedAliasedType|`Test`|
