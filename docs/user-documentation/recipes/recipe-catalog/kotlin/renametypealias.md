...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/kotlin/renametypealias" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.RenameTypeAlias"}
  languages={["Kotlin"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-kotlin/src/main/java/org/openrewrite/kotlin/RenameTypeAlias.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"aliasName","value":"OldAlias"},{"parameter":"newName","value":"NewAlias"},{"parameter":"fullyQualifiedAliasedType","value":"Test"}],"variants":[{"language":"kotlin","before":"class Test\ntypealias OldAlias = Test\n","after":"class Test\ntypealias NewAlias = Test\n","diff":"@@ -2,1 +2,1 @@\nclass Test\n-typealias OldAlias = Test\n+typealias NewAlias = Test\n\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.kotlin.RenameTypeAlias","displayName":"Rename type alias","groupId":"org.openrewrite","artifactId":"rewrite-kotlin","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_KOTLIN","requiresConfiguration":true,"cliOptions":" --recipe-option \"aliasName=OldAlias\" --recipe-option \"newName=NewAlias\" --recipe-option \"fullyQualifiedAliasedType=org.junit.Assume\""}}>
