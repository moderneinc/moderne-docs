...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.idiom.FindNullCheckIdioms$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.idiom.FindNullCheckIdioms$KtRecipe","displayName":"Find manual null-check idioms","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
