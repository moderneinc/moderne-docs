...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.idiom.FindScopeFunctionSwaps$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.idiom.FindScopeFunctionSwaps$KtRecipe","displayName":"Find scope-function correctness swaps","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
