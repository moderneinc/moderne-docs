...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.bestpractices.FindStringConstructionSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.bestpractices.FindStringConstructionSmells$KtRecipe","displayName":"Find string-construction smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
