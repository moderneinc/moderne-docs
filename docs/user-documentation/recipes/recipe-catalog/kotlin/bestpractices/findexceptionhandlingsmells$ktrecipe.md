...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.bestpractices.FindExceptionHandlingSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.bestpractices.FindExceptionHandlingSmells$KtRecipe","displayName":"Find exception-handling smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
