...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.bestpractices.FindLambdaSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.bestpractices.FindLambdaSmells$KtRecipe","displayName":"Find lambda / functional smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
