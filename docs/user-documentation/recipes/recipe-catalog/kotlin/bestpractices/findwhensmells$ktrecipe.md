...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.bestpractices.FindWhenSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.bestpractices.FindWhenSmells$KtRecipe","displayName":"Find `when`-statement smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
