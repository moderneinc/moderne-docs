...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.bestpractices.FindFunctionDeclarationSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.bestpractices.FindFunctionDeclarationSmells$KtRecipe","displayName":"Find function-declaration smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
