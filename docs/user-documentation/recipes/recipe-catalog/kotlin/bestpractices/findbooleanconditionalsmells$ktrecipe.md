...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.bestpractices.FindBooleanConditionalSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.bestpractices.FindBooleanConditionalSmells$KtRecipe","displayName":"Find Boolean-conditional smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
