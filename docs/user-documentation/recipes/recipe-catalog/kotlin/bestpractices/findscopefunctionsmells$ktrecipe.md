...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.bestpractices.FindScopeFunctionSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.bestpractices.FindScopeFunctionSmells$KtRecipe","displayName":"Find scope-function smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
