...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.coroutines.FindBlockingOnSuspend$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.coroutines.FindBlockingOnSuspend$KtRecipe","displayName":"Find blocking calls inside coroutine contexts","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
