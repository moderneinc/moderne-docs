...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.performance.Performance$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.performance.Performance$KtRecipe","displayName":"Apply Kotlin performance idioms","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
