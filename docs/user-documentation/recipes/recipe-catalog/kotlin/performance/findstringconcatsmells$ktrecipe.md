...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.performance.FindStringConcatSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.performance.FindStringConcatSmells$KtRecipe","displayName":"Find string-allocation smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
