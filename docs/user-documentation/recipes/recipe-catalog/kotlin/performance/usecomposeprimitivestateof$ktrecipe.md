...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.performance.UseComposePrimitiveStateOf$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.performance.UseComposePrimitiveStateOf$KtRecipe","displayName":"Use primitive `mutable<Int|Long|Float|Double>StateOf` in Compose","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
