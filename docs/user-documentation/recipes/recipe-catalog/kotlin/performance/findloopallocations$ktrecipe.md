...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.performance.FindLoopAllocations$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.performance.FindLoopAllocations$KtRecipe","displayName":"Find collection construction inside loops","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
