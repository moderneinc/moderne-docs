...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.performance.FindSequencePipelineSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.performance.FindSequencePipelineSmells$KtRecipe","displayName":"Find `Sequence`/`List` pipeline shape smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
