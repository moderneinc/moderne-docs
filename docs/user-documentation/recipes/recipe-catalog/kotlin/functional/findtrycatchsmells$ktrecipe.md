...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.functional.FindTryCatchSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.functional.FindTryCatchSmells$KtRecipe","displayName":"Find raw `try`/`catch` smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
