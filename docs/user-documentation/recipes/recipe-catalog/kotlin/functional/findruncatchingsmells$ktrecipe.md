...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.functional.FindRunCatchingSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.functional.FindRunCatchingSmells$KtRecipe","displayName":"Find `runCatching { }` smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
