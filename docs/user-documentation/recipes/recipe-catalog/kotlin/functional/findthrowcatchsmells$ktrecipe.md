...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.functional.FindThrowCatchSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.functional.FindThrowCatchSmells$KtRecipe","displayName":"Find throw/catch shape smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
