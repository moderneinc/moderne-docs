...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.interop.FindMissingJvmAnnotations$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.interop.FindMissingJvmAnnotations$KtRecipe","displayName":"Find Kotlin declarations missing `@Jvm*` interop annotations","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
