...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.interop.FindReactiveInteropFriction$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.interop.FindReactiveInteropFriction$KtRecipe","displayName":"Find reactive-framework return types in Kotlin","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
