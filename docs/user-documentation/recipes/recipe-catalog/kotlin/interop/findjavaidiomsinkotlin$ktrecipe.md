...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.interop.FindJavaIdiomsInKotlin$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.interop.FindJavaIdiomsInKotlin$KtRecipe","displayName":"Find Java-style call shapes inside Kotlin source","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
