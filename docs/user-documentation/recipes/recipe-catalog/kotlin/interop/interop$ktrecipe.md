...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.interop.Interop$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.interop.Interop$KtRecipe","displayName":"Improve Java↔Kotlin interop ergonomics","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
