...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.interop.FindOptionalFriction$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.interop.FindOptionalFriction$KtRecipe","displayName":"Find `java.util.Optional` friction inside Kotlin","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
