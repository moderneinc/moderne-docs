...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.interop.FindJavaUtilCollectionsFriction$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.interop.FindJavaUtilCollectionsFriction$KtRecipe","displayName":"Find `java.util.Collections` / `Arrays` factory usage inside Kotlin","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
