...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.interop.FindClockAndTestabilityFriction$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.interop.FindClockAndTestabilityFriction$KtRecipe","displayName":"Find non-injected clock / I/O calls (testability)","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
