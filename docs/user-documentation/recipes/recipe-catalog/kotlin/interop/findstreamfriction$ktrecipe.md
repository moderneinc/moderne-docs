...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.interop.FindStreamFriction$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.interop.FindStreamFriction$KtRecipe","displayName":"Find `java.util.stream.Stream` friction inside Kotlin","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
