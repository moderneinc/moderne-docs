...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.android.FindAndroidStorageSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.android.FindAndroidStorageSmells$KtRecipe","displayName":"Find Android storage / data-layer smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
