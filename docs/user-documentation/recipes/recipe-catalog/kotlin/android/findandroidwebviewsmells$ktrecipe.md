...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.android.FindAndroidWebViewSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.android.FindAndroidWebViewSmells$KtRecipe","displayName":"Find Android WebView smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
