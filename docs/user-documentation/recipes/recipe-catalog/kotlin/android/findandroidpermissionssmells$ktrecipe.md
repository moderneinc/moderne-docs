...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.android.FindAndroidPermissionsSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.android.FindAndroidPermissionsSmells$KtRecipe","displayName":"Find Android permissions / security smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
