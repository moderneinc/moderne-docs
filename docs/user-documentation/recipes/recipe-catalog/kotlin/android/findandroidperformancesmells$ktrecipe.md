...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.android.FindAndroidPerformanceSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.android.FindAndroidPerformanceSmells$KtRecipe","displayName":"Find Android-specific performance smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
