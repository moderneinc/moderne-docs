...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.android.FindAndroidLoggingSmells$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.android.FindAndroidLoggingSmells$KtRecipe","displayName":"Find Android logging smells","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
