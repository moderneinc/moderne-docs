...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.stdlib.EmptyConstructorShorthands$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.stdlib.EmptyConstructorShorthands$KtRecipe","displayName":"Prefer `emptyList()` / `emptySet()` / `emptyMap()` over zero-arg builders","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
