...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.stdlib.StringShorthands$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.stdlib.StringShorthands$KtRecipe","displayName":"Apply Kotlin string shorthands","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
