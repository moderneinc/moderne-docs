...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.stdlib.Stdlib$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.stdlib.Stdlib$KtRecipe","displayName":"Apply Kotlin standard-library idioms","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
