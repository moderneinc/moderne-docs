...
_Migrate deprecated Kotlin 1.x APIs to their Kotlin 2.x replacements and update Gradle build files for Kotlin 2.x compatibility. Deprecated APIs were deprecated in Kotlin 1.4-1.5 and become errors in Kotlin 2.1._
...
## Examples
##### Example 1
`UpgradeToKotlin2Test#migrateMultipleDeprecations`
...
<RunRecipe
  recipeName="org.openrewrite.kotlin.migrate.UpgradeToKotlin2"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.kotlin.migrate.UpgradeToKotlin2" />
