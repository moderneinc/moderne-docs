...
_Replace `String.toLowerCase()` with `String.lowercase()` and `String.toUpperCase()` with `String.uppercase()`. These were deprecated in Kotlin 1.5 and become errors in Kotlin 2.1._
...
## Examples
##### Example 1
`ReplaceDeprecatedStringCaseConversionsTest#replaceToLowerCaseAndToUpperCase`
...
<RunRecipe
  recipeName="org.openrewrite.kotlin.migrate.ReplaceDeprecatedStringCaseConversions"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.kotlin.migrate.ReplaceDeprecatedStringCaseConversions" />
