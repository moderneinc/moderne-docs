...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.migrate.ReplaceEnumValuesWithEntries"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.migrate.ReplaceEnumValuesWithEntries","displayName":"Replace `Enum.values()` with `Enum.entries`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-kotlin","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_KOTLIN","requiresConfiguration":false}}>
