---
title: "Upgrade to `kotlinx-serialization` 1.8"
sidebar_label: "Upgrade to `kotlinx-serialization` 1.8"
hide_title: true
---
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.migrate.UpgradeKotlinxSerialization_1_8"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.migrate.UpgradeKotlinxSerialization_1_8","displayName":"Upgrade to `kotlinx-serialization` 1.8","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-kotlin","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_KOTLIN","requiresConfiguration":false}}>
