...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.migrate.UpgradeKotlinxDatetime_0_7"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.migrate.UpgradeKotlinxDatetime_0_7","displayName":"Migrate to `kotlinx-datetime` 0.7","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-kotlin","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_KOTLIN","requiresConfiguration":false}}>
