...
_Upgrade all `org.jetbrains.kotlin.*` Gradle plugins to Kotlin 2.x. This includes the core kotlin-jvm plugin as well as all official Kotlin Gradle plugins such as serialization, Spring, allopen, noarg, JPA, and parcelize._
...
## Examples
##### Example 1
`UpgradeKotlinGradlePluginsTest#upgradeKotlinJvmPlugin`
...
<RunRecipe
  recipeName="org.openrewrite.kotlin.migrate.UpgradeKotlinGradlePlugins"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.kotlin.migrate.UpgradeKotlinGradlePlugins" />
