...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.migrate.UpgradeKotlinGradlePlugins"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.migrate.UpgradeKotlinGradlePlugins","displayName":"Upgrade Kotlin Gradle plugins to 2.x","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-kotlin","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_KOTLIN","requiresConfiguration":false}}>
