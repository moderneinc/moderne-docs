...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.migrate.RenameKotlinOptionsToCompilerOptions"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.migrate.RenameKotlinOptionsToCompilerOptions","displayName":"Rename the `kotlinOptions` block to `compilerOptions`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-kotlin","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_KOTLIN","requiresConfiguration":false}}>
