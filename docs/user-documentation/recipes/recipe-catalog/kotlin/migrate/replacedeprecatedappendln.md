...
_Replace `appendln()` with `appendLine()`. This was deprecated in Kotlin 1.4 and becomes an error in Kotlin 2.1._
...
## Examples
##### Example 1
`ReplaceDeprecatedAppendlnTest#replaceAppendlnWithArgument`
...
<RunRecipe
  recipeName="org.openrewrite.kotlin.migrate.ReplaceDeprecatedAppendln"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.kotlin.migrate.ReplaceDeprecatedAppendln" />
