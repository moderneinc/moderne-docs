...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.migrate.RemoveRedundantOptIns$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.migrate.RemoveRedundantOptIns$KtRecipe","displayName":"Remove redundant `@OptIn` annotations","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
