...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.migrate.UseKotlinRegex$KtRecipe"}
  languages={["Kotlin"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.kotlin.migrate.UseKotlinRegex$KtRecipe","displayName":"Use `kotlin.text.Regex` instead of `java.util.regex.Pattern`","groupId":"io.moderne.recipe","artifactId":"recipes-kotlin","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_KOTLIN","requiresConfiguration":false}}>
