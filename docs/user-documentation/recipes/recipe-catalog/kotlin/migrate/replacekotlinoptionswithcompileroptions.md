...
<RecipeMeta
  ...
  fqName={"org.openrewrite.kotlin.migrate.ReplaceKotlinOptionsWithCompilerOptions"}
  languages={["Kotlin"]}
...
<ExampleList examples={[{"variants":[{"language":"buildGradleKts","before":"plugins {\n    kotlin(\"jvm\") version \"1.9.24\"\n}\ntasks.withType<org.jetbrains.kotlin.gradle.tasks.KotlinCompile> {\n    kotlinOptions {\n        freeCompilerArgs = listOf(\"-Xjsr305=strict\")\n        jvmTarget = \"11\"\n    }\n}\n","after":"import org.jetbrains.kotlin.gradle.dsl.JvmTarget\n\nplugins {\n    kotlin(\"jvm\") version \"1.9.24\"\n}\ntasks.withType<org.jetbrains.kotlin.gradle.tasks.KotlinCompile> {\n    compilerOptions {\n        freeCompilerArgs.addAll(\"-Xjsr305=strict\")\n        jvmTarget.set(JvmTarget.JVM_11)\n    }\n}\n","diff":"@@ -1,0 +1,2 @@\n+import org.jetbrains.kotlin.gradle.dsl.JvmTarget\n+\nplugins {\n@@ -5,3 +7,3 @@\n}\ntasks.withType<org.jetbrains.kotlin.gradle.tasks.KotlinCompile> {\n-   kotlinOptions {\n-       freeCompilerArgs = listOf(\"-Xjsr305=strict\")\n-       jvmTarget = \"11\"\n+   compilerOptions {\n+       freeCompilerArgs.addAll(\"-Xjsr305=strict\")\n+       jvmTarget.set(JvmTarget.JVM_11)\n    }\n","newFile":false}]},{"variants":[{"language":"buildGradleKts","before":"plugins {\n    kotlin(\"jvm\") version \"1.9.24\"\n}\ntasks.withType<org.jetbrains.kotlin.gradle.tasks.KotlinCompile> {\n    kotlinOptions {\n        freeCompilerArgs = listOf(\"-Xjsr305=strict\")\n        jvmTarget = \"11\"\n    }\n}\n","after":"import org.jetbrains.kotlin.gradle.dsl.JvmTarget\n\nplugins {\n    kotlin(\"jvm\") version \"1.9.24\"\n}\ntasks.withType<org.jetbrains.kotlin.gradle.tasks.KotlinCompile> {\n    compilerOptions {\n        freeCompilerArgs.addAll(\"-Xjsr305=strict\")\n        jvmTarget.set(JvmTarget.JVM_11)\n    }\n}\n","diff":"@@ -1,0 +1,2 @@\n+import org.jetbrains.kotlin.gradle.dsl.JvmTarget\n+\nplugins {\n@@ -5,3 +7,3 @@\n}\ntasks.withType<org.jetbrains.kotlin.gradle.tasks.KotlinCompile> {\n-   kotlinOptions {\n-       freeCompilerArgs = listOf(\"-Xjsr305=strict\")\n-       jvmTarget = \"11\"\n+   compilerOptions {\n+       freeCompilerArgs.addAll(\"-Xjsr305=strict\")\n+       jvmTarget.set(JvmTarget.JVM_11)\n    }\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.kotlin.migrate.ReplaceKotlinOptionsWithCompilerOptions","displayName":"Replace `kotlinOptions` with `compilerOptions` in Gradle build files","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-kotlin","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_KOTLIN","requiresConfiguration":false}}>
