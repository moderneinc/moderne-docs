...
* [plain text](/user-documentation/recipes/lists/recipes-by-tag#plain-text)

## Recipe source

[GitHub: ChangeText.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-core/src/main/java/org/openrewrite/text/ChangeText.java),
...
```shell title="shell"
mod run . --recipe ChangeText --recipe-option "toText=Some text."
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.text.ChangeText" />
