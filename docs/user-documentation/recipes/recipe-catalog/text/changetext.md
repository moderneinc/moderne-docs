...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/text/changetext" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.text.ChangeText"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-core/src/main/java/org/openrewrite/text/ChangeText.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.text.ChangeText","displayName":"Change text","groupId":"org.openrewrite","artifactId":"rewrite-core","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_CORE","requiresConfiguration":true,"cliOptions":" --recipe-option \"toText=Some text.\""}}>
