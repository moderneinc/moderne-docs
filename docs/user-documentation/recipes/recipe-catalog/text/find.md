...
[GitHub: Find.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-core/src/main/java/org/openrewrite/text/Find.java),
...
| `Boolean` | description | *Optional*. Add the matched value(s) as description on the search result marker.  Default `false`. |  |
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.text.Find" />
