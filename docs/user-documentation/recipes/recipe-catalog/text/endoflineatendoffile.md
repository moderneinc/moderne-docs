...
<RecipeMeta
  ...
  fqName={"org.openrewrite.text.EndOfLineAtEndOfFile"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-core/src/main/java/org/openrewrite/text/EndOfLineAtEndOfFile.java"}
/>
