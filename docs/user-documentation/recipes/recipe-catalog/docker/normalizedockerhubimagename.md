...
_Normalizes Docker Hub image names to their canonical short form by removing redundant registry prefixes like `docker.io/library/` or `index.docker.io/`._
...
```shell title="shell"
mod run . --recipe NormalizeDockerHubImageName
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.docker.NormalizeDockerHubImageName" />
