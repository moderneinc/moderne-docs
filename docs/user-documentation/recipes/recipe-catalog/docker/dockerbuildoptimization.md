...
<RecipeMeta
  ...
  fqName={"org.openrewrite.docker.DockerBuildOptimization"}
...
<UsageList usage={{"recipeName":"org.openrewrite.docker.DockerBuildOptimization","displayName":"Optimize Docker builds","groupId":"org.openrewrite","artifactId":"rewrite-docker","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_DOCKER","requiresConfiguration":false}}>
