...
<RecipeMeta
  ...
  fqName={"org.openrewrite.docker.AddAptGetCleanup"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-docker/src/main/java/org/openrewrite/docker/AddAptGetCleanup.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"cleanupCommand","value":"null"}],"variants":[{"language":"docker","before":"FROM ubuntu:22.04\nRUN apt-get update && apt-get install -y curl\n","after":"FROM ubuntu:22.04\nRUN apt-get update && apt-get install -y curl && rm -rf /var/lib/apt/lists/*\n","diff":"@@ -2,1 +2,1 @@\nFROM ubuntu:22.04\n-RUN apt-get update && apt-get install -y curl\n+RUN apt-get update && apt-get install -y curl && rm -rf /var/lib/apt/lists/*\n\n","newFile":false}]}]}>
