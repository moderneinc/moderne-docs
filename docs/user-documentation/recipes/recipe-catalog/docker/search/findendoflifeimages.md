...
_Identifies Docker base images that have reached end-of-life. Using EOL images poses security risks as they no longer receive security updates. Detected images include EOL versions of Debian, Ubuntu, Alpine, Python, and Node.js._
...
| --- | --- | --- | --- |
| `Boolean` | includeApproaching | *Optional*. If true, also flag images that will reach EOL within the next 6 months. | `true` |
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.docker.search.FindEndOfLifeImages" />
