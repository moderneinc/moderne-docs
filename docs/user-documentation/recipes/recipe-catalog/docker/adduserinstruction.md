...
<RecipeMeta
  ...
  fqName={"org.openrewrite.docker.AddUserInstruction"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-docker/src/main/java/org/openrewrite/docker/AddUserInstruction.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"userName","value":"appuser"},{"parameter":"groupName","value":"null"},{"parameter":"stageName","value":"null"},{"parameter":"skipIfUserExists","value":"null"}],"variants":[{"language":"docker","before":"FROM ubuntu:22.04\nRUN apt-get update\n","after":"FROM ubuntu:22.04\nRUN apt-get update\nUSER appuser\n","diff":"@@ -3,0 +3,1 @@\nFROM ubuntu:22.04\nRUN apt-get update\n+USER appuser\n\n","newFile":false}]}]}>
