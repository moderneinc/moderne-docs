...
_Add the JUnit Platform Launcher to the buildscript dependencies._
...
```shell title="shell"
mod run . --recipe AddJUnitPlatformLauncher
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.gradle.AddJUnitPlatformLauncher" />
