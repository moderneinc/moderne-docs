---
title: "Remove redundant explicit dependencies and versions"
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gradle.RemoveRedundantDependencyVersions"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/RemoveRedundantDependencyVersions.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"groupPattern","value":"null"},{"parameter":"artifactPattern","value":"null"},{"parameter":"onlyIfManagedVersionIs","value":"null"}],"variants":[{"language":"groovy","before":"plugins {\n    id \"java\"\n}\n\nrepositories {\n    mavenCentral()\n}\n\ndependencies {\n    implementation(platform(\"org.springframework.boot:spring-boot-dependencies:3.3.3\"))\n    implementation(\"org.apache.commons:commons-lang3:3.14.0\")\n}\n","after":"plugins {\n    id \"java\"\n}\n\nrepositories {\n    mavenCentral()\n}\n\ndependencies {\n    implementation(platform(\"org.springframework.boot:spring-boot-dependencies:3.3.3\"))\n    implementation(\"org.apache.commons:commons-lang3\")\n}\n","diff":"--- build.gradle\n+++ build.gradle\n@@ -11,1 +11,1 @@\ndependencies {\n    implementation(platform(\"org.springframework.boot:spring-boot-dependencies:3.3.3\"))\n-   implementation(\"org.apache.commons:commons-lang3:3.14.0\")\n+   implementation(\"org.apache.commons:commons-lang3\")\n}\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.gradle.RemoveRedundantDependencyVersions","displayName":"Remove redundant explicit dependencies and versions","groupId":"org.openrewrite","artifactId":"rewrite-gradle","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_GRADLE","requiresConfiguration":false}}>
