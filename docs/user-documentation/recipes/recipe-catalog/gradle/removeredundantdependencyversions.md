...
canonical_url: "https://docs.openrewrite.org/recipes/gradle/removeredundantdependencyversions"
---
...
_Remove explicitly-specified dependency versions that are managed by a Gradle `platform`, `enforcedPlatform` or the `io.spring.dependency-management` plugin. Also removes redundant direct dependencies and dependency constraints that are already satisfied by transitive dependencies._

## Recipe source

[GitHub: RemoveRedundantDependencyVersions.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/RemoveRedundantDependencyVersions.java),
