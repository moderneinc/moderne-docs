...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/gradle/syncgradleextpropertieswithbom" />
</head>
...
<RecipeMeta
  ...
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/SyncGradleExtPropertiesWithBom.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"groupId","value":"org.springframework.boot"},{"parameter":"artifactId","value":"spring-boot-dependencies"},{"parameter":"version","value":"3.4.0"},{"parameter":"removeRedundantOverrides","value":"false"}],"variants":[{"language":"groovy","before":"ext['jackson-bom.version'] = '2.14.0'\n","after":"ext['jackson-bom.version'] = '2.18.1'\n","diff":"--- build.gradle\n+++ build.gradle\n@@ -1,1 +1,1 @@\n-ext['jackson-bom.version'] = '2.14.0'\n+ext['jackson-bom.version'] = '2.18.1'\n\n","newFile":false}]}]}>
