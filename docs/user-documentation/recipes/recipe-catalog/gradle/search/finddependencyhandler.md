...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/gradle/search/finddependencyhandler" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gradle.search.FindDependencyHandler"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/search/FindDependencyHandler.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.gradle.search.FindDependencyHandler","displayName":"Find Gradle `dependencies` blocks","groupId":"org.openrewrite","artifactId":"rewrite-gradle","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_GRADLE","requiresConfiguration":false}}>
