...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/gradle/search/effectivegradlepluginrepositories" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gradle.search.EffectiveGradlePluginRepositories"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/search/EffectiveGradlePluginRepositories.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"useMarkers","value":"true"}],"unchanged":{"language":"groovy","code":"plugins {\n    id 'java'\n}\n"},"variants":[]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.gradle.search.EffectiveGradlePluginRepositories","displayName":"List effective Gradle plugin repositories","groupId":"org.openrewrite","artifactId":"rewrite-gradle","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_GRADLE","requiresConfiguration":false}}>
