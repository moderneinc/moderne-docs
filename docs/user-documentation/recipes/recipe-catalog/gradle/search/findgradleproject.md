...
[GitHub: FindGradleProject.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/search/FindGradleProject.java),
...
```shell title="shell"
mod run . --recipe FindGradleProject --recipe-option "searchCriteria=Marker"
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.gradle.search.FindGradleProject" />
