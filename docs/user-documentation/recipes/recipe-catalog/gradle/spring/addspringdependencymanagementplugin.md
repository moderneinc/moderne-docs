...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/gradle/spring/addspringdependencymanagementplugin" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gradle.spring.AddSpringDependencyManagementPlugin"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/gradle/spring/AddSpringDependencyManagementPlugin.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.gradle.spring.AddSpringDependencyManagementPlugin","displayName":"Add `io.spring.dependency-management` plugin, if in use","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
