...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/gradle/migratetogradle8" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gradle.MigrateToGradle8"}
...
<UsageList usage={{"recipeName":"org.openrewrite.gradle.MigrateToGradle8","displayName":"Migrate to Gradle 8 from Gradle 7","groupId":"org.openrewrite","artifactId":"rewrite-gradle","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_GRADLE","requiresConfiguration":false}}>
