...
_Migrate to version 5.x. See the Gradle upgrade guide from [version 4.x to 5.0](https://docs.gradle.org/current/userguide/upgrading_version_4.html) for more information._

## Recipe source

[GitHub: gradle-5.yml](https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/resources/META-INF/rewrite/gradle-5.yml),
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.gradle.MigrateToGradle5" />
