...
<RecipeHeader.Title>Remove a Gradle dependency</RecipeHeader.Title>

<RecipeHeader.Description>Removes a single dependency from the dependencies section of the `build.gradle`.</RecipeHeader.Description>
