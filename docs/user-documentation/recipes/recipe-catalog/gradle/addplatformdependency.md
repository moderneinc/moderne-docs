...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gradle.AddPlatformDependency"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/AddPlatformDependency.java"}
/>
