...
<RunRecipe
  ...
  cliOptions={' --recipe-option "groupId=com.fasterxml.jackson*" --recipe-option "artifactId=jackson-module*" --recipe-option "newArtifactId=jackson-custom" --recipe-option "configuration=api"'}
  showGradle={false}
  showMaven={false}
  hasDataTables
/>
