...
canonical_url: "https://docs.openrewrite.org/recipes/gradle/changedependencyartifactid"
---
...
[GitHub: ChangeDependencyArtifactId.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/ChangeDependencyArtifactId.java),
...
This recipe has required configuration parameters. Recipes with required configuration parameters cannot be activated directly (unless you are running them via the Moderne CLI). To activate this recipe you must create a new recipe which fills in the required parameters. In your `rewrite.yml` create a new recipe with a unique name. For example: `com.yourorg.ChangeDependencyArtifactIdExample`.
...
```shell title="shell"
mod run . --recipe ChangeDependencyArtifactId --recipe-option "groupId=com.fasterxml.jackson*" --recipe-option "artifactId=jackson-module*" --recipe-option "newArtifactId=jackson-custom" --recipe-option "configuration=api"
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.gradle.ChangeDependencyArtifactId" />
