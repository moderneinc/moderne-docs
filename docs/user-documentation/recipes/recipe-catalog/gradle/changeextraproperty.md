...
[GitHub: ChangeExtraProperty.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/ChangeExtraProperty.java),
