...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/gradle/updatejavacompatibility" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gradle.UpdateJavaCompatibility"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/UpdateJavaCompatibility.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"version","value":"11"},{"parameter":"compatibilityType","value":"UpdateJavaCompatibility.CompatibilityType.source"},{"parameter":"declarationStyle","value":"null"},{"parameter":"allowDowngrade","value":"null"},{"parameter":"addIfMissing","value":"null"}],"variants":[{"language":"groovy","before":"plugins {\n    id \"java\"\n}\n\nsourceCompatibility = 1.8\ntargetCompatibility = 1.8\n","after":"plugins {\n    id \"java\"\n}\n\nsourceCompatibility = 11\ntargetCompatibility = 1.8\n","diff":"--- build.gradle\n+++ build.gradle\n@@ -5,1 +5,1 @@\n}\n\n-sourceCompatibility = 1.8\n+sourceCompatibility = 11\ntargetCompatibility = 1.8\n","newFile":false}]}]}>
