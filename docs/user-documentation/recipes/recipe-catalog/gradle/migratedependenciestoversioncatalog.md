...
[GitHub: MigrateDependenciesToVersionCatalog.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/MigrateDependenciesToVersionCatalog.java),
...
rewrite {
    activeRecipe("org.openrewrite.gradle.MigrateDependenciesToVersionCatalog")
...
```shell title="shell"
mod run . --recipe MigrateDependenciesToVersionCatalog
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.gradle.MigrateDependenciesToVersionCatalog" />
