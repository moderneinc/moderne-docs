...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gradle.gradle9.UseMainClassPropertyForApplication"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/gradle9/UseMainClassPropertyForApplication.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.gradle.gradle9.UseMainClassPropertyForApplication","displayName":"Use `application { mainClass }` instead of `mainClassName`","groupId":"org.openrewrite","artifactId":"rewrite-gradle","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_GRADLE","requiresConfiguration":false}}>
