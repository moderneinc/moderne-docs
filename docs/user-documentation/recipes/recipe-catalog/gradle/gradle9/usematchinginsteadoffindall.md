...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gradle.gradle9.UseMatchingInsteadOfFindAll"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/gradle9/UseMatchingInsteadOfFindAll.java"}
/>
