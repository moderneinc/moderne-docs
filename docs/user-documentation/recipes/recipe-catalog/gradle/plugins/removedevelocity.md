...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/gradle/plugins/removedevelocity" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gradle.plugins.RemoveDevelocity"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/resources/META-INF/rewrite/develocity.yml"}
/>
...
<ExampleList examples={[{"unchanged":{"language":"settingsGradle","code":"plugins {\n    id 'com.gradle.enterprise' version '3.16'\n}\ngradleEnterprise {\n    server = 'https://ge.sam.com/'\n    allowUntrustedServer = true\n    buildScan {\n        publishAlways()\n        uploadInBackground = true\n        capture {\n            taskInputFiles = true\n        }\n    }\n    buildCache {\n        remote(gradleEnterprise.buildCache) {\n            enabled = true\n            push = System.getenv(\"CI\") != null\n        }\n    }\n}\n"},"variants":[]},{"unchanged":{"language":"settingsGradle","code":"plugins {\n    id 'com.gradle.enterprise' version '3.16'\n}\ngradleEnterprise {\n    server = 'https://ge.sam.com/'\n    allowUntrustedServer = true\n    buildScan {\n        publishAlways()\n        uploadInBackground = true\n        capture {\n            taskInputFiles = true\n        }\n    }\n    buildCache {\n        remote(gradleEnterprise.buildCache) {\n            enabled = true\n            push = System.getenv(\"CI\") != null\n        }\n    }\n}\n"},"variants":[]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.gradle.plugins.RemoveDevelocity","displayName":"Remove Develocity","groupId":"org.openrewrite","artifactId":"rewrite-gradle","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_GRADLE","requiresConfiguration":false}}>
