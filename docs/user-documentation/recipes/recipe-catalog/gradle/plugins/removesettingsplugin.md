...
[GitHub: RemoveSettingsPlugin.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/plugins/RemoveSettingsPlugin.java),
...
```shell title="shell"
mod run . --recipe RemoveSettingsPlugin --recipe-option "pluginId=com.jfrog.bintray"
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.gradle.plugins.RemoveSettingsPlugin" />
