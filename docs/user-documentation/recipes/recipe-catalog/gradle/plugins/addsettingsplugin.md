...
<RecipeHeader.Title>Add Gradle settings plugin</RecipeHeader.Title>

<RecipeHeader.Description>Add plugin to Gradle settings file `plugins` block by id.</RecipeHeader.Description>
