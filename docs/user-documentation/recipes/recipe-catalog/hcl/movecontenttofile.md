...
[GitHub: MoveContentToFile.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-hcl/src/main/java/org/openrewrite/hcl/MoveContentToFile.java),
...
```shell title="shell"
mod run . --recipe MoveContentToFile --recipe-option "contentPath=$.provider" --recipe-option "fromPath=from.tf" --recipe-option "destinationPath=to.tf"
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.hcl.MoveContentToFile" />
