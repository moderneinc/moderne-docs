...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/hcl/movecontenttofile" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.hcl.MoveContentToFile"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-hcl/src/main/java/org/openrewrite/hcl/MoveContentToFile.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"contentPath","value":"$.before"},{"parameter":"fromPath","value":"from.tf"},{"parameter":"destinationPath","value":"to.tf"}],"variants":[{"language":"hcl","before":"","after":"before {\n}\n","newFile":true},{"language":"hcl","before":"after {\n}\nbefore {\n}\n","after":"after {\n}\n","diff":"--- from.tf\n+++ from.tf\n@@ -3,2 +3,0 @@\nafter {\n}\n-before {\n-}\n\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.hcl.MoveContentToFile","displayName":"Move content to another file","groupId":"org.openrewrite","artifactId":"rewrite-hcl","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_HCL","requiresConfiguration":true,"cliOptions":" --recipe-option \"contentPath=$.provider\" --recipe-option \"fromPath=from.tf\" --recipe-option \"destinationPath=to.tf\""}}>
