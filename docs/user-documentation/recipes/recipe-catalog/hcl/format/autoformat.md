...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/hcl/format/autoformat" />
</head>
...
[GitHub: AutoFormat.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-hcl/src/main/java/org/openrewrite/hcl/format/AutoFormat.java),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.hcl.format.AutoFormat -Drewrite.exportDatatables=true
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.hcl.format.AutoFormat" />
