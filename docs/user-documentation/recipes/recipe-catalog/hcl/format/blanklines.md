...
<RecipeMeta
  ...
  fqName={"org.openrewrite.hcl.format.BlankLines"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-hcl/src/main/java/org/openrewrite/hcl/format/BlankLines.java"}
/>
