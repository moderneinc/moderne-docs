...
[GitHub: MergeYaml.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-yaml/src/main/java/org/openrewrite/yaml/MergeYaml.java),
...
* [Add GitLab component](/user-documentation/recipes/recipe-catalog/gitlab/addcomponent.md)
* [Add GitLab stages](/user-documentation/recipes/recipe-catalog/gitlab/addstages.md)
* [Add GitLab template](/user-documentation/recipes/recipe-catalog/gitlab/addtemplate.md)
* [Add artifacts expire_in](/user-documentation/recipes/recipe-catalog/gitlab/addartifactsexpirein.md)
* [Add cache configuration](/user-documentation/recipes/recipe-catalog/gitlab/addcache.md)
* [Add default keyword](/user-documentation/recipes/recipe-catalog/gitlab/adddefaultkeyword.md)
* [Add interruptible](/user-documentation/recipes/recipe-catalog/gitlab/addinterruptible.md)
* [Add job timeout](/user-documentation/recipes/recipe-catalog/gitlab/addtimeout.md)
