...
[GitHub: DeleteKey.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-yaml/src/main/java/org/openrewrite/yaml/DeleteKey.java),
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.yaml.DeleteKey" />
