...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/yaml/changekey" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.yaml.ChangeKey"}
  languages={["YAML"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-yaml/src/main/java/org/openrewrite/yaml/ChangeKey.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"oldKeyPath","value":"$.metadata.name"},{"parameter":"newKey","value":"name2"}],"variants":[{"language":"yaml","before":"    apiVersion: v1\n    metadata:\n      name: monitoring-tools\n      namespace: monitoring-tools\n","after":"    apiVersion: v1\n    metadata:\n      name2: monitoring-tools\n      namespace: monitoring-tools\n","diff":"@@ -3,1 +3,1 @@\n    apiVersion: v1\n    metadata:\n-     name: monitoring-tools\n+     name2: monitoring-tools\n      namespace: monitoring-tools\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.yaml.ChangeKey","displayName":"Change key","groupId":"org.openrewrite","artifactId":"rewrite-yaml","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_YAML","requiresConfiguration":true,"cliOptions":" --recipe-option \"oldKeyPath=$.subjects.kind\" --recipe-option \"newKey=kind\""}}>
