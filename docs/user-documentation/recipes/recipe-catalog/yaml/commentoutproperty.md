...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/yaml/commentoutproperty" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.yaml.CommentOutProperty"}
  languages={["YAML"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-yaml/src/main/java/org/openrewrite/yaml/CommentOutProperty.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"propertyKey","value":"foo.bar.sequence.propertyA"},{"parameter":"commentText","value":"Some comments"},{"parameter":"commentOutProperty","value":"null"}],"variants":[{"language":"yaml","before":"  foo:\n    bar:\n      sequence:\n        - name: name\n        - propertyA: fieldA\n        - propertyB: fieldB\n      scalar: value\n","after":"  foo:\n    bar:\n      sequence:\n        - name: name\n        # Some comments\n        # propertyA: fieldA\n        - propertyB: fieldB\n      scalar: value\n","diff":"@@ -5,1 +5,2 @@\n      sequence:\n        - name: name\n-       - propertyA: fieldA\n+       # Some comments\n+       # propertyA: fieldA\n        - propertyB: fieldB\n","newFile":false}]}]}>
