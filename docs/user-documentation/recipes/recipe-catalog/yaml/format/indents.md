...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/yaml/format/indents" />
</head>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.yaml.format.Indents -Drewrite.exportDatatables=true
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.yaml.format.Indents" />
