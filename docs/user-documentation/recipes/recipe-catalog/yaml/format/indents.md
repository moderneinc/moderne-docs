...
<RecipeMeta
  ...
  fqName={"org.openrewrite.yaml.format.Indents"}
  languages={["YAML"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-yaml/src/main/java/org/openrewrite/yaml/format/Indents.java"}
/>
