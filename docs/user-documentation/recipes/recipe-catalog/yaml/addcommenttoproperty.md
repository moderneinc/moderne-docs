...
<RecipeMeta
  ...
  fqName={"org.openrewrite.yaml.AddCommentToProperty"}
  languages={["YAML"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-yaml/src/main/java/org/openrewrite/yaml/AddCommentToProperty.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"propertyKey","value":"management.metrics.enabled"},{"parameter":"comment","value":"This property is deprecated"},{"parameter":"relaxedBinding","value":"null"},{"parameter":"filePattern","value":"null"}],"variants":[{"language":"yaml","before":"management:\n  metrics:\n    enabled: true\n","after":"management:\n  metrics:\n    # This property is deprecated\n    enabled: true\n","diff":"@@ -3,0 +3,1 @@\nmanagement:\n  metrics:\n+   # This property is deprecated\n    enabled: true\n","newFile":false}]}]}>
