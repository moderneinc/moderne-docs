...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/yaml/createyamlfile" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.yaml.CreateYamlFile"}
  languages={["YAML"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-yaml/src/main/java/org/openrewrite/yaml/CreateYamlFile.java"}
/>
