...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/yaml/cleanup/removeunused" />
</head>
...
[GitHub: RemoveUnused.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-yaml/src/main/java/org/openrewrite/yaml/cleanup/RemoveUnused.java),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.yaml.cleanup.RemoveUnused -Drewrite.exportDatatables=true
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.yaml.cleanup.RemoveUnused" />
