...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/yaml/changevalue" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.yaml.ChangeValue"}
  languages={["YAML"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-yaml/src/main/java/org/openrewrite/yaml/ChangeValue.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"keyPath","value":"$.metadata.name"},{"parameter":"value","value":"monitoring"},{"parameter":"filePattern","value":"null"}],"variants":[{"language":"yaml","before":"    apiVersion: v1\n    metadata:\n      name: monitoring-tools\n      namespace: monitoring-tools\n","after":"    apiVersion: v1\n    metadata:\n      name: monitoring\n      namespace: monitoring-tools\n","diff":"@@ -3,1 +3,1 @@\n    apiVersion: v1\n    metadata:\n-     name: monitoring-tools\n+     name: monitoring\n      namespace: monitoring-tools\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.yaml.ChangeValue","displayName":"Change value","groupId":"org.openrewrite","artifactId":"rewrite-yaml","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_YAML","requiresConfiguration":true,"cliOptions":" --recipe-option \"keyPath=$.subjects.kind\" --recipe-option \"value=Deployment\" --recipe-option \"filePattern=.github/workflows/*.yml\""}}>
