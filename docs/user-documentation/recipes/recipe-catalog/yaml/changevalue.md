...
[GitHub: ChangeValue.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-yaml/src/main/java/org/openrewrite/yaml/ChangeValue.java),
...
* [Change GitLab Component](/user-documentation/recipes/recipe-catalog/gitlab/changecomponent.md)
* [Change GitLab template](/user-documentation/recipes/recipe-catalog/gitlab/changetemplate.md)
