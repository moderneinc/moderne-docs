...
<RecipeMeta
  ...
  fqName={"ai.timefold.solver.migration.v8.SingleConstraintAssertionMethodsRecipe"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=ai.timefold.solver.migration.v8.SingleConstraintAssertionMethodsRecipe"}
/>
...
<UsageList usage={{"recipeName":"ai.timefold.solver.migration.v8.SingleConstraintAssertionMethodsRecipe","displayName":"Use non-deprecated SingleConstraintAssertion methods","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
