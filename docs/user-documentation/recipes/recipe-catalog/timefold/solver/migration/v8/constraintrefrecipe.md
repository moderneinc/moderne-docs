...
<RecipeMeta
  ...
  fqName={"ai.timefold.solver.migration.v8.ConstraintRefRecipe"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=ai.timefold.solver.migration.v8.ConstraintRefRecipe"}
/>
