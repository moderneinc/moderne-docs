...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/timefold/solver/migration/changeversion" />
</head>
...
<RecipeMeta
  ...
  fqName={"ai.timefold.solver.migration.ChangeVersion"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=ai.timefold.solver.migration.ChangeVersion"}
/>
...
<UsageList usage={{"recipeName":"ai.timefold.solver.migration.ChangeVersion","displayName":"Change the Timefold version","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
