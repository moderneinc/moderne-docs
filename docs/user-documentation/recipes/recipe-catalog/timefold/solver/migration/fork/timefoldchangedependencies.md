---
title: "Migrate all Maven and Gradle groupIds and artifactIds from OptaPlanner to Timefold"
sidebar_label: "Migrate all Maven and Gradle groupIds and artifactIds from OptaPlanner to Timefold"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/timefold/solver/migration/fork/timefoldchangedependencies" />
</head>
...
<RunRecipe
  recipeName="ai.timefold.solver.migration.fork.TimefoldChangeDependencies"
  displayName="Migrate all Maven and Gradle groupIds and artifactIds from OptaPlanner to Timefold"
