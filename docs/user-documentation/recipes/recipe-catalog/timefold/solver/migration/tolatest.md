...
* [Migrate from OptaPlanner to Timefold Solver](../../../timefold/solver/migration/fromoptaplannertotimefoldsolver)
...
* [ScoreManager: explain(), update()](../../../timefold/solver/migration/v8/scoremanagermethodsrecipe)
...
* [Score: use shorter getters](../../../timefold/solver/migration/v8/scoregettersrecipe)
* [Replace getConstraint*() with getConstraintRef()](../../../timefold/solver/migration/v8/constraintrefrecipe)
* [SolverManager: use builder API](../../../timefold/solver/migration/v8/solvermanagerbuilderrecipe)
* [PlanningVariable's `nullable` is newly called `unassignedValues`](../../../timefold/solver/migration/v8/nullablerecipe)
* [Use non-deprecated SingleConstraintAssertion methods](../../../timefold/solver/migration/v8/singleconstraintassertionmethodsrecipe)
* [ConstraintStreams: use asConstraint() methods to define constraints](../../../timefold/solver/migration/v8/asconstraintrecipe)
* [Constraint Streams: don't use package name in the asConstraint() method](../../../timefold/solver/migration/v8/removeconstraintpackagerecipe)
* [Recommended Fit API becomes Assignment Recommendation API](../../../timefold/solver/migration/v8/solutionmanagerrecommendassignmentrecipe)
* [Use non-deprecated related sorting fields and methods](../../../timefold/solver/migration/v8/sortingmigrationrecipe)
* [Use non-deprecated environment constants](../../../timefold/solver/migration/v8/environmentmigrationrecipe)
* [Remove unused imports](../../../java/removeunusedimports)
* [Change the Timefold version](../../../timefold/solver/migration/changeversion)
