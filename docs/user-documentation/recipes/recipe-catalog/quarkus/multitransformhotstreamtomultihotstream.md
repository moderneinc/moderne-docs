...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/multitransformhotstreamtomultihotstream" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.quarkus.MultiTransformHotStreamToMultiHotStream"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-quarkus/blob/main/src/main/java/org/openrewrite/quarkus/MultiTransformHotStreamToMultiHotStream.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.quarkus.MultiTransformHotStreamToMultiHotStream","displayName":"Use Mutiny `multi.toHotStream()`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-quarkus","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_QUARKUS","requiresConfiguration":false}}>
