---
title: "Remove `avro-maven-plugin`"
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.quarkus.quarkus2.RemoveAvroMavenPlugin"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-quarkus/blob/main/src/main/java/org/openrewrite/quarkus/quarkus2/RemoveAvroMavenPlugin.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.quarkus.quarkus2.RemoveAvroMavenPlugin","displayName":"Remove `avro-maven-plugin`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-quarkus","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_QUARKUS","requiresConfiguration":false}}>
