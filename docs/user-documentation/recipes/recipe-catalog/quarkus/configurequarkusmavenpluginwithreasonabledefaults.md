...
<RecipeMeta
  ...
  fqName={"org.openrewrite.quarkus.ConfigureQuarkusMavenPluginWithReasonableDefaults"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-quarkus/blob/main/src/main/java/org/openrewrite/quarkus/ConfigureQuarkusMavenPluginWithReasonableDefaults.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.quarkus.ConfigureQuarkusMavenPluginWithReasonableDefaults","displayName":"Configure `quarkus-maven-plugin` with reasonable defaults","groupId":"org.openrewrite.recipe","artifactId":"rewrite-quarkus","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_QUARKUS","requiresConfiguration":false}}>
