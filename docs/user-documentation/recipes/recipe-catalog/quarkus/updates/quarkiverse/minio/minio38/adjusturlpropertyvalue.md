...
<RecipeMeta
  ...
  fqName={"io.quarkus.updates.quarkiverse.minio.minio38.AdjustURLPropertyValue"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=io.quarkus.updates.quarkiverse.minio.minio38.AdjustURLPropertyValue"}
/>
