...
<RecipeMeta
  ...
  description={""}
  fqName={"io.quarkus.updates.core.quarkus312.SyncHibernateJpaModelgenVersionWithBOM"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=io.quarkus.updates.core.quarkus312.SyncHibernateJpaModelgenVersionWithBOM"}
/>
