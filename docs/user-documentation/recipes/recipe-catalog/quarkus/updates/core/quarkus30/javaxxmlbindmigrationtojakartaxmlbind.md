...
<RecipeMeta
  ...
  fqName={"io.quarkus.updates.core.quarkus30.JavaxXmlBindMigrationToJakartaXmlBind"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=io.quarkus.updates.core.quarkus30.JavaxXmlBindMigrationToJakartaXmlBind"}
/>
...
<UsageList usage={{"recipeName":"io.quarkus.updates.core.quarkus30.JavaxXmlBindMigrationToJakartaXmlBind","displayName":"Migrate deprecated `javax.xml.bind` packages to `jakarta.xml.bind`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
