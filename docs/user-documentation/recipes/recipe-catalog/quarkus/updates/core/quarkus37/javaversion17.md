...
<RecipeMeta
  ...
  fqName={"io.quarkus.updates.core.quarkus37.JavaVersion17"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=io.quarkus.updates.core.quarkus37.JavaVersion17"}
/>
...
<UsageList usage={{"recipeName":"io.quarkus.updates.core.quarkus37.JavaVersion17","displayName":"Change Maven and Gradle Java version property values to 17","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
