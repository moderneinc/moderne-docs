...
<RecipeMeta
  ...
  fqName={"io.quarkus.updates.camel.camel410.CamelQuarkusMigrationRecipe"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=io.quarkus.updates.camel.camel410.CamelQuarkusMigrationRecipe"}
/>
...
<UsageList usage={{"recipeName":"io.quarkus.updates.camel.camel410.CamelQuarkusMigrationRecipe","displayName":"Migrates `camel 4.9` application to `camel 4.10`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
