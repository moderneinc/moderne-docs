...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootactuatortoquarkus" />
</head>
...
_Migrates `spring-boot-starter-actuator` to `quarkus-smallrye-health`._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [actuator](/user-documentation/recipes/lists/recipes-by-tag#actuator)
* [quarkus](/user-documentation/recipes/lists/recipes-by-tag#quarkus)
* [health](/user-documentation/recipes/lists/recipes-by-tag#health)
...
name: org.openrewrite.quarkus.spring.SpringBootActuatorToQuarkus
displayName: Replace Spring Boot Actuator with Quarkus SmallRye Health
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootActuatorToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootActuatorToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootActuatorToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootActuatorToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootActuatorToQuarkus" />
