...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springkafkatoquarkusclassic" />
</head>
...
_Migrates `spring-kafka` to `quarkus-kafka-client` when no reactor dependencies are present._
...
name: org.openrewrite.quarkus.spring.SpringKafkaToQuarkusClassic
displayName: Replace Spring Kafka with Quarkus Kafka Client
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringKafkaToQuarkusClassic")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringKafkaToQuarkusClassic</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringKafkaToQuarkusClassic -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringKafkaToQuarkusClassic
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringKafkaToQuarkusClassic" />
