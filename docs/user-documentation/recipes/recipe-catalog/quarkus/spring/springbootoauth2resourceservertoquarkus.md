...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootoauth2resourceservertoquarkus" />
</head>
...
_Migrates `spring-boot-starter-oauth2-resource-server` to `quarkus-oidc`._
...
* [oauth2](/user-documentation/recipes/lists/recipes-by-tag#oauth2)
...
name: org.openrewrite.quarkus.spring.SpringBootOAuth2ResourceServerToQuarkus
displayName: Replace Spring Boot OAuth2 Resource Server with Quarkus OIDC
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootOAuth2ResourceServerToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootOAuth2ResourceServerToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootOAuth2ResourceServerToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootOAuth2ResourceServerToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootOAuth2ResourceServerToQuarkus" />
