...
_Migrates `spring-boot-starter-validation` to `quarkus-hibernate-validator`._
...
name: org.openrewrite.quarkus.spring.SpringBootValidationToQuarkus
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootValidationToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootValidationToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootValidationToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootValidationToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootValidationToQuarkus" />
