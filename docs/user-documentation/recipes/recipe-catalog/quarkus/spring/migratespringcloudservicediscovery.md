...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/migratespringcloudservicediscovery" />
</head>
...
_Migrates Spring Cloud Service Discovery annotations and configurations to Quarkus equivalents. Converts @EnableDiscoveryClient and related patterns to Quarkus Stork service discovery._
...
* [service-discovery](/user-documentation/recipes/lists/recipes-by-tag#service)

## Recipe source

[GitHub: spring-cloud.yml](https://github.com/openrewrite/rewrite-spring-to-quarkus/blob/main/src/main/resources/META-INF/rewrite/spring-cloud.yml),
...
## Examples
##### Example 1
`MigrateSpringCloudServiceDiscoveryTest#removeEnableDiscoveryClientAnnotation`
...
```shell title="shell"
mod run . --recipe MigrateSpringCloudServiceDiscovery
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.MigrateSpringCloudServiceDiscovery" />
