...
<RecipeMeta
  ...
  fqName={"org.openrewrite.quarkus.spring.MigrateSpringCloudServiceDiscovery"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring-to-quarkus/blob/main/src/main/resources/META-INF/rewrite/spring-cloud.yml"}
/>

<RecipeHeader
  type={"Composite recipe"}
  languages={["OpenRewrite"]}
  tags={["spring","cloud","migration","service-discovery","quarkus"]}
  license={"Moderne Source Available License"}
  fqName={"org.openrewrite.quarkus.spring.MigrateSpringCloudServiceDiscovery"}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"import org.springframework.cloud.client.discovery.EnableDiscoveryClient;\n\n@EnableDiscoveryClient\npublic class Application {\n    public static void main(String[] args) {\n        // Application startup\n    }\n}\n","after":"public class Application {\n    public static void main(String[] args) {\n        // Application startup\n    }\n}\n","diff":"@@ -1,3 +1,0 @@\n-import org.springframework.cloud.client.discovery.EnableDiscoveryClient;\n-\n-@EnableDiscoveryClient\npublic class Application {\n","newFile":false}]},{"variants":[{"language":"java","before":"import org.springframework.cloud.client.discovery.EnableDiscoveryClient;\n\n@EnableDiscoveryClient\npublic class Application {\n    public static void main(String[] args) {\n        // Application startup\n    }\n}\n","after":"public class Application {\n    public static void main(String[] args) {\n        // Application startup\n    }\n}\n","diff":"@@ -1,3 +1,0 @@\n-import org.springframework.cloud.client.discovery.EnableDiscoveryClient;\n-\n-@EnableDiscoveryClient\npublic class Application {\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.quarkus.spring.MigrateSpringCloudServiceDiscovery","displayName":"Migrate Spring Cloud Service Discovery to Quarkus","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring-to-quarkus","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING_TO_QUARKUS","requiresConfiguration":false}}>
