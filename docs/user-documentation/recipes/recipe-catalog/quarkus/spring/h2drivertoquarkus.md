...
<UsageList usage={{"recipeName":"org.openrewrite.quarkus.spring.H2DriverToQuarkus","displayName":"Replace H2 driver with Quarkus JDBC H2","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring-to-quarkus","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING_TO_QUARKUS","requiresConfiguration":false}}>
