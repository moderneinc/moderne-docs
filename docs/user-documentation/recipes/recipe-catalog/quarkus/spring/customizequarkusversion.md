...
_Allows customization of the Quarkus BOM version used in the migration. By default uses 3.x (latest 3.x version), but can be configured to use a specific version._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [bom](/user-documentation/recipes/lists/recipes-by-tag#bom)
* [quarkus](/user-documentation/recipes/lists/recipes-by-tag#quarkus)
* [migration](/user-documentation/recipes/lists/recipes-by-tag#migration)
* [version](/user-documentation/recipes/lists/recipes-by-tag#version)
...
## Examples
##### Example 1
`CustomizeQuarkusVersionTest#updateQuarkusBomVersion`
...
```shell title="shell"
mod run . --recipe CustomizeQuarkusVersion
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.CustomizeQuarkusVersion" />
