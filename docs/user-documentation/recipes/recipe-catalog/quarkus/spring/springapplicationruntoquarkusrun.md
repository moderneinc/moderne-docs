...
[GitHub: SpringApplicationRunToQuarkusRun.java](https://github.com/openrewrite/rewrite-spring-to-quarkus/blob/main/src/main/java/org/openrewrite/quarkus/spring/SpringApplicationRunToQuarkusRun.java),
