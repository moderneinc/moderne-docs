...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springapplicationruntoquarkusrun" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.quarkus.spring.SpringApplicationRunToQuarkusRun"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring-to-quarkus/blob/main/src/main/java/org/openrewrite/quarkus/spring/SpringApplicationRunToQuarkusRun.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.quarkus.spring.SpringApplicationRunToQuarkusRun","displayName":"Replace `SpringApplication.run()` with `Quarkus.run()`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring-to-quarkus","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING_TO_QUARKUS","requiresConfiguration":false}}>
