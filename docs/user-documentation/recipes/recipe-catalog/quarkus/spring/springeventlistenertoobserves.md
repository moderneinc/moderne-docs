...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springeventlistenertoobserves" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.quarkus.spring.SpringEventListenerToObserves"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring-to-quarkus/blob/main/src/main/java/org/openrewrite/quarkus/spring/SpringEventListenerToObserves.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.quarkus.spring.SpringEventListenerToObserves","displayName":"Convert Spring @EventListener to CDI @Observes","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring-to-quarkus","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING_TO_QUARKUS","requiresConfiguration":false}}>
