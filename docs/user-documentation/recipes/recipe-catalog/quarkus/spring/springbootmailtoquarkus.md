...
_Migrates `spring-boot-starter-mail` to `quarkus-mailer`._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [mail](/user-documentation/recipes/lists/recipes-by-tag#mail)
...
name: org.openrewrite.quarkus.spring.SpringBootMailToQuarkus
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootMailToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootMailToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootMailToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootMailToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootMailToQuarkus" />
