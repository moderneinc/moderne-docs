...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootoauth2clienttoquarkus" />
</head>
...
_Migrates spring-boot-starter-oauth2-client` to `quarkus-oidc-client`._
...
* [Add Gradle or Maven dependency](../../java/dependencies/adddependency)
  * groupId: `io.quarkus`
  * artifactId: `quarkus-oidc-client`
  * version: `x`
...
name: org.openrewrite.quarkus.spring.SpringBootOAuth2ClientToQuarkus
displayName: Replace Spring Boot OAuth2 Client with Quarkus OIDC Client
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootOAuth2ClientToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootOAuth2ClientToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootOAuth2ClientToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootOAuth2ClientToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootOAuth2ClientToQuarkus" />
