...
<RecipeMeta
  ...
  fqName={"org.openrewrite.quarkus.spring.DerbyDriverToQuarkus"}
...
<RecipeHeader
  ...
  languages={["OpenRewrite"]}
  tags={["spring","derby","database","quarkus"]}
  license={"Moderne Source Available License"}
  fqName={"org.openrewrite.quarkus.spring.DerbyDriverToQuarkus"}
...
<UsageList usage={{"recipeName":"org.openrewrite.quarkus.spring.DerbyDriverToQuarkus","displayName":"Replace Derby driver with Quarkus JDBC Derby","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring-to-quarkus","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING_TO_QUARKUS","requiresConfiguration":false}}>
