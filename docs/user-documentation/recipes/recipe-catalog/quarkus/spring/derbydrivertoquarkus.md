...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/derbydrivertoquarkus" />
</head>
...
_Migrates `org.apache.derby:derby` or `derbyclient` to `io.quarkus:quarkus-jdbc-derby` (excludes test scope)._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [database](/user-documentation/recipes/lists/recipes-by-tag#database)
* [quarkus](/user-documentation/recipes/lists/recipes-by-tag#quarkus)
* [derby](/user-documentation/recipes/lists/recipes-by-tag#derby)
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.DerbyDriverToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.DerbyDriverToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.DerbyDriverToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe DerbyDriverToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.DerbyDriverToQuarkus" />
