...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootquartztoquarkus" />
</head>
...
_Migrates `spring-boot-starter-quartz` to `quarkus-quartz`._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [scheduler](/user-documentation/recipes/lists/recipes-by-tag#scheduler)
* [quarkus](/user-documentation/recipes/lists/recipes-by-tag#quarkus)
* [quartz](/user-documentation/recipes/lists/recipes-by-tag#quartz)
...
name: org.openrewrite.quarkus.spring.SpringBootQuartzToQuarkus
displayName: Replace Spring Boot Quartz with Quarkus Quartz
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootQuartzToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootQuartzToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootQuartzToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootQuartzToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootQuartzToQuarkus" />
