...
_Transforms standard JPA entities to extend Quarkus PanacheEntity, enabling the Active Record pattern with built-in CRUD operations._

## Recipe source

[GitHub: JpaEntityToPanacheEntity.java](https://github.com/openrewrite/rewrite-spring-to-quarkus/blob/main/src/main/java/org/openrewrite/quarkus/spring/JpaEntityToPanacheEntity.java),
...
```shell title="shell"
mod run . --recipe JpaEntityToPanacheEntity
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.JpaEntityToPanacheEntity" />
