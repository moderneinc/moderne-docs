...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootjdbctoquarkus" />
</head>
...
_Migrates `spring-boot-starter-jdbc` to `quarkus-agroal`._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [datasource](/user-documentation/recipes/lists/recipes-by-tag#datasource)
...
name: org.openrewrite.quarkus.spring.SpringBootJdbcToQuarkus
displayName: Replace Spring Boot JDBC with Quarkus Agroal
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootJdbcToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootJdbcToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootJdbcToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootJdbcToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootJdbcToQuarkus" />
