...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootthymeleaftoquarkus" />
</head>
...
_Migrates `spring-boot-starter-thymeleaf` to `quarkus-qute`._
...
* [templating](/user-documentation/recipes/lists/recipes-by-tag#templating)
...
name: org.openrewrite.quarkus.spring.SpringBootThymeleafToQuarkus
displayName: Replace Spring Boot Thymeleaf with Quarkus Qute
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootThymeleafToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootThymeleafToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootThymeleafToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootThymeleafToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootThymeleafToQuarkus" />
