...
_Remove Spring Boot Maven plugin if present and add Quarkus Maven plugin using the same version as the quarkus-bom._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [build](/user-documentation/recipes/lists/recipes-by-tag#build)
* [maven](/user-documentation/recipes/lists/recipes-by-tag#maven)
...
name: org.openrewrite.quarkus.spring.MigrateMavenPlugin
...
## Examples
##### Example 1
`MigrateMavenPluginTest#replaceSpringBootMavenPlugin`
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.MigrateMavenPlugin")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.MigrateMavenPlugin</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.MigrateMavenPlugin -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe MigrateMavenPlugin
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.MigrateMavenPlugin" />
