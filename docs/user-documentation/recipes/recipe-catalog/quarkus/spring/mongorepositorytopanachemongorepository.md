...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/mongorepositorytopanachemongorepository" />
</head>
...
_Transforms Spring Data `MongoRepository<T, ID>` interfaces to Quarkus `PanacheMongoRepository<T>`, dropping the ID type parameter._

## Recipe source

[GitHub: MongoRepositoryToPanacheMongoRepository.java](https://github.com/openrewrite/rewrite-spring-to-quarkus/blob/main/src/main/java/org/openrewrite/quarkus/spring/MongoRepositoryToPanacheMongoRepository.java),
...
<RunRecipe
  recipeName="org.openrewrite.quarkus.spring.MongoRepositoryToPanacheMongoRepository"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.MongoRepositoryToPanacheMongoRepository" />
