...
<RecipeMeta
  ...
  fqName={"org.openrewrite.quarkus.spring.CustomizeQuarkusPluginGoals"}
...
<RecipeHeader
  ...
  languages={["OpenRewrite"]}
  tags={["spring","migration","plugin","build","maven","quarkus"]}
  license={"Moderne Source Available License"}
  fqName={"org.openrewrite.quarkus.spring.CustomizeQuarkusPluginGoals"}
...
<UsageList usage={{"recipeName":"org.openrewrite.quarkus.spring.CustomizeQuarkusPluginGoals","displayName":"Customize Quarkus Maven Plugin Goals","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring-to-quarkus","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING_TO_QUARKUS","requiresConfiguration":false}}>
