...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/customizequarkusplugingoals" />
</head>
...
_Allows customization of Quarkus Maven plugin goals. Adds or modifies the executions and goals for the quarkus-maven-plugin._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [plugin](/user-documentation/recipes/lists/recipes-by-tag#plugin)
...
[GitHub: spring-native.yml](https://github.com/openrewrite/rewrite-spring-to-quarkus/blob/main/src/main/resources/META-INF/rewrite/spring-native.yml),
...
## Examples
##### Example 1
`CustomizeQuarkusPluginGoalsTest#addNativeProfile`
...
```shell title="shell"
mod run . --recipe CustomizeQuarkusPluginGoals
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.CustomizeQuarkusPluginGoals" />
