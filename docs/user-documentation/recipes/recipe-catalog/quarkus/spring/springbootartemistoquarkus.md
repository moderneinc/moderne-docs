...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootartemistoquarkus" />
</head>
...
_Migrates `spring-boot-starter-artemis` to `quarkus-artemis-jms`._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [jms](/user-documentation/recipes/lists/recipes-by-tag#jms)
* [artemis](/user-documentation/recipes/lists/recipes-by-tag#artemis)
...
name: org.openrewrite.quarkus.spring.SpringBootArtemisToQuarkus
displayName: Replace Spring Boot Artemis with Quarkus Artemis JMS
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootArtemisToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootArtemisToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootArtemisToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootArtemisToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootArtemisToQuarkus" />
