...
_Migrates additional Spring Web parameter annotations not covered by the main WebToJaxRs recipe. Includes @MatrixVariable, @CookieValue, and other edge cases._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [jaxrs](/user-documentation/recipes/lists/recipes-by-tag#jaxrs)
...
<RunRecipe
  recipeName="org.openrewrite.quarkus.spring.MigrateRequestParameterEdgeCases"
  displayName="Migrate Additional Spring Web Parameter Annotations"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.MigrateRequestParameterEdgeCases" />
