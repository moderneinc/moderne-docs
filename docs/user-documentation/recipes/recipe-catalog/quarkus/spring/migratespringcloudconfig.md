...
<RecipeMeta
  ...
  fqName={"org.openrewrite.quarkus.spring.MigrateSpringCloudConfig"}
...
<RecipeHeader
  ...
  languages={["OpenRewrite"]}
  tags={["spring","cloud","migration","config","quarkus"]}
  license={"Moderne Source Available License"}
  fqName={"org.openrewrite.quarkus.spring.MigrateSpringCloudConfig"}
...
<UsageList usage={{"recipeName":"org.openrewrite.quarkus.spring.MigrateSpringCloudConfig","displayName":"Migrate Spring Cloud Config Client to Quarkus Config","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring-to-quarkus","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING_TO_QUARKUS","requiresConfiguration":false}}>
