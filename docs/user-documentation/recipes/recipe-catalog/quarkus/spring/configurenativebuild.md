...
<RecipeMeta
  ...
  fqName={"org.openrewrite.quarkus.spring.ConfigureNativeBuild"}
...
<RecipeHeader
  ...
  languages={["OpenRewrite"]}
  tags={["spring","migration","native","graalvm","quarkus"]}
  license={"Moderne Source Available License"}
  fqName={"org.openrewrite.quarkus.spring.ConfigureNativeBuild"}
...
<UsageList usage={{"recipeName":"org.openrewrite.quarkus.spring.ConfigureNativeBuild","displayName":"Configure Quarkus Native Build Support","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring-to-quarkus","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING_TO_QUARKUS","requiresConfiguration":false}}>
