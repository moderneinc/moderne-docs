...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/configurenativebuild" />
</head>
...
_Adds configuration and dependencies required for Quarkus native image compilation with GraalVM. Includes native profile configuration and reflection hints where needed._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [native](/user-documentation/recipes/lists/recipes-by-tag#native)
* [graalvm](/user-documentation/recipes/lists/recipes-by-tag#graalvm)
...
<RunRecipe
  recipeName="org.openrewrite.quarkus.spring.ConfigureNativeBuild"
  displayName="Configure Quarkus Native Build Support"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.ConfigureNativeBuild" />
