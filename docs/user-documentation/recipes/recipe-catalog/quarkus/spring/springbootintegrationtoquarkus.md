...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootintegrationtoquarkus" />
</head>
...
_Migrates `spring-boot-starter-integration` to `camel-quarkus-core`._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [camel](/user-documentation/recipes/lists/recipes-by-tag#camel)
...
name: org.openrewrite.quarkus.spring.SpringBootIntegrationToQuarkus
displayName: Replace Spring Boot Integration with Camel Quarkus
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootIntegrationToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootIntegrationToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootIntegrationToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootIntegrationToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootIntegrationToQuarkus" />
