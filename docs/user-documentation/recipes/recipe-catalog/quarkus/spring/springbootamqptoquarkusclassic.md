...
canonical_url: "https://docs.openrewrite.org/recipes/quarkus/spring/springbootamqptoquarkusclassic"
---
...
_Migrates `spring-boot-starter-amqp` to `quarkus-messaging-rabbitmq` when no reactor dependencies are present._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [classic](/user-documentation/recipes/lists/recipes-by-tag#classic)
* [amqp](/user-documentation/recipes/lists/recipes-by-tag#amqp)
* [quarkus](/user-documentation/recipes/lists/recipes-by-tag#quarkus)
* [rabbitmq](/user-documentation/recipes/lists/recipes-by-tag#rabbitmq)
...
* [Add Gradle or Maven dependency](../../java/dependencies/adddependency)
  * groupId: `io.quarkus`
  * artifactId: `quarkus-messaging-rabbitmq`
  * version: `x`
...
name: org.openrewrite.quarkus.spring.SpringBootAmqpToQuarkusClassic
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootAmqpToQuarkusClassic")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootAmqpToQuarkusClassic</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootAmqpToQuarkusClassic -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootAmqpToQuarkusClassic
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootAmqpToQuarkusClassic" />
