...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootdatajpatoquarkus" />
</head>
...
_Migrates `spring-boot-starter-data-jpa` to `quarkus-hibernate-orm-panache`._
...
name: org.openrewrite.quarkus.spring.SpringBootDataJpaToQuarkus
displayName: Replace Spring Boot Data JPA with Quarkus Hibernate ORM Panache
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootDataJpaToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootDataJpaToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootDataJpaToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootDataJpaToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootDataJpaToQuarkus" />
