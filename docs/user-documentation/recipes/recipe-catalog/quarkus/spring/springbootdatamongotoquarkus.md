...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootdatamongotoquarkus" />
</head>
...
_Migrates `spring-boot-starter-data-mongodb` to `quarkus-mongodb-panache`._
...
* [mongodb](/user-documentation/recipes/lists/recipes-by-tag#mongodb)
...
name: org.openrewrite.quarkus.spring.SpringBootDataMongoToQuarkus
displayName: Replace Spring Boot Data MongoDB with Quarkus MongoDB Panache
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootDataMongoToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootDataMongoToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootDataMongoToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootDataMongoToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootDataMongoToQuarkus" />
