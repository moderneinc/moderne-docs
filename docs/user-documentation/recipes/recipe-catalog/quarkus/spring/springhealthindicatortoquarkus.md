...
_Transforms Spring Boot Actuator `HealthIndicator` implementations to MicroProfile Health `HealthCheck` pattern used by Quarkus._

## Recipe source

[GitHub: SpringHealthIndicatorToQuarkus.java](https://github.com/openrewrite/rewrite-spring-to-quarkus/blob/main/src/main/java/org/openrewrite/quarkus/spring/SpringHealthIndicatorToQuarkus.java),
...
```shell title="shell"
mod run . --recipe SpringHealthIndicatorToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringHealthIndicatorToQuarkus" />
