---
title: "Migrate Spring Data MongoDB to Quarkus Panache MongoDB"
sidebar_label: "Migrate Spring Data MongoDB to Quarkus Panache MongoDB"
hide_title: true
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/migratespringdatamongodb" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.quarkus.spring.MigrateSpringDataMongodb"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring-to-quarkus/blob/main/src/main/resources/META-INF/rewrite/spring-panache.yml"}
/>

<RecipeHeader
  type={"Composite recipe"}
  languages={["OpenRewrite"]}
  tags={["spring","migration","mongodb","quarkus","panache"]}
  license={"Moderne Source Available License"}
  fqName={"org.openrewrite.quarkus.spring.MigrateSpringDataMongodb"}
...
<ExampleList examples={[{"unchanged":{"language":"java","code":"public class User {\n}\n"},"variants":[{"language":"java","before":"import org.springframework.data.mongodb.repository.MongoRepository;\n\npublic interface UserRepository extends MongoRepository<User, String> {\n}\n","after":"import io.quarkus.mongodb.panache.PanacheMongoRepository;\n\npublic interface UserRepository extends PanacheMongoRepository<User> {\n}\n","diff":"@@ -1,1 +1,1 @@\n-import org.springframework.data.mongodb.repository.MongoRepository;\n+import io.quarkus.mongodb.panache.PanacheMongoRepository;\n\n@@ -3,1 +3,1 @@\nimport org.springframework.data.mongodb.repository.MongoRepository;\n\n-public interface UserRepository extends MongoRepository<User, String> {\n+public interface UserRepository extends PanacheMongoRepository<User> {\n}\n","newFile":false}]},{"unchanged":{"language":"java","code":"public class User {\n}\n"},"variants":[{"language":"java","before":"import org.springframework.data.mongodb.repository.MongoRepository;\n\npublic interface UserRepository extends MongoRepository<User, String> {\n}\n","after":"import io.quarkus.mongodb.panache.PanacheMongoRepository;\n\npublic interface UserRepository extends PanacheMongoRepository<User> {\n}\n","diff":"@@ -1,1 +1,1 @@\n-import org.springframework.data.mongodb.repository.MongoRepository;\n+import io.quarkus.mongodb.panache.PanacheMongoRepository;\n\n@@ -3,1 +3,1 @@\nimport org.springframework.data.mongodb.repository.MongoRepository;\n\n-public interface UserRepository extends MongoRepository<User, String> {\n+public interface UserRepository extends PanacheMongoRepository<User> {\n}\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.quarkus.spring.MigrateSpringDataMongodb","displayName":"Migrate Spring Data MongoDB to Quarkus Panache MongoDB","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring-to-quarkus","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING_TO_QUARKUS","requiresConfiguration":false}}>
