...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootcachetoquarkus" />
</head>
...
_Migrates `spring-boot-starter-cache` to `quarkus-cache`._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [cache](/user-documentation/recipes/lists/recipes-by-tag#cache)
...
name: org.openrewrite.quarkus.spring.SpringBootCacheToQuarkus
displayName: Replace Spring Boot Cache with Quarkus Cache
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootCacheToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootCacheToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootCacheToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootCacheToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootCacheToQuarkus" />
