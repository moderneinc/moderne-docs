...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootbatchtoquarkus" />
</head>
...
_Migrates `spring-boot-starter-batch` to `quarkus-scheduler`._
...
name: org.openrewrite.quarkus.spring.SpringBootBatchToQuarkus
displayName: Replace Spring Boot Batch with Quarkus Scheduler
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootBatchToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootBatchToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootBatchToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootBatchToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootBatchToQuarkus" />
