...
canonical_url: "https://docs.openrewrite.org/recipes/quarkus/spring/springbootdataresttoquarkus"
---
...
_Migrates `spring-boot-starter-data-rest` to `quarkus-rest-jackson`._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [rest](/user-documentation/recipes/lists/recipes-by-tag#rest)
...
name: org.openrewrite.quarkus.spring.SpringBootDataRestToQuarkus
displayName: Replace Spring Boot Data REST with Quarkus REST
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootDataRestToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootDataRestToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootDataRestToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootDataRestToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootDataRestToQuarkus" />
