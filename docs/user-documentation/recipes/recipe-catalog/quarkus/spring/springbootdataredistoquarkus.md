...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootdataredistoquarkus" />
</head>
...
_Migrates `spring-boot-starter-data-redis` to `quarkus-redis-client`._
...
* [redis](/user-documentation/recipes/lists/recipes-by-tag#redis)
...
name: org.openrewrite.quarkus.spring.SpringBootDataRedisToQuarkus
displayName: Replace Spring Boot Data Redis with Quarkus Redis Client
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootDataRedisToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootDataRedisToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootDataRedisToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootDataRedisToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootDataRedisToQuarkus" />
