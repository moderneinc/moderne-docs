...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootactivemqtoquarkus" />
</head>
...
_Migrates `spring-boot-starter-activemq` to `quarkus-artemis-jms`._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [jms](/user-documentation/recipes/lists/recipes-by-tag#jms)
* [activemq](/user-documentation/recipes/lists/recipes-by-tag#activemq)
...
name: org.openrewrite.quarkus.spring.SpringBootActiveMQToQuarkus
displayName: Replace Spring Boot ActiveMQ with Quarkus Artemis JMS
description: |
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootActiveMQToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootActiveMQToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootActiveMQToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootActiveMQToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootActiveMQToQuarkus" />
