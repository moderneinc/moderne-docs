...
<RecipeMeta
  ...
  fqName={"org.openrewrite.quarkus.spring.SpringBeanToCdiProduces"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring-to-quarkus/blob/main/src/main/java/org/openrewrite/quarkus/spring/SpringBeanToCdiProduces.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.quarkus.spring.SpringBeanToCdiProduces","displayName":"Replace Spring `@Bean` with CDI `@Produces`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring-to-quarkus","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING_TO_QUARKUS","requiresConfiguration":false}}>
