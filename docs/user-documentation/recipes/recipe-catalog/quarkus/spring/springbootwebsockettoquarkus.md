...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/spring/springbootwebsockettoquarkus" />
</head>
...
_Migrates `spring-boot-starter-websocket` to `quarkus-websockets`._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [websocket](/user-documentation/recipes/lists/recipes-by-tag#websocket)
...
name: org.openrewrite.quarkus.spring.SpringBootWebSocketToQuarkus
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.SpringBootWebSocketToQuarkus")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.SpringBootWebSocketToQuarkus</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.SpringBootWebSocketToQuarkus -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SpringBootWebSocketToQuarkus
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.spring.SpringBootWebSocketToQuarkus" />
