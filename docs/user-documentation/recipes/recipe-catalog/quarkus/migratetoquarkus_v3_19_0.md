---
sidebar_label: "Quarkus Updates Aggregate 3.19.0"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/migratetoquarkus_v3_19_0" />
</head>
...
**org.openrewrite.quarkus.MigrateToQuarkus\_v3\_19\_0**

_Quarkus update recipes to upgrade your application to 3.19.0._
...
rewrite {
    activeRecipe("org.openrewrite.quarkus.MigrateToQuarkus_v3_19_0")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.MigrateToQuarkus_v3_19_0</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.MigrateToQuarkus_v3_19_0 -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe MigrateToQuarkus_v3_19_0
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.quarkus.MigrateToQuarkus_v3_19_0" />
