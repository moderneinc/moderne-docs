...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/quarkus/changequarkuspropertykey" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.quarkus.ChangeQuarkusPropertyKey"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-quarkus/blob/main/src/main/java/org/openrewrite/quarkus/ChangeQuarkusPropertyKey.java"}
/>
