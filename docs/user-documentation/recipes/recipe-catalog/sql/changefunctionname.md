---
title: "Change a SQL function name"
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.sql.ChangeFunctionName"}
...
<UsageList usage={{"recipeName":"org.openrewrite.sql.ChangeFunctionName","displayName":"Change a SQL function name","groupId":"org.openrewrite.recipe","artifactId":"rewrite-sql","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SQL","requiresConfiguration":true,"cliOptions":" --recipe-option \"oldFunctionName=NVL\" --recipe-option \"newFunctionName=COALESCE\""}}>
