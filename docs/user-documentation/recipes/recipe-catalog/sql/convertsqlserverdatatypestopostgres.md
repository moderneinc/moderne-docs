...
<RecipeMeta
  ...
  fqName={"org.openrewrite.sql.ConvertSqlServerDataTypesToPostgres"}
...
<UsageList usage={{"recipeName":"org.openrewrite.sql.ConvertSqlServerDataTypesToPostgres","displayName":"Convert SQL Server data types to PostgreSQL","groupId":"org.openrewrite.recipe","artifactId":"rewrite-sql","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SQL","requiresConfiguration":false}}>
