...
<RecipeMeta
  ...
  fqName={"org.openrewrite.sql.ConvertOracleFunctionsToPostgres"}
...
<UsageList usage={{"recipeName":"org.openrewrite.sql.ConvertOracleFunctionsToPostgres","displayName":"Convert Oracle functions to PostgreSQL","groupId":"org.openrewrite.recipe","artifactId":"rewrite-sql","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SQL","requiresConfiguration":false}}>
