...
<RecipeMeta
  ...
  fqName={"org.openrewrite.sql.ConvertDataType"}
...
<UsageList usage={{"recipeName":"org.openrewrite.sql.ConvertDataType","displayName":"Convert SQL data type","groupId":"org.openrewrite.recipe","artifactId":"rewrite-sql","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SQL","requiresConfiguration":true,"cliOptions":" --recipe-option \"oldDataType=VARCHAR2\" --recipe-option \"newDataType=VARCHAR\""}}>
