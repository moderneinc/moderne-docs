...
<RecipeMeta
  ...
  fqName={"org.openrewrite.sql.MigrateSqlServerToPostgres"}
...
<RecipeHeader
  ...
  languages={["OpenRewrite"]}
  tags={["migration","sqlserver","postgresql","mssql","sql"]}
  license={"Moderne Proprietary License"}
  fqName={"org.openrewrite.sql.MigrateSqlServerToPostgres"}
...
<UsageList usage={{"recipeName":"org.openrewrite.sql.MigrateSqlServerToPostgres","displayName":"Migrate SQL Server to PostgreSQL","groupId":"org.openrewrite.recipe","artifactId":"rewrite-sql","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SQL","requiresConfiguration":false}}>
