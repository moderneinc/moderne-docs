...
_Analyzes the repository to plan a JBoss migration, identifying JBoss descriptor files (jboss-web.xml, jboss-deployment-structure.xml) and recording them in a data table._
...
<RunRecipe
  recipeName="io.moderne.java.server.jboss.PlanJBossMigration"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.server.jboss.PlanJBossMigration" />
...
| ----------- | ----------- |
| Descriptor File | JBoss descriptor file found |
