...
_Creates a `jetty-env.xml` file for projects containing JBoss descriptor files._
...
<RunRecipe
  recipeName="io.moderne.java.server.jboss.jetty.CreateJettyEnvXml"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.server.jboss.jetty.CreateJettyEnvXml" />
