...
_Moves `src/main/webapp/WEB-INF/web.xml` to `src/main/resources/web.xml`._
...
<RunRecipe
  recipeName="io.moderne.java.server.jboss.MoveWebXml"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.server.jboss.MoveWebXml" />
