...
_Comprehensive migration from JBoss to Tomcat._
...
name: com.yourorg.CreateTomcatFilesInPathExample
displayName: Migrate JBoss to Tomcat example
recipeList:
  - io.moderne.java.server.jboss.tomcat.CreateTomcatFilesInPath:
...
<RunRecipe
  recipeName="io.moderne.java.server.jboss.tomcat.CreateTomcatFilesInPath"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.server.jboss.tomcat.CreateTomcatFilesInPath" />
