---
title: "JBoss to Tomcat migration"
sidebar_label: "JBoss to Tomcat migration"
---
...
_Measures the progress of migrating applications from JBoss to Tomcat. Analyzes the presence of JBoss descriptor files (jboss-web.xml, jboss-deployment-structure.xml) and Tomcat context.xml configuration files to determine migration state._
...
<RunRecipe
  recipeName="io.moderne.java.server.jboss.tomcat.devcenter.JBossToTomcatMigrationCard"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.server.jboss.tomcat.devcenter.JBossToTomcatMigrationCard" />
