...
_Creates a `context.xml` file for projects containing JBoss descriptor files._
...
<RunRecipe
  recipeName="io.moderne.java.server.jboss.tomcat.CreateTomcatContextXml"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.server.jboss.tomcat.CreateTomcatContextXml" />
