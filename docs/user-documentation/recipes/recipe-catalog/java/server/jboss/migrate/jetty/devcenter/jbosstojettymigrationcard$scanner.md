...
```shell title="shell"
mod run . --recipe JBossToJettyMigrationCard$Scanner
```
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.server.jboss.migrate.jetty.devcenter.JBossToJettyMigrationCard$Scanner" />
