...
<RecipeHeader.Title>Remove static import</RecipeHeader.Title>

<RecipeHeader.Description>Removes static imports and replaces them with qualified references. For example, `emptyList()` becomes `Collections.emptyList()`.</RecipeHeader.Description>
