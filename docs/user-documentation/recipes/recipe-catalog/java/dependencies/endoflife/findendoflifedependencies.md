---
title: "Find end-of-life dependencies"
sidebar_label: "Find end-of-life dependencies"
hide_title: true
---
...
<RecipeMeta
  displayName={"Find end-of-life dependencies"}
  description={"Find Maven and Gradle dependencies whose upstream release is end-of-life or scheduled for end-of-life soon, using a snapshot of [endoflife.date](https://endoflife.date). Direct dependencies are marked in source; all matches (direct and transitive) are reported in the data table."}
  fqName={"org.openrewrite.java.dependencies.endoflife.FindEndOfLifeDependencies"}
  languages={["Java"]}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.java.dependencies.endoflife.FindEndOfLifeDependencies"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/java/dependencies/endoflife/findendoflifedependencies.md"}
  moderneOnly
>

<RecipeHeader.Title>Find end-of-life dependencies</RecipeHeader.Title>

<RecipeHeader.Description>Find Maven and Gradle dependencies whose upstream release is end-of-life or scheduled for end-of-life soon, using a snapshot of [endoflife.date](https://endoflife.date). Direct dependencies are marked in source; all matches (direct and transitive) are reported in the data table.</RecipeHeader.Description>
