...
<RecipeMeta
  displayName={"Repository has dependency"}
  ...
  fqName={"org.openrewrite.java.dependencies.search.RepositoryHasDependency"}
  languages={["Java"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-java-dependencies/blob/main/src/main/java/org/openrewrite/java/dependencies/search/RepositoryHasDependency.java"}
/>
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.java.dependencies.search.RepositoryHasDependency"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/java/dependencies/search/repositoryhasdependency.md"}
>

<RecipeHeader.Title>Repository has dependency</RecipeHeader.Title>
