...
_Determine the order in which dependencies will be resolved for each `pom.xml` or `build.gradle` based on its defined repositories and effective settings._

## Recipe source

[GitHub: FindRepositoryOrder.java](https://github.com/openrewrite/rewrite-java-dependencies/blob/main/src/main/java/org/openrewrite/java/dependencies/FindRepositoryOrder.java),
...
<RunRecipe
  recipeName="org.openrewrite.java.dependencies.FindRepositoryOrder"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.dependencies.FindRepositoryOrder" />
