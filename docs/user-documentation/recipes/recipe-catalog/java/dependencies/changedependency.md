...
* [Migrate Hibernate Types to Hypersistence Utils 6.2](/user-documentation/recipes/recipe-catalog/hibernate/migratetohypersistenceutilshibernate62.md)
* [Migrate Hibernate Types to Hypersistence Utils 6.3](/user-documentation/recipes/recipe-catalog/hibernate/migratetohypersistenceutilshibernate63.md)
* [Migrate Hibernate Types to Hypersistence Utils for Hibernate 7.0](/user-documentation/recipes/recipe-catalog/hibernate/migratetohypersistenceutilshibernate70.md)
* [Migrate Hibernate Types to Hypersistence Utils for Hibernate 7.1](/user-documentation/recipes/recipe-catalog/hibernate/migratetohypersistenceutilshibernate71.md)
...
* [Migrate Tag Libraries to 2.0 (Jakarta EE 9)](/user-documentation/recipes/recipe-catalog/oracle/weblogic/rewrite/jakarta/migratetaglibstojakartaee9.md)
...
* [Migrate deprecated `org.glassfish.javax.el` packages to `jakarta.el`](/user-documentation/recipes/recipe-catalog/oracle/weblogic/rewrite/jakarta/orgglassfishjavaxeltojakartael.md)
...
* [Migrate javax.javaee-web-api to jakarta.jakartaee-web-api (Jakarta EE 9)](/user-documentation/recipes/recipe-catalog/oracle/weblogic/rewrite/jakarta/migratejavaxwebtojakartaweb9.md)
* [Migrate javax.mvc to 2.0 (Jakarta EE 9)](/user-documentation/recipes/recipe-catalog/oracle/weblogic/rewrite/jakarta/migratejavaxmvctojakartaee9.md)
...
* [Migrate the Axon Server connector to Axoniq Framework 5](/user-documentation/recipes/recipe-catalog/axoniq/framework/migration/axon4toaxoniq5axonserverconnector.md)
* [Migrate the Dropwizard Metrics extension to Axon Framework 5](/user-documentation/recipes/recipe-catalog/axonframework/migration/axon4toaxon5metricsdropwizardextension.md)
* [Migrate the Micrometer Metrics extension to Axon Framework 5](/user-documentation/recipes/recipe-catalog/axonframework/migration/axon4toaxon5metricsmicrometerextension.md)
* [Migrate the Reactor extension to Axon Framework 5](/user-documentation/recipes/recipe-catalog/axonframework/migration/axon4toaxon5reactorextension.md)
...
* [Migrate to Hibernate Validator 8.0.x](/user-documentation/recipes/recipe-catalog/hibernate/validator/hibernatevalidator_8_0.md)
...
* [Migrates `camel 4.16` application to `camel 4.17`](/user-documentation/recipes/recipe-catalog/quarkus/updates/camel/camel417/camelquarkusmigrationrecipe.md)
...
* [Mitigation of Java XML Bind Deprecation in Java 11 vs WebLogic 14.1.2](/user-documentation/recipes/recipe-catalog/oracle/weblogic/rewrite/weblogic1412javaxmlbindmitigation.md)
...
* [Rename Spring Boot 4.0 starters with managed versions](/user-documentation/recipes/recipe-catalog/java/spring/boot4/renamedeprecatedstartersmanagedversions.md)
...
* [Swap the Spring Boot starter to Axoniq Framework 5 commercial](/user-documentation/recipes/recipe-catalog/axoniq/framework/migration/axon4toaxoniq5springboot.md)
...
* [Upgrade WireMock to 3.x](/user-documentation/recipes/recipe-catalog/java/testing/wiremock/upgradewiremockdependencyversion.md)
...
* [io.quarkus.updates.core.quarkus30.JavaxToJakartaAdditionalMigration](/user-documentation/recipes/recipe-catalog/quarkus/updates/core/quarkus30/javaxtojakartaadditionalmigration.md)
* [io.quarkus.updates.core.quarkus33.GraalVMSubstitutionsArtifact](/user-documentation/recipes/recipe-catalog/quarkus/updates/core/quarkus33/graalvmsubstitutionsartifact.md)
* [io.quarkus.updates.core.quarkus331.JUnitRelocations](/user-documentation/recipes/recipe-catalog/quarkus/updates/core/quarkus331/junitrelocations.md)
...
* [io.quarkus.updates.core.quarkus36.JaegerSmallRyeOpenTracing](/user-documentation/recipes/recipe-catalog/quarkus/updates/core/quarkus36/jaegersmallryeopentracing.md)
* [io.quarkus.updates.core.quarkus37.HibernateSearchOutboxPolling](/user-documentation/recipes/recipe-catalog/quarkus/updates/core/quarkus37/hibernatesearchoutboxpolling.md)
* [io.quarkus.updates.core.quarkus37.ResteasyClientRenaming](/user-documentation/recipes/recipe-catalog/quarkus/updates/core/quarkus37/resteasyclientrenaming.md)
* [io.quarkus.updates.core.quarkus383.GraalSDK](/user-documentation/recipes/recipe-catalog/quarkus/updates/core/quarkus383/graalsdk.md)
* [io.quarkus.updates.core.quarkus39.GraalSDK](/user-documentation/recipes/recipe-catalog/quarkus/updates/core/quarkus39/graalsdk.md)
* [io.quarkus.updates.core.quarkus39.Relocations](/user-documentation/recipes/recipe-catalog/quarkus/updates/core/quarkus39/relocations.md)
