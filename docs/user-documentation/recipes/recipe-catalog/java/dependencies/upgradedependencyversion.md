...
canonical_url: "https://docs.openrewrite.org/recipes/java/dependencies/upgradedependencyversion"
---
...
* [Migrate to Hibernate 6.2.x (Community Edition)](/user-documentation/recipes/recipe-catalog/hibernate/migratetohibernate62.md)
* [Migrate to Hibernate 6.3.x (Community Edition)](/user-documentation/recipes/recipe-catalog/hibernate/migratetohibernate63.md)
* [Migrate to Hibernate 6.4.x (Community Edition)](/user-documentation/recipes/recipe-catalog/hibernate/migratetohibernate64.md)
...
* [Migrate to JasperReports 6](/user-documentation/recipes/recipe-catalog/jasperreports/upgradetojasperreports6.md)
...
* [Migrate to Kafka 2.4](/user-documentation/recipes/recipe-catalog/kafka/migratetokafka24.md)
* [Migrate to Kafka 2.5](/user-documentation/recipes/recipe-catalog/kafka/migratetokafka25.md)
* [Migrate to Kafka 2.6](/user-documentation/recipes/recipe-catalog/kafka/migratetokafka26.md)
* [Migrate to Kafka 2.7](/user-documentation/recipes/recipe-catalog/kafka/migratetokafka27.md)
* [Migrate to Kafka 2.8](/user-documentation/recipes/recipe-catalog/kafka/migratetokafka28.md)
* [Migrate to Kafka 3.0](/user-documentation/recipes/recipe-catalog/kafka/migratetokafka30.md)
* [Migrate to Kafka 3.1](/user-documentation/recipes/recipe-catalog/kafka/migratetokafka31.md)
* [Migrate to Kafka 3.2](/user-documentation/recipes/recipe-catalog/kafka/migratetokafka32.md)
* [Migrate to Kafka 3.3](/user-documentation/recipes/recipe-catalog/kafka/migratetokafka33.md)
...
* [Migrate to Spring Security 6.5](/user-documentation/recipes/recipe-catalog/java/spring/security6/upgradespringsecurity_6_5-community-edition.md)
...
* [Update Jakarta EE Platform Dependencies to 9.1.0](/user-documentation/recipes/recipe-catalog/com/oracle/weblogic/rewrite/jakarta/updatejakartaplatform9_1.md)
...
* [Update Jakarta Persistence to 3.1](/user-documentation/recipes/recipe-catalog/com/oracle/weblogic/rewrite/jakarta/updatejakartapersistenceto31.md)
* [Update Jakarta Persistence to 3.2](/user-documentation/recipes/recipe-catalog/com/oracle/weblogic/rewrite/jakarta/updatejakartapersistenceto32.md)
...
* [Upgrade Common open source libraries](/user-documentation/recipes/recipe-catalog/com/oracle/weblogic/rewrite/jakarta/upgradecommonopensourcelibraries.md)
* [Upgrade Faces open source libraries](/user-documentation/recipes/recipe-catalog/com/oracle/weblogic/rewrite/jakarta/upgradefacesopensourcelibraries2.md)
...
* [Upgrade Spring Cloud AWS to Spring Boot 3.4 compatible version](/user-documentation/recipes/recipe-catalog/java/spring/boot3/upgradespringcloudawstospringboot_3_4.md)
...
* [Upgrade Spring Data JPA to 3.4.6](/user-documentation/recipes/recipe-catalog/com/oracle/weblogic/rewrite/spring/data/upgradespringdatajpa.md)
