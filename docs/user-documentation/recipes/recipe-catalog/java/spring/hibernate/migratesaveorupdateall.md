...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.hibernate.MigrateSaveOrUpdateAll"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.hibernate.MigrateSaveOrUpdateAll","displayName":"Migrate `HibernateDaoSupport#getHibernateTemplate#saveOrUpdateAll`","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
