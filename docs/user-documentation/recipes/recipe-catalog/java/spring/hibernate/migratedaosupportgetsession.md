...
_Migrate `HibernateDaoSupport#getSession()` usage to `HibernateDaoSupport#getSessionFactory()#getCurrentSession()` and annotate the methods with `@Transactional`._
...
<RunRecipe
  recipeName="io.moderne.java.spring.hibernate.MigrateDaoSupportGetSession"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.hibernate.MigrateDaoSupportGetSession" />
