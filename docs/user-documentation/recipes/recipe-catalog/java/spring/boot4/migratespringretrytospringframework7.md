...
_Migrate `spring-retry`s `@Retryable` and `@Backoff` annotation to Spring Framework 7 Resilience annotations._
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot4.MigrateSpringRetryToSpringFramework7"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot4.MigrateSpringRetryToSpringFramework7" />
