...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot4.AddMongoDbRepresentationProperties"}
...
<ExampleList examples={[{"unchanged":{"language":"java","code":"class Test {}"},"variants":[]},{"unchanged":{"language":"java","code":"class Test {}"},"variants":[]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"io.moderne.java.spring.boot4.AddMongoDbRepresentationProperties","displayName":"Add MongoDB representation properties for UUID and BigDecimal","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
