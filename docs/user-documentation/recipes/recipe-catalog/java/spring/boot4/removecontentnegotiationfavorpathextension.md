...
_Spring Framework 7 removed `favorPathExtension()` from `ContentNegotiationConfigurer`. Path extension content negotiation is no longer supported. This recipe removes calls to `favorPathExtension()`._
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot4.RemoveContentNegotiationFavorPathExtension"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot4.RemoveContentNegotiationFavorPathExtension" />
