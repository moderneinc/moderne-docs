...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot4.RemoveContentNegotiationFavorPathExtension"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot4.RemoveContentNegotiationFavorPathExtension","displayName":"Remove `ContentNegotiationConfigurer.favorPathExtension()` calls","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
