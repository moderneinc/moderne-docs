...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot4.RemoveGradleUberJarLoaderImplementationConfig"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot4.RemoveGradleUberJarLoaderImplementationConfig","displayName":"Remove `loaderImplementation` from Gradle","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
