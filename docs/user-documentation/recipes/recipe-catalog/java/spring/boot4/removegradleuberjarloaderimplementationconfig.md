...
_Removes the Spring Boot Uber-Jar `loaderImplementation` configuration from Gradle build files._
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot4.RemoveGradleUberJarLoaderImplementationConfig"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot4.RemoveGradleUberJarLoaderImplementationConfig" />
