...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot4.MigrateAutoConfigureMockMvcHtmlUnit"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot4.MigrateAutoConfigureMockMvcHtmlUnit","displayName":"Migrate `@AutoConfigureMockMvc` HtmlUnit attributes to nested `@HtmlUnit`","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
