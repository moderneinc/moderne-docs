...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot4.RemoveZipkinAutoConfigurationExclude"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot4.RemoveZipkinAutoConfigurationExclude","displayName":"Remove `ZipkinAutoConfiguration`","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
