...
_Spring Boot 4.0 removed support for Spring Pulsar Reactive as it is no longer maintained. This recipe removes the Spring Pulsar Reactive dependencies._

### Tags

* [spring](/user-documentation/recipes/lists/recipes-by-tag#spring)
* [boot](/user-documentation/recipes/lists/recipes-by-tag#boot)
* [pulsar](/user-documentation/recipes/lists/recipes-by-tag#pulsar)
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot4.RemoveSpringPulsarReactive"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot4.RemoveSpringPulsarReactive" />
