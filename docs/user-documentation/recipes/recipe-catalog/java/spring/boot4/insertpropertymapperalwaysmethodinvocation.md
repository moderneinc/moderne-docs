...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot4.InsertPropertyMapperAlwaysMethodInvocation"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot4.InsertPropertyMapperAlwaysMethodInvocation","displayName":"Preserve `PropertyMapper` null-passing behavior","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
