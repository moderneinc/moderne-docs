...
_Replaces deprecated `DockerApi` constructors and configuration methods with their modern equivalents._
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot4.ReplaceDeprecatedDockerApi"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot4.ReplaceDeprecatedDockerApi" />
