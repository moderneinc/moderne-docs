...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot4.ReplaceDeprecatedDockerApi"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot4.ReplaceDeprecatedDockerApi","displayName":"Replace deprecated `DockerApi`","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
