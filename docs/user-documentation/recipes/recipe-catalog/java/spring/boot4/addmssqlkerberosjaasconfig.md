...
_For MSSQL JDBC connections using Kerberos authentication (`authenticationScheme=JavaKerberos` or `integratedSecurity=true`), adds `useDefaultJaasConfig=true` to the connection string. This is required for compatibility with Keycloak 26.4+ which changes JAAS configuration handling._
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot4.AddMssqlKerberosJaasConfig"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot4.AddMssqlKerberosJaasConfig" />
