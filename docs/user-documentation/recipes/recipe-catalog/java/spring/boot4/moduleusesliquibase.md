...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot4.ModuleUsesLiquibase"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot4.ModuleUsesLiquibase","displayName":"Module uses Liquibase","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
