...
canonical_url: "https://docs.openrewrite.org/recipes/java/spring/boot4/addspringbootstarterflyway"
---
...
rewrite {
    activeRecipe("org.openrewrite.java.spring.boot4.AddSpringBootStarterFlyway")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.spring.boot4.AddSpringBootStarterFlyway</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.boot4.AddSpringBootStarterFlyway -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe AddSpringBootStarterFlyway
```
