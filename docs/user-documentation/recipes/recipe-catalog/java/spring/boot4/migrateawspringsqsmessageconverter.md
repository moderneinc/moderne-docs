...
## Examples
##### Example 1
`MigrateAwspringSqsMessageConverterKotlinTest#addsTodoCommentInKotlin`
...
##### Example 2
`MigrateAwspringSqsMessageConverterTest#foldExpressionLambdaIntoConstructor`
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot4.MigrateAwspringSqsMessageConverter"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot4.MigrateAwspringSqsMessageConverter" />
