...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot4.AddValidationStarterDependency"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot4.AddValidationStarterDependency","displayName":"Add `spring-boot-starter-validation` dependency","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
