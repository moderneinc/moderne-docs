...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot4.RemoveHttpMessageConvertersAutoConfigurationReferences"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot4.RemoveHttpMessageConvertersAutoConfigurationReferences","displayName":"Remove `HttpMessageConvertersAutoConfiguration` references","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
