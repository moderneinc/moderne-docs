...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot4.RemoveKafkaPropertiesSslBundlesParameter"}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"import org.springframework.boot.autoconfigure.kafka.KafkaProperties;\n\nclass KafkaConfig {\n    void configure(KafkaProperties kafkaProperties) {\n        var producerConfigs = kafkaProperties.buildProducerProperties(null);\n    }\n}\n","after":"import org.springframework.boot.autoconfigure.kafka.KafkaProperties;\n\nclass KafkaConfig {\n    void configure(KafkaProperties kafkaProperties) {\n        var producerConfigs = kafkaProperties.buildProducerProperties();\n    }\n}\n","diff":"@@ -5,1 +5,1 @@\nclass KafkaConfig {\n    void configure(KafkaProperties kafkaProperties) {\n-       var producerConfigs = kafkaProperties.buildProducerProperties(null);\n+       var producerConfigs = kafkaProperties.buildProducerProperties();\n    }\n","newFile":false}]},{"variants":[{"language":"java","before":"import org.springframework.boot.autoconfigure.kafka.KafkaProperties;\n\nclass KafkaConfig {\n    void configure(KafkaProperties kafkaProperties) {\n        var producerConfigs = kafkaProperties.buildProducerProperties(null);\n    }\n}\n","after":"import org.springframework.boot.autoconfigure.kafka.KafkaProperties;\n\nclass KafkaConfig {\n    void configure(KafkaProperties kafkaProperties) {\n        var producerConfigs = kafkaProperties.buildProducerProperties();\n    }\n}\n","diff":"@@ -5,1 +5,1 @@\nclass KafkaConfig {\n    void configure(KafkaProperties kafkaProperties) {\n-       var producerConfigs = kafkaProperties.buildProducerProperties(null);\n+       var producerConfigs = kafkaProperties.buildProducerProperties();\n    }\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"io.moderne.java.spring.boot4.RemoveKafkaPropertiesSslBundlesParameter","displayName":"Remove `SslBundles` parameter from `KafkaProperties` build methods","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
