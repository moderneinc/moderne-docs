...
canonical_url: "https://docs.openrewrite.org/recipes/java/spring/boot4/replacemockbeanandspybean"
---
...
[GitHub: replace-mock-and-spybean.yml](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/resources/META-INF/rewrite/replace-mock-and-spybean.yml),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.boot4.ReplaceMockBeanAndSpyBean -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.boot4.ReplaceMockBeanAndSpyBean" />
