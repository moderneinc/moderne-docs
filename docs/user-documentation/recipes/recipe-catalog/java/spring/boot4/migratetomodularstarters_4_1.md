...
**io.moderne.java.spring.boot4.MigrateToModularStarters\_4\_1**

_Add Spring Boot 4.1 starter dependencies for modules introduced in 4.1 (gRPC server, gRPC client, and Spring Batch with MongoDB support). This recipe complements `MigrateToModularStarters` from 4.0 and only adds the new starters; it does not rewrite or remove anything else._
...
## Examples
##### Example 1
`MigrateToModularStarters_4_1Test#addsGrpcServerStarterWhenBindableServiceUsed`
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot4.MigrateToModularStarters_4_1"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot4.MigrateToModularStarters_4_1" />
