...
_Adds `@AutoConfigureMockMvc` annotation to classes annotated with `@SpringBootTest` that use `MockMvc`._
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot4.AddAutoConfigureMockMvc"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot4.AddAutoConfigureMockMvc" />
