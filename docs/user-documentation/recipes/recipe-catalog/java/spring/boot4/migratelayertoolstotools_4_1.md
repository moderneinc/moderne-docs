...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot4.MigrateLayertoolsToTools_4_1"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot4.MigrateLayertoolsToTools_4_1","displayName":"Migrate `layertools` jarmode to `tools`","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
