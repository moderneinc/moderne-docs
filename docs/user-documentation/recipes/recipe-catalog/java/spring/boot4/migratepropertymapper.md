...
<RunRecipe
  recipeName="io.moderne.java.spring.boot4.MigratePropertyMapper"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot4.MigratePropertyMapper" />
