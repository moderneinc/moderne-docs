...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot4.MigratePropertyMapper"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot4.MigratePropertyMapper","displayName":"Migrate `PropertyMapper` API for Spring Boot 4.0","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
