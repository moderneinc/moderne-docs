...
[GitHub: ApiInfoBuilderToInfo.java](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/doc/ApiInfoBuilderToInfo.java),
...
name: org.openrewrite.java.spring.doc.ApiInfoBuilderToInfo
...
rewrite {
    activeRecipe("org.openrewrite.java.spring.doc.ApiInfoBuilderToInfo")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.spring.doc.ApiInfoBuilderToInfo</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.doc.ApiInfoBuilderToInfo -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.doc.ApiInfoBuilderToInfo" />
