...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.security7.SecurityConfigurerRemoveThrowsException"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.security7.SecurityConfigurerRemoveThrowsException","displayName":"Remove throws exception in `SecurityConfigurer` methods `init` and `configure`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
