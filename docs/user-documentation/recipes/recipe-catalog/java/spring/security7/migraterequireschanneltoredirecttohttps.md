...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.security7.MigrateRequiresChannelToRedirectToHttps"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.security7.MigrateRequiresChannelToRedirectToHttps","displayName":"Migrate `requiresChannel()` to `redirectToHttps()`","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
