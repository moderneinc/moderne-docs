...
_A new set of `OAuth2AccessTokenResponseClient` implementations were introduced based on `RestClient`. This recipe replaces the `RestOperations`-based implementations which have been deprecated. The `RestClient` implementations are drop-in replacements for the deprecated implementations._
...
<RunRecipe
  recipeName="io.moderne.java.spring.security7.MigrateOAuth2AccessTokenResponseClient"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.security7.MigrateOAuth2AccessTokenResponseClient" />
