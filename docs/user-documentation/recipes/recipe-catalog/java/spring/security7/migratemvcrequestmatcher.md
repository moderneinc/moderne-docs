...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.security7.MigrateMvcRequestMatcher"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.security7.MigrateMvcRequestMatcher","displayName":"Migrate `MvcRequestMatcher` to `PathPatternRequestMatcher`","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
