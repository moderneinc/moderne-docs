...
_In Spring Security 7.0, `MvcRequestMatcher` which depends on the deprecated `HandlerMappingIntrospector` is removed in favor of `PathPatternRequestMatcher`. This recipe migrates constructor and builder usage to the new pattern._
...
<RunRecipe
  recipeName="io.moderne.java.spring.security7.MigrateMvcRequestMatcher"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.security7.MigrateMvcRequestMatcher" />
