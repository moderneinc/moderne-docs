---
title: "Migrate Spring Cloud properties to 2025.1"
sidebar_label: "Migrate Spring Cloud properties to 2025.1"
---
...
**io.moderne.java.spring.cloud20251.SpringCloudProperties\_2025\_1**

_Migrate properties found in `application.properties` and `application.yml` for Spring Cloud 2025.1 (Oakwood). This includes the stubrunner property prefix migration from `stubrunner.` to `spring.cloud.contract.stubrunner.`._
...
<RunRecipe
  recipeName="io.moderne.java.spring.cloud20251.SpringCloudProperties_2025_1"
  displayName="Migrate Spring Cloud properties to 2025.1"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.cloud20251.SpringCloudProperties_2025_1" />
