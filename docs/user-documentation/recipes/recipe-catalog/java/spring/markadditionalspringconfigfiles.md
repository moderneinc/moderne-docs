...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.MarkAdditionalSpringConfigFiles"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/MarkAdditionalSpringConfigFiles.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.MarkAdditionalSpringConfigFiles","displayName":"Mark additional files as Spring configuration","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":true,"cliOptions":" --recipe-option \"pathPatterns=**/properties/*.properties\""}}>
