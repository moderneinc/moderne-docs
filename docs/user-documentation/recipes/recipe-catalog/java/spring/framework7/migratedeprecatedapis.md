...
<ExampleList examples={[{"variants":[{"language":"java","before":"import jakarta.servlet.http.HttpServletRequest;\nimport org.springframework.web.util.ContentCachingRequestWrapper;\n\nclass MyFilter {\n    void doFilter(HttpServletRequest request) {\n        ContentCachingRequestWrapper wrappedRequest = new ContentCachingRequestWrapper(request);\n    }\n}\n","after":"import jakarta.servlet.http.HttpServletRequest;\nimport org.springframework.web.util.ContentCachingRequestWrapper;\n\nclass MyFilter {\n    void doFilter(HttpServletRequest request) {\n        ContentCachingRequestWrapper wrappedRequest = new ContentCachingRequestWrapper(request, 0);\n    }\n}\n","diff":"@@ -6,1 +6,1 @@\nclass MyFilter {\n    void doFilter(HttpServletRequest request) {\n-       ContentCachingRequestWrapper wrappedRequest = new ContentCachingRequestWrapper(request);\n+       ContentCachingRequestWrapper wrappedRequest = new ContentCachingRequestWrapper(request, 0);\n    }\n","newFile":false}]},{"variants":[{"language":"java","before":"import org.springframework.web.util.NestedServletException;\n\nclass MyFilter {\n    void doFilter() throws NestedServletException {\n        throw new NestedServletException(\"error\");\n    }\n}\n","after":"import jakarta.servlet.ServletException;\n\nclass MyFilter {\n    void doFilter() throws ServletException {\n        throw new ServletException(\"error\");\n    }\n}\n","diff":"@@ -1,1 +1,1 @@\n-import org.springframework.web.util.NestedServletException;\n+import jakarta.servlet.ServletException;\n\n@@ -4,2 +4,2 @@\n\nclass MyFilter {\n-   void doFilter() throws NestedServletException {\n-       throw new NestedServletException(\"error\");\n+   void doFilter() throws ServletException {\n+       throw new ServletException(\"error\");\n    }\n","newFile":false}]},{"variants":[{"language":"java","before":"import jakarta.servlet.http.HttpServletRequest;\nimport org.springframework.web.util.ContentCachingRequestWrapper;\n\nclass MyFilter {\n    void doFilter(HttpServletRequest request) {\n        ContentCachingRequestWrapper wrappedRequest = new ContentCachingRequestWrapper(request);\n    }\n}\n","after":"import jakarta.servlet.http.HttpServletRequest;\nimport org.springframework.web.util.ContentCachingRequestWrapper;\n\nclass MyFilter {\n    void doFilter(HttpServletRequest request) {\n        ContentCachingRequestWrapper wrappedRequest = new ContentCachingRequestWrapper(request, 0);\n    }\n}\n","diff":"@@ -6,1 +6,1 @@\nclass MyFilter {\n    void doFilter(HttpServletRequest request) {\n-       ContentCachingRequestWrapper wrappedRequest = new ContentCachingRequestWrapper(request);\n+       ContentCachingRequestWrapper wrappedRequest = new ContentCachingRequestWrapper(request, 0);\n    }\n","newFile":false}]},{"variants":[{"language":"java","before":"import org.springframework.web.util.NestedServletException;\n\nclass MyFilter {\n    void doFilter() throws NestedServletException {\n        throw new NestedServletException(\"error\");\n    }\n}\n","after":"import jakarta.servlet.ServletException;\n\nclass MyFilter {\n    void doFilter() throws ServletException {\n        throw new ServletException(\"error\");\n    }\n}\n","diff":"@@ -1,1 +1,1 @@\n-import org.springframework.web.util.NestedServletException;\n+import jakarta.servlet.ServletException;\n\n@@ -4,2 +4,2 @@\n\nclass MyFilter {\n-   void doFilter() throws NestedServletException {\n-       throw new NestedServletException(\"error\");\n+   void doFilter() throws ServletException {\n+       throw new ServletException(\"error\");\n    }\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"io.moderne.java.spring.framework7.MigrateDeprecatedAPIs","displayName":"Migrate deprecated APIs removed in Spring Framework 7.0","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
