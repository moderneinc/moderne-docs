---
title: "Migrate `ResponseEntity#getStatusCodeValue()` to `getStatusCode().value()`"
sidebar_label: "Migrate `ResponseEntity#getStatusCodeValue()` to `getStatusCode().value()`"
---
...
_Replaces calls to `ResponseEntity#getStatusCodeValue()` which was deprecated in Spring Framework 6.0 and removed in Spring Framework 7.0 with `getStatusCode().value()`._
...
<RunRecipe
  recipeName="io.moderne.java.spring.framework7.MigrateResponseEntityGetStatusCodeValueMethod"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.framework7.MigrateResponseEntityGetStatusCodeValueMethod" />
