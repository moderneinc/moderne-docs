...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework7.MigrateAbstractClientHttpResponse"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework7.MigrateAbstractClientHttpResponse","displayName":"Migrate `AbstractClientHttpResponse` to `ClientHttpResponse`","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
