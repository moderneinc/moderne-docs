...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework7.FindServletViewSupportUsage"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework7.FindServletViewSupportUsage","displayName":"Find removed Spring servlet view classes","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
