...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework7.UpdateGraalVmNativeHints"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework7.UpdateGraalVmNativeHints","displayName":"Update GraalVM native reflection hints for Spring Framework 7.0","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
