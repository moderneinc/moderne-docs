...
## Examples
##### Example 1
`RenameMemberCategoryConstantsTest#renamePublicFieldsToInvokePublicFields`
...
class MyHintsRegistrar {
    void registerHints(RuntimeHints hints) {
        hints.reflection().registerType(String.class, MemberCategory.INVOKE_PUBLIC_FIELDS);
    }
}
```
...
<RunRecipe
  recipeName="io.moderne.java.spring.framework7.RenameMemberCategoryConstants"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.framework7.RenameMemberCategoryConstants" />
