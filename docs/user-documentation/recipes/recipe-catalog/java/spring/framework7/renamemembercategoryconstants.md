...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework7.RenameMemberCategoryConstants"}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"import org.springframework.aot.hint.MemberCategory;\nimport org.springframework.aot.hint.RuntimeHints;\n\nclass MyHintsRegistrar {\n    void registerHints(RuntimeHints hints) {\n        hints.reflection().registerType(String.class, MemberCategory.PUBLIC_FIELDS);\n    }\n}\n","after":"import org.springframework.aot.hint.MemberCategory;\nimport org.springframework.aot.hint.RuntimeHints;\n\nclass MyHintsRegistrar {\n    void registerHints(RuntimeHints hints) {\n        hints.reflection().registerType(String.class, MemberCategory.INVOKE_PUBLIC_FIELDS);\n    }\n}\n","diff":"@@ -6,1 +6,1 @@\nclass MyHintsRegistrar {\n    void registerHints(RuntimeHints hints) {\n-       hints.reflection().registerType(String.class, MemberCategory.PUBLIC_FIELDS);\n+       hints.reflection().registerType(String.class, MemberCategory.INVOKE_PUBLIC_FIELDS);\n    }\n","newFile":false}]},{"variants":[{"language":"java","before":"import org.springframework.aot.hint.MemberCategory;\nimport org.springframework.aot.hint.RuntimeHints;\n\nclass MyHintsRegistrar {\n    void registerHints(RuntimeHints hints) {\n        hints.reflection().registerType(String.class, MemberCategory.PUBLIC_FIELDS);\n    }\n}\n","after":"import org.springframework.aot.hint.MemberCategory;\nimport org.springframework.aot.hint.RuntimeHints;\n\nclass MyHintsRegistrar {\n    void registerHints(RuntimeHints hints) {\n        hints.reflection().registerType(String.class, MemberCategory.INVOKE_PUBLIC_FIELDS);\n    }\n}\n","diff":"@@ -6,1 +6,1 @@\nclass MyHintsRegistrar {\n    void registerHints(RuntimeHints hints) {\n-       hints.reflection().registerType(String.class, MemberCategory.PUBLIC_FIELDS);\n+       hints.reflection().registerType(String.class, MemberCategory.INVOKE_PUBLIC_FIELDS);\n    }\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"io.moderne.java.spring.framework7.RenameMemberCategoryConstants","displayName":"Rename MemberCategory field constants for Spring Framework 7.0","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
