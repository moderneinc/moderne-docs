...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework7.ReplaceJUnit4SpringTestBaseClasses"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework7.ReplaceJUnit4SpringTestBaseClasses","displayName":"Replace JUnit 4 Spring test base classes with JUnit Jupiter annotations","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
