...
## Examples
##### Example 1
`RemoveSpringJclTest#removeExplicitSpringJclDependency`
...
<RunRecipe
  recipeName="io.moderne.java.spring.framework7.RemoveSpringJcl"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.framework7.RemoveSpringJcl" />
