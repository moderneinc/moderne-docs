...
* [Find removed APIs in Spring Framework 7.0](https://docs.moderne.io/user-documentation/recipes/recipe-catalog/java/spring/framework7/findremovedapis)


## Usage

<RunRecipe
  recipeName="io.moderne.java.spring.framework7.FindOkHttp3IntegrationUsage"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.framework7.FindOkHttp3IntegrationUsage" />
