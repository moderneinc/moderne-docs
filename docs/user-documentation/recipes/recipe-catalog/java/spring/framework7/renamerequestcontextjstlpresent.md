...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework7.RenameRequestContextJstlPresent"}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"import org.springframework.web.servlet.support.RequestContext;\n\nclass MyRequestContext extends RequestContext {\n    boolean hasJstl() {\n        return RequestContext.jstPresent;\n    }\n}\n","after":"import org.springframework.web.servlet.support.RequestContext;\n\nclass MyRequestContext extends RequestContext {\n    boolean hasJstl() {\n        return RequestContext.JSTL_PRESENT;\n    }\n}\n","diff":"@@ -5,1 +5,1 @@\nclass MyRequestContext extends RequestContext {\n    boolean hasJstl() {\n-       return RequestContext.jstPresent;\n+       return RequestContext.JSTL_PRESENT;\n    }\n","newFile":false}]},{"variants":[{"language":"java","before":"import org.springframework.web.servlet.support.RequestContext;\n\nclass MyRequestContext extends RequestContext {\n    boolean hasJstl() {\n        return RequestContext.jstPresent;\n    }\n}\n","after":"import org.springframework.web.servlet.support.RequestContext;\n\nclass MyRequestContext extends RequestContext {\n    boolean hasJstl() {\n        return RequestContext.JSTL_PRESENT;\n    }\n}\n","diff":"@@ -5,1 +5,1 @@\nclass MyRequestContext extends RequestContext {\n    boolean hasJstl() {\n-       return RequestContext.jstPresent;\n+       return RequestContext.JSTL_PRESENT;\n    }\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"io.moderne.java.spring.framework7.RenameRequestContextJstlPresent","displayName":"Rename `RequestContext.jstPresent` to `JSTL_PRESENT`","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
