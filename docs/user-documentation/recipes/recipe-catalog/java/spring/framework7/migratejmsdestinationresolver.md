...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework7.MigrateJmsDestinationResolver"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework7.MigrateJmsDestinationResolver","displayName":"Preserve DynamicDestinationResolver behavior for JmsTemplate","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
