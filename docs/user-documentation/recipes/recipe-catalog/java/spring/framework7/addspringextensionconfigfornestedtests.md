...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework7.AddSpringExtensionConfigForNestedTests"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework7.AddSpringExtensionConfigForNestedTests","displayName":"Add `@SpringExtensionConfig` for nested tests","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
