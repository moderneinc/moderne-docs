...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework7.FindRemovedAPIs"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework7.FindRemovedAPIs","displayName":"Find removed APIs in Spring Framework 7.0","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
