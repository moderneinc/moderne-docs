---
description: Framework7 OpenRewrite recipes.
---
...
* [Add `@SpringExtensionConfig` for nested tests](./addspringextensionconfigfornestedtests.md)
* [Explicitly set DynamicDestinationResolver on JmsTemplate](./adddynamicdestinationresolvertojmstemplate.md)
