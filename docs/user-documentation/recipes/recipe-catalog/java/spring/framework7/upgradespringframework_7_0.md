...
<RecipeList recipes={[{"name":"Migrate to Spring Framework 6.0","href":"java/spring/framework/upgradespringframework_6_0-moderne-edition"},{"name":"Migrate `Jackson2ObjectMapperBuilder` to mapper builder pattern","href":"java/spring/framework7/migratejackson2objectmapperbuilder"},{"name":"Migrate to Spring Framework 7.0","href":"java/spring/framework/upgradespringframework_7_0"},{"name":"Migrate to Spring Kafka 4.0","href":"java/spring/boot4/upgradespringkafka_4_0"},{"name":"Update GraalVM native reflection hints for Spring Framework 7.0","href":"java/spring/framework7/updategraalvmnativehints"},{"name":"Remove spring-jcl dependency","href":"java/spring/framework7/removespringjcl"},{"name":"Migrate deprecated APIs removed in Spring Framework 7.0","href":"java/spring/framework7/migratedeprecatedapis"},{"name":"Find removed APIs in Spring Framework 7.0","href":"java/spring/framework7/findremovedapis"},{"name":"Rename `RequestContext.jstPresent` to `JSTL_PRESENT`","href":"java/spring/framework7/renamerequestcontextjstlpresent"},{"name":"Preserve DynamicDestinationResolver behavior for JmsTemplate","href":"java/spring/framework7/migratejmsdestinationresolver"},{"name":"Migrate `HttpStatus` enum values to RFC 9110 names","href":"java/spring/framework7/migratehttpstatustorfc9110"},{"name":"Add `@SpringExtensionConfig` for nested tests","href":"java/spring/framework7/addspringextensionconfigfornestedtests"},{"name":"Wrap `GenericMessage` map argument in `MessageHeaders`","href":"java/spring/framework7/wrapgenericmessagemapinmessageheaders"},{"name":"Remove Kotlin nullability from Spring HTTP entity type arguments","href":"java/spring/framework7/removenullabilityfromspringhttpentitytypearguments"}]} preconditions={[{"name":"Singleton","href":"core/singleton"}]}>
