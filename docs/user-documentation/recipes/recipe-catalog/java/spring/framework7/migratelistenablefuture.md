...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework7.MigrateListenableFuture"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework7.MigrateListenableFuture","displayName":"Migrate `ListenableFuture` to `CompletableFuture`","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
