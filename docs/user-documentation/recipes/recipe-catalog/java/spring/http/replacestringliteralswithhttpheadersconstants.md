...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/spring/http/replacestringliteralswithhttpheadersconstants" />
</head>
...
<RunRecipe
  recipeName="org.openrewrite.java.spring.http.ReplaceStringLiteralsWithHttpHeadersConstants"
  displayName="Replace String literals with `HttpHeaders` constants"
