...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/spring/http/springwebdependency" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.http.SpringWebDependency"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring/blob/main/src/main/resources/META-INF/rewrite/spring-web-dependency.yml"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.http.SpringWebDependency","displayName":"Find Spring Web dependency","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
