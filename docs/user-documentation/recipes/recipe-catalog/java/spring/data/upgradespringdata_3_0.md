---
title: "Migrate to Spring Data 3.0"
sidebar_label: "Migrate to Spring Data 3.0"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/spring/data/upgradespringdata_3_0" />
</head>
...
**org.openrewrite.java.spring.data.UpgradeSpringData\_3\_0**

_Migrate applications to Spring Data 3.0. Handles the PagingAndSortingRepository hierarchy change where it no longer extends CrudRepository, and chains prior deprecation fixes from Spring Data 2.7._
...
<RunRecipe
  recipeName="org.openrewrite.java.spring.data.UpgradeSpringData_3_0"
  displayName="Migrate to Spring Data 3.0"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.data.UpgradeSpringData_3_0" />
