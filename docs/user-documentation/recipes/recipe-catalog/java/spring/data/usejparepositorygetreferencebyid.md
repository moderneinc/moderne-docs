...
canonical_url: "https://docs.openrewrite.org/recipes/java/spring/data/usejparepositorygetreferencebyid"
---
...
_`JpaRepository#getOne(ID)` was deprecated in 2.5 and `JpaRepository#getById(ID)` was deprecated in 2.7._
...
rewrite {
    activeRecipe("org.openrewrite.java.spring.data.UseJpaRepositoryGetReferenceById")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.spring.data.UseJpaRepositoryGetReferenceById</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mod run . --recipe UseJpaRepositoryGetReferenceById
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.data.UseJpaRepositoryGetReferenceById" />
