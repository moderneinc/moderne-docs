...
canonical_url: "https://docs.openrewrite.org/recipes/java/spring/data/upgradespringdata_3_4"
---
...
rewrite {
    activeRecipe("org.openrewrite.java.spring.data.UpgradeSpringData_3_4")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.spring.data.UpgradeSpringData_3_4</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.data.UpgradeSpringData_3_4 -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe UpgradeSpringData_3_4
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.data.UpgradeSpringData_3_4" />
