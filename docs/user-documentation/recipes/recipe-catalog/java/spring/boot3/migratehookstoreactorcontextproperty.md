...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.boot3.MigrateHooksToReactorContextProperty"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/boot3/MigrateHooksToReactorContextProperty.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.boot3.MigrateHooksToReactorContextProperty","displayName":"Use `spring.reactor.context-propagation` property","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
