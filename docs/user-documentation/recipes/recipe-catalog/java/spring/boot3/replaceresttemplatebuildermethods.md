...
canonical_url: "https://docs.openrewrite.org/recipes/java/spring/boot3/replaceresttemplatebuildermethods"
---
...
[GitHub: replace-methods-rest-template-builder.yml](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/resources/META-INF/rewrite/replace-methods-rest-template-builder.yml),
...
## Examples
##### Example 1
`ReplaceRestTemplateBuilderMethodsTest#replacesSetConnectTimeout`
