...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/spring/boot3/upgradespringboot_3_5-community-edition" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.boot3.UpgradeSpringBoot_3_5"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.boot3.UpgradeSpringBoot_3_5","displayName":"Migrate to Spring Boot 3.5","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false,"useFullyQualifiedCliName":true}}>
