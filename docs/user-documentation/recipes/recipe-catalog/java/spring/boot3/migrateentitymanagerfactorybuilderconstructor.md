...
_The constructors of `EntityManagerFactoryBuilder` have been deprecated in Spring Boot 3.4. This recipe transforms them to use the new constructor with a Function parameter for property mapping._
...
```shell title="shell"
mod run . --recipe MigrateEntityManagerFactoryBuilderConstructor
```
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot3.MigrateEntityManagerFactoryBuilderConstructor" />
