...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot3.AddValidToConfigurationPropertiesFields"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot3.AddValidToConfigurationPropertiesFields","displayName":"Add `@Valid` annotation to fields","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
