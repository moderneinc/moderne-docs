...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot3.ReplaceDeprecatedKafkaConnectionDetailsBootstrapServerGetters"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot3.ReplaceDeprecatedKafkaConnectionDetailsBootstrapServerGetters","displayName":"Replace deprecated `KafkaConnectionDetails` bootstrap server methods","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
