...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot3.MigrateEndpointDiscovererConstructor"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot3.MigrateEndpointDiscovererConstructor","displayName":"Migrate `EndpointDiscoverer` deprecated constructor","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
