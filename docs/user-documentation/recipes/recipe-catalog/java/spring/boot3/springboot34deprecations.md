...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot3.SpringBoot34Deprecations"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot3.SpringBoot34Deprecations","displayName":"Migrate Spring Boot 3.4 deprecated classes and methods","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
