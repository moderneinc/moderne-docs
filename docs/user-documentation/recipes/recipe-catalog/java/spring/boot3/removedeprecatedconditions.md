...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot3.RemoveDeprecatedConditions"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot3.RemoveDeprecatedConditions","displayName":"Remove Spring Boot 3.5 deprecated conditions","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
