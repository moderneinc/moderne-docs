...
* [Migrate to Spring Boot 3.0 (Moderne Edition)](./upgradespringboot_3_0-moderne-edition.md)
...
* [Migrate `@Endpoint` Security properties to 3.4 (Moderne Edition)](./springbootproperties_3_4-moderne-edition.md)
...
* [Migrate `RestTemplate` API calls to `RestClient`](./migratetorestclientapi.md)
* [Migrate `RestTemplate` configuration to `RestClient`](./migrateresttemplateconfigurationtorestclient.md)
* [Migrate `RestTemplate` constructor calls to `RestClient.create()`](./migratetorestclientconstructor.md)
