...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/spring/boot3/replacestringliteralswithconstants" />
</head>
...
_Replace String literals with Spring constants where applicable._
...
[GitHub: best-practices.yml](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/resources/META-INF/rewrite/best-practices.yml),
...
name: org.openrewrite.java.spring.boot3.ReplaceStringLiteralsWithConstants
...
* [Spring Boot 3.3 best practices (only)](/user-documentation/recipes/recipe-catalog/java/spring/boot3/springboot3bestpracticesonly.md)
...
rewrite {
    activeRecipe("org.openrewrite.java.spring.boot3.ReplaceStringLiteralsWithConstants")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.spring.boot3.ReplaceStringLiteralsWithConstants</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.boot3.ReplaceStringLiteralsWithConstants -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe ReplaceStringLiteralsWithConstants
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.boot3.ReplaceStringLiteralsWithConstants" />
