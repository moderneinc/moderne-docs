...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot3.MigrateEndpointAnnotationAccessValueSpring34"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot3.MigrateEndpointAnnotationAccessValueSpring34","displayName":"Migrate `@Endpoint`s `defaultAccess` value","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
