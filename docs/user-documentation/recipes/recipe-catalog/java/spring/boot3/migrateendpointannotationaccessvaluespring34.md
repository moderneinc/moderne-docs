---
title: "Migrate `@Endpoint`s `defaultAccess` value"
...
* [Migrate `@Endpoint` Security properties to 3.4 (Moderne Edition)](https://docs.moderne.io/user-documentation/recipes/recipe-catalog/java/spring/boot3/springbootproperties_3_4-moderne-edition)
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot3.MigrateEndpointAnnotationAccessValueSpring34"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot3.MigrateEndpointAnnotationAccessValueSpring34" />
