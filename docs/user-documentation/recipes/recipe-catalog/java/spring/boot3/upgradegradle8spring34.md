...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot3.UpgradeGradle8Spring34"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot3.UpgradeGradle8Spring34","displayName":"Upgrade Gradle 8 to 8.4+ for Spring Boot 3.4","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
