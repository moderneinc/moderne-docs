...
_The 4-parameter constructor of `JmxEndpointDiscoverer` has been deprecated in Spring Boot 3.4. This recipe transforms it to use the new 5-parameter constructor with an additional Collection parameter._
...
```shell title="shell"
mod run . --recipe MigrateJmxEndpointDiscovererConstructor
```
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot3.MigrateJmxEndpointDiscovererConstructor" />
