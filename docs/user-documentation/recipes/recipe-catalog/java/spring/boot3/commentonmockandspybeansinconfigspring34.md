...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot3.CommentOnMockAndSpyBeansInConfigSpring34"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot3.CommentOnMockAndSpyBeansInConfigSpring34","displayName":"Comment on `@MockitoSpyBean` and `@MockitoBean` in `@Configuration`","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
