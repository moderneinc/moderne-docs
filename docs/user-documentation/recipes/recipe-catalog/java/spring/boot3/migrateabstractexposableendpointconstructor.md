...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot3.MigrateAbstractExposableEndpointConstructor"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot3.MigrateAbstractExposableEndpointConstructor","displayName":"Migrate `AbstractExposableEndpoint` deprecated constructor","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
