...
_Replace deprecated `ConditionOutcome.inverse(ConditionOutcome outcome)` calls with `new ConditionOutcome(!outcome.isMatch(), outcome.getConditionMessage())`._
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot3.ReplaceConditionalOutcomeInverse"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot3.ReplaceConditionalOutcomeInverse" />
