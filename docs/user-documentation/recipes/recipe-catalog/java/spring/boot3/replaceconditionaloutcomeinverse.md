...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot3.ReplaceConditionalOutcomeInverse"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot3.ReplaceConditionalOutcomeInverse","displayName":"Replace ConditionOutcome.inverse() with constructor","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
