...
_`Replace.NONE` is the default value for `@AutoConfigureTestDatabase` since Spring Boot 3.4._
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot3.RemoveReplaceNoneFromAutoConfigureTestDatabase"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot3.RemoveReplaceNoneFromAutoConfigureTestDatabase" />
