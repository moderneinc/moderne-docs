...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot3.RemoveTestRestTemplateEnableRedirectsOptionRecipe"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot3.RemoveTestRestTemplateEnableRedirectsOptionRecipe","displayName":"Remove `TestRestTemplate.HttpClientOption.ENABLE_REDIRECTS` option","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
