...
[GitHub: spring-security-62.yml](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/resources/META-INF/rewrite/spring-security-62.yml),
...
* [Upgrade Gradle or Maven dependency versions](../../../java/dependencies/upgradedependencyversion)
  ...
  * newVersion: `1.2.x`
  * overrideManagedVersion: `false`
* [Convert `HttpSecurity::apply` chained calls into `HttpSecurity::with` Lambda DSL](../../../java/spring/security6/applytowithlambdadsl)
...
<RunRecipe
  recipeName="org.openrewrite.java.spring.security6.UpgradeSpringSecurity_6_2"
  displayName="Migrate to Spring Security 6.2"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.security6.UpgradeSpringSecurity_6_2" />
