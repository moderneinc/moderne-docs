...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.security6.UpdateEnableReactiveMethodSecurity"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/security6/UpdateEnableReactiveMethodSecurity.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.security6.UpdateEnableReactiveMethodSecurity","displayName":"Remove the `useAuthorizationManager=true` attribute from `@EnableReactiveMethodSecurity`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
