---
title: "Convert `OAuth2ResourceServerConfigurer` chained calls into Lambda DSL"
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.security6.oauth2.server.resource.OAuth2ResourceServerLambdaDsl"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/security6/oauth2/server/resource/OAuth2ResourceServerLambdaDsl.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.security6.oauth2.server.resource.OAuth2ResourceServerLambdaDsl","displayName":"Convert `OAuth2ResourceServerConfigurer` chained calls into Lambda DSL","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
