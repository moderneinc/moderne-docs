...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot.IsLikelyNotSpringBoot"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot.IsLikelyNotSpringBoot","displayName":"Is likely not a Spring Boot project","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
