...
_Marks the project if it's likely not a Spring Boot project._
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot.IsLikelyNotSpringBoot"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot.IsLikelyNotSpringBoot" />
