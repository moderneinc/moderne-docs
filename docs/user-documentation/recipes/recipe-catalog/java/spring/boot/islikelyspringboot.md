...
_Marks the project if it's likely a Spring Boot project._
...
<RunRecipe
  recipeName="io.moderne.java.spring.boot.IsLikelySpringBoot"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.boot.IsLikelySpringBoot" />
