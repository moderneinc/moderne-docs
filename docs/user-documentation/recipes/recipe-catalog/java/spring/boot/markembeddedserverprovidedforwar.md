...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot.MarkEmbeddedServerProvidedForWar"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot.MarkEmbeddedServerProvidedForWar","displayName":"Mark embedded server as provided for WAR projects","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
