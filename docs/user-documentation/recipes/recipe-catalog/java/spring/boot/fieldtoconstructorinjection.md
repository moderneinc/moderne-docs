...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.boot.FieldToConstructorInjection"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.boot.FieldToConstructorInjection","displayName":"Convert field injection to constructor injection","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
