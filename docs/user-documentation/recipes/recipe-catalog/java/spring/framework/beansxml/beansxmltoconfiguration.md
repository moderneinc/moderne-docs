...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework.beansxml.BeansXmlToConfiguration"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework.beansxml.BeansXmlToConfiguration","displayName":"Migrate `beans.xml` to Spring Framework configuration class","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
