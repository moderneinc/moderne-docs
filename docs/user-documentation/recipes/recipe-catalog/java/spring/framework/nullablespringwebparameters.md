...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework.NullableSpringWebParameters"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework.NullableSpringWebParameters","displayName":"Add `@Nullable` to optional Spring web parameters","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
