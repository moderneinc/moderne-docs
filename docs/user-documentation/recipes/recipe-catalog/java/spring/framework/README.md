...
* [Jsf23](/user-documentation/recipes/recipe-catalog/java/spring/framework/jsf23)
* [Webxml](/user-documentation/recipes/recipe-catalog/java/spring/framework/webxml)
...
* [Migrate to Spring Framework 5.3 (Moderne Edition)](./upgradespringframework_5_3-moderne-edition.md)
* [Migrate to Spring Framework 5.3 (Community Edition)](./upgradespringframework_5_3-community-edition.md)
* [Migrate to Spring Framework 6.0 (Moderne Edition)](./upgradespringframework_6_0-moderne-edition.md)
...
* [Migrate `HttpHeaders` methods removed when `MultiValueMap` contract was dropped](./migratehttpheadersmultivaluemapmethods.md)
...
* [Replace `ChannelInterceptorAdapter` with `ChannelInterceptor`](./migratechannelinterceptoradapter.md)
