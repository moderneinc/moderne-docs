...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework.IsLikelySpringFramework"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework.IsLikelySpringFramework","displayName":"Is likely a Spring Framework project","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
