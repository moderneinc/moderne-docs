...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework.MigrateHandleErrorMethodInvocations"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework.MigrateHandleErrorMethodInvocations","displayName":"Migrate `handleError` method invocations to new signature","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
