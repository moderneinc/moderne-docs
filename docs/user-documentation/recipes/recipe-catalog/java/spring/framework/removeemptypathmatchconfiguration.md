...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework.RemoveEmptyPathMatchConfiguration"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework.RemoveEmptyPathMatchConfiguration","displayName":"Remove empty path match configuration methods","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
