...
_Folds `setObjectMapper` calls on `MappingJackson2HttpMessageConverter` into the constructor. If the converter is instantiated in the same block with no other invocations, the setter call is replaced with constructor injection. Otherwise, a TODO comment is added._
...
<RunRecipe
  recipeName="io.moderne.java.spring.framework.MigrateConverterSetObjectMapper"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.framework.MigrateConverterSetObjectMapper" />
