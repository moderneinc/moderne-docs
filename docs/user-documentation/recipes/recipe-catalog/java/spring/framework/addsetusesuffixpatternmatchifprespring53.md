...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework.AddSetUseSuffixPatternMatchIfPreSpring53"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework.AddSetUseSuffixPatternMatchIfPreSpring53","displayName":"Add `setUseSuffixPatternMatch(true)` for pre-Spring Framework 5.3 projects","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
