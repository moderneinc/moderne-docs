...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework.JaxRsToSpringWeb"}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"import jakarta.ws.rs.GET;\nimport jakarta.ws.rs.Path;\n\npublic class UserController {\n\n    @GET\n    @Path(\"/users\")\n    public String getUsers() {\n        return \"users\";\n    }\n}\n","after":"import org.springframework.web.bind.annotation.GetMapping;\nimport org.springframework.web.bind.annotation.RestController;\n\n@RestController\npublic class UserController {\n\n    @GetMapping(value = \"/users\")\n    public String getUsers() {\n        return \"users\";\n    }\n}\n","diff":"@@ -1,2 +1,2 @@\n-import jakarta.ws.rs.GET;\n-import jakarta.ws.rs.Path;\n+import org.springframework.web.bind.annotation.GetMapping;\n+import org.springframework.web.bind.annotation.RestController;\n\n@@ -4,0 +4,1 @@\nimport jakarta.ws.rs.Path;\n\n+@RestController\npublic class UserController {\n@@ -6,2 +7,1 @@\npublic class UserController {\n\n-   @GET\n-   @Path(\"/users\")\n+   @GetMapping(value = \"/users\")\n    public String getUsers() {\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"io.moderne.java.spring.framework.JaxRsToSpringWeb","displayName":"Convert JAX-RS annotations to Spring Web","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
