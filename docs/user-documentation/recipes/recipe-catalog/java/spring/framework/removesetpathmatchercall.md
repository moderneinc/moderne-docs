...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework.RemoveSetPathMatcherCall"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework.RemoveSetPathMatcherCall","displayName":"Remove deprecated `setPathMatcher()` calls","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
