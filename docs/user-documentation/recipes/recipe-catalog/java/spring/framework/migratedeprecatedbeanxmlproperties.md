...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.framework.MigrateDeprecatedBeanXmlProperties"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.framework.MigrateDeprecatedBeanXmlProperties","displayName":"Migrate Bean XML properties deprecated in Spring Framework 3.0","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
