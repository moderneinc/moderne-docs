...
<RecipeList recipes={[{"name":"Migrate to Spring Framework 6.1","href":"java/spring/framework/upgradespringframework_6_1"},{"name":"Upgrade Gradle or Maven dependency versions","href":"java/dependencies/upgradedependencyversion"},{"name":"Migrate `org.springframework.util.Base64Utils` to `java.io.Base64`","href":"java/spring/framework/migratebase64utils"},{"name":"Migrate `HandlerResult.hasExceptionHandler()` to `getExceptionHandler()`","href":"java/spring/framework/migratehandlerresulthasexceptionhandlermethod"},{"name":"Migrate `org.springframework.web.reactive.HandlerResult.setExceptionHandler` method","href":"java/spring/framework/migratehandlerresultsetexceptionhandlermethod"},{"name":"Migrate `MethodArgumentNotValidException.errorsToStringList` and `resolveErrorMessages`","href":"java/spring/framework/migratemethodargumentnotvalidexceptionerrormethod"},{"name":"Migrate `ResourceHttpMessageWriter.addHeaders`","href":"java/spring/framework/migrateresourcehttpmessagewriteraddheadersmethod"},{"name":"Migrate deprecated `UriComponentsBuilder` methods","href":"java/spring/framework/migrateuricomponentsbuildermethods"},{"name":"Migrate `WebExchangeBindException.resolveErrorMessages`","href":"java/spring/framework/migratewebexchangebindexceptionresolveerrormethod"},{"name":"Migrate `setConnectTimeout(..)` to ConnectionConfig `setConnectTimeout(..)`","href":"java/spring/framework/httpcomponentsclienthttprequestfactoryconnecttimeout"},{"name":"Replace constant with another constant","href":"java/replaceconstantwithanotherconstant"},{"name":"Replace constant with another constant","href":"java/replaceconstantwithanotherconstant"},{"name":"Change method name","href":"java/changemethodname"},{"name":"Change method name","href":"java/changemethodname"},{"name":"Change type","href":"java/changetype"},{"name":"Change type","href":"java/changetype"}]} preconditions={[{"name":"Singleton","href":"core/singleton"}]}>
