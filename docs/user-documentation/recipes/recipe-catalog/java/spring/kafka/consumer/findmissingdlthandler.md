...
_Flags classes that use `@RetryableTopic` without a corresponding `@DltHandler` method. A DLT handler should be defined to process messages that have exhausted all retries._
...
<RunRecipe
  recipeName="io.moderne.java.spring.kafka.consumer.FindMissingDltHandler"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.spring.kafka.consumer.FindMissingDltHandler" />
