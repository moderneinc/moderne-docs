...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.kafka.consumer.FindKafkaListenerWithoutErrorHandling"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.kafka.consumer.FindKafkaListenerWithoutErrorHandling","displayName":"Find `@KafkaListener` methods without error handling","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
