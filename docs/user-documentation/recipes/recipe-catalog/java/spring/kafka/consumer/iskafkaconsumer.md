...
<RecipeMeta
  ...
  fqName={"io.moderne.java.spring.kafka.consumer.IsKafkaConsumer"}
...
<UsageList usage={{"recipeName":"io.moderne.java.spring.kafka.consumer.IsKafkaConsumer","displayName":"Is likely a Kafka consumer module","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
