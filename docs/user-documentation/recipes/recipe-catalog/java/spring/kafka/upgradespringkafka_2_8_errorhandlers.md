...
**org.openrewrite.java.spring.kafka.UpgradeSpringKafka\_2\_8\_ErrorHandlers**

_Migrate error handlers deprecated in Spring Kafka `2.8.x` to their replacements._
...
## Examples
##### Example 1
`UpgradeSpringKafkaErrorHandlersTest#migratesSeekToCurrentErrorHandler`
...
rewrite {
    activeRecipe("org.openrewrite.java.spring.kafka.UpgradeSpringKafka_2_8_ErrorHandlers")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.spring.kafka.UpgradeSpringKafka_2_8_ErrorHandlers</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.kafka.UpgradeSpringKafka_2_8_ErrorHandlers -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe UpgradeSpringKafka_2_8_ErrorHandlers
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.kafka.UpgradeSpringKafka_2_8_ErrorHandlers" />
