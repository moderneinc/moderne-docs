...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.opentelemetry.MigrateFromZipkinToOpenTelemetry"}
  languages={["Java"]}
...
<RecipeHeader
  ...
  languages={["Java"]}
  tags={["spring","migration","opentelemetry","boot","zipkin"]}
  license={"Moderne Source Available License"}
  fqName={"org.openrewrite.java.spring.opentelemetry.MigrateFromZipkinToOpenTelemetry"}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.opentelemetry.MigrateFromZipkinToOpenTelemetry","displayName":"Migrate from Zipkin to OpenTelemetry OTLP","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
