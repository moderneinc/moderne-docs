...
* [opentracing](/user-documentation/recipes/lists/recipes-by-tag#opentracing)
...
rewrite {
    activeRecipe("org.openrewrite.java.spring.opentelemetry.MigrateOpenTracingToOpenTelemetry")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.spring.opentelemetry.MigrateOpenTracingToOpenTelemetry</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.opentelemetry.MigrateOpenTracingToOpenTelemetry -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe MigrateOpenTracingToOpenTelemetry
```
