...
* [brave](/user-documentation/recipes/lists/recipes-by-tag#brave)
...
rewrite {
    activeRecipe("org.openrewrite.java.spring.opentelemetry.MigrateBraveToOpenTelemetry")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.spring.opentelemetry.MigrateBraveToOpenTelemetry</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.opentelemetry.MigrateBraveToOpenTelemetry -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe MigrateBraveToOpenTelemetry
```
