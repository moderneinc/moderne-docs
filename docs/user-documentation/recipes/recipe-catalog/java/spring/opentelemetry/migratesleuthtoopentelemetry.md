...
* [sleuth](/user-documentation/recipes/lists/recipes-by-tag#sleuth)
...
* [observability](/user-documentation/recipes/lists/recipes-by-tag#observability)
...
<RunRecipe
  recipeName="org.openrewrite.java.spring.opentelemetry.MigrateSleuthToOpenTelemetry"
  displayName="Migrate from Spring Cloud Sleuth to OpenTelemetry"
