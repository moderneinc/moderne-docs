...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.boot2.SpringBoot2JUnit4to5Migration"}
  languages={["Java"]}
...
<RecipeHeader
  ...
  languages={["Java"]}
  tags={["spring","junit","jupiter","test","boot"]}
  license={"Moderne Source Available License"}
  fqName={"org.openrewrite.java.spring.boot2.SpringBoot2JUnit4to5Migration"}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.boot2.SpringBoot2JUnit4to5Migration","displayName":"Migrate Spring Boot 2.x projects to JUnit 5 from JUnit 4","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
