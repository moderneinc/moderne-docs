...
name: org.openrewrite.java.spring.boot2.ConditionalOnBeanAnyNestedConditionBoot1
...
<RunRecipe
  recipeName="org.openrewrite.java.spring.boot2.ConditionalOnBeanAnyNestedConditionBoot1"
  displayName="Migrate multi-condition `@ConditionalOnBean` annotations from Boot 1.x"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.boot2.ConditionalOnBeanAnyNestedConditionBoot1" />
