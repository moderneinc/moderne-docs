...
canonical_url: "https://docs.openrewrite.org/recipes/java/spring/boot2/upgradespringboot_2_1"
---
...
* [Update Gradle wrapper](../../../gradle/updategradlewrapper)
  * version: `^4.4`
  * addIfMissing: `false`
* [Use `RestTemplateBuilder#basicAuthentication`](../../../java/spring/boot2/migrateresttemplatebuilderbasicauthorization)
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.boot2.UpgradeSpringBoot_2_1 -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe UpgradeSpringBoot_2_1
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.boot2.UpgradeSpringBoot_2_1" />
