...
* [Upgrade to Spring Boot 2.5](../../../java/spring/boot2/upgradespringboot_2_5)
...
* [Update a Gradle plugin by id](../../../gradle/plugins/upgradepluginversion)
  ...
  * newVersion: `2.6.x`
* [Migrate from SpringFox Swagger to SpringDoc and OpenAPI](../../../java/springdoc/springfoxtospringdoc)
* [Upgrade Gradle or Maven dependency versions](../../../java/dependencies/upgradedependencyversion)
  * groupId: `org.springdoc`
  * artifactId: `*`
  * newVersion: `1.5.x`
* [Migrate Spring Boot properties to 2.6](../../../java/spring/boot2/springbootproperties_2_6)
* [Upgrade Gradle or Maven dependency versions](../../../java/dependencies/upgradedependencyversion)
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.boot2.UpgradeSpringBoot_2_6 -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.boot2.UpgradeSpringBoot_2_6" />
