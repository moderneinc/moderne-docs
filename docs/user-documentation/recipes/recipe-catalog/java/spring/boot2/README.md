...
* [Search](/user-documentation/recipes/recipe-catalog/java/spring/boot2/search)
...
* [Migrate from Spring Boot 1.x to 2.0 (Community Edition)](./upgradespringboot_2_0-community-edition.md)
...
* [Migrate to Spring Boot 2.0 (Moderne Edition)](./upgradespringboot_2_0-moderne-edition.md)
