...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.boot2.MigrateHttpMessageConvertersPackageName"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.boot2.MigrateHttpMessageConvertersPackageName","displayName":"Use `org.springframework.boot.autoconfigure.http.HttpMessageConverters`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
