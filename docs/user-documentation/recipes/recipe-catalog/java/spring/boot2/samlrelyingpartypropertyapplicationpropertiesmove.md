...
canonical_url: "https://docs.openrewrite.org/recipes/java/spring/boot2/samlrelyingpartypropertyapplicationpropertiesmove"
---
...
[GitHub: SamlRelyingPartyPropertyApplicationPropertiesMove.java](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/boot2/SamlRelyingPartyPropertyApplicationPropertiesMove.java),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.boot2.SamlRelyingPartyPropertyApplicationPropertiesMove -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SamlRelyingPartyPropertyApplicationPropertiesMove
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.boot2.SamlRelyingPartyPropertyApplicationPropertiesMove" />
