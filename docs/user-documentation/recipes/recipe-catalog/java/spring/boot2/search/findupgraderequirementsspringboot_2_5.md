...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.boot2.search.FindUpgradeRequirementsSpringBoot_2_5"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.boot2.search.FindUpgradeRequirementsSpringBoot_2_5","displayName":"Find patterns that require updating for Spring Boot 2.5","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
