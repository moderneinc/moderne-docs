...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.boot2.MigrateActuatorMediaTypeToApiVersion"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/boot2/MigrateActuatorMediaTypeToApiVersion.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.boot2.MigrateActuatorMediaTypeToApiVersion","displayName":"Migrate deprecated `ActuatorMediaType` to `ApiVersion#getProducedMimeType`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
