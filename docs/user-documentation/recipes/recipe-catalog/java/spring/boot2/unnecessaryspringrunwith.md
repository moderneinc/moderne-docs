---
title: "Remove unnecessary Spring `@RunWith`"
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.boot2.UnnecessarySpringRunWith"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.boot2.UnnecessarySpringRunWith","displayName":"Remove unnecessary Spring `@RunWith`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
