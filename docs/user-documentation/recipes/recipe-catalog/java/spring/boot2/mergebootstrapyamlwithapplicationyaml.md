...
<RecipeMeta
  ...
  sourceUrl={"https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/boot2/MergeBootstrapYamlWithApplicationYaml.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.boot2.MergeBootstrapYamlWithApplicationYaml","displayName":"Merge Spring `bootstrap.yml` with `application.yml`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
