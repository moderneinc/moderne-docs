...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.boot2.MaybeAddJavaxValidationApi"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.boot2.MaybeAddJavaxValidationApi","displayName":"Add `javax.validation-api` dependency","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
