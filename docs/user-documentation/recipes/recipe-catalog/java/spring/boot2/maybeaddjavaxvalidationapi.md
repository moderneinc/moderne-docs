...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/spring/boot2/maybeaddjavaxvalidationapi" />
</head>
...
rewrite {
    activeRecipe("org.openrewrite.java.spring.boot2.MaybeAddJavaxValidationApi")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.spring.boot2.MaybeAddJavaxValidationApi</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.boot2.MaybeAddJavaxValidationApi -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe MaybeAddJavaxValidationApi
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.boot2.MaybeAddJavaxValidationApi" />
