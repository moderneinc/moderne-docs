...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/spring/boot2/migrateartemisproperties" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.boot2.MigrateArtemisProperties"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/boot2/MigrateArtemisProperties.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.boot2.MigrateArtemisProperties","displayName":"Migrate `spring.artemis.host` and `spring.artemis.port` to `spring.artemis.broker-url`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
