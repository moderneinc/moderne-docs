...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/spring/deletespringproperty" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.DeleteSpringProperty"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/DeleteSpringProperty.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"propertyKey","value":"server.servlet-path"}],"unchanged":{"language":"mavenProject","code":"project"},"variants":[]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.spring.DeleteSpringProperty","displayName":"Delete a spring configuration property","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":true,"cliOptions":" --recipe-option \"propertyKey=management.endpoint.configprops.*\""}}>
