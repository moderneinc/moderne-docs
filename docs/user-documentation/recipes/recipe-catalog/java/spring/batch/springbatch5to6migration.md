...
[GitHub: spring-batch-6.0.yml](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/resources/META-INF/rewrite/spring-batch-6.0.yml),
...
<RunRecipe
  recipeName="org.openrewrite.java.spring.batch.SpringBatch5To6Migration"
  displayName="Migrate to Spring Batch 6.0 from 5.2"
