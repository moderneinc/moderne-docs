...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/spring/norepoannotationonrepointerface" />
</head>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.NoRepoAnnotationOnRepoInterface -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe NoRepoAnnotationOnRepoInterface
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.NoRepoAnnotationOnRepoInterface" />
