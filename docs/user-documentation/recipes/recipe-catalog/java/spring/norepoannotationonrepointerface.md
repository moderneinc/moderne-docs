...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.spring.NoRepoAnnotationOnRepoInterface"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/NoRepoAnnotationOnRepoInterface.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.spring.NoRepoAnnotationOnRepoInterface","displayName":"Remove unnecessary `@Repository` annotation from Spring Data `Repository` sub-interface","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
