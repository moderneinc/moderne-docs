...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/liberty/migratefromwebspheretoliberty" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.liberty.MigrateFromWebSphereToLiberty"}
  languages={["Java"]}
