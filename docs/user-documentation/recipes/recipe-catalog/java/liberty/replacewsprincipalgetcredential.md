...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.liberty.ReplaceWSPrincipalGetCredential"}
  languages={["Java"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-liberty/blob/main/src/main/java/org/openrewrite/java/liberty/ReplaceWSPrincipalGetCredential.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.liberty.ReplaceWSPrincipalGetCredential","displayName":"Replace `WSPrincipal.getCredential()` with `WSSubject` lookup","groupId":"org.openrewrite.recipe","artifactId":"rewrite-liberty","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LIBERTY","requiresConfiguration":false}}>
