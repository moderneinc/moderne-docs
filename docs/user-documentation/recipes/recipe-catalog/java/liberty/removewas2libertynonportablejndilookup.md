...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.liberty.RemoveWas2LibertyNonPortableJndiLookup"}
  languages={["Java"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-liberty/blob/main/src/main/java/org/openrewrite/java/liberty/RemoveWas2LibertyNonPortableJndiLookup.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.liberty.RemoveWas2LibertyNonPortableJndiLookup","displayName":"Removes invalid JNDI properties","groupId":"org.openrewrite.recipe","artifactId":"rewrite-liberty","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LIBERTY","requiresConfiguration":false}}>
