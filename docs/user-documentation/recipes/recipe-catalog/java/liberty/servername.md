...
<RecipeMeta
  ...
  sourceUrl={"https://github.com/openrewrite/rewrite-liberty/blob/main/src/main/java/org/openrewrite/java/liberty/ServerName.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.liberty.ServerName","displayName":"Use `getProperty(\"wlp.server.name\")`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-liberty","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LIBERTY","requiresConfiguration":false}}>
