...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/liberty/servername" />
</head>
...
[GitHub: ServerName.java](https://github.com/openrewrite/rewrite-liberty/blob/main/src/main/java/org/openrewrite/java/liberty/ServerName.java),
...
* [Migrate from WebSphere traditional to Liberty](/user-documentation/recipes/recipe-catalog/java/liberty/migratefromwebspheretoliberty.md)
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-liberty:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.liberty.ServerName -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.liberty.ServerName" />
