...
<RecipeHeader.Title>Remove elements from a method declaration `throws` clause</RecipeHeader.Title>

<RecipeHeader.Description>Remove specific, or all exceptions from a method declaration `throws` clause.</RecipeHeader.Description>
