...
_When `@Jacksonized` is used, Lombok generates Jackson annotations. By default it generates Jackson 2.x annotations. This recipe adds `lombok.jacksonized.jacksonVersion += 3` to `lombok.config` so Lombok generates Jackson 3 compatible annotations._

## Recipe source

[GitHub: LombokJacksonizedConfig.java](https://github.com/openrewrite/rewrite-jackson/blob/main/src/main/java/org/openrewrite/java/jackson/LombokJacksonizedConfig.java),
...
<RunRecipe
  recipeName="org.openrewrite.java.jackson.LombokJacksonizedConfig"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.jackson.LombokJacksonizedConfig" />
