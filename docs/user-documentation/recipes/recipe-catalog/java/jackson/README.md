...
* [Codehaus](/user-documentation/recipes/recipe-catalog/java/jackson/codehaus)
...
* [Replace `throw new IOException(..)` inside Jackson serializer / deserializer overrides](./replaceioexceptionthrowinjacksonoverrides.md)
...
* [Use `DeserializationContext.readTreeAsValue()` instead of `ObjectCodec.treeToValue()`](./usereadtreeasvalueindeserializer.md)
