...
[GitHub: codehaus-to-fasterxml.yml](https://github.com/openrewrite/rewrite-jackson/blob/main/src/main/resources/META-INF/rewrite/codehaus-to-fasterxml.yml),
...
<RunRecipe
  recipeName="org.openrewrite.java.jackson.CodehausClassesToFasterXML"
  displayName="Migrate classes from Jackson Codehaus (legacy) to Jackson FasterXML"
