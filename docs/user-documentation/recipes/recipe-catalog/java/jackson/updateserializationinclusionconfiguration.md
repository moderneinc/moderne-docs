...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/jackson/updateserializationinclusionconfiguration" />
</head>
...
_In Jackson 3, `mapper.setSerializationInclusion(JsonInclude.Include.NON_NULL)` is no longer supported and should be replaced by `changeDefaultPropertyInclusion()` for both `valueInclusion` and `contentInclusion`._
...
[GitHub: UpdateSerializationInclusionConfiguration.java](https://github.com/openrewrite/rewrite-jackson/blob/main/src/main/java/org/openrewrite/java/jackson/UpdateSerializationInclusionConfiguration.java),
...
rewrite {
    activeRecipe("org.openrewrite.java.jackson.UpdateSerializationInclusionConfiguration")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.jackson.UpdateSerializationInclusionConfiguration</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-jackson:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.jackson.UpdateSerializationInclusionConfiguration -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe UpdateSerializationInclusionConfiguration
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.jackson.UpdateSerializationInclusionConfiguration" />
