...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.jackson.StdDeserializerNullConstructor"}
  languages={["Java"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-jackson/blob/main/src/main/java/org/openrewrite/java/jackson/StdDeserializerNullConstructor.java"}
/>
