...
_Migrate from SpringFox Swagger to SpringDoc and OpenAPI._
...
rewrite {
    activeRecipe("org.openrewrite.java.springdoc.SpringFoxToSpringDoc")
...
```shell title="shell"
mod run . --recipe SpringFoxToSpringDoc
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.springdoc.SpringFoxToSpringDoc" />
