...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/springdoc/cleanupremainingspringfox" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.springdoc.CleanupRemainingSpringfox"}
  languages={["Java"]}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"import springfox.documentation.service.ApiInfo;\n\nclass SwaggerConfig {\n\n    public void publicMethod() {\n    }\n\n    private ApiInfo appInfo() {\n        return new ApiInfo(\"My API\", \"Description\", \"1.0\", \"\", \"\", \"\", \"\");\n    }\n}\n","after":"class SwaggerConfig {\n\n    public void publicMethod() {\n    }\n}\n","diff":"@@ -1,2 +1,0 @@\n-import springfox.documentation.service.ApiInfo;\n-\nclass SwaggerConfig {\n@@ -7,4 +5,0 @@\n    public void publicMethod() {\n    }\n-\n-   private ApiInfo appInfo() {\n-       return new ApiInfo(\"My API\", \"Description\", \"1.0\", \"\", \"\", \"\", \"\");\n-   }\n}\n","newFile":false}]},{"variants":[{"language":"java","before":"import springfox.documentation.service.ApiInfo;\n\nclass SwaggerConfig {\n\n    public void publicMethod() {\n    }\n\n    private ApiInfo appInfo() {\n        return new ApiInfo(\"My API\", \"Description\", \"1.0\", \"\", \"\", \"\", \"\");\n    }\n}\n","after":"class SwaggerConfig {\n\n    public void publicMethod() {\n    }\n}\n","diff":"@@ -1,2 +1,0 @@\n-import springfox.documentation.service.ApiInfo;\n-\nclass SwaggerConfig {\n@@ -7,4 +5,0 @@\n    public void publicMethod() {\n    }\n-\n-   private ApiInfo appInfo() {\n-       return new ApiInfo(\"My API\", \"Description\", \"1.0\", \"\", \"\", \"\", \"\");\n-   }\n}\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.springdoc.CleanupRemainingSpringfox","displayName":"Remove remaining Springfox dead code","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
