...
* [openapi](/user-documentation/recipes/lists/recipes-by-tag#openapi)
* [springdoc](/user-documentation/recipes/lists/recipes-by-tag#springdoc)
* [swagger](/user-documentation/recipes/lists/recipes-by-tag#swagger)
...
rewrite {
    activeRecipe("org.openrewrite.java.springdoc.SwaggerToSpringDoc")
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.springdoc.SwaggerToSpringDoc -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SwaggerToSpringDoc
```
