...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.springdoc.UpgradeSpringDoc_3_0"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.springdoc.UpgradeSpringDoc_3_0","displayName":"Upgrade to SpringDoc 3.0","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
