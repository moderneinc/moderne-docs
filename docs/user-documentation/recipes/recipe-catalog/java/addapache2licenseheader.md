...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/addapache2licenseheader" />
</head>
...
* [oss](/user-documentation/recipes/lists/recipes-by-tag#oss)

## Recipe source

[GitHub: apache-license-header.yml](https://github.com/openrewrite/rewrite/blob/main/rewrite-java/src/main/resources/META-INF/rewrite/apache-license-header.yml),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.java.AddApache2LicenseHeader -Drewrite.exportDatatables=true
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.AddApache2LicenseHeader" />
