...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.ArgumentArrayToVarargs"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-logging-frameworks/blob/main/src/main/java/org/openrewrite/java/logging/ArgumentArrayToVarargs.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.logging.ArgumentArrayToVarargs","displayName":"Unpack Logger method `new Object[] {...}` into varargs","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
