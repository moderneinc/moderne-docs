...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/logging/log4j/commonsloggingtolog4j" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.log4j.CommonsLoggingToLog4j"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.logging.log4j.CommonsLoggingToLog4j","displayName":"Migrate JCL to Log4j 2.x API","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
