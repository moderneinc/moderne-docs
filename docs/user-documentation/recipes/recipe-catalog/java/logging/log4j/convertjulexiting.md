...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.log4j.ConvertJulExiting"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-logging-frameworks/blob/main/src/main/java/org/openrewrite/java/logging/log4j/ConvertJulExiting.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.logging.log4j.ConvertJulExiting","displayName":"Rewrites JUL's Logger#exiting method to Log4j API","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
