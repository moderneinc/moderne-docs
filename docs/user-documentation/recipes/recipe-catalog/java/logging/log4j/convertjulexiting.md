...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/logging/log4j/convertjulexiting" />
</head>
...
_Replaces JUL's Logger#exiting method calls to Log4j API Logger#traceEntry calls._

## Recipe source

[GitHub: ConvertJulExiting.java](https://github.com/openrewrite/rewrite-logging-frameworks/blob/main/src/main/java/org/openrewrite/java/logging/log4j/ConvertJulExiting.java),
...
rewrite {
    activeRecipe("org.openrewrite.java.logging.log4j.ConvertJulExiting")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.logging.log4j.ConvertJulExiting</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-logging-frameworks:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.logging.log4j.ConvertJulExiting -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe ConvertJulExiting
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.logging.log4j.ConvertJulExiting" />
