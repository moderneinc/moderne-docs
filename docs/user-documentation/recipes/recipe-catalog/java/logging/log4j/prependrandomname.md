...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.log4j.PrependRandomName"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-logging-frameworks/blob/main/src/main/java/org/openrewrite/java/logging/log4j/PrependRandomName.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.logging.log4j.PrependRandomName","displayName":"Prepend a random name to each Log4J statement","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
