...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.jboss.LoggerLevelArgumentToMethod"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-logging-frameworks/blob/main/src/main/java/org/openrewrite/java/logging/jboss/LoggerLevelArgumentToMethod.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.logging.jboss.LoggerLevelArgumentToMethod","displayName":"Replace JBoss Logging Level arguments with the corresponding eponymous level method calls","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
