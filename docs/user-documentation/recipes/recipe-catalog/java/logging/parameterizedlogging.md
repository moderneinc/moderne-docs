...
[GitHub: ParameterizedLogging.java](https://github.com/openrewrite/rewrite-logging-frameworks/blob/main/src/main/java/org/openrewrite/java/logging/ParameterizedLogging.java),
...
* [Parameterize Log4j 2.x logging statements](/user-documentation/recipes/recipe-catalog/java/logging/log4j/parameterizedlogging.md)
* [Parameterize SLF4J's logging statements](/user-documentation/recipes/recipe-catalog/java/logging/slf4j/parameterizedlogging.md)
