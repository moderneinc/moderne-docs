...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.slf4j.LoggersNamedForEnclosingClass"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-logging-frameworks/blob/main/src/main/java/org/openrewrite/java/logging/slf4j/LoggersNamedForEnclosingClass.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.logging.slf4j.LoggersNamedForEnclosingClass","displayName":"Loggers should be named for their enclosing classes","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
