...
canonical_url: "https://docs.openrewrite.org/recipes/java/logging/slf4j/loggersnamedforenclosingclass"
---
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-logging-frameworks:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.logging.slf4j.LoggersNamedForEnclosingClass -Drewrite.exportDatatables=true
```
</TabItem>
