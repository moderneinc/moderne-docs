...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/logging/slf4j/slf4jbestpractices" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.slf4j.Slf4jBestPractices"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.logging.slf4j.Slf4jBestPractices","displayName":"SLF4J best practices","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
