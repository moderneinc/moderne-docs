...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.slf4j.Log4j1ToSlf4j1"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.logging.slf4j.Log4j1ToSlf4j1","displayName":"Migrate Log4j 1.x to SLF4J 1.x","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
