...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/logging/slf4j/parameterizedlogging" />
</head>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.logging.slf4j.ParameterizedLogging","displayName":"Parameterize SLF4J's logging statements","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
