...
rewrite {
    activeRecipe("org.openrewrite.java.logging.slf4j.AddJBossLogManagerSlf4jProviderDependency")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.logging.slf4j.AddJBossLogManagerSlf4jProviderDependency</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-logging-frameworks:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.logging.slf4j.AddJBossLogManagerSlf4jProviderDependency -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe AddJBossLogManagerSlf4jProviderDependency
```
