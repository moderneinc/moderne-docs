---
title: "Replace JUL `log(Level, Throwable, Supplier&lt;String&gt;)` with corresponding SLF4J method calls"
...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/logging/slf4j/jultoslf4jlambdasupplierwiththrowablerecipes" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.slf4j.JulToSlf4jLambdaSupplierWithThrowableRecipes"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.logging.slf4j.JulToSlf4jLambdaSupplierWithThrowableRecipes","displayName":"Replace JUL `log(Level, Throwable, Supplier<String>)` with corresponding SLF4J method calls","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
