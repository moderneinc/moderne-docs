...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/logging/slf4j/jbossloggingtoslf4j" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.slf4j.JBossLoggingToSlf4j"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.logging.slf4j.JBossLoggingToSlf4j","displayName":"Migrate JBoss Logging to SLF4J","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
