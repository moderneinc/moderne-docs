...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.slf4j.Slf4jLogShouldBeConstant"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-logging-frameworks/blob/main/src/main/java/org/openrewrite/java/logging/slf4j/Slf4jLogShouldBeConstant.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.logging.slf4j.Slf4jLogShouldBeConstant","displayName":"SLF4J logging statements should begin with constants","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
