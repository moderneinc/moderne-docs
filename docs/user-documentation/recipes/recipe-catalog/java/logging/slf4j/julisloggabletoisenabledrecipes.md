...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/logging/slf4j/julisloggabletoisenabledrecipes" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.slf4j.JulIsLoggableToIsEnabledRecipes"}
  languages={["Java"]}
