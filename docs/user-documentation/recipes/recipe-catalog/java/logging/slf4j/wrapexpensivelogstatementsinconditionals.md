...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/logging/slf4j/wrapexpensivelogstatementsinconditionals" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.slf4j.WrapExpensiveLogStatementsInConditionals"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-logging-frameworks/blob/main/src/main/java/org/openrewrite/java/logging/slf4j/WrapExpensiveLogStatementsInConditionals.java"}
/>
...
<OptionsTable options={[{"type":"String","name":"messageMethod","required":false,"description":"The SLF4J 2.0+ fluent API method that takes the message template: `SET_MESSAGE` passes it to `setMessage(..)` ahead of the arguments, `LOG` passes it to `log(..)` after the arguments. Defaults to `LOG`."}]}>

## Options

</OptionsTable>

<ExampleList examples={[{"parameters":[{"parameter":"messageMethod","value":"null"}],"variants":[{"language":"java","before":"import org.slf4j.Logger;\n\nclass A {\n    void method(Logger logger) {\n        logger.info(\"Result: {}\", calculateResult());\n        logger.info(\"This was {} and {}\", doExpensiveOperation(), \"bar\");\n    }\n\n    String calculateResult() {\n        return \"result\";\n    }\n\n    String doExpensiveOperation() {\n        return \"foo\";\n    }\n}\n","after":"import org.slf4j.Logger;\n\nclass A {\n    void method(Logger logger) {\n        logger.atInfo().addArgument(() -> calculateResult()).log(\"Result: {}\");\n        logger.atInfo().addArgument(() -> doExpensiveOperation()).addArgument(\"bar\").log(\"This was {} and {}\");\n    }\n\n    String calculateResult() {\n        return \"result\";\n    }\n\n    String doExpensiveOperation() {\n        return \"foo\";\n    }\n}\n","diff":"@@ -5,2 +5,2 @@\nclass A {\n    void method(Logger logger) {\n-       logger.info(\"Result: {}\", calculateResult());\n-       logger.info(\"This was {} and {}\", doExpensiveOperation(), \"bar\");\n+       logger.atInfo().addArgument(() -> calculateResult()).log(\"Result: {}\");\n+       logger.atInfo().addArgument(() -> doExpensiveOperation()).addArgument(\"bar\").log(\"This was {} and {}\");\n    }\n","newFile":false}]},{"parameters":[{"parameter":"messageMethod","value":"null"}],"variants":[{"language":"java","before":"import org.slf4j.Logger;\n\nclass A {\n    void method(Logger LOG) {\n        LOG.debug(\"SomeString {}, {}\", \"some param\", expensiveOp());\n    }\n\n    String expensiveOp() {\n        return \"expensive\";\n    }\n}\n","after":"import org.slf4j.Logger;\n\nclass A {\n    void method(Logger LOG) {\n        if (LOG.isDebugEnabled()) {\n            LOG.debug(\"SomeString {}, {}\", \"some param\", expensiveOp());\n        }\n    }\n\n    String expensiveOp() {\n        return \"expensive\";\n    }\n}\n","diff":"@@ -5,1 +5,3 @@\nclass A {\n    void method(Logger LOG) {\n-       LOG.debug(\"SomeString {}, {}\", \"some param\", expensiveOp());\n+       if (LOG.isDebugEnabled()) {\n+           LOG.debug(\"SomeString {}, {}\", \"some param\", expensiveOp());\n+       }\n    }\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.logging.slf4j.WrapExpensiveLogStatementsInConditionals","displayName":"Optimize log statements","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
