...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.logging.ChangeLoggersToPrivate"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-logging-frameworks/blob/main/src/main/java/org/openrewrite/java/logging/ChangeLoggersToPrivate.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.logging.ChangeLoggersToPrivate","displayName":"Change logger fields to `private`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
