...
<RecipeHeader.Title>Change method access level</RecipeHeader.Title>

<RecipeHeader.Description>Change the access level (public, protected, private, package private) of a method.</RecipeHeader.Description>
