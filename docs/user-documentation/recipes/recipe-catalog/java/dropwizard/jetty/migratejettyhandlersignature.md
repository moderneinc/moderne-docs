...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/dropwizard/jetty/migratejettyhandlersignature" />
</head>
...
```shell title="shell"
mod run . --recipe MigrateJettyHandlerSignature
```
