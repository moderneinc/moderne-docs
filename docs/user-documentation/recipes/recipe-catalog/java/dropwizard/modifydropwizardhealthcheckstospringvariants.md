...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/dropwizard/modifydropwizardhealthcheckstospringvariants" />
</head>
...
_Transforms Dropwizard HealthCheck classes to Spring Boot HealthIndicator._
...
* [Change superclass](../../java/dropwizard/method/changesupertype)
...
rewrite {
    activeRecipe("org.openrewrite.java.dropwizard.ModifyDropwizardHealthChecksToSpringVariants")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.dropwizard.ModifyDropwizardHealthChecksToSpringVariants</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-dropwizard:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.dropwizard.ModifyDropwizardHealthChecksToSpringVariants -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe ModifyDropwizardHealthChecksToSpringVariants
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.dropwizard.ModifyDropwizardHealthChecksToSpringVariants" />
