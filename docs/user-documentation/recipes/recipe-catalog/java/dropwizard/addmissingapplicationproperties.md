...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/dropwizard/addmissingapplicationproperties" />
</head>
...
_This recipe creates an application.properties file in the resources folder if it does not exist._
...
rewrite {
    activeRecipe("org.openrewrite.java.dropwizard.AddMissingApplicationProperties")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.dropwizard.AddMissingApplicationProperties</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-dropwizard:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.dropwizard.AddMissingApplicationProperties -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe AddMissingApplicationProperties
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.dropwizard.AddMissingApplicationProperties" />
