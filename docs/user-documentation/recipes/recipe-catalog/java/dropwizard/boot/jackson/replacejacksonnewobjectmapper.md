...
<RecipeMeta
  ...
  fqName={"io.moderne.java.dropwizard.boot.jackson.ReplaceJacksonNewObjectMapper"}
...
<UsageList usage={{"recipeName":"io.moderne.java.dropwizard.boot.jackson.ReplaceJacksonNewObjectMapper","displayName":"Replace `Jackson.newObjectMapper()` with `new ObjectMapper().findAndRegisterModules()`","groupId":"io.moderne.recipe","artifactId":"rewrite-dropwizard","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_DROPWIZARD","requiresConfiguration":false}}>
