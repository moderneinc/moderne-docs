...
<RecipeMeta
  ...
  fqName={"io.moderne.java.dropwizard.boot.datasource.RemoveLifecycleManageCalls"}
...
<UsageList usage={{"recipeName":"io.moderne.java.dropwizard.boot.datasource.RemoveLifecycleManageCalls","displayName":"Remove Dropwizard lifecycle.manage() calls","groupId":"io.moderne.recipe","artifactId":"rewrite-dropwizard","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_DROPWIZARD","requiresConfiguration":false}}>
