...
<RecipeMeta
  ...
  fqName={"io.moderne.java.dropwizard.boot.method.RemoveUnnecessarySuperCalls"}
...
<UsageList usage={{"recipeName":"io.moderne.java.dropwizard.boot.method.RemoveUnnecessarySuperCalls","displayName":"Remove `super` calls when the class does not extend another class","groupId":"io.moderne.recipe","artifactId":"rewrite-dropwizard","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_DROPWIZARD","requiresConfiguration":false}}>
