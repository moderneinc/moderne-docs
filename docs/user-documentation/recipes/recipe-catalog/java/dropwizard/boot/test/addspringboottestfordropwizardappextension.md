...
_Adds `@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)` to test classes that contain a `DropwizardAppExtension` field, when no Spring test annotation is already present._
...
<RunRecipe
  recipeName="io.moderne.java.dropwizard.boot.test.AddSpringBootTestForDropwizardAppExtension"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.dropwizard.boot.test.AddSpringBootTestForDropwizardAppExtension" />
