...
<RecipeMeta
  ...
  fqName={"io.moderne.java.dropwizard.boot.test.DropwizardRulesJUnit4ToSpringBoot"}
...
<UsageList usage={{"recipeName":"io.moderne.java.dropwizard.boot.test.DropwizardRulesJUnit4ToSpringBoot","displayName":"Replace Dropwizard rules with Spring Boot test configuration","groupId":"io.moderne.recipe","artifactId":"rewrite-dropwizard","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_DROPWIZARD","requiresConfiguration":false}}>
