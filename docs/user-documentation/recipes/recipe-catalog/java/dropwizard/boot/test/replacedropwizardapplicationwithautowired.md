---
title: "Replace `DropwizardAppExtension.getApplication()` with `@Autowired` application field"
sidebar_label: "Replace `DropwizardAppExtension.getApplication()` with `@Autowired` application field"
---
...
<RunRecipe
  recipeName="io.moderne.java.dropwizard.boot.test.ReplaceDropwizardApplicationWithAutowired"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.dropwizard.boot.test.ReplaceDropwizardApplicationWithAutowired" />
