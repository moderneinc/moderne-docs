...
<RecipeMeta
  ...
  fqName={"io.moderne.java.dropwizard.boot.test.ReplaceDropwizardApplicationWithAutowired"}
...
<UsageList usage={{"recipeName":"io.moderne.java.dropwizard.boot.test.ReplaceDropwizardApplicationWithAutowired","displayName":"Replace `DropwizardAppExtension.getApplication()` with `@Autowired` application field","groupId":"io.moderne.recipe","artifactId":"rewrite-dropwizard","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_DROPWIZARD","requiresConfiguration":false}}>
