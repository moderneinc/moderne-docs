---
title: "Migrate Dropwizard Application.run() to SpringApplication.run()"
sidebar_label: "Migrate Dropwizard Application.run() to SpringApplication.run()"
hide_title: true
---
...
<RecipeMeta
  ...
  fqName={"io.moderne.java.dropwizard.boot.MigrateApplicationRunMethod"}
...
<UsageList usage={{"recipeName":"io.moderne.java.dropwizard.boot.MigrateApplicationRunMethod","displayName":"Migrate Dropwizard Application.run() to SpringApplication.run()","groupId":"io.moderne.recipe","artifactId":"rewrite-dropwizard","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_DROPWIZARD","requiresConfiguration":false}}>
