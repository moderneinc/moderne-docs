...
<RecipeMeta
  ...
  fqName={"io.moderne.java.dropwizard.boot.annotation.AddClassAnnotationIfSuperTypeExists"}
...
<ExampleList examples={[{"parameters":[{"parameter":"annotationToAdd","value":"javax.persistence.Entity"},{"parameter":"targetSupertypeName","value":"java.util.AbstractList"},{"parameter":"annotateInnerClasses","value":"false"}],"variants":[{"language":"java","before":"import java.util.AbstractList;\n\npublic class CustomList extends AbstractList<String> {\n    @Override\n    public String get(int index) {\n        return null;\n    }\n\n    @Override\n    public int size() {\n        return 0;\n    }\n}\n","after":"import javax.persistence.Entity;\n\nimport java.util.AbstractList;\n\n@Entity\npublic class CustomList extends AbstractList<String> {\n    @Override\n    public String get(int index) {\n        return null;\n    }\n\n    @Override\n    public int size() {\n        return 0;\n    }\n}\n","diff":"@@ -1,0 +1,2 @@\n+import javax.persistence.Entity;\n+\nimport java.util.AbstractList;\n@@ -3,0 +5,1 @@\nimport java.util.AbstractList;\n\n+@Entity\npublic class CustomList extends AbstractList<String> {\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"io.moderne.java.dropwizard.boot.annotation.AddClassAnnotationIfSuperTypeExists","displayName":"Add annotation if target supertype exists","groupId":"io.moderne.recipe","artifactId":"rewrite-dropwizard","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_DROPWIZARD","requiresConfiguration":true,"cliOptions":" --recipe-option \"annotationToAdd=org.springframework.stereotype.Component\" --recipe-option \"targetSupertypeName=javax.ws.rs.Path\""}}>
