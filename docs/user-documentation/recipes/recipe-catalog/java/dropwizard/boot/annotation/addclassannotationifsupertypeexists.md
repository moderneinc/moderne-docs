---
title: "Add annotation if target supertype exists"
sidebar_label: "Add annotation if target supertype exists"
---
...
_Adds an annotation to a class if it extends or implements a specified target type._
...
| `String` | targetSupertypeName | The supertype that should be looked for. | `javax.ws.rs.Path` |
| `Boolean` | annotateInnerClasses | *Optional*. Whether to also annotate inner classes of the matched class |  |
...
displayName: Add annotation if target supertype exists example
recipeList:
  - io.moderne.java.dropwizard.boot.annotation.AddClassAnnotationIfSuperTypeExists:
...
<RunRecipe
  recipeName="io.moderne.java.dropwizard.boot.annotation.AddClassAnnotationIfSuperTypeExists"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.dropwizard.boot.annotation.AddClassAnnotationIfSuperTypeExists" />
