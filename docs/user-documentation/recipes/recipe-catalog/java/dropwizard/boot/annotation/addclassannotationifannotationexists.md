...
_Adds an annotation to a class if it already has a specified target annotation._
...
| `String` | targetAnnotationClassName | The annotation that should be looked for. | `javax.ws.rs.Path` |
...
displayName: Add annotation if target annotation exists example
recipeList:
  - io.moderne.java.dropwizard.boot.annotation.AddClassAnnotationIfAnnotationExists:
...
<RunRecipe
  recipeName="io.moderne.java.dropwizard.boot.annotation.AddClassAnnotationIfAnnotationExists"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.java.dropwizard.boot.annotation.AddClassAnnotationIfAnnotationExists" />
