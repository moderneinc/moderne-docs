...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/dropwizard/addhibernateconfiguration" />
</head>
...
<RunRecipe
  recipeName="org.openrewrite.java.dropwizard.AddHibernateConfiguration"
  displayName="Add Hibernate Configuration"
