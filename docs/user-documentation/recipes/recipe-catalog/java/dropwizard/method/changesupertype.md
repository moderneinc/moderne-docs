...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/dropwizard/method/changesupertype" />
</head>
...
[GitHub: ChangeSuperType.java](https://github.com/openrewrite/rewrite-dropwizard/blob/main/src/main/java/org/openrewrite/java/dropwizard/method/ChangeSuperType.java),
...
Now that `com.yourorg.ChangeSuperTypeExample` has been defined, activate it and take a dependency on `org.openrewrite.recipe:rewrite-dropwizard:{{VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_DROPWIZARD}}` in your build file:
