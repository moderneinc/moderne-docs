...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/dropwizard/migratedropwizardtospringboot" />
</head>
...
<RunRecipe
  recipeName="org.openrewrite.java.dropwizard.MigrateDropwizardToSpringBoot"
  displayName="Migrate Dropwizard to Spring Boot"
