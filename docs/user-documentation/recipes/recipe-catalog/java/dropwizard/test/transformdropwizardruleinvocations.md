...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/dropwizard/test/transformdropwizardruleinvocations" />
</head>
...
```shell title="shell"
mod run . --recipe TransformDropwizardRuleInvocations
```
