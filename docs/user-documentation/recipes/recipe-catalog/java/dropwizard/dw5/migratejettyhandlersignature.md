...
<RecipeMeta
  ...
  fqName={"io.moderne.java.dropwizard.dw5.MigrateJettyHandlerSignature"}
...
<UsageList usage={{"recipeName":"io.moderne.java.dropwizard.dw5.MigrateJettyHandlerSignature","displayName":"Migrate Jetty `AbstractHandler` to Jetty 12 `Handler.Abstract`","groupId":"io.moderne.recipe","artifactId":"rewrite-dropwizard","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_DROPWIZARD","requiresConfiguration":false}}>
