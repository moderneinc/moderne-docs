---
sidebar_label: "Migrate Hibernate"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/dropwizard/migratehibernate" />
</head>
...
* [Add annotation if target supertypes exist](../../java/dropwizard/annotation/addclassannotationifsupertypeexists)
  ...
  * targetSupertypeName: `io.dropwizard.hibernate.AbstractDAO`
* [Add Hibernate Configuration](../../java/dropwizard/addhibernateconfiguration)
...
rewrite {
    activeRecipe("org.openrewrite.java.dropwizard.MigrateHibernate")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.dropwizard.MigrateHibernate</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-dropwizard:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.dropwizard.MigrateHibernate -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe MigrateHibernate
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.dropwizard.MigrateHibernate" />
