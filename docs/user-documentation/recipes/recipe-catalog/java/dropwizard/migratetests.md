...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/dropwizard/migratetests" />
</head>
...
_Converts Dropwizard tests to Spring Boot format._
...
rewrite {
    activeRecipe("org.openrewrite.java.dropwizard.MigrateTests")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.dropwizard.MigrateTests</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-dropwizard:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.dropwizard.MigrateTests -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.dropwizard.MigrateTests" />
