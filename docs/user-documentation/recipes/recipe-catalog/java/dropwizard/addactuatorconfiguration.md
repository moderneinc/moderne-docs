---
sidebar_label: "Add Spring Boot Actuator Configuration"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/dropwizard/addactuatorconfiguration" />
</head>
...
_Configures Spring Boot Actuator endpoints and health checks in application.properties._
...
* [Add Spring Boot Actuator](/user-documentation/recipes/recipe-catalog/java/dropwizard/migratehealthchecksandmetrics.md)
...
rewrite {
    activeRecipe("org.openrewrite.java.dropwizard.AddActuatorConfiguration")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.dropwizard.AddActuatorConfiguration</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-dropwizard:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.dropwizard.AddActuatorConfiguration -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe AddActuatorConfiguration
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.dropwizard.AddActuatorConfiguration" />
