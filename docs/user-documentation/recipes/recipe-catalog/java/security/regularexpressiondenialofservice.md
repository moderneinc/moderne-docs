...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.RegularExpressionDenialOfService"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.RegularExpressionDenialOfService","displayName":"Regular Expression Denial of Service (ReDOS)","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
