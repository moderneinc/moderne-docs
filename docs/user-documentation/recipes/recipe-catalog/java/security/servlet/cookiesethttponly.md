...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.servlet.CookieSetHttpOnly"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.servlet.CookieSetHttpOnly","displayName":"Cookies missing HttpOnly flag","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
