...
_Finds calls to `ScriptEngine.eval()` which can execute arbitrary code if the script string is influenced by user input. Consider sandboxing or removing dynamic script evaluation._

### Tags

* [security](/user-documentation/recipes/lists/recipes-by-tag#security)
* [CWE-95](/user-documentation/recipes/lists/recipes-by-tag#cwe)
* [CWE-94](/user-documentation/recipes/lists/recipes-by-tag#cwe)
...
<RunRecipe
  recipeName="org.openrewrite.java.security.search.FindScriptEngineInjection"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.security.search.FindScriptEngineInjection" />
