...
_Flags any call to `User.withDefaultPasswordEncoder()` from Spring Security. The factory is documented as for non-production demos only: it stores credentials in memory with a fixed encoder and is unsafe for real workloads._
...
<RunRecipe
  recipeName="org.openrewrite.java.security.search.FindUserWithDefaultPasswordEncoder"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.security.search.FindUserWithDefaultPasswordEncoder" />
