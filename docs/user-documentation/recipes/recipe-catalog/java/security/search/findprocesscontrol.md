...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.search.FindProcessControl"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.search.FindProcessControl","displayName":"Find process control vectors","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
