...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.search.FindUnsafeReflection","displayName":"Find unsafe reflection vectors","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
