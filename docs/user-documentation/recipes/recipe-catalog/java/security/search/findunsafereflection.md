...
_Finds calls to `Class.forName()` which, when the class name is derived from user input, can allow an attacker to instantiate arbitrary classes. Review these call sites to ensure the class name is not externally controlled._
...
<RunRecipe
  recipeName="org.openrewrite.java.security.search.FindUnsafeReflection"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.security.search.FindUnsafeReflection" />
