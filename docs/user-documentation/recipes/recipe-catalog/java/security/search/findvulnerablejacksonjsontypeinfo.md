...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.search.FindVulnerableJacksonJsonTypeInfo"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.search.FindVulnerableJacksonJsonTypeInfo","displayName":"Find vulnerable uses of Jackson `@JsonTypeInfo`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
