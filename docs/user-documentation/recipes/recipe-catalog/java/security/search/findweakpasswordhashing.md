...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.search.FindWeakPasswordHashing"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.search.FindWeakPasswordHashing","displayName":"Find weak password hashing","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
