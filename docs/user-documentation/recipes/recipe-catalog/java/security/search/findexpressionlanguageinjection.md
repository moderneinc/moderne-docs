...
_Finds calls to Expression Language (EL) evaluation methods which, when the expression is built from user input, can allow arbitrary code execution. Use parameterized expressions or input validation instead._

### Tags

* [security](/user-documentation/recipes/lists/recipes-by-tag#security)
* [CWE-917](/user-documentation/recipes/lists/recipes-by-tag#cwe)
...
<RunRecipe
  recipeName="org.openrewrite.java.security.search.FindExpressionLanguageInjection"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.security.search.FindExpressionLanguageInjection" />
