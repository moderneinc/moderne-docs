...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.search.FindInsecureSessionFixationConfig"}
  languages={["Java"]}
...
<RecipeHeader
  type={"Single recipe"}
  languages={["Java"]}
  tags={["security","CWE-384","RSPEC-S5876"]}
  license={"Moderne Proprietary License"}
  fqName={"org.openrewrite.java.security.search.FindInsecureSessionFixationConfig"}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.search.FindInsecureSessionFixationConfig","displayName":"Find Spring Security configurations that disable session fixation protection","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
