...
_Finds construction or parsing of Nimbus `PlainJWT` — an unsecured JWT that has no signature or MAC. Unsecured JWTs allow an attacker to forge tokens because their payloads are not integrity-protected. Use a signed (`SignedJWT`) or encrypted (`EncryptedJWT`) JWT instead._

### Tags

* [security](/user-documentation/recipes/lists/recipes-by-tag#security)
* [CWE-347](/user-documentation/recipes/lists/recipes-by-tag#cwe)
...
<RunRecipe
  recipeName="org.openrewrite.java.security.search.FindUnsignedJwt"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.security.search.FindUnsignedJwt" />
