...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.search.FindPredictableSalt"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.search.FindPredictableSalt","displayName":"Find predictable cryptographic salts","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
