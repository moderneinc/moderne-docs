...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.search.FindHttpResponseSplitting"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.search.FindHttpResponseSplitting","displayName":"Find HTTP response splitting vectors","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
