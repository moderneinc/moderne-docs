...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.search.FindSqlInjection"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.search.FindSqlInjection","displayName":"Find potential SQL injection","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
