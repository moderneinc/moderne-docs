...
_Finds `IvParameterSpec` constructed with hardcoded byte arrays or string literals. A static IV makes CBC and other modes deterministic, enabling chosen-plaintext attacks. IVs should be generated randomly using `SecureRandom` for each encryption operation._
...
<RunRecipe
  recipeName="org.openrewrite.java.security.search.FindHardcodedIv"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.security.search.FindHardcodedIv" />
