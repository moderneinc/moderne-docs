...
_Finds Spring Security `BCryptPasswordEncoder` instantiations with a strength (work factor) below 10. The default and OWASP-recommended minimum is 10; lower values make stolen password hashes substantially cheaper to brute-force._

### Tags

* [CWE-521](/user-documentation/recipes/lists/recipes-by-tag#cwe)
...
<RunRecipe
  recipeName="org.openrewrite.java.security.search.FindWeakPasswordEncoderStrength"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.security.search.FindWeakPasswordEncoderStrength" />
