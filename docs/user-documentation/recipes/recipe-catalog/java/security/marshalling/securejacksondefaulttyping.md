...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.marshalling.SecureJacksonDefaultTyping"}
  languages={["Java"]}
...
<RecipeHeader
  type={"Single recipe"}
  languages={["Java"]}
  tags={["CWE-502","CWE-94","RSPEC-S4544"]}
  license={"Moderne Proprietary License"}
  fqName={"org.openrewrite.java.security.marshalling.SecureJacksonDefaultTyping"}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.marshalling.SecureJacksonDefaultTyping","displayName":"Secure the use of Jackson default typing","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
