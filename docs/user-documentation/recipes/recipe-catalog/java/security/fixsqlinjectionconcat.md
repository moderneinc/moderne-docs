...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.FixSqlInjectionConcat","displayName":"Replace SQL string concatenation with a `PreparedStatement`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
