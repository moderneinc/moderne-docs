...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.FindTextDirectionChanges"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.FindTextDirectionChanges","displayName":"Find text-direction changes","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
