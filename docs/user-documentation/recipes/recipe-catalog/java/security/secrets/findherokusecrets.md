...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.secrets.FindHerokuSecrets"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.secrets.FindHerokuSecrets","displayName":"Find Heroku secrets","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
