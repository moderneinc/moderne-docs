...
_Locates HTTP Basic authentication credentials stored in plain text in code._
...
## Examples
##### Example 1
`FindBasicAuthSecretsTest#findBasicAuthHeaderInJavaLiteral`
...
<RunRecipe
  recipeName="org.openrewrite.java.security.secrets.FindBasicAuthSecrets"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.security.secrets.FindBasicAuthSecrets" />
