---
title: "Find Bearer token secrets"
sidebar_label: "Find Bearer token secrets"
hide_title: true
---
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.secrets.FindBearerTokenSecrets"}
  languages={["Java"]}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"class Test {\n    void request() {\n        String header = \"Bearer sample-token\";\n        String notSecret = \"application/json\";\n    }\n}\n","after":"class Test {\n    void request() {\n        String header = /*~~(Bearer token)~~>*/\"Bearer sample-token\";\n        String notSecret = \"application/json\";\n    }\n}\n","diff":"@@ -3,1 +3,1 @@\nclass Test {\n    void request() {\n-       String header = \"Bearer sample-token\";\n+       String header = /*~~(Bearer token)~~>*/\"Bearer sample-token\";\n        String notSecret = \"application/json\";\n","newFile":false}]},{"variants":[{"language":"java","before":"class Test {\n    void request() {\n        String header = \"Bearer sample-token\";\n        String notSecret = \"application/json\";\n    }\n}\n","after":"class Test {\n    void request() {\n        String header = /*~~(Bearer token)~~>*/\"Bearer sample-token\";\n        String notSecret = \"application/json\";\n    }\n}\n","diff":"@@ -3,1 +3,1 @@\nclass Test {\n    void request() {\n-       String header = \"Bearer sample-token\";\n+       String header = /*~~(Bearer token)~~>*/\"Bearer sample-token\";\n        String notSecret = \"application/json\";\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.security.secrets.FindBearerTokenSecrets","displayName":"Find Bearer token secrets","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
