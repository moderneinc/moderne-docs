...
<RecipeHeader.Title>Find GitHub secrets</RecipeHeader.Title>

<RecipeHeader.Description>Locates GitHub secrets stored in plain text in code.</RecipeHeader.Description>
