...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.secrets.FindSlackSecrets"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.secrets.FindSlackSecrets","displayName":"Find Slack secrets","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
