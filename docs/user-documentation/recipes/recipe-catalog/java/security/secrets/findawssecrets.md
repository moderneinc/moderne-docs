...
<RecipeHeader.Title>Find AWS secrets</RecipeHeader.Title>

<RecipeHeader.Description>Locates AWS secrets stored in plain text in code.</RecipeHeader.Description>
