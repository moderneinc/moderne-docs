...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.security.SecureTempFileCreation"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.security.SecureTempFileCreation","displayName":"Use secure temporary file creation","groupId":"org.openrewrite.recipe","artifactId":"rewrite-java-security","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_JAVA_SECURITY","requiresConfiguration":false}}>
