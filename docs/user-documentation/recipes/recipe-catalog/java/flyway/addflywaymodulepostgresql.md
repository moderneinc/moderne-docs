...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.flyway.AddFlywayModulePostgreSQL"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.flyway.AddFlywayModulePostgreSQL","displayName":"Add missing Flyway module for PostgreSQL","groupId":"org.openrewrite.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
