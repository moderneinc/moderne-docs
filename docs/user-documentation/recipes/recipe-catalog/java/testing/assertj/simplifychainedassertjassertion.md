...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/testing/assertj/simplifychainedassertjassertion" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.testing.assertj.SimplifyChainedAssertJAssertion"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/assertj/SimplifyChainedAssertJAssertion.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"chainedAssertion","value":"isEmpty"},{"parameter":"assertToReplace","value":"isTrue"},{"parameter":"dedicatedAssertion","value":"isEmpty"},{"parameter":"requiredType","value":"java.lang.String"}],"variants":[{"language":"java","before":"import static org.assertj.core.api.Assertions.assertThat;\n\nclass MyTest {\n    void testMethod() {\n        assertThat(\"hello world\".isEmpty()).isTrue();\n    }\n}\n","after":"import static org.assertj.core.api.Assertions.assertThat;\n\nclass MyTest {\n    void testMethod() {\n        assertThat(\"hello world\").isEmpty();\n    }\n}\n","diff":"@@ -5,1 +5,1 @@\nclass MyTest {\n    void testMethod() {\n-       assertThat(\"hello world\".isEmpty()).isTrue();\n+       assertThat(\"hello world\").isEmpty();\n    }\n","newFile":false}]}]}>
