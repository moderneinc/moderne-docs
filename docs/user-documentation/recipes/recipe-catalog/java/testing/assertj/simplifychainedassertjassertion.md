...
* [Simplify AssertJ chained assertions](/user-documentation/recipes/recipe-catalog/java/testing/assertj/simplifychainedassertjassertions.md)
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-testing-frameworks:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.testing.assertj.SimplifyChainedAssertJAssertion -Drewrite.exportDatatables=true
```
</TabItem>
