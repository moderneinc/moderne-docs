...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.testing.assertj.SimplifyStreamMapToExtracting"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/assertj/SimplifyStreamMapToExtracting.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.testing.assertj.SimplifyStreamMapToExtracting","displayName":"Simplify `assertThat(collection.stream().map(...))` to `assertThat(collection).extracting(...)`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-testing-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TESTING_FRAMEWORKS","requiresConfiguration":false}}>
