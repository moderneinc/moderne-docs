...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/testing/assertj/simplifyassertjassertions" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.testing.assertj.SimplifyAssertJAssertions"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.testing.assertj.SimplifyAssertJAssertions","displayName":"Shorten AssertJ assertions","groupId":"org.openrewrite.recipe","artifactId":"rewrite-testing-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TESTING_FRAMEWORKS","requiresConfiguration":false}}>
