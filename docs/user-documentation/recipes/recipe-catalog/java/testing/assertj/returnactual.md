...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/testing/assertj/returnactual" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.testing.assertj.ReturnActual"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/assertj/ReturnActual.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.testing.assertj.ReturnActual","displayName":"Collapse `assertThat` followed by `return` into single statement","groupId":"org.openrewrite.recipe","artifactId":"rewrite-testing-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TESTING_FRAMEWORKS","requiresConfiguration":false}}>
