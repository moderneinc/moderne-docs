...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/testing/mockito/powermockwhiteboxtojavareflection" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.testing.mockito.PowerMockWhiteboxToJavaReflection"}
  languages={["Java"]}
