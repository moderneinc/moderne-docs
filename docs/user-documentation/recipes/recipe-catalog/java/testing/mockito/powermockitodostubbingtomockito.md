...
_Replaces PowerMockito's private method stubbing pattern `doNothing().when(instance, "methodName", args...)` with the standard Mockito pattern `doNothing().when(instance).methodName(args...)`._

## Recipe source

[GitHub: PowerMockitoDoStubbingToMockito.java](https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/mockito/PowerMockitoDoStubbingToMockito.java),
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.testing.mockito.PowerMockitoDoStubbingToMockito" />
