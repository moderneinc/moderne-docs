---
title: "Replace Mockito 1.x `anyString()`/`any()` with `nullable(Class)`"
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.testing.mockito.AnyToNullable"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/mockito/AnyToNullable.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.testing.mockito.AnyToNullable","displayName":"Replace Mockito 1.x `anyString()`/`any()` with `nullable(Class)`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-testing-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TESTING_FRAMEWORKS","requiresConfiguration":false}}>
