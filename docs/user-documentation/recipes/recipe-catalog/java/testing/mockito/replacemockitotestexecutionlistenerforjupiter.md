...
_Replace `MockitoTestExecutionListener` in projects that have JUnit Jupiter as a dependency. Uses `@ExtendWith(MockitoExtension.class)` as the replacement._
...
<RunRecipe
  recipeName="org.openrewrite.java.testing.mockito.ReplaceMockitoTestExecutionListenerForJupiter"
  displayName="Replace `MockitoTestExecutionListener` (JUnit Jupiter projects)"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.testing.mockito.ReplaceMockitoTestExecutionListenerForJupiter" />
