...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/testing/mockito/removepowermockclassextensions" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.testing.mockito.RemovePowerMockClassExtensions"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/mockito/RemovePowerMockClassExtensions.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.testing.mockito.RemovePowerMockClassExtensions","displayName":"Remove PowerMock class extensions","groupId":"org.openrewrite.recipe","artifactId":"rewrite-testing-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TESTING_FRAMEWORKS","requiresConfiguration":false}}>
