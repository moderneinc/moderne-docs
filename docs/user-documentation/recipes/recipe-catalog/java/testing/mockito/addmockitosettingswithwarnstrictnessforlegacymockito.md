...
* [Add `@MockitoSettings(strictness = Strictness.WARN)` to `@ExtendWith(MockitoExtension.class)` classes](../../../java/testing/mockito/addmockitosettingswithwarnstrictness)
...
name: org.openrewrite.java.testing.mockito.AddMockitoSettingsWithWarnStrictnessForLegacyMockito
...
<RunRecipe
  recipeName="org.openrewrite.java.testing.mockito.AddMockitoSettingsWithWarnStrictnessForLegacyMockito"
  displayName="Add `@MockitoSettings(strictness = Strictness.WARN)` for legacy Mockito modules"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.testing.mockito.AddMockitoSettingsWithWarnStrictnessForLegacyMockito" />
