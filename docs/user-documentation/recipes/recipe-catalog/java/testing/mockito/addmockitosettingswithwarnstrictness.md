...
* [Add `@MockitoSettings(strictness = Strictness.WARN)` for legacy Mockito modules](/user-documentation/recipes/recipe-catalog/java/testing/mockito/addmockitosettingswithwarnstrictnessforlegacymockito.md)
