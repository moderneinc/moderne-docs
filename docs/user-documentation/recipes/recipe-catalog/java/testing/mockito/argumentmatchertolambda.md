...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/testing/mockito/argumentmatchertolambda" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.testing.mockito.ArgumentMatcherToLambda"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/mockito/ArgumentMatcherToLambda.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.testing.mockito.ArgumentMatcherToLambda","displayName":"Convert `ArgumentMatcher<T>` anonymous class to lambda","groupId":"org.openrewrite.recipe","artifactId":"rewrite-testing-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TESTING_FRAMEWORKS","requiresConfiguration":false}}>
