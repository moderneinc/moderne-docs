...
* [testng](/user-documentation/recipes/lists/recipes-by-tag#testng)

## Recipe source

[GitHub: testng.yml](https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/resources/META-INF/rewrite/testng.yml),
...
<RunRecipe
  recipeName="org.openrewrite.java.testing.testng.TestNgToAssertj"
  displayName="Migrate TestNG assertions to AssertJ"
