...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/testing/testng/testngtoassertj" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.testing.testng.TestNgToAssertj"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/resources/META-INF/rewrite/testng.yml"}
/>

<RecipeHeader
  type={"Composite recipe"}
  languages={["Java"]}
  tags={["testng","assertj","testing"]}
  license={"Moderne Source Available License"}
  fqName={"org.openrewrite.java.testing.testng.TestNgToAssertj"}
