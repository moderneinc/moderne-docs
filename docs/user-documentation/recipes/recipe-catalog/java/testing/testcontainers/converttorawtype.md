...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.testing.testcontainers.ConvertToRawType"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/testcontainers/ConvertToRawType.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.testing.testcontainers.ConvertToRawType","displayName":"Remove parameterized type arguments from a Java class","groupId":"org.openrewrite.recipe","artifactId":"rewrite-testing-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TESTING_FRAMEWORKS","requiresConfiguration":true,"cliOptions":" --recipe-option \"fullyQualifiedTypeName=org.testcontainers.containers.PostgreSQLContainer\""}}>
