...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/testing/testcontainers/explicitcontainerimage" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.testing.testcontainers.ExplicitContainerImage"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/testcontainers/ExplicitContainerImage.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"containerClass","value":"org.testcontainers.containers.NginxContainer"},{"parameter":"image","value":"nginx:1.9.4"},{"parameter":"parseImage","value":"null"}],"variants":[{"language":"java","before":"import org.testcontainers.containers.NginxContainer;\nclass Foo {\n    NginxContainer container = new NginxContainer();\n}\n","after":"import org.testcontainers.containers.NginxContainer;\nclass Foo {\n    NginxContainer container = new NginxContainer(\"nginx:1.9.4\");\n}\n","diff":"@@ -3,1 +3,1 @@\nimport org.testcontainers.containers.NginxContainer;\nclass Foo {\n-   NginxContainer container = new NginxContainer();\n+   NginxContainer container = new NginxContainer(\"nginx:1.9.4\");\n}\n","newFile":false}]}]}>
