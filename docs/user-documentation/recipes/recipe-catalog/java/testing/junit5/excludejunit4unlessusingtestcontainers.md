...
rewrite {
    activeRecipe("org.openrewrite.java.testing.junit5.ExcludeJUnit4UnlessUsingTestcontainers")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.testing.junit5.ExcludeJUnit4UnlessUsingTestcontainers</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-testing-frameworks:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.testing.junit5.ExcludeJUnit4UnlessUsingTestcontainers -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe ExcludeJUnit4UnlessUsingTestcontainers
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.testing.junit5.ExcludeJUnit4UnlessUsingTestcontainers" />
