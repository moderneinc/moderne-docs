...
[GitHub: TimeoutRuleToClassAnnotation.java](https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/junit5/TimeoutRuleToClassAnnotation.java),
