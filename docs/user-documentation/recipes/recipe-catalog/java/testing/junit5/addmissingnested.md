...
<RecipeMeta
  ...
  sourceUrl={"https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/junit5/AddMissingNested.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.testing.junit5.AddMissingNested","displayName":"JUnit 5 inner test classes should be annotated with `@Nested`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-testing-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TESTING_FRAMEWORKS","requiresConfiguration":false}}>
