...
canonical_url: "https://docs.openrewrite.org/recipes/java/testing/junit5/assertthrowsonlaststatement"
---
...
rewrite {
    activeRecipe("org.openrewrite.java.testing.junit5.AssertThrowsOnLastStatement")
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-testing-frameworks:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.testing.junit5.AssertThrowsOnLastStatement -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe AssertThrowsOnLastStatement
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.testing.junit5.AssertThrowsOnLastStatement" />
