...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.testing.junit5.RemoveTryCatchFailBlocks"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/junit5/RemoveTryCatchFailBlocks.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.testing.junit5.RemoveTryCatchFailBlocks","displayName":"Replace `fail()` in `try-catch` blocks with `Assertions.assertDoesNotThrow(() -> { ... })`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-testing-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TESTING_FRAMEWORKS","requiresConfiguration":false}}>
