...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.testing.truth.TruthThrowableAssertions"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/truth/TruthThrowableAssertions.java"}
/>
