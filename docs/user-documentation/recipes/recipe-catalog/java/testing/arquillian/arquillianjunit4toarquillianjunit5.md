...
* [arquillian](/user-documentation/recipes/lists/recipes-by-tag#arquillian)

## Recipe source

[GitHub: arquillian.yml](https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/resources/META-INF/rewrite/arquillian.yml),
...
## Examples
##### Example 1
`ArquillianJUnit4ToArquillianJunit5Test#convert`
