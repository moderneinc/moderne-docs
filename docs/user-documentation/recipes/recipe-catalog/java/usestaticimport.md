...
<RecipeHeader.Title>Use static import</RecipeHeader.Title>

<RecipeHeader.Description>Removes unnecessary receiver types from static method invocations. For example, `Collections.emptyList()` becomes `emptyList()`.</RecipeHeader.Description>
