...
_Update `xwork-validator` DTD from 1.0.3 to 1.0.4 for Struts 6 compatibility._
...
<TabItem value="UserAction-validation.xml" label="UserAction-validation.xml">


###### Before
```xml title="UserAction-validation.xml"
...
<RunRecipe
  recipeName="org.openrewrite.java.struts.migrate6.MigrateValidatorDtd"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.struts.migrate6.MigrateValidatorDtd" />
