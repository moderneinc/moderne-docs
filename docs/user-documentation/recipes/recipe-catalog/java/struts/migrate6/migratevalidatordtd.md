...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.struts.migrate6.MigrateValidatorDtd"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.struts.migrate6.MigrateValidatorDtd","displayName":"Migrate `xwork-validator` DTD to 1.0.4","groupId":"org.openrewrite.recipe","artifactId":"rewrite-struts","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STRUTS","requiresConfiguration":false}}>
