...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.struts.migrate6.RemoveFreemarkerHtmlBuiltin"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.struts.migrate6.RemoveFreemarkerHtmlBuiltin","displayName":"Remove deprecated Freemarker `?html` built-in","groupId":"org.openrewrite.recipe","artifactId":"rewrite-struts","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STRUTS","requiresConfiguration":false}}>
