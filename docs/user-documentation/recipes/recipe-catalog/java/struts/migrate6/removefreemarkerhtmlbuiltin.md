...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/struts/migrate6/removefreemarkerhtmlbuiltin" />
</head>
...
name: org.openrewrite.java.struts.migrate6.RemoveFreemarkerHtmlBuiltin
...
rewrite {
    activeRecipe("org.openrewrite.java.struts.migrate6.RemoveFreemarkerHtmlBuiltin")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.struts.migrate6.RemoveFreemarkerHtmlBuiltin</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-struts:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.struts.migrate6.RemoveFreemarkerHtmlBuiltin -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe RemoveFreemarkerHtmlBuiltin
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.struts.migrate6.RemoveFreemarkerHtmlBuiltin" />
