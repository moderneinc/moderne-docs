...
canonical_url: "https://docs.openrewrite.org/recipes/java/struts/migrate6/migratestaticognlmethodaccess"
---
...
rewrite {
    activeRecipe("org.openrewrite.java.struts.migrate6.MigrateStaticOgnlMethodAccess")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.struts.migrate6.MigrateStaticOgnlMethodAccess</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-struts:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.struts.migrate6.MigrateStaticOgnlMethodAccess -Drewrite.exportDatatables=true
```
</TabItem>
