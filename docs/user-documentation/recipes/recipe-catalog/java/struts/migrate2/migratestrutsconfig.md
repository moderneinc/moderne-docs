...
_Transforms Struts 1.x `struts-config.xml` to Struts 2.x `struts.xml` format._
...
<RunRecipe
  recipeName="org.openrewrite.java.struts.migrate2.MigrateStrutsConfig"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.struts.migrate2.MigrateStrutsConfig" />
