...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.struts.migrate2.MigrateStruts2"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.struts.migrate2.MigrateStruts2","displayName":"Migrate to Struts 2.x from Struts 1.x","groupId":"org.openrewrite.recipe","artifactId":"rewrite-struts","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STRUTS","requiresConfiguration":false}}>
