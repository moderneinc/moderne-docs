...
_Transforms Struts 1 JSP tags (`html:`, `bean:`, `logic:`) to Struts 2 tags (`s:`)._
...
<TabItem value="login.jsp" label="login.jsp">
...
<RunRecipe
  recipeName="org.openrewrite.java.struts.migrate2.MigrateJspTags"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.struts.migrate2.MigrateJspTags" />
