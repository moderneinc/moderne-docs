...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.struts.search.FindStaticOgnlMethodAccess"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.struts.search.FindStaticOgnlMethodAccess","displayName":"Find static OGNL method access","groupId":"org.openrewrite.recipe","artifactId":"rewrite-struts","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STRUTS","requiresConfiguration":false}}>
