...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.struts.migrate7.MigrateStruts7"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.struts.migrate7.MigrateStruts7","displayName":"Migrate to Struts 7.0","groupId":"org.openrewrite.recipe","artifactId":"rewrite-struts","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_STRUTS","requiresConfiguration":false}}>
