...
_Updates Struts XML constants that were renamed or tightened in Struts 7._
...
rewrite {
    activeRecipe("org.openrewrite.java.struts.migrate7.UpdateStruts7Constants")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.struts.migrate7.UpdateStruts7Constants</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-struts:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.struts.migrate7.UpdateStruts7Constants -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe UpdateStruts7Constants
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.struts.migrate7.UpdateStruts7Constants" />
