...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/jspecify/migratetojspecify" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.jspecify.MigrateToJSpecify"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.jspecify.MigrateToJSpecify","displayName":"Migrate to JSpecify","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
