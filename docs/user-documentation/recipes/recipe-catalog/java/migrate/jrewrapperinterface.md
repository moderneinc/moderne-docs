...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.JREWrapperInterface"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/resources/META-INF/rewrite/java-version-6.yml"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.JREWrapperInterface","displayName":"Add missing `isWrapperFor` and `unwrap` methods","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
