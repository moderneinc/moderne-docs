...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.EnableLombokAnnotationProcessor"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.EnableLombokAnnotationProcessor","displayName":"Enable Lombok annotation processor","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
