...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.UpgradeBuildToJava11"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.UpgradeBuildToJava11","displayName":"Upgrade build to Java 11","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
