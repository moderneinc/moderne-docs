...
[GitHub: AddMissingMethodImplementation.java](https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/AddMissingMethodImplementation.java),
...
* [Add missing `isWrapperFor` and `unwrap` methods](/user-documentation/recipes/recipe-catalog/java/migrate/jrewrapperinterface.md)
* [Adds missing JDBC interface methods](/user-documentation/recipes/recipe-catalog/java/migrate/jrejdbcinterfacenewmethods.md)
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.AddMissingMethodImplementation" />
