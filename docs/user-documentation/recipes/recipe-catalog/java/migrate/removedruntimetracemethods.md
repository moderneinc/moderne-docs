...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.RemovedRuntimeTraceMethods"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.RemovedRuntimeTraceMethods","displayName":"Remove `Runtime.traceInstructions(boolean)` and `Runtime.traceMethodCalls` methods","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
