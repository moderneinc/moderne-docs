...
canonical_url: "https://docs.openrewrite.org/recipes/java/migrate/net/migratemulticastsocketgetttltogettimetolive"
---
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.net.MigrateMulticastSocketGetTTLToGetTimeToLive -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe MigrateMulticastSocketGetTTLToGetTimeToLive
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.net.MigrateMulticastSocketGetTTLToGetTimeToLive" />
