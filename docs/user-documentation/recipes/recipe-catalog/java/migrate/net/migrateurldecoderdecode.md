---
title: "Use `java.net.URLDecoder#decode(String, StandardCharsets.UTF_8)`"
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.net.MigrateURLDecoderDecode"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/net/MigrateURLDecoderDecode.java"}
/>
