...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/sql/javasqlapis" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.sql.JavaSqlAPIs"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/resources/META-INF/rewrite/java-sql-apis.yml"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.sql.JavaSqlAPIs","displayName":"Use modernized `java.sql` APIs","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
