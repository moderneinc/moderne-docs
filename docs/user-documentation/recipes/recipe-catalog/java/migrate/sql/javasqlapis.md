...
[GitHub: java-sql-apis.yml](https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/resources/META-INF/rewrite/java-sql-apis.yml),
...
<RunRecipe
  recipeName="org.openrewrite.java.migrate.sql.JavaSqlAPIs"
  displayName="Use modernized `java.sql` APIs"
