...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.java.migrate.guava.PreferLongDivideUnsigned"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/java/migrate/guava/preferlongdivideunsigned.md"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.guava.PreferLongDivideUnsigned","displayName":"Prefer `Long#divideUnsigned`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
