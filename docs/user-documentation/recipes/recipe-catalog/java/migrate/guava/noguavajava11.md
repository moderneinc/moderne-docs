---
title: "Prefer the Java 11 standard library instead of Guava"
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.guava.NoGuavaJava11"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.guava.NoGuavaJava11","displayName":"Prefer the Java 11 standard library instead of Guava","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
