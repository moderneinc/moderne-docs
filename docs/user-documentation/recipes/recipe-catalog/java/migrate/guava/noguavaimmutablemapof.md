...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.guava.NoGuavaImmutableMapOf"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/guava/NoGuavaImmutableMapOf.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.guava.NoGuavaImmutableMapOf","displayName":"Prefer `Map.of(..)` in Java 9 or higher","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
