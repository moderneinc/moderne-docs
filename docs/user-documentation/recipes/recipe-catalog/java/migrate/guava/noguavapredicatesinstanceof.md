...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/guava/noguavapredicatesinstanceof" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.guava.NoGuavaPredicatesInstanceOf"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/guava/NoGuavaPredicatesInstanceOf.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.guava.NoGuavaPredicatesInstanceOf","displayName":"Prefer `A.class::isInstance`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
