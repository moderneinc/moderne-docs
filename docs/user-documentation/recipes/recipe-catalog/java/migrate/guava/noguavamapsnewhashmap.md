...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.guava.NoGuavaMapsNewHashMap"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/guava/NoGuavaMapsNewHashMap.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.guava.NoGuavaMapsNewHashMap","displayName":"Prefer `new HashMap<>()`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
