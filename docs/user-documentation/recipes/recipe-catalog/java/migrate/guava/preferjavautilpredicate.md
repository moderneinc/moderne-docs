...
canonical_url: "https://docs.openrewrite.org/recipes/java/migrate/guava/preferjavautilpredicate"
---
...
## Examples
##### Example 1
`PreferJavaUtilPredicateTest#changeTypeAndMethodName`
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.guava.PreferJavaUtilPredicate -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe PreferJavaUtilPredicate
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.guava.PreferJavaUtilPredicate" />
