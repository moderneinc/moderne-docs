...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.guava.PreferJavaUtilPredicate"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.guava.PreferJavaUtilPredicate","displayName":"Prefer `java.util.function.Predicate`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
