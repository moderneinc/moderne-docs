...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.guava.NoMapsAndSetsWithExpectedSize"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/guava/NoMapsAndSetsWithExpectedSize.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.guava.NoMapsAndSetsWithExpectedSize","displayName":"Prefer JDK methods for Maps and Sets of an expected size","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
