...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.guava.NoGuavaIterablesAnyFilter"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/guava/NoGuavaIterablesAnyFilter.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.guava.NoGuavaIterablesAnyFilter","displayName":"Prefer `Collection.stream().anyMatch(Predicate)`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
