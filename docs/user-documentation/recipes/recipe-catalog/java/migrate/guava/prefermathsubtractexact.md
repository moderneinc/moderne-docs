---
title: "Prefer `Math#subtractExact`"
...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/guava/prefermathsubtractexact" />
</head>
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.java.migrate.guava.PreferMathSubtractExact"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/java/migrate/guava/prefermathsubtractexact.md"}
>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.guava.PreferMathSubtractExact","displayName":"Prefer `Math#subtractExact`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
