...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.guava.PreferJavaStringJoin"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/guava/PreferJavaStringJoin.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.guava.PreferJavaStringJoin","displayName":"Prefer `String#join()` over Guava `Joiner#join()`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
