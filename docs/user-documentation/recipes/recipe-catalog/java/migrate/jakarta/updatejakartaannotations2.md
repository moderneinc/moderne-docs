...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.jakarta.UpdateJakartaAnnotations2"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.jakarta.UpdateJakartaAnnotations2","displayName":"Update Jakarta EE annotation Dependencies to 2.1.x","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
