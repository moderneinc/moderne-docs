...
canonical_url: "https://docs.openrewrite.org/recipes/java/migrate/jakarta/removedstatemanagermethods"
---
...
## Examples
##### Example 1
`RemovedStateManagerMethodsTest#stateManagerReplacement`
