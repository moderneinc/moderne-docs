...
canonical_url: "https://docs.openrewrite.org/recipes/java/migrate/jakarta/javaxjsptojakartajsp"
---
...
name: org.openrewrite.java.migrate.jakarta.JavaxJspToJakartaJsp
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.jakarta.JavaxJspToJakartaJsp")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.jakarta.JavaxJspToJakartaJsp</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.jakarta.JavaxJspToJakartaJsp -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe JavaxJspToJakartaJsp
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.jakarta.JavaxJspToJakartaJsp" />
