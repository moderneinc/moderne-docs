...
canonical_url: "https://docs.openrewrite.org/recipes/java/migrate/jakarta/javaxeeapitojakarta"
---
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.jakarta.JavaxEEApiToJakarta")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.jakarta.JavaxEEApiToJakarta</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.jakarta.JavaxEEApiToJakarta -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe JavaxEEApiToJakarta
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.jakarta.JavaxEEApiToJakarta" />
