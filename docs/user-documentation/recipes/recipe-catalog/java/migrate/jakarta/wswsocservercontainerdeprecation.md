...
canonical_url: "https://docs.openrewrite.org/recipes/java/migrate/jakarta/wswsocservercontainerdeprecation"
---
...
## Examples
##### Example 1
`WsWsocServerContainerDeprecationTest#deprecateWsWsocServerContainer`
