...
_Update Apache Commons Email to Email2 for Jakarta._
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.jakarta.UpdateApacheCommonsEmailDependencies")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.jakarta.UpdateApacheCommonsEmailDependencies</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.jakarta.UpdateApacheCommonsEmailDependencies -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe UpdateApacheCommonsEmailDependencies
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.jakarta.UpdateApacheCommonsEmailDependencies" />
