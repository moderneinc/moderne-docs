...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/jakarta/fileuploadtofileupload2" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.jakarta.FileuploadToFileUpload2"}
  languages={["Java"]}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.java.migrate.jakarta.FileuploadToFileUpload2"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/java/migrate/jakarta/fileuploadtofileupload2.md"}
>

<RecipeHeader.Title>Migrate deprecated `org.apache.commons.fileload` packages to `org.apache.commons.fileload.core`</RecipeHeader.Title>

<RecipeHeader.Description>Migrate deprecated `org.apache.commons.fileload` packages to `org.apache.commons.fileload.core`.</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.jakarta.FileuploadToFileUpload2","displayName":"Migrate deprecated `org.apache.commons.fileload` packages to `org.apache.commons.fileload.core`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
