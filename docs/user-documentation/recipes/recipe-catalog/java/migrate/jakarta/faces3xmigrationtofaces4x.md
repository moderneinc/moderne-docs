...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.jakarta.Faces3xMigrationToFaces4x"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.jakarta.Faces3xMigrationToFaces4x","displayName":"Upgrade to Jakarta Faces 4.x","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
