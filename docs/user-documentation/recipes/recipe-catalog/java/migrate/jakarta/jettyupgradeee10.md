...
canonical_url: "https://docs.openrewrite.org/recipes/java/migrate/jakarta/jettyupgradeee10"
---
...
_Update Jetty dependencies from EE9 to EE10, changing the groupId and artifactIds as needed._
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.jakarta.JettyUpgradeEE10")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.jakarta.JettyUpgradeEE10</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.jakarta.JettyUpgradeEE10 -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe JettyUpgradeEE10
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.jakarta.JettyUpgradeEE10" />
