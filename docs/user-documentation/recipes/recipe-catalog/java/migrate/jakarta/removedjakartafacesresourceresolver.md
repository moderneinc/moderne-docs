...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/jakarta/removedjakartafacesresourceresolver" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.jakarta.RemovedJakartaFacesResourceResolver"}
  languages={["Java"]}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.java.migrate.jakarta.RemovedJakartaFacesResourceResolver"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/java/migrate/jakarta/removedjakartafacesresourceresolver.md"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.jakarta.RemovedJakartaFacesResourceResolver","displayName":"Replace `ResourceResolver` with `ResourceHandler`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
