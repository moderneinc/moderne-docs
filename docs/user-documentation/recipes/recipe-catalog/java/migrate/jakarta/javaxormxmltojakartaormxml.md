...
<RunRecipe
  recipeName="org.openrewrite.java.migrate.jakarta.JavaxOrmXmlToJakartaOrmXml"
  displayName="Migrate xmlns entries in `orm.xml` files"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.jakarta.JavaxOrmXmlToJakartaOrmXml" />
