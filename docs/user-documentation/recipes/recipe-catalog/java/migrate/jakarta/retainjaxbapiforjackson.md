...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.jakarta.RetainJaxbApiForJackson"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.jakarta.RetainJaxbApiForJackson","displayName":"Retain `javax.xml.bind:jaxb-api` when `jackson-module-jaxb-annotations` is present","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
