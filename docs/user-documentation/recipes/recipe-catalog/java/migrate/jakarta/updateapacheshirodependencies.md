...
_Update Apache Shiro Dependencies to 2.0.x._
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.jakarta.UpdateApacheShiroDependencies")
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.jakarta.UpdateApacheShiroDependencies -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe UpdateApacheShiroDependencies
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.jakarta.UpdateApacheShiroDependencies" />
