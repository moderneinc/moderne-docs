...
_Do not use the `com.ibm.security.auth.module.Krb5LoginModule` class._
...
* [Migrate from IBM Runtimes to Oracle Runtimes](/user-documentation/recipes/recipe-catalog/java/migrate/ibmjdktooraclejdk.md)
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.Krb5LoginModuleClass")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.Krb5LoginModuleClass</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.Krb5LoginModuleClass -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe Krb5LoginModuleClass
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.Krb5LoginModuleClass" />
