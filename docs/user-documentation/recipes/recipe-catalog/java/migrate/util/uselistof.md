...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/util/uselistof" />
</head>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.util.UseListOf","displayName":"Prefer `List.of(..)`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
