...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.util.MigrateCollectionsSingletonSet"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/util/MigrateCollectionsSingletonSet.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.util.MigrateCollectionsSingletonSet","displayName":"Prefer `Set.of(..)`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
