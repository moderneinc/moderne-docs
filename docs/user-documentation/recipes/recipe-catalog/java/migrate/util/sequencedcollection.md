...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/util/sequencedcollection" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.util.SequencedCollection"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.util.SequencedCollection","displayName":"Adopt `SequencedCollection`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
