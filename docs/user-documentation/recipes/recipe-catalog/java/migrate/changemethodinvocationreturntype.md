...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/changemethodinvocationreturntype" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.ChangeMethodInvocationReturnType"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/ChangeMethodInvocationReturnType.java"}
/>
...
<OptionsTable options={[{"type":"String","name":"methodPattern","required":true,"description":"A method pattern that is used to find matching method declarations/invocations.","example":"org.mockito.Matchers anyVararg()"},{"type":"String","name":"newReturnType","required":true,"description":"The fully qualified new return type of method invocation.","example":"long"}]}>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.ChangeMethodInvocationReturnType","displayName":"Change method invocation return type","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":true,"cliOptions":" --recipe-option \"methodPattern=org.mockito.Matchers anyVararg()\" --recipe-option \"newReturnType=long\""}}>
