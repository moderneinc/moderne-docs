...
[GitHub: ChangeMethodInvocationReturnType.java](https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/ChangeMethodInvocationReturnType.java),
...
Now that `com.yourorg.ChangeMethodInvocationReturnTypeExample` has been defined, activate it and take a dependency on `org.openrewrite.recipe:rewrite-migrate-java:{{VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA}}` in your build file:
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.ChangeMethodInvocationReturnType" />
