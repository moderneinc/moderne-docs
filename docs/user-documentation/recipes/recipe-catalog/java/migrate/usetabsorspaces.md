...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.UseTabsOrSpaces"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/UseTabsOrSpaces.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"useTabs","value":"true"}],"variants":[{"language":"java","before":"class Test {\n    void test() {\n    }\n}\n","after":"class Test {\n\tvoid test() {\n\t}\n}\n","diff":"@@ -2,2 +2,2 @@\nclass Test {\n-   void test() {\n-   }\n+\tvoid test() {\n+\t}\n}\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.UseTabsOrSpaces","displayName":"Force indentation to either tabs or spaces","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":true,"cliOptions":" --recipe-option \"useTabs=false\""}}>
