...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.lang.NullCheckAsSwitchCase"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/lang/NullCheckAsSwitchCase.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.lang.NullCheckAsSwitchCase","displayName":"Add null check to existing switch cases","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
