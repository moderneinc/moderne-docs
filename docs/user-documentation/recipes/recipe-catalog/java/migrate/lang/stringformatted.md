...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/lang/stringformatted" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.lang.StringFormatted"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/lang/StringFormatted.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"addParentheses","value":"null"}],"variants":[{"language":"java","before":"package com.example.app;\nclass A {\n    String str = String.format(\"foo\"\n            + \"%s\", \"a\");\n}\n","after":"package com.example.app;\nclass A {\n    String str = (\"foo\"\n            + \"%s\").formatted(\"a\");\n}\n","diff":"@@ -3,2 +3,2 @@\npackage com.example.app;\nclass A {\n-   String str = String.format(\"foo\"\n-           + \"%s\", \"a\");\n+   String str = (\"foo\"\n+           + \"%s\").formatted(\"a\");\n}\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.lang.StringFormatted","displayName":"Prefer `String.formatted(Object...)`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
