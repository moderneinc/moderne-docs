...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.lang.UseStringIsEmptyRecipe"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/lang/UseStringIsEmpty.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.lang.UseStringIsEmptyRecipe","displayName":"Replace `0 < s.length()` with `!s.isEmpty()`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
