...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.lang.MigrateProcessWaitForDuration"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/lang/MigrateProcessWaitForDuration.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.lang.MigrateProcessWaitForDuration","displayName":"Use `Process#waitFor(Duration)`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
