...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.lang.JavaLangAPIs"}
  languages={["Java"]}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"package com.abc;\n\nclass A {\n   public void test() {\n       boolean result = Character.isJavaLetter('b');\n   }\n}\n","after":"package com.abc;\n\nclass A {\n   public void test() {\n       boolean result = Character.isJavaIdentifierStart('b');\n   }\n}\n","diff":"@@ -5,1 +5,1 @@\nclass A {\n   public void test() {\n-      boolean result = Character.isJavaLetter('b');\n+      boolean result = Character.isJavaIdentifierStart('b');\n   }\n","newFile":false}]},{"variants":[{"language":"java","before":"package com.abc;\n\nclass A {\n   public void test() {\n       boolean result = Character.isJavaLetter('b');\n   }\n}\n","after":"package com.abc;\n\nclass A {\n   public void test() {\n       boolean result = Character.isJavaIdentifierStart('b');\n   }\n}\n","diff":"@@ -5,1 +5,1 @@\nclass A {\n   public void test() {\n-      boolean result = Character.isJavaLetter('b');\n+      boolean result = Character.isJavaIdentifierStart('b');\n   }\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.lang.JavaLangAPIs","displayName":"Use modernized `java.lang` APIs","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
