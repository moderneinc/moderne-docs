...
[GitHub: DontOverfetchDto.java](https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/DontOverfetchDto.java),
...
```shell title="shell"
mod run . --recipe DontOverfetchDto --recipe-option "dtoType=animals.Dog" --recipe-option "dtoDataElement=name"
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.DontOverfetchDto" />
