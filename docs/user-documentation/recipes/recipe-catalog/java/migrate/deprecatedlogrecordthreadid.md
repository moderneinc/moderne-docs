...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.DeprecatedLogRecordThreadID"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.DeprecatedLogRecordThreadID","displayName":"Adopt `setLongThreadID` in `java.util.logging.LogRecord`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
