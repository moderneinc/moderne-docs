...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/upgradebuildtojava25" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.UpgradeBuildToJava25"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.UpgradeBuildToJava25","displayName":"Upgrade build to Java 25 (non-Kotlin)","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
