...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.AddSuppressionForIllegalReflectionWarningsPlugin"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/AddSuppressionForIllegalReflectionWarningsPlugin.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.AddSuppressionForIllegalReflectionWarningsPlugin","displayName":"Add maven jar plugin to suppress illegal reflection warnings","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
