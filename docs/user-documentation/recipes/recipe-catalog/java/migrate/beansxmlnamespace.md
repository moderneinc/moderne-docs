...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.BeansXmlNamespace"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/BeansXmlNamespace.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.BeansXmlNamespace","displayName":"Change `beans.xml` `schemaLocation` to match XML namespace","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
