...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.search.FindInternalJavaxApis"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/search/FindInternalJavaxApis.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"methodPattern","value":"null"}],"unchanged":{"language":"java","code":"package org.openrewrite;\n\ninterface Api {\n    javax.xml.stream.StreamFilter test();\n}\n"},"variants":[{"language":"java","before":"package org.openrewrite;\n\nimport javax.xml.stream.StreamFilter;\n\nclass Consumer {\n    void test(Api api) {\n        StreamFilter sf = api.test();\n    }\n}\n","after":"package org.openrewrite;\n\nimport javax.xml.stream.StreamFilter;\n\nclass Consumer {\n    void test(Api api) {\n        StreamFilter sf = /*~~>*/api.test();\n    }\n}\n","diff":"@@ -7,1 +7,1 @@\nclass Consumer {\n    void test(Api api) {\n-       StreamFilter sf = api.test();\n+       StreamFilter sf = /*~~>*/api.test();\n    }\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.search.FindInternalJavaxApis","displayName":"Find uses of internal javax APIs","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
