...
* [cobertura](/user-documentation/recipes/lists/recipes-by-tag#cobertura)
* [java11](/user-documentation/recipes/lists/recipes-by-tag#java11)

## Recipe source

[GitHub: remove-cobertura-maven-plugin.yml](https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/resources/META-INF/rewrite/remove-cobertura-maven-plugin.yml),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.cobertura.RemoveCoberturaMavenPlugin -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.cobertura.RemoveCoberturaMavenPlugin" />
