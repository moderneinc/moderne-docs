...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.JREDoNotUseSunNetSslInternalWwwProtocol -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe JREDoNotUseSunNetSslInternalWwwProtocol
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.JREDoNotUseSunNetSslInternalWwwProtocol" />
