...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/upgradetojava8" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.UpgradeToJava8"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/resources/META-INF/rewrite/java-version-8.yml"}
/>
...
<ExampleList examples={[{"unchanged":{"language":"mavenProject","code":"project"},"variants":[{"language":"java","before":"package com.abc;\n\ninterface SomeMBean {\n    String test();\n}\n","after":"package com.abc;\n\npublic interface SomeMBean {\n    String test();\n}\n","diff":"@@ -3,1 +3,1 @@\npackage com.abc;\n\n-interface SomeMBean {\n+public interface SomeMBean {\n    String test();\n","newFile":false},{"language":"java","before":"package com.abc;\n\ninterface SomeMXBean {\n    String test();\n}\n","after":"package com.abc;\n\npublic interface SomeMXBean {\n    String test();\n}\n","diff":"@@ -3,1 +3,1 @@\npackage com.abc;\n\n-interface SomeMXBean {\n+public interface SomeMXBean {\n    String test();\n","newFile":false}]},{"unchanged":{"language":"mavenProject","code":"project"},"variants":[{"language":"java","before":"package com.abc;\n\ninterface SomeMBean {\n    String test();\n}\n","after":"package com.abc;\n\npublic interface SomeMBean {\n    String test();\n}\n","diff":"@@ -3,1 +3,1 @@\npackage com.abc;\n\n-interface SomeMBean {\n+public interface SomeMBean {\n    String test();\n","newFile":false},{"language":"java","before":"package com.abc;\n\ninterface SomeMXBean {\n    String test();\n}\n","after":"package com.abc;\n\npublic interface SomeMXBean {\n    String test();\n}\n","diff":"@@ -3,1 +3,1 @@\npackage com.abc;\n\n-interface SomeMXBean {\n+public interface SomeMXBean {\n    String test();\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.UpgradeToJava8","displayName":"Migrate to Java 8","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
