...
_The Security Manager API is unsupported in Java 24. This recipe will remove the use of `java.security.Policy`._
...
* [deprecation](/user-documentation/recipes/lists/recipes-by-tag#deprecation)
...
* [Unnecessary throws](../../staticanalysis/unnecessarythrows)
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.RemoveSecurityPolicy")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.RemoveSecurityPolicy</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.RemoveSecurityPolicy -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe RemoveSecurityPolicy
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.RemoveSecurityPolicy" />
