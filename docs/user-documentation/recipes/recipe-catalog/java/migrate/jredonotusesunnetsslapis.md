...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.JREDoNotUseSunNetSslAPIs"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.JREDoNotUseSunNetSslAPIs","displayName":"Use `javax.net.ssl` instead of `com.sun.net.ssl`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
