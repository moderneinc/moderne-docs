...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.UpgradeBuildToJava24ForKotlin1x"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.UpgradeBuildToJava24ForKotlin1x","displayName":"Upgrade build to Java 24 for Kotlin 1.x","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
