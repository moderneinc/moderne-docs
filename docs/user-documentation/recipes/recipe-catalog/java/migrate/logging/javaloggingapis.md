---
title: "Use modernized `java.util.logging` APIs"
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.logging.JavaLoggingAPIs"}
  languages={["Java"]}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"import java.util.logging.LoggingMXBean;\n\nclass Test {\n    static void method() {\n        LoggingMXBean loggingBean = null;\n    }\n}\n","after":"import java.lang.management.PlatformLoggingMXBean;\n\nclass Test {\n    static void method() {\n        PlatformLoggingMXBean loggingBean = null;\n    }\n}\n","diff":"@@ -1,1 +1,1 @@\n-import java.util.logging.LoggingMXBean;\n+import java.lang.management.PlatformLoggingMXBean;\n\n@@ -5,1 +5,1 @@\nclass Test {\n    static void method() {\n-       LoggingMXBean loggingBean = null;\n+       PlatformLoggingMXBean loggingBean = null;\n    }\n","newFile":false}]},{"variants":[{"language":"java","before":"import java.util.logging.LoggingMXBean;\n\nclass Test {\n    static void method() {\n        LoggingMXBean loggingBean = null;\n    }\n}\n","after":"import java.lang.management.PlatformLoggingMXBean;\n\nclass Test {\n    static void method() {\n        PlatformLoggingMXBean loggingBean = null;\n    }\n}\n","diff":"@@ -1,1 +1,1 @@\n-import java.util.logging.LoggingMXBean;\n+import java.lang.management.PlatformLoggingMXBean;\n\n@@ -5,1 +5,1 @@\nclass Test {\n    static void method() {\n-       LoggingMXBean loggingBean = null;\n+       PlatformLoggingMXBean loggingBean = null;\n    }\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.logging.JavaLoggingAPIs","displayName":"Use modernized `java.util.logging` APIs","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
