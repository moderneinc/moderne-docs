...
[GitHub: ReplaceStringLiteralValue.java](https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/ReplaceStringLiteralValue.java),
...
<RunRecipe
  recipeName="org.openrewrite.java.migrate.ReplaceStringLiteralValue"
  displayName="Replace `String` literal"
