...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/removedpolicy" />
</head>
...
_The `javax.security.auth.Policy` class is not available from Java SE 11 onwards._
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.RemovedPolicy")
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.RemovedPolicy -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.RemovedPolicy" />
