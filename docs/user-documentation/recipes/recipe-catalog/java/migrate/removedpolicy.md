...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.RemovedPolicy"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.RemovedPolicy","displayName":"Replace `javax.security.auth.Policy` with `java.security.Policy`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
