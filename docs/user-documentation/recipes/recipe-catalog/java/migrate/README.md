...
* [Cobertura](/user-documentation/recipes/recipe-catalog/java/migrate/cobertura)
* [DataNucleus](/user-documentation/recipes/recipe-catalog/java/migrate/datanucleus)
* [Guava](/user-documentation/recipes/recipe-catalog/java/migrate/guava)
* [JaCoCo](/user-documentation/recipes/recipe-catalog/java/migrate/jacoco)
* [Jakarta](/user-documentation/recipes/recipe-catalog/java/migrate/jakarta)
* [Java EE 7](/user-documentation/recipes/recipe-catalog/java/migrate/javaee7)
* [Java EE 8](/user-documentation/recipes/recipe-catalog/java/migrate/javaee8)
* [Jspecify](/user-documentation/recipes/recipe-catalog/java/migrate/jspecify)
* [Lombok](/user-documentation/recipes/recipe-catalog/java/migrate/lombok)
* [Maven](/user-documentation/recipes/recipe-catalog/java/migrate/maven)
* [Metrics](/user-documentation/recipes/recipe-catalog/java/migrate/metrics)
* [Nio](/user-documentation/recipes/recipe-catalog/java/migrate/nio)
* [Search](/user-documentation/recipes/recipe-catalog/java/migrate/search)
* [java.io APIs](/user-documentation/recipes/recipe-catalog/java/migrate/io)
* [java.lang APIs](/user-documentation/recipes/recipe-catalog/java/migrate/lang)
* [java.net APIs](/user-documentation/recipes/recipe-catalog/java/migrate/net)
* [java.sql APIs](/user-documentation/recipes/recipe-catalog/java/migrate/sql)
* [java.util APIs](/user-documentation/recipes/recipe-catalog/java/migrate/util)
* [java.util.concurrent APIs](/user-documentation/recipes/recipe-catalog/java/migrate/concurrent)
* [java.util.logging APIs](/user-documentation/recipes/recipe-catalog/java/migrate/logging)
* [javax APIs](/user-documentation/recipes/recipe-catalog/java/migrate/javax)
...
* [Upgrade Kotlin to 2.3 for Java 25 compatibility](./upgradekotlinforjava25.md)
...
* [Comment Kotlin modules capped at Java 24](./commentkotlinmodulescappedatjava24.md)
* [Disable the persistence unit second-level cache](./jpacacheproperties.md)
* [Explain why the Java version was capped at 24 for Kotlin modules](./commentjava24kotlincap.md)
* [Force indentation to either tabs or spaces](./usetabsorspaces.md)
* [MBean and MXBean interfaces must be public](./mxbeanrule.md)
* [Migrate GraalVM resource-config.json to glob patterns](./migrategraalvmresourceconfig.md)
...
* [Upgrade build to Java 24 for Kotlin 1.x](./upgradebuildtojava24forkotlin1x.md)
