...
**org.openrewrite.java.migrate.datanucleus.UpgradeDataNucleus\_4\_0**

_Migrate DataNucleus 3.x applications to 4.0. This recipe handles package relocations, type renames, property key changes, and dependency updates introduced in AccessPlatform 4.0._
...
* [DataNucleus 4.0 package moves](../../../java/migrate/datanucleus/datanucleuspackagemoves_4_0)
* [DataNucleus 4.0 type changes](../../../java/migrate/datanucleus/datanucleustypechanges_4_0)
* [DataNucleus 4.0 property migrations](../../../java/migrate/datanucleus/datanucleusproperties_4_0)
...
## Examples
##### Example 1
`UpgradeDataNucleus_4_0Test#renameSchemaPropertyKeys`
...
```shell title="shell"
mod run . --recipe UpgradeDataNucleus_4_0
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.datanucleus.UpgradeDataNucleus_4_0" />
