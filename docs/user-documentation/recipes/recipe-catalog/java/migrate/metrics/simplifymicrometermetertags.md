...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.metrics.SimplifyMicrometerMeterTags"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/metrics/SimplifyMicrometerMeterTags.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.metrics.SimplifyMicrometerMeterTags","displayName":"Simplify [Micrometer](https://micrometer.io) meter tags","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
