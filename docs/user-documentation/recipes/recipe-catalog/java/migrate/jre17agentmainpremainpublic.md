...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.Jre17AgentMainPreMainPublic"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.Jre17AgentMainPreMainPublic","displayName":"Set visibility of `premain` and `agentmain` methods to `public`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
