...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/javaee8-recipe" />
</head>
...
_These recipes help with the Migration to Java EE 8, flagging and updating deprecated methods._

### Tags

* [javaee8](/user-documentation/recipes/lists/recipes-by-tag#javaee8)
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.javaee8")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.javaee8</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.javaee8 -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.javaee8" />
