...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/arraystoreexceptiontotypenotpresentexception" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.ArrayStoreExceptionToTypeNotPresentException"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/ArrayStoreExceptionToTypeNotPresentException.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.ArrayStoreExceptionToTypeNotPresentException","displayName":"Catch `TypeNotPresentException` thrown by `Class.getAnnotation()`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
