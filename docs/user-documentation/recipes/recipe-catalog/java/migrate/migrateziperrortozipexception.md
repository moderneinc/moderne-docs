...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.MigrateZipErrorToZipException"}
  languages={["Java"]}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"import java.util.zip.ZipError;\n\nclass Test {\n    void test() {\n        try {\n            // Some zip operation\n        } catch (ZipError e) {\n            System.out.println(\"Zip error occurred: \" + e.getMessage());\n        }\n    }\n}\n","after":"import java.util.zip.ZipException;\n\nclass Test {\n    void test() {\n        try {\n            // Some zip operation\n        } catch (ZipException e) {\n            System.out.println(\"Zip error occurred: \" + e.getMessage());\n        }\n    }\n}\n","diff":"@@ -1,1 +1,1 @@\n-import java.util.zip.ZipError;\n+import java.util.zip.ZipException;\n\n@@ -7,1 +7,1 @@\n        try {\n            // Some zip operation\n-       } catch (ZipError e) {\n+       } catch (ZipException e) {\n            System.out.println(\"Zip error occurred: \" + e.getMessage());\n","newFile":false}]},{"variants":[{"language":"java","before":"import java.util.zip.ZipError;\n\nclass Test {\n    void test() {\n        try {\n            // Some zip operation\n        } catch (ZipError e) {\n            System.out.println(\"Zip error occurred: \" + e.getMessage());\n        }\n    }\n}\n","after":"import java.util.zip.ZipException;\n\nclass Test {\n    void test() {\n        try {\n            // Some zip operation\n        } catch (ZipException e) {\n            System.out.println(\"Zip error occurred: \" + e.getMessage());\n        }\n    }\n}\n","diff":"@@ -1,1 +1,1 @@\n-import java.util.zip.ZipError;\n+import java.util.zip.ZipException;\n\n@@ -7,1 +7,1 @@\n        try {\n            // Some zip operation\n-       } catch (ZipError e) {\n+       } catch (ZipException e) {\n            System.out.println(\"Zip error occurred: \" + e.getMessage());\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.MigrateZipErrorToZipException","displayName":"Use `ZipException` instead of `ZipError`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
