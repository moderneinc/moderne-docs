...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.RemovedSSLSessionGetPeerCertificateChainMethodImpl"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.RemovedSSLSessionGetPeerCertificateChainMethodImpl","displayName":"Replace `SSLSession.getPeerCertificateChain()` method","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
