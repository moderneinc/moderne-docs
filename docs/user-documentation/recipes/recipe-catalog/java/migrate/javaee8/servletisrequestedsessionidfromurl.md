...
_The  method `HttpServletRequestWrapper.isRequestedSessionIdFromUrl()` is deprecated in JavaEE8 and is replaced by `HttpServletRequestWrapper.isRequestedSessionIdFromURL()`._
...
## Examples
##### Example 1
`ServletIsRequestedSessionIdFromURLTest#servletIsRequestedSessionIdFromURL`
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.javaee8.ServletIsRequestedSessionIdFromURL")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.javaee8.ServletIsRequestedSessionIdFromURL</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.javaee8.ServletIsRequestedSessionIdFromURL -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe ServletIsRequestedSessionIdFromURL
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.javaee8.ServletIsRequestedSessionIdFromURL" />
