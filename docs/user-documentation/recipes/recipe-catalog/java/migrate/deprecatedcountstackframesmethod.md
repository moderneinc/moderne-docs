...
## Examples
##### Example 1
`DeprecatedCountStackFramesMethodTest#deprecatedCountStackFrameRemoveMethod`
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.DeprecatedCountStackFramesMethod -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.DeprecatedCountStackFramesMethod" />
