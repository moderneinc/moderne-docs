...
* [glassfish](/user-documentation/recipes/lists/recipes-by-tag#glassfish)
* [javax](/user-documentation/recipes/lists/recipes-by-tag#javax)
* [javaee](/user-documentation/recipes/lists/recipes-by-tag#javaee)
...
[GitHub: AddJaxbRuntime.java](https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/javax/AddJaxbRuntime.java),
...
Now that `com.yourorg.AddJaxbRuntimeExample` has been defined, activate it and take a dependency on `org.openrewrite.recipe:rewrite-migrate-java:{{VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA}}` in your build file:
...
```shell title="shell"
mod run . --recipe AddJaxbRuntime --recipe-option "runtime=glassfish"
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.javax.AddJaxbRuntime" />
