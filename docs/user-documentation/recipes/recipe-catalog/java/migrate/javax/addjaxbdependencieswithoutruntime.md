...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.javax.AddJaxbDependenciesWithoutRuntime"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.javax.AddJaxbDependenciesWithoutRuntime","displayName":"Add explicit JAXB API dependencies and remove runtimes","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
