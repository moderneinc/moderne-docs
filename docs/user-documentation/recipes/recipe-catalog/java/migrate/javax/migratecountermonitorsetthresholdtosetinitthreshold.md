...
[GitHub: javax-management-monitor-apis.yml](https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/resources/META-INF/rewrite/javax-management-monitor-apis.yml),
...
* [Use modernized `javax.management.monitor` APIs](/user-documentation/recipes/recipe-catalog/java/migrate/javax/javaxmanagementmonitorapis.md)
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.javax.MigrateCounterMonitorSetThresholdToSetInitThreshold -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.javax.MigrateCounterMonitorSetThresholdToSetInitThreshold" />
