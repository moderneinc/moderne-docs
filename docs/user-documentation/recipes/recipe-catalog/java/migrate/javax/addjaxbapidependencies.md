...
[GitHub: jaxb-apis.yml](https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/resources/META-INF/rewrite/jaxb-apis.yml),
...
* [Add explicit JAXB API dependencies and runtime](/user-documentation/recipes/recipe-catalog/java/migrate/javax/addjaxbdependencieswithruntime.md)
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.javax.AddJaxbAPIDependencies")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.javax.AddJaxbAPIDependencies</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.javax.AddJaxbAPIDependencies -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.javax.AddJaxbAPIDependencies" />
