...
canonical_url: "https://docs.openrewrite.org/recipes/java/migrate/javax/javaxmanagementmonitorapis"
---
...
## Examples
##### Example 1
`JavaxManagementMonitorAPIsTest#counterMonitorSetInitThreshold`
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.javax.JavaxManagementMonitorAPIs -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe JavaxManagementMonitorAPIs
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.javax.JavaxManagementMonitorAPIs" />
