...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/javax/addjaxwsdependencies" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.javax.AddJaxwsDependencies"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.javax.AddJaxwsDependencies","displayName":"Add explicit JAX-WS dependencies","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
