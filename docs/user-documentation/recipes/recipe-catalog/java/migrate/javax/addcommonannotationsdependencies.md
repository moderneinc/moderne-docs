...
* [jsr250](/user-documentation/recipes/lists/recipes-by-tag#jsr250)
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.javax.AddCommonAnnotationsDependencies")
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.javax.AddCommonAnnotationsDependencies -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe AddCommonAnnotationsDependencies
```
