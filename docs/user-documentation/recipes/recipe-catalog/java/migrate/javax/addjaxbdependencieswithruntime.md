...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.javax.AddJaxbDependenciesWithRuntime"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.javax.AddJaxbDependenciesWithRuntime","displayName":"Add explicit JAXB API dependencies and runtime","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
