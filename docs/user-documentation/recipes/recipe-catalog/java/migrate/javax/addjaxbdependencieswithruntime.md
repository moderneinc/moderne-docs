...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/javax/addjaxbdependencieswithruntime" />
</head>
...
<RunRecipe
  recipeName="org.openrewrite.java.migrate.javax.AddJaxbDependenciesWithRuntime"
  displayName="Add explicit JAXB API dependencies and runtime"
