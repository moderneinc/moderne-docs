...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/javax/removetemporalannotation" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.javax.RemoveTemporalAnnotation"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/javax/RemoveTemporalAnnotation.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.javax.RemoveTemporalAnnotation","displayName":"Remove the `@Temporal` annotation for some `java.sql` attributes","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
