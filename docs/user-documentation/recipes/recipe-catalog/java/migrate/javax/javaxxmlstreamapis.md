...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/javax/javaxxmlstreamapis" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.javax.JavaxXmlStreamAPIs"}
  languages={["Java"]}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"import javax.xml.stream.XMLEventFactory;\n\npublic class Test {\n    public void method() {\n        XMLEventFactory eventFactory = XMLEventFactory.newInstance(\"test\", Test.class.getClassLoader());\n    }\n}\n","after":"import javax.xml.stream.XMLEventFactory;\n\npublic class Test {\n    public void method() {\n        XMLEventFactory eventFactory = XMLEventFactory.newFactory(\"test\", Test.class.getClassLoader());\n    }\n}\n","diff":"@@ -5,1 +5,1 @@\npublic class Test {\n    public void method() {\n-       XMLEventFactory eventFactory = XMLEventFactory.newInstance(\"test\", Test.class.getClassLoader());\n+       XMLEventFactory eventFactory = XMLEventFactory.newFactory(\"test\", Test.class.getClassLoader());\n    }\n","newFile":false}]},{"variants":[{"language":"java","before":"import javax.xml.stream.XMLEventFactory;\n\npublic class Test {\n    public void method() {\n        XMLEventFactory eventFactory = XMLEventFactory.newInstance(\"test\", Test.class.getClassLoader());\n    }\n}\n","after":"import javax.xml.stream.XMLEventFactory;\n\npublic class Test {\n    public void method() {\n        XMLEventFactory eventFactory = XMLEventFactory.newFactory(\"test\", Test.class.getClassLoader());\n    }\n}\n","diff":"@@ -5,1 +5,1 @@\npublic class Test {\n    public void method() {\n-       XMLEventFactory eventFactory = XMLEventFactory.newInstance(\"test\", Test.class.getClassLoader());\n+       XMLEventFactory eventFactory = XMLEventFactory.newFactory(\"test\", Test.class.getClassLoader());\n    }\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.javax.JavaxXmlStreamAPIs","displayName":"Use modernized `javax.xml.stream` APIs","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
