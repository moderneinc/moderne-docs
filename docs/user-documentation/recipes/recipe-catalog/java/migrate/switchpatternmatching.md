...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.SwitchPatternMatching"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.SwitchPatternMatching","displayName":"Adopt switch pattern matching (JEP 441)","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
