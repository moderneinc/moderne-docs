...
_The Security Manager API is unsupported in Java 24. This recipe will remove the usage of `java.security.SecurityManager`._
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.RemoveSecurityManager")
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.RemoveSecurityManager -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe RemoveSecurityManager
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.RemoveSecurityManager" />
