...
_Prefer the lombok annotation `@Slf4` over explicitly written out `org.slf4j.Logger` fields._

## Recipe source

[GitHub: UseSlf4j.java](https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/lombok/log/UseSlf4j.java),
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.lombok.log.UseSlf4j")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.lombok.log.UseSlf4j</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.lombok.log.UseSlf4j" />
