...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.lombok.LombokOnXToOnX_"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/lombok/LombokOnXToOnX_.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.lombok.LombokOnXToOnX_","displayName":"Migrate Lombok's `@__` syntax to `onX_` for Java 8+","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
