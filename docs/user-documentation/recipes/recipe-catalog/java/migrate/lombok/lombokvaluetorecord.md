...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.lombok.LombokValueToRecord"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/lombok/LombokValueToRecord.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"useExactToString","value":"false"}],"variants":[{"language":"java","before":"package example;\n\nimport lombok.Value;\n\n@Value\npublic class A {\n    String test;\n}\n","after":"package example;\n\npublic record A(\n        String test) {\n}\n","diff":"@@ -3,5 +3,2 @@\npackage example;\n\n-import lombok.Value;\n-\n-@Value\n-public class A {\n-   String test;\n+public record A(\n+       String test) {\n}\n","newFile":false},{"language":"java","before":"package example;\n\npublic class UserOfA {\n\n    private final A record;\n\n    public UserOfA() {\n        this.record = new A(\"some value\");\n    }\n\n    public String getRecordValue() {\n        return record.getTest();\n    }\n}\n","after":"package example;\n\npublic class UserOfA {\n\n    private final A record;\n\n    public UserOfA() {\n        this.record = new A(\"some value\");\n    }\n\n    public String getRecordValue() {\n        return record.test();\n    }\n}\n","diff":"@@ -12,1 +12,1 @@\n\n    public String getRecordValue() {\n-       return record.getTest();\n+       return record.test();\n    }\n","newFile":false}]}]}>
