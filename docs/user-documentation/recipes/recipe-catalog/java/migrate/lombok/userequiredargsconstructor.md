...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/lombok/userequiredargsconstructor" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.lombok.UseRequiredArgsConstructor"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/lombok/UseRequiredArgsConstructor.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.lombok.UseRequiredArgsConstructor","displayName":"Use `@RequiredArgsConstructor` where applicable","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
