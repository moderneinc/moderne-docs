...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/lombok/updatelomboktojava11" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.lombok.UpdateLombokToJava11"}
  languages={["Java"]}
...
<ExampleList examples={[{"unchanged":{"language":"xml","code":"<project>\n    <modelVersion>4.0.0</modelVersion>\n    <groupId>com.example.jackson</groupId>\n    <artifactId>jackson-legacy</artifactId>\n    <version>1.0.0</version>\n    <dependencies>\n        <dependency>\n            <groupId>org.projectlombok</groupId>\n            <artifactId>lombok</artifactId>\n            <version>1.18.6</version>\n        </dependency>\n    </dependencies>\n</project>\n"},"variants":[{"language":"java","before":"import lombok.experimental.Wither;\nimport lombok.experimental.Builder;\nimport lombok.experimental.Value;\n\n@Wither\n@Builder\n@Value\npublic class Fred {\n    private String firstName;\n    private String lastName;\n}\n","after":"import lombok.Value;\nimport lombok.With;\nimport lombok.Builder;\n\n@With\n@Builder\n@Value\npublic class Fred {\n    private String firstName;\n    private String lastName;\n}\n","diff":"@@ -1,3 +1,3 @@\n-import lombok.experimental.Wither;\n-import lombok.experimental.Builder;\n-import lombok.experimental.Value;\n+import lombok.Value;\n+import lombok.With;\n+import lombok.Builder;\n\n@@ -5,1 +5,1 @@\nimport lombok.experimental.Value;\n\n-@Wither\n+@With\n@Builder\n","newFile":false}]},{"unchanged":{"language":"xml","code":"<project>\n    <modelVersion>4.0.0</modelVersion>\n    <groupId>com.example.jackson</groupId>\n    <artifactId>jackson-legacy</artifactId>\n    <version>1.0.0</version>\n    <dependencies>\n        <dependency>\n            <groupId>org.projectlombok</groupId>\n            <artifactId>lombok</artifactId>\n            <version>1.18.6</version>\n        </dependency>\n    </dependencies>\n</project>\n"},"variants":[{"language":"java","before":"import lombok.experimental.Wither;\nimport lombok.experimental.Builder;\nimport lombok.experimental.Value;\n\n@Wither\n@Builder\n@Value\npublic class Fred {\n    private String firstName;\n    private String lastName;\n}\n","after":"import lombok.Value;\nimport lombok.With;\nimport lombok.Builder;\n\n@With\n@Builder\n@Value\npublic class Fred {\n    private String firstName;\n    private String lastName;\n}\n","diff":"@@ -1,3 +1,3 @@\n-import lombok.experimental.Wither;\n-import lombok.experimental.Builder;\n-import lombok.experimental.Value;\n+import lombok.Value;\n+import lombok.With;\n+import lombok.Builder;\n\n@@ -5,1 +5,1 @@\nimport lombok.experimental.Value;\n\n-@Wither\n+@With\n@Builder\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.migrate.lombok.UpdateLombokToJava11","displayName":"Migrate Lombok to a Java 11 compatible version","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-java","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_JAVA","requiresConfiguration":false}}>
