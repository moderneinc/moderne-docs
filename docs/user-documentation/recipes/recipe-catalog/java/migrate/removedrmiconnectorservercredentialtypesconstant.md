...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/removedrmiconnectorservercredentialtypesconstant" />
</head>
...
_This recipe replaces the `RMIConnectorServer.CREDENTIAL_TYPES` constant with the `RMIConnectorServer.CREDENTIALS_FILTER_PATTERN` constant._
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.RemovedRMIConnectorServerCredentialTypesConstant")
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.RemovedRMIConnectorServerCredentialTypesConstant -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe RemovedRMIConnectorServerCredentialTypesConstant
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.RemovedRMIConnectorServerCredentialTypesConstant" />
