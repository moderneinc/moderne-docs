...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.migrate.io.AddInputStreamBulkReadMethod"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/io/AddInputStreamBulkReadMethod.java"}
/>
