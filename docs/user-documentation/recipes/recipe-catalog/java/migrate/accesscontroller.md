...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/migrate/accesscontroller" />
</head>
...
_The Security Manager API is unsupported in Java 24. This recipe will remove the usage of `java.security.AccessController`._
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.AccessController")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.AccessController</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.AccessController -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe AccessController
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.AccessController" />
