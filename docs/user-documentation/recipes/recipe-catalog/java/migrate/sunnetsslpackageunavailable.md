...
_The internal API `com.sun.net.ssl` is removed. The package was intended for internal use only and replacement APIs can be found in the `javax.net.ssl` package._
...
## Examples
##### Example 1
`SunNetSslPackageUnavailableTest#sunNetSslPackageUnavailableTest`
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.SunNetSslPackageUnavailable -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SunNetSslPackageUnavailable
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.migrate.SunNetSslPackageUnavailable" />
