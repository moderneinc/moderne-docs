...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.search.ModuleUsesType"}
  languages={["Java"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-java/src/main/java/org/openrewrite/java/search/ModuleUsesType.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"fullyQualifiedTypeName","value":"java.util.List"},{"parameter":"includeImplicit","value":"null"}],"unchanged":{"language":"java","code":"class C {}\n"},"variants":[{"language":"java","before":"class B {}\n","after":"/*~~(Module uses type: java.util.List)~~>*/class B {}\n","diff":"@@ -1,1 +1,1 @@\n-class B {}\n+/*~~(Module uses type: java.util.List)~~>*/class B {}\n\n","newFile":false},{"language":"java","before":"import java.util.List;\nclass A {\n    List<String> items;\n}\n","after":"/*~~(Module uses type: java.util.List)~~>*/import java.util.List;\nclass A {\n    List<String> items;\n}\n","diff":"@@ -1,1 +1,1 @@\n-import java.util.List;\n+/*~~(Module uses type: java.util.List)~~>*/import java.util.List;\nclass A {\n","newFile":false}]}]}>
