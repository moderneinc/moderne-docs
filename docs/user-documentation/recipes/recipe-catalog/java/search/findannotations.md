...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/search/findannotations" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.search.FindAnnotations"}
  languages={["Java"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-java/src/main/java/org/openrewrite/java/search/FindAnnotations.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"annotationPattern","value":"@org.jspecify.annotations.Nullable"},{"parameter":"matchMetaAnnotations","value":"true"}],"variants":[{"language":"java","before":"import org.openrewrite.internal.lang.Nullable;\npublic class Test {\n    @Nullable String name;\n}\n","after":"import org.openrewrite.internal.lang.Nullable;\npublic class Test {\n    /*~~>*/@Nullable String name;\n}\n","diff":"@@ -3,1 +3,1 @@\nimport org.openrewrite.internal.lang.Nullable;\npublic class Test {\n-   @Nullable String name;\n+   /*~~>*/@Nullable String name;\n}\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.search.FindAnnotations","displayName":"Find annotations","groupId":"org.openrewrite","artifactId":"rewrite-java","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_JAVA","requiresConfiguration":true,"cliOptions":" --recipe-option \"annotationPattern='@java.lang.SuppressWarnings(\"deprecation\")'\""}}>
