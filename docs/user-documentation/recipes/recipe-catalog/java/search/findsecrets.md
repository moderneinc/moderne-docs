...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/search/findsecrets" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.search.FindSecrets"}
  languages={["Java"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-java/src/main/resources/META-INF/rewrite/find-plaintext-secrets.yml"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.search.FindSecrets","displayName":"Find plain text secrets","groupId":"org.openrewrite","artifactId":"rewrite-java","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_JAVA","requiresConfiguration":false}}>
