...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.micronaut.UpdateJakartaAnnotations"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.micronaut.UpdateJakartaAnnotations","displayName":"Update jakarta annotations dependency","groupId":"org.openrewrite.recipe","artifactId":"rewrite-micronaut","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MICRONAUT","requiresConfiguration":false}}>
