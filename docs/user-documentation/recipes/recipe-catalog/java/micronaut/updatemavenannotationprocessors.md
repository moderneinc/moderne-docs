...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/micronaut/updatemavenannotationprocessors" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.micronaut.UpdateMavenAnnotationProcessors"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.micronaut.UpdateMavenAnnotationProcessors","displayName":"Update the version of core annotation processors","groupId":"org.openrewrite.recipe","artifactId":"rewrite-micronaut","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MICRONAUT","requiresConfiguration":false}}>
