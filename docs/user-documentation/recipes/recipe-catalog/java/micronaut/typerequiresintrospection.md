...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.micronaut.TypeRequiresIntrospection"}
  languages={["Java"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-micronaut/blob/main/src/main/java/org/openrewrite/java/micronaut/TypeRequiresIntrospection.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.micronaut.TypeRequiresIntrospection","displayName":"Add `@Introspected` to classes requiring a map representation","groupId":"org.openrewrite.recipe","artifactId":"rewrite-micronaut","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MICRONAUT","requiresConfiguration":false}}>
