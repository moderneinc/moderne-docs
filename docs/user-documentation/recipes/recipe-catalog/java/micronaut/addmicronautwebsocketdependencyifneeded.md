...
canonical_url: "https://docs.openrewrite.org/recipes/java/micronaut/addmicronautwebsocketdependencyifneeded"
---
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-micronaut:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.micronaut.AddMicronautWebsocketDependencyIfNeeded -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.micronaut.AddMicronautWebsocketDependencyIfNeeded" />
