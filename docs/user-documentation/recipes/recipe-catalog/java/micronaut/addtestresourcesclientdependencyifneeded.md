...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.micronaut.AddTestResourcesClientDependencyIfNeeded"}
  languages={["Java"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-micronaut/blob/main/src/main/java/org/openrewrite/java/micronaut/AddTestResourcesClientDependencyIfNeeded.java"}
/>
