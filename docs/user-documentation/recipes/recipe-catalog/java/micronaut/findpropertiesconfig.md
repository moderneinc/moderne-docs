...
_Find Micronaut properties configuration files._
...
rewrite {
    activeRecipe("org.openrewrite.java.micronaut.FindPropertiesConfig")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.micronaut.FindPropertiesConfig</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-micronaut:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.micronaut.FindPropertiesConfig -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe FindPropertiesConfig
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.micronaut.FindPropertiesConfig" />
