...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.micronaut.UpdateBuildToMicronaut4Version"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.micronaut.UpdateBuildToMicronaut4Version","displayName":"Update the Micronaut version to 4.x","groupId":"org.openrewrite.recipe","artifactId":"rewrite-micronaut","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MICRONAUT","requiresConfiguration":false}}>
