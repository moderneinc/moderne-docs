...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.micronaut.AddHttpRequestTypeParameter"}
  languages={["Java"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-micronaut/blob/main/src/main/java/org/openrewrite/java/micronaut/AddHttpRequestTypeParameter.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.micronaut.AddHttpRequestTypeParameter","displayName":"Add `HttpRequest` type parameter for implemented interfaces","groupId":"org.openrewrite.recipe","artifactId":"rewrite-micronaut","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MICRONAUT","requiresConfiguration":false}}>
