...
canonical_url: "https://docs.openrewrite.org/recipes/java/micronaut/removewithjansilogbackconfiguration"
---
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-micronaut:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.micronaut.RemoveWithJansiLogbackConfiguration -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe RemoveWithJansiLogbackConfiguration
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.micronaut.RemoveWithJansiLogbackConfiguration" />
