...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.micronaut.UpdateMicronautPlatformBom"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.micronaut.UpdateMicronautPlatformBom","displayName":"Update to Micronaut 4.x platform BOM","groupId":"org.openrewrite.recipe","artifactId":"rewrite-micronaut","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MICRONAUT","requiresConfiguration":false}}>
