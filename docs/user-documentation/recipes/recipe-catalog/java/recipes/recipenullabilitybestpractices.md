...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/recipes/recipenullabilitybestpractices" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.RecipeNullabilityBestPractices"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.RecipeNullabilityBestPractices","displayName":"Recipe nullability best practices","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
