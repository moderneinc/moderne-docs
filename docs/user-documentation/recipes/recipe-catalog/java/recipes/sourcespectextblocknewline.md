...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/recipes/sourcespectextblocknewline" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.SourceSpecTextBlockNewLine"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/SourceSpecTextBlockNewLine.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.SourceSpecTextBlockNewLine","displayName":"New line at the end of `SourceSpecs` text blocks","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
