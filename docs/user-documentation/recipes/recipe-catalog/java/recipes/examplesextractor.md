...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/recipes/examplesextractor" />
</head>
...
_Extract the before/after sources from tests annotated with `@DocumentExample`, and generate a YAML file with those examples to be shown in the documentation to show usage._

## Recipe source

[GitHub: ExamplesExtractor.java](https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/ExamplesExtractor.java),
...
###### New file
```yaml title="src/main/resources/META-INF/rewrite/examples.yml"
---
...
rewrite {
    activeRecipe("org.openrewrite.java.recipes.ExamplesExtractor")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.recipes.ExamplesExtractor</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-rewrite:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.recipes.ExamplesExtractor -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe ExamplesExtractor
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.recipes.ExamplesExtractor" />
