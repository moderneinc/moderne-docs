...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.ReorderTestMethods"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/ReorderTestMethods.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.ReorderTestMethods","displayName":"Show `@DocumentExample`s first","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
