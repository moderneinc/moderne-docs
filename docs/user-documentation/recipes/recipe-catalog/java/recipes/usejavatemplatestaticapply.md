...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/recipes/usejavatemplatestaticapply" />
</head>
...
_Replaces `JavaTemplate.builder(template).build().apply(cursor, coordinates, args...)` with `JavaTemplate.apply(template, cursor, coordinates, args...)` when the builder chain has no intermediate configuration methods._

## Recipe source

[GitHub: UseJavaTemplateStaticApply.java](https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/UseJavaTemplateStaticApply.java),
...
<RunRecipe
  recipeName="org.openrewrite.java.recipes.UseJavaTemplateStaticApply"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.recipes.UseJavaTemplateStaticApply" />
