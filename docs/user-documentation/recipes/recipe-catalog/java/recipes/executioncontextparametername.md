...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/recipes/executioncontextparametername" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.ExecutionContextParameterName"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/ExecutionContextParameterName.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"parameterName","value":"null"}],"variants":[{"language":"java","before":"import org.openrewrite.*;\nclass SampleRecipe extends Recipe {\n    public void test(ExecutionContext executionContext) {}\n}\n","after":"import org.openrewrite.*;\nclass SampleRecipe extends Recipe {\n    public void test(ExecutionContext ctx) {}\n}\n","diff":"@@ -3,1 +3,1 @@\nimport org.openrewrite.*;\nclass SampleRecipe extends Recipe {\n-   public void test(ExecutionContext executionContext) {}\n+   public void test(ExecutionContext ctx) {}\n}\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.ExecutionContextParameterName","displayName":"Use a standard name for `ExecutionContext`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
