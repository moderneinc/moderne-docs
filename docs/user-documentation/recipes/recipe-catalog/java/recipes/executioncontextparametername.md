...
[GitHub: ExecutionContextParameterName.java](https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/ExecutionContextParameterName.java),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-rewrite:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.recipes.ExecutionContextParameterName -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe ExecutionContextParameterName
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.recipes.ExecutionContextParameterName" />
