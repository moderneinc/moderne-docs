...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/recipes/sourcespectextblockindentation" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.SourceSpecTextBlockIndentation"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/SourceSpecTextBlockIndentation.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.SourceSpecTextBlockIndentation","displayName":"Minimal indentation for `SourceSpecs` text blocks","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
