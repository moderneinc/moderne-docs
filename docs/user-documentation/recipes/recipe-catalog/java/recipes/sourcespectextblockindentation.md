...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-rewrite:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.recipes.SourceSpecTextBlockIndentation -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SourceSpecTextBlockIndentation
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.recipes.SourceSpecTextBlockIndentation" />
