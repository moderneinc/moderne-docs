...
canonical_url: "https://docs.openrewrite.org/recipes/java/recipes/usetreerandomid"
---
...
_Replaces occurrences of `UUID.randomUUID()` with `Tree.randomId()` when passed as an argument to a constructor call for LST elements._

## Recipe source

[GitHub: UseTreeRandomId.java](https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/UseTreeRandomId.java),
...
```shell title="shell"
mod run . --recipe UseTreeRandomId
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.recipes.UseTreeRandomId" />
