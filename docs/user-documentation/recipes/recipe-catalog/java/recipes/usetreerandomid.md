...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.UseTreeRandomId"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/UseTreeRandomId.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.UseTreeRandomId","displayName":"Use `Tree.randomId()` in LST constructors","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
