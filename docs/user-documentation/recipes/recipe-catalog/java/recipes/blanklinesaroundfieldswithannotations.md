...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/recipes/blanklinesaroundfieldswithannotations" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.BlankLinesAroundFieldsWithAnnotations"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/BlankLinesAroundFieldsWithAnnotations.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.BlankLinesAroundFieldsWithAnnotations","displayName":"Add a blank line around fields with annotations","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
