...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/recipes/replacenullwithdoesnotexist" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.ReplaceNullWithDoesNotExist"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/ReplaceNullWithDoesNotExist.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.ReplaceNullWithDoesNotExist","displayName":"Replace null with RewriteTest.doesNotExist()","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
