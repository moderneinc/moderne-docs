...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/recipes/isliteralnullrecipe" />
</head>
...
[GitHub: IsLiteralNull.java](https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/IsLiteralNull.java),
...
rewrite {
    activeRecipe("org.openrewrite.java.recipes.IsLiteralNullRecipe")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.recipes.IsLiteralNullRecipe</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-rewrite:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.recipes.IsLiteralNullRecipe -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe IsLiteralNullRecipe
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.recipes.IsLiteralNullRecipe" />
