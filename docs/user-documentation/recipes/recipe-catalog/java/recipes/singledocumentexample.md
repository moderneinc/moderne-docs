...
[GitHub: SingleDocumentExample.java](https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/SingleDocumentExample.java),
...
rewrite {
    activeRecipe("org.openrewrite.java.recipes.SingleDocumentExample")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.recipes.SingleDocumentExample</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-rewrite:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.recipes.SingleDocumentExample -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SingleDocumentExample
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.recipes.SingleDocumentExample" />
