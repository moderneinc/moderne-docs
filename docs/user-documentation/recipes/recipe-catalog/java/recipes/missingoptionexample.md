...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/recipes/missingoptionexample" />
</head>
...
rewrite {
    activeRecipe("org.openrewrite.java.recipes.MissingOptionExample")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.recipes.MissingOptionExample</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-rewrite:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.recipes.MissingOptionExample -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe MissingOptionExample
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.recipes.MissingOptionExample" />
