...
<RecipeMeta
  ...
  sourceUrl={"https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/MissingOptionExample.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.MissingOptionExample","displayName":"Find missing `@Option` `example` values","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
