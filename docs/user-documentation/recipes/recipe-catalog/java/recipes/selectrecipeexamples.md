...
canonical_url: "https://docs.openrewrite.org/recipes/java/recipes/selectrecipeexamples"
---
...
[GitHub: SelectRecipeExamples.java](https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/SelectRecipeExamples.java),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-rewrite:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.recipes.SelectRecipeExamples -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe SelectRecipeExamples
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.recipes.SelectRecipeExamples" />
