...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.SelectRecipeExamples"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/SelectRecipeExamples.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.SelectRecipeExamples","displayName":"Automatically select recipe examples from the unit test cases of a recipe","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
