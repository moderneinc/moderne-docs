...
canonical_url: "https://docs.openrewrite.org/recipes/java/recipes/javarecipebestpractices"
---
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-rewrite:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.recipes.JavaRecipeBestPractices -Drewrite.exportDatatables=true
```
</TabItem>
