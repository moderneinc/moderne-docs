...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.UseStringUtilsRecipes"}
  languages={["Java"]}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"class Test {\n    boolean test(String str) {\n        return str != null && !str.isEmpty();\n    }\n}\n","after":"import org.openrewrite.internal.StringUtils;\n\nclass Test {\n    boolean test(String str) {\n        return StringUtils.isNotEmpty(str);\n    }\n}\n","diff":"@@ -1,0 +1,2 @@\n+import org.openrewrite.internal.StringUtils;\n+\nclass Test {\n@@ -3,1 +5,1 @@\nclass Test {\n    boolean test(String str) {\n-       return str != null && !str.isEmpty();\n+       return StringUtils.isNotEmpty(str);\n    }\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.UseStringUtilsRecipes","displayName":"Use `StringUtils` utility methods","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
