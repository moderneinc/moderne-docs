...
_Remove `@NlsRewrite.DisplayName` and `@NlsRewrite.Description` annotations, but only from classes that extend `Recipe`._

## Recipe source

[GitHub: RemoveNlsRewriteAnnotations.java](https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/RemoveNlsRewriteAnnotations.java),
...
<RunRecipe
  recipeName="org.openrewrite.java.recipes.RemoveNlsRewriteAnnotations"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.recipes.RemoveNlsRewriteAnnotations" />
