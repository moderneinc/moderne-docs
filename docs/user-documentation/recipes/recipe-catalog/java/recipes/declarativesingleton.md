...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.DeclarativeSingleton"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/DeclarativeSingleton.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"exclusions","value":"null"}],"variants":[{"language":"yaml","before":"---\ntype: specs.openrewrite.org/v1beta/recipe\nname: com.example.MyRecipe\ndisplayName: My Recipe\ndescription: Does something useful\nrecipeList:\n  - org.openrewrite.java.OrderImports\n","after":"---\ntype: specs.openrewrite.org/v1beta/recipe\nname: com.example.MyRecipe\ndisplayName: My Recipe\ndescription: Does something useful\npreconditions:\n  - org.openrewrite.Singleton\nrecipeList:\n  - org.openrewrite.java.OrderImports\n","diff":"--- src/main/resources/META-INF/rewrite/test.yml\n+++ src/main/resources/META-INF/rewrite/test.yml\n@@ -6,0 +6,2 @@\ndisplayName: My Recipe\ndescription: Does something useful\n+preconditions:\n+ - org.openrewrite.Singleton\nrecipeList:\n","newFile":false}]}]}>
