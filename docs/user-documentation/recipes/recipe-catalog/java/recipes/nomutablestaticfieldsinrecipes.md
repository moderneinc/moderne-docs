...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.NoMutableStaticFieldsInRecipes"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/NoMutableStaticFieldsInRecipes.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.NoMutableStaticFieldsInRecipes","displayName":"Recipe classes should not have mutable `static` fields","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
