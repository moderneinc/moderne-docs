...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/java/recipes/upgradeteststojava21" />
</head>
...
_Use Java 21 features in tests._
...
name: org.openrewrite.java.recipes.UpgradeTestsToJava21
...
rewrite {
    activeRecipe("org.openrewrite.java.recipes.UpgradeTestsToJava21")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.recipes.UpgradeTestsToJava21</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-rewrite:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.recipes.UpgradeTestsToJava21 -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe UpgradeTestsToJava21
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.recipes.UpgradeTestsToJava21" />
