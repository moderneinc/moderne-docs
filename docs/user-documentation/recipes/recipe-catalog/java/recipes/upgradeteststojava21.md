...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.UpgradeTestsToJava21"}
  languages={["Java"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.UpgradeTestsToJava21","displayName":"Migrate tests to Java 21","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
