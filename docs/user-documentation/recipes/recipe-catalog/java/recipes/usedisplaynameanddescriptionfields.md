...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.recipes.UseDisplayNameAndDescriptionFields"}
  languages={["Java"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-rewrite/blob/main/src/main/java/org/openrewrite/java/recipes/UseDisplayNameAndDescriptionFields.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.java.recipes.UseDisplayNameAndDescriptionFields","displayName":"Replace `getDisplayName()` and `getDescription()` methods with fields","groupId":"org.openrewrite.recipe","artifactId":"rewrite-rewrite","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_REWRITE","requiresConfiguration":false}}>
