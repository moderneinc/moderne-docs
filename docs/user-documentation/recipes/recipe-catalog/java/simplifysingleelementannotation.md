...
rewrite {
    activeRecipe("org.openrewrite.java.SimplifySingleElementAnnotation")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.SimplifySingleElementAnnotation</recipe>
          </activeRecipes>
        </configuration>
      </plugin>
    </plugins>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.java.SimplifySingleElementAnnotation -Drewrite.exportDatatables=true
```
...
```shell title="shell"
mod run . --recipe SimplifySingleElementAnnotation
```
