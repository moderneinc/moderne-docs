...
<RecipeMeta
  ...
  fqName={"io.moderne.java.jsf.richfaces.ConvertExtendedDataTableHeightToStyle"}
...
<UsageList usage={{"recipeName":"io.moderne.java.jsf.richfaces.ConvertExtendedDataTableHeightToStyle","displayName":"Convert height/width attributes to `extendedDataTable` style","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
