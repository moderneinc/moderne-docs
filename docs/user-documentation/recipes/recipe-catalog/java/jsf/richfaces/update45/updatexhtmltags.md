...
<RecipeMeta
  ...
  fqName={"io.moderne.java.jsf.richfaces.update45.UpdateXHTMLTags"}
...
<UsageList usage={{"recipeName":"io.moderne.java.jsf.richfaces.update45.UpdateXHTMLTags","displayName":"Migrate RichFaces tags in `xhtml` files","groupId":"io.moderne.recipe","artifactId":"rewrite-spring","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_SPRING","requiresConfiguration":false}}>
