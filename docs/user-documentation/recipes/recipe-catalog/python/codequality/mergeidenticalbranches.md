...
<UsageList usage={{"recipeName":"org.openrewrite.python.codequality.MergeIdenticalBranches","displayName":"Merge consecutive branches with identical bodies","pipPackage":"openrewrite-migrate-python","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_PYTHON"}}>
