...
* [Mitigate Unaffected Non-EE Jakarta 9 Packages](/user-documentation/recipes/recipe-catalog/com/oracle/weblogic/rewrite/jakarta/mitigateunaffectednoneejakarta9packages.md)
...
* [Use `java.security.cert` instead of `javax.security.cert`](/user-documentation/recipes/recipe-catalog/io/quarkus/updates/core/quarkus37/deprecatedjavaxsecuritycert.md)
