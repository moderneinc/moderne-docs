...
<RunRecipe
  recipeName="org.openrewrite.python.ChangePackage"
  displayName="Change package"
  pipPackage="openrewrite"
/>
ewrite/java/ChangePackage.java),
...
* [Migrate the Sequenced Dead-Letter Queue to Axoniq Framework 5](/user-documentation/recipes/recipe-catalog/axoniq/framework/migration/axon4toaxoniq5deadletter.md)
* [Migrate the Spring Boot Actuator extension to Axon Framework 5](/user-documentation/recipes/recipe-catalog/axonframework/migration/axon4toaxon5springbootactuatorextension.md)
...
* [Mitigate Unaffected Non-EE Jakarta 9 Packages](/user-documentation/recipes/recipe-catalog/oracle/weblogic/rewrite/jakarta/mitigateunaffectednoneejakarta9packages.md)
...
* [Update Jackson package names from 2.x to 3.x](/user-documentation/recipes/recipe-catalog/java/jackson/upgradejackson_2_3_packagechanges.md)
...
* [Use `java.security.cert` instead of `javax.security.cert`](/user-documentation/recipes/recipe-catalog/java/migrate/deprecatedjavaxsecuritycert.md)
* [Use `java.security.cert` instead of `javax.security.cert`](/user-documentation/recipes/recipe-catalog/quarkus/updates/core/quarkus37/deprecatedjavaxsecuritycert.md)
* [Use `javax.net.ssl` instead of `com.sun.net.ssl`](/user-documentation/recipes/recipe-catalog/java/migrate/jredonotusesunnetsslapis.md)
...
* [io.quarkus.updates.core.quarkus331.OpenTelemetryTracingPackageTypoFix](/user-documentation/recipes/recipe-catalog/quarkus/updates/core/quarkus331/opentelemetrytracingpackagetypofix.md)
