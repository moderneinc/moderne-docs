...
<RecipeMeta
  ...
  fqName={"org.openrewrite.java.search.FindMethods"}
  languages={["Java"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-java/src/main/java/org/openrewrite/java/search/FindMethods.java"}
/>
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.java.search.FindMethods"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/java/search/findmethods.md"}
>

<RecipeHeader.Title>Find method usages</RecipeHeader.Title>

<RecipeHeader.Description>Find method calls by pattern.</RecipeHeader.Description>
...
<ExampleList examples={[{"parameters":[{"parameter":"methodPattern","value":"A <constructor>(String)"},{"parameter":"matchOverrides","value":"false"}],"unchanged":{"language":"java","code":"class A {\n    public A(String s) {}\n}\n"},"variants":[{"language":"java","before":"class Test {\n    A a = new A(\"test\");\n}\n","after":"class Test {\n    A a = /*~~>*/new A(\"test\");\n}\n","diff":"@@ -2,1 +2,1 @@\nclass Test {\n-   A a = new A(\"test\");\n+   A a = /*~~>*/new A(\"test\");\n}\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.java.search.FindMethods","displayName":"Find method usages","groupId":"org.openrewrite","artifactId":"rewrite-java","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_JAVA","requiresConfiguration":true,"cliOptions":" --recipe-option \"methodPattern=java.util.List add(..)\""}}>
