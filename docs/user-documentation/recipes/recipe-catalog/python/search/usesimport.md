---
title: "Find Python files that import a module"
sidebar_label: "Find Python files that import a module"
hide_title: true
---
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.python.search.UsesImport"}
  languages={["Python"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.python.search.UsesImport","displayName":"Find Python files that import a module","groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON","requiresConfiguration":true,"cliOptions":" --recipe-option \"module=datetime\""}}>
