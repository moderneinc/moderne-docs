...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.SimplifyNegativeIndex","displayName":"Use negative index instead of `len()` offset","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
