...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveRedundantConstructorInDictUnion","displayName":"Unwrap unnecessary `dict()` from union operands","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
