...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveUnitStepFromRange","displayName":"Drop unnecessary step `1` argument from `range()`","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
