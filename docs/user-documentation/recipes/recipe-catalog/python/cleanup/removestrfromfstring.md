...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveStrFromFstring","displayName":"Strip ``str()`` from f-string placeholders","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
