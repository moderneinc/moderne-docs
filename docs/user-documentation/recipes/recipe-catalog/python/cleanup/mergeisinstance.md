...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.MergeIsinstance","displayName":"Merge `isinstance()` calls","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
