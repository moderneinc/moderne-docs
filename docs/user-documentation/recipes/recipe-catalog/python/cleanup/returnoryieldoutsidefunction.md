...
<RecipeMeta
  ...
  fqName={"org.openrewrite.python.cleanup.ReturnOrYieldOutsideFunction"}
  languages={["Python"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.ReturnOrYieldOutsideFunction","displayName":"Remove `return`/`yield` outside function","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
