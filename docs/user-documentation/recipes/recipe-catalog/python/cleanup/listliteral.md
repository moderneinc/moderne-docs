---
title: "Use `[]` literal instead of `list()` constructor"
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.python.cleanup.ListLiteral"}
  languages={["Python"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.ListLiteral","displayName":"Use `[]` literal instead of `list()` constructor","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
