...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveRedundantBoolean","displayName":"Eliminate boolean literal from `and`/`or`","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
