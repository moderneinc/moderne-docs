...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.SwapIfExpression","displayName":"Swap ternary branches to drop negated condition","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
