...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.TernaryToIfExpression","displayName":"Convert `and`/`or` ternary trick to conditional expression","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
