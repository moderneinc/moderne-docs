...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.SwapVariable","displayName":"Simplify temp-variable swap to tuple unpacking","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
