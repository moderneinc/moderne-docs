...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.CollectionIntoSet","displayName":"Prefer set literals in `in` membership tests","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
