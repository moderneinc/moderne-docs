...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.PandasAvoidInplace","displayName":"Eliminate `inplace=True` in favor of reassignment","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
