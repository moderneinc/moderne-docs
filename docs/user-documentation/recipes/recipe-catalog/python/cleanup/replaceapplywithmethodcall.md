...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.ReplaceApplyWithMethodCall","displayName":"Convert `apply('name')` to a direct method invocation","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
