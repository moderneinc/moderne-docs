...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.InstanceMethodFirstArgName","displayName":"Standardize instance method first parameter to `self`","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
