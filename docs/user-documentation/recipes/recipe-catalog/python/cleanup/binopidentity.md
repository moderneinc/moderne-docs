...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.BinOpIdentity","displayName":"Collapse self-cancelling `^` / `-` with duplicate operands to `0`","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
