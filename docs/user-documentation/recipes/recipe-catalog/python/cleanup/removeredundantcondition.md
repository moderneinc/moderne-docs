...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveRedundantCondition","displayName":"Remove redundant ternary condition","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
