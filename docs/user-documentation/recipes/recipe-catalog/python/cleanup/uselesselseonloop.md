...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.UselessElseOnLoop","displayName":"Flatten `for/else` when the loop has no `break`","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
