...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveUnnecessaryElse","displayName":"Drop ``else`` after early-exit ``if`` branch","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
