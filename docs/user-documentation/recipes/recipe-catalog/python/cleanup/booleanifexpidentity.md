...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.BooleanIfExpIdentity","displayName":"Collapse boolean ternary to bare condition","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
