...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.MergeElseIfIntoElif","displayName":"Convert ``else: if`` to ``elif``","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
