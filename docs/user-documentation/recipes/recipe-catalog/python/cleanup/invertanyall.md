...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.InvertAnyAll","displayName":"Swap `not all()`/`not any()` by negating the comparison","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
