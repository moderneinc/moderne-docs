...
<RecipeMeta
  ...
  fqName={"org.openrewrite.python.cleanup.RemoveStrFromPrint"}
  languages={["Python"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveStrFromPrint","displayName":"Unwrap ``str()`` from ``print()`` arguments","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
