...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveRedundantContinue","displayName":"Strip trailing ``continue`` from loop body","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
