...
<RecipeMeta
  ...
  fqName={"org.openrewrite.python.cleanup.SquareIdentity"}
  languages={["Python"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.SquareIdentity","displayName":"Rewrite self-multiplication as `** 2`","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
