...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.MergeComparisons","displayName":"Consolidate repeated `==` with `or` into `in`","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
