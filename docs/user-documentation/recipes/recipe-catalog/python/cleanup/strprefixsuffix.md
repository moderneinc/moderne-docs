...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.StrPrefixSuffix","displayName":"Prefer ``startswith``/``endswith`` over slice comparison","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
