...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.DataframeAppendToConcat","displayName":"Migrate deprecated `.append()` to `pd.concat()`","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
