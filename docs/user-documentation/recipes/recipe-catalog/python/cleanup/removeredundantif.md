...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveRedundantIf","displayName":"Simplify negated ``elif`` to ``else``","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
