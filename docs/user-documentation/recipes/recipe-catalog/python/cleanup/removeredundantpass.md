...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveRedundantPass","displayName":"Delete unnecessary ``pass`` in non-empty blocks","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
