...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemovePassElif","displayName":"Drop ``pass``-only ``elif`` by negating its condition","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
