...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RaiseFromPreviousError","displayName":"Chain exceptions with `raise ... from` in except blocks","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
