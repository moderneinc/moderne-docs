...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.UnwrapIterableConstruction","displayName":"Flatten redundant collection constructor wrapping a literal","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
