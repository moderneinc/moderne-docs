...
<RecipeMeta
  ...
  fqName={"org.openrewrite.python.cleanup.RemoveNoneFromDefaultGet"}
  languages={["Python"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveNoneFromDefaultGet","displayName":"Remove redundant `None` default from `dict.get()`","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
