...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.InvertAnyAllBody","displayName":"Apply De Morgan's law to `any(not ...)`/`all(not ...)`","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
