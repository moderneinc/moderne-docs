...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.AssignIfExp","displayName":"Use inline conditional for simple ``if``/``else`` assignment","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
