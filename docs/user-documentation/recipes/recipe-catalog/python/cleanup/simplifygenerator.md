...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.SimplifyGenerator","displayName":"Pass iterable directly to `any()`/`all()` instead of identity generator","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
