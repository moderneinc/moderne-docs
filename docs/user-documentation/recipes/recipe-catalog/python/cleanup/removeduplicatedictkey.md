...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveDuplicateDictKey","displayName":"Deduplicate repeated keys in dict literals","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
