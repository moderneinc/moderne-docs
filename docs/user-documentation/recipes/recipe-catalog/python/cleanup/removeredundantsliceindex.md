...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveRedundantSliceIndex","displayName":"Drop default-value slice boundaries","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
