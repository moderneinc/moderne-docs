...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.DefaultMutableArg","displayName":"Guard mutable default arguments with `None` sentinel","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
