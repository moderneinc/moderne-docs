...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveUnreachableCode","displayName":"Strip dead code after terminal statements","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
