...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.SimplifyDictionaryUpdate","displayName":"Convert one-item `dict.update()` to bracket assignment","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
