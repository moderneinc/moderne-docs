...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.SwapIfElseBranches","displayName":"Flip empty ``if``-body by negating the condition","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
