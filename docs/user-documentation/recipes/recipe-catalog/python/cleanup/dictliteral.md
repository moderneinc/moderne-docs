---
title: "Use `{}` literal instead of `dict()` constructor"
sidebar_label: "Use `{}` literal instead of `dict()` constructor"
hide_title: true
---
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.python.cleanup.DictLiteral"}
  languages={["Python"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.DictLiteral","displayName":"Use `{}` literal instead of `dict()` constructor","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
