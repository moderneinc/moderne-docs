...
<RecipeMeta
  ...
  fqName={"org.openrewrite.python.cleanup.SimplifyDivision"}
  languages={["Python"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.SimplifyDivision","displayName":"Convert `int(a / b)` to floor division","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
