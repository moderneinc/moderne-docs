...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.RemoveAssertTrue","displayName":"Delete no-op `assert True` statements","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
