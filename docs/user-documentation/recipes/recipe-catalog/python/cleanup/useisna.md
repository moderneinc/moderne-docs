...
<UsageList usage={{"recipeName":"org.openrewrite.python.cleanup.UseIsna","displayName":"Use `.isna()` instead of `== np.nan` comparisons","pipPackage":"openrewrite-static-analysis","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
