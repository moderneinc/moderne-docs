...
<RecipeMeta
  ...
  fqName={"org.openrewrite.python.ChangeMethodName"}
  languages={["Python"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.python.ChangeMethodName","displayName":"Change method name","pipPackage":"openrewrite"}}>
