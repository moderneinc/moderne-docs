...
displayName: Add Python dependency example
recipeList:
  - org.openrewrite.python.AddDependency:
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.python.AddDependency" />
