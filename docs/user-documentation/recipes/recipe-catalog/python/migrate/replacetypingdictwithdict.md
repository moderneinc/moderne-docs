...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingDictWithDict](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingDictWithDict),
[Issue Tracker](),
