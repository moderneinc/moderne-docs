...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.FindTelnetlibModule](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.FindTelnetlibModule),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.FindTelnetlibModule
```
