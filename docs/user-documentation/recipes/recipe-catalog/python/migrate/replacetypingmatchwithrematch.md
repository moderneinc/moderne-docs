---
sidebar_label: "Replace `typing.Match` with `re.Match`"
---
...
_Replace `typing.Match` with `re.Match`. Available in Python 3.9+ (PEP 585)._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingMatchWithReMatch](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingMatchWithReMatch),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.ReplaceTypingMatchWithReMatch
```
