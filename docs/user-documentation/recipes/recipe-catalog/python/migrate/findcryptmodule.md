...
_The `crypt` module was deprecated in Python 3.11 and removed in Python 3.13. Use `bcrypt`, `argon2-cffi`, or `passlib` instead._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.FindCryptModule](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.FindCryptModule),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.FindCryptModule
```
