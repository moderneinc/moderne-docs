...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingCallableWithCollectionsAbcCallable](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingCallableWithCollectionsAbcCallable),
[Issue Tracker](),
