...
<UsageList usage={{"recipeName":"org.openrewrite.python.migrate.FindTypes","displayName":"Find Python types","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-python","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_PYTHON","requiresConfiguration":true,"pipPackage":"openrewrite-migrate-python","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}],"cliOptions":" --recipe-option \"typeName=OrderedDict\""}}>
