...
_The `uu` module was deprecated in Python 3.11 and removed in Python 3.13. Use `base64` module instead for encoding binary data._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.FindUuModule](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.FindUuModule),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.FindUuModule
```
