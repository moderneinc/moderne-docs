...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.FindSndhdrModule](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.FindSndhdrModule),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.FindSndhdrModule
```
