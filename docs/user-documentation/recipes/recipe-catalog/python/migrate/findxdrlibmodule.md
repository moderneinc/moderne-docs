...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.FindXdrlibModule](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.FindXdrlibModule),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.FindXdrlibModule
```
