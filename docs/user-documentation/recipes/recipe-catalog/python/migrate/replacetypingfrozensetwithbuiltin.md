...
_Replace `typing.FrozenSet` with the built-in `frozenset` type. Available in Python 3.9+ (PEP 585)._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingFrozenSetWithBuiltin](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingFrozenSetWithBuiltin),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.ReplaceTypingFrozenSetWithBuiltin
```
