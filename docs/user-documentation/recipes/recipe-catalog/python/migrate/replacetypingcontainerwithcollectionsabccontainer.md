...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingContainerWithCollectionsAbcContainer](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingContainerWithCollectionsAbcContainer),
[Issue Tracker](),
