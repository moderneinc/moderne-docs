...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceElementGetiterator](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceElementGetiterator),
[Issue Tracker](),
