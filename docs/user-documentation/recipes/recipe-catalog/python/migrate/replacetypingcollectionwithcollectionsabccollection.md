...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingCollectionWithCollectionsAbcCollection](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingCollectionWithCollectionsAbcCollection),
[Issue Tracker](),
