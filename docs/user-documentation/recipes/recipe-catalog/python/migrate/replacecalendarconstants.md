...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceCalendarConstants](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceCalendarConstants),
[Issue Tracker](),
