...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.FindPipesModule](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.FindPipesModule),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.FindPipesModule
```
