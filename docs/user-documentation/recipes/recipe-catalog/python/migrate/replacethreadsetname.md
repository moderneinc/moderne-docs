...
_Replace `setName()` method calls with `name` property assignment. Deprecated in Python 3.10, removed in 3.12._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceThreadSetName](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceThreadSetName),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.ReplaceThreadSetName
```
