...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.FindImghdrModule](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.FindImghdrModule),
[Issue Tracker](),
