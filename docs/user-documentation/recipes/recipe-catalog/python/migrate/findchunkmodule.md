...
_The `chunk` module was deprecated in Python 3.11 and removed in Python 3.13. Implement IFF chunk reading manually or use specialized libraries._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.FindChunkModule](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.FindChunkModule),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.FindChunkModule
```
