...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceAstNameConstant](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceAstNameConstant),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.ReplaceAstNameConstant
```
