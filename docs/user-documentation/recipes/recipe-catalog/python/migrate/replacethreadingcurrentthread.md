...
_Replace `threading.currentThread()` with `threading.current_thread()`. The camelCase version was deprecated in Python 3.10 and removed in 3.12._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceThreadingCurrentThread](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceThreadingCurrentThread),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.ReplaceThreadingCurrentThread
```
