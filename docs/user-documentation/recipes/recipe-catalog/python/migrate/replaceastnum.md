...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceAstNum](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceAstNum),
[Issue Tracker](),
