...
_Replace `getName()` method calls with the `name` property. Deprecated in Python 3.10, removed in 3.12._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceThreadGetName](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceThreadGetName),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.ReplaceThreadGetName
```
