...
<RecipeMeta
  ...
  description={"Migrate deprecated abstract base class imports from `collections` to `collections.abc`. These imports were deprecated in Python 3.3 and removed in Python 3.10."}
  fqName={"org.openrewrite.python.migrate.ReplaceCollectionsAbcImports"}
  languages={["Python"]}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.python.migrate.ReplaceCollectionsAbcImports"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/python/migrate/replacecollectionsabcimports.md"}
  moderneOnly
>

<RecipeHeader.Title>Replace `collections` ABC imports with `collections.abc`</RecipeHeader.Title>
