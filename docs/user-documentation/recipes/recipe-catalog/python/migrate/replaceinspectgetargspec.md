...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceInspectGetargspec](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceInspectGetargspec),
[Issue Tracker](),
