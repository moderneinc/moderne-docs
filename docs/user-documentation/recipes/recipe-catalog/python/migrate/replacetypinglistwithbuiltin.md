...
_Replace `typing.List` with the built-in `list` type. Available in Python 3.9+ (PEP 585)._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingListWithBuiltin](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingListWithBuiltin),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.ReplaceTypingListWithBuiltin
```
