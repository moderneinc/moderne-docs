...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.python.migrate.ReplaceUnittestDeprecatedAliases"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/python/migrate/replaceunittestdeprecatedaliases.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.python.migrate.ReplaceUnittestDeprecatedAliases","displayName":"Replace deprecated unittest method aliases","pipPackage":"openrewrite-migrate-python","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_PYTHON","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-python","companionJars":[{"groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON"}]}}>
