...
_The `cgi` module was deprecated in Python 3.11 and removed in Python 3.13. Use `urllib.parse` for query string parsing, `html.escape()` for escaping, and web frameworks or `email.message` for form handling._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.FindCgiModule](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.FindCgiModule),
[Issue Tracker](),
