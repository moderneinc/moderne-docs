...
_Replace `isSet()` method calls with `is_set()`. The camelCase version was deprecated in Python 3.10 and removed in 3.12._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceEventIsSet](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceEventIsSet),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.ReplaceEventIsSet
```
