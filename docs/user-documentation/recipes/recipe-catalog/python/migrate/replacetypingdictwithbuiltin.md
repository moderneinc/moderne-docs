...
_Replace `typing.Dict` with the built-in `dict` type. Available in Python 3.9+ (PEP 585)._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingDictWithBuiltin](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingDictWithBuiltin),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.ReplaceTypingDictWithBuiltin
```
