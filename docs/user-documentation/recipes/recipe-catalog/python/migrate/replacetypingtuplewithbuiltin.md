...
_Replace `typing.Tuple` with the built-in `tuple` type. Available in Python 3.9+ (PEP 585)._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingTupleWithBuiltin](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingTupleWithBuiltin),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.ReplaceTypingTupleWithBuiltin
```
