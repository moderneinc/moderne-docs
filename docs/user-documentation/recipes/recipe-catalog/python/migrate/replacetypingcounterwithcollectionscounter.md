---
sidebar_label: "Replace `typing.Counter` with `collections.Counter`"
---
...
_Replace `typing.Counter` with `collections.Counter`. Available in Python 3.9+ (PEP 585)._
...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingCounterWithCollectionsCounter](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingCounterWithCollectionsCounter),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.ReplaceTypingCounterWithCollectionsCounter
```
