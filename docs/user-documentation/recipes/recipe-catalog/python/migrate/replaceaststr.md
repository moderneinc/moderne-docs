...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceAstStr](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceAstStr),
[Issue Tracker](),
...
mod run . --recipe org.openrewrite.python.migrate.ReplaceAstStr
```
