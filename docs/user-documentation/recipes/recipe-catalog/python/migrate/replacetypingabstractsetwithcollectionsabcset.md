...
[GitHub: search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingAbstractSetWithCollectionsAbcSet](https://github.com/search?type=code&q=repo:+org.openrewrite.python.migrate.ReplaceTypingAbstractSetWithCollectionsAbcSet),
[Issue Tracker](),
