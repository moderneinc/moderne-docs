...
<RecipeMeta
  ...
  fqName={"org.openrewrite.python.format.PythonSpaces"}
  languages={["Python"]}
...
<UsageList usage={{"recipeName":"org.openrewrite.python.format.PythonSpaces","displayName":"Formats spaces in Python code","groupId":"org.openrewrite","artifactId":"rewrite-python","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_PYTHON","requiresConfiguration":false}}>
