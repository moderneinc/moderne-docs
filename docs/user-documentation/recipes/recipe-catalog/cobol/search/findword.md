...
<RecipeHeader.Title>Find matching words in the source code</RecipeHeader.Title>

<RecipeHeader.Description>Search for COBOL words based on a search term.</RecipeHeader.Description>
