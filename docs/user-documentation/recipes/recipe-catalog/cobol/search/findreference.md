...
[GitHub: FindReference.java](https://github.com/moderneinc/rewrite-cobol/blob/main/src/main/java/org/openrewrite/cobol/search/FindReference.java),
...
<TabItem value="org.openrewrite.cobol.table.ReferenceSearchResult" label="ReferenceSearchResult">

### COBOL reference search results
**org.openrewrite.cobol.table.ReferenceSearchResult**

_Identifier references found in COBOL, copybook, and JCL sources._

| Column Name | Description |
| ----------- | ----------- |
| Source path | The source path of the file that contains the matching reference. |
| Source type | The type of source where the reference was found. |
| Reference | The identifier text that matched the search criteria. |
