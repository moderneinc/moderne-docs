...
[GitHub: FindIndicators.java](https://github.com/moderneinc/rewrite-cobol/blob/main/src/main/java/org/openrewrite/cobol/search/FindIndicators.java),
...
<TabItem value="org.openrewrite.cobol.table.IndicatorSearchResult" label="IndicatorSearchResult">

### COBOL indicator search results
**org.openrewrite.cobol.table.IndicatorSearchResult**

_Indicator area matches found in COBOL source code._

| Column Name | Description |
| ----------- | ----------- |
| Source path | The source path of the file that contains the matching indicator. |
| Indicator | The indicator character found in the indicator area. |
| Word | The word text on the line where the indicator was found. |
