...
<RecipeMeta
  ...
  fqName={"org.openrewrite.tapestry.ReplaceReverseComparator"}
...
<UsageList usage={{"recipeName":"org.openrewrite.tapestry.ReplaceReverseComparator","displayName":"Replace `ReverseComparator` with `Collections.reverseOrder()`","groupId":"io.moderne.recipe","artifactId":"rewrite-tapestry","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_TAPESTRY","requiresConfiguration":false}}>
