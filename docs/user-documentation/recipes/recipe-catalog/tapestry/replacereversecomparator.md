...
_Replaces tapestry-contrib's `ReverseComparator` with the standard Java `Collections.reverseOrder()` method._
...
<RunRecipe
  recipeName="org.openrewrite.tapestry.ReplaceReverseComparator"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.tapestry.ReplaceReverseComparator" />
