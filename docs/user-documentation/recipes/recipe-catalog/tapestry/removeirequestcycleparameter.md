...
_Removes `IRequestCycle` parameters from methods. In Tapestry 5, event handler methods don't receive the request cycle as a parameter._
...
<RunRecipe
  recipeName="org.openrewrite.tapestry.RemoveIRequestCycleParameter"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.tapestry.RemoveIRequestCycleParameter" />
