...
<RecipeMeta
  ...
  fqName={"org.openrewrite.tapestry.RemoveIRequestCycleParameter"}
...
<UsageList usage={{"recipeName":"org.openrewrite.tapestry.RemoveIRequestCycleParameter","displayName":"Remove `IRequestCycle` parameters","groupId":"io.moderne.recipe","artifactId":"rewrite-tapestry","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_TAPESTRY","requiresConfiguration":false}}>
