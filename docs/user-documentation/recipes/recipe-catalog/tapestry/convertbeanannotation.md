...
_Converts Tapestry 4's `@Bean` annotation to `@Property` fields. Bean initialization with 'initializer' attribute requires manual migration._
...
<RunRecipe
  recipeName="org.openrewrite.tapestry.ConvertBeanAnnotation"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.tapestry.ConvertBeanAnnotation" />
