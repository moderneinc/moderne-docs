...
<RecipeMeta
  ...
  fqName={"org.openrewrite.tapestry.ConvertBeanAnnotation"}
...
<UsageList usage={{"recipeName":"org.openrewrite.tapestry.ConvertBeanAnnotation","displayName":"Convert Tapestry 4 `@Bean` to `@Property`","groupId":"io.moderne.recipe","artifactId":"rewrite-tapestry","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_TAPESTRY","requiresConfiguration":false}}>
