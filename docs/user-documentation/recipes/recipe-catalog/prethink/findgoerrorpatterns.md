...
_Detect Go error-handling idioms: error returns, fmt.Errorf %w wrapping, errors.Is/As, panic/recover, and sentinel error variables._
...
<RunRecipe
  recipeName="io.moderne.prethink.FindGoErrorPatterns"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.FindGoErrorPatterns" />
