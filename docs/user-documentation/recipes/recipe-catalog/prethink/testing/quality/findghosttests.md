...
<RecipeMeta
  ...
  fqName={"io.moderne.prethink.testing.quality.FindGhostTests"}
...
<UsageList usage={{"recipeName":"io.moderne.prethink.testing.quality.FindGhostTests","displayName":"Find ghost tests","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
