...
<RecipeMeta
  ...
  fqName={"io.moderne.prethink.testing.quality.FindUnmockedExternalCalls"}
...
<UsageList usage={{"recipeName":"io.moderne.prethink.testing.quality.FindUnmockedExternalCalls","displayName":"Find unmocked external calls in tests","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
