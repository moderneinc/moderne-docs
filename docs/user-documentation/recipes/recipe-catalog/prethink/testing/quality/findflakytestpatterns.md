...
<RecipeMeta
  ...
  fqName={"io.moderne.prethink.testing.quality.FindFlakyTestPatterns"}
...
<UsageList usage={{"recipeName":"io.moderne.prethink.testing.quality.FindFlakyTestPatterns","displayName":"Find flaky test patterns","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
