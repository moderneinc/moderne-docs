...
<RecipeMeta
  ...
  fqName={"io.moderne.prethink.testing.quality.FindNodeFragileTestData"}
...
<UsageList usage={{"recipeName":"io.moderne.prethink.testing.quality.FindNodeFragileTestData","displayName":"Find Node.js fragile test data","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
