...
_Detect patterns that commonly cause flaky tests in JavaScript and TypeScript code, including static waits (setTimeout, setInterval), prototype mutation, and shared mutable state (module-scope let/var declarations)._
...
<RunRecipe
  recipeName="io.moderne.prethink.testing.quality.FindNodeFlakyTestPatterns"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.testing.quality.FindNodeFlakyTestPatterns" />
