...
_Detect Thread.Sleep, Task.Delay (without CancellationToken), and .Result/.Wait() on Task in .NET tests — patterns that cause flakiness or deadlocks._
...
<RunRecipe
  recipeName="io.moderne.prethink.testing.quality.FindDotnetFlakyTestPatterns"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.testing.quality.FindDotnetFlakyTestPatterns" />
