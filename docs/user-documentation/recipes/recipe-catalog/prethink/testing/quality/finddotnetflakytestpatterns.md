---
title: "Find .NET flaky test patterns"
sidebar_label: "Find .NET flaky test patterns"
hide_title: true
---
...
<RecipeMeta
  displayName={"Find .NET flaky test patterns"}
  description={"Detect Thread.Sleep, Task.Delay (without CancellationToken), and .Result/.Wait() on Task in .NET tests — patterns that cause flakiness or deadlocks."}
  fqName={"io.moderne.prethink.testing.quality.FindDotnetFlakyTestPatterns"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.prethink.testing.quality.FindDotnetFlakyTestPatterns"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/prethink/testing/quality/finddotnetflakytestpatterns.md"}
  moderneOnly
>

<RecipeHeader.Title>Find .NET flaky test patterns</RecipeHeader.Title>

<RecipeHeader.Description>Detect Thread.Sleep, Task.Delay (without CancellationToken), and .Result/.Wait() on Task in .NET tests — patterns that cause flakiness or deadlocks.</RecipeHeader.Description>

</RecipeHeader>

<UsageList usage={{"recipeName":"io.moderne.prethink.testing.quality.FindDotnetFlakyTestPatterns","displayName":"Find .NET flaky test patterns","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
