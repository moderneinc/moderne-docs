---
title: "Find unmocked external calls in Node.js tests"
sidebar_label: "Find unmocked external calls in Node.js tests"
---
...
_Detect direct HTTP, database, and network calls in JavaScript/TypeScript test files that are not mocked. Integration and e2e test files are excluded._
...
###### Unchanged
```javascript title="src/api.test.js"
...
<RunRecipe
  recipeName="io.moderne.prethink.testing.quality.FindNodeUnmockedExternalCalls"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.testing.quality.FindNodeUnmockedExternalCalls" />
