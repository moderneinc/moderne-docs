...
<RecipeMeta
  ...
  fqName={"io.moderne.prethink.testing.quality.FindSilentTestFailures"}
...
<UsageList usage={{"recipeName":"io.moderne.prethink.testing.quality.FindSilentTestFailures","displayName":"Find silent test failures","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
