...
_Analyze the codebase to extract dependency usage patterns by examining which types from external libraries are actually used in the code._

## Recipe source

[GitHub: ExtractDependencyUsage.java](https://github.com/openrewrite/rewrite-prethink/blob/main/src/main/java/io/moderne/prethink/ExtractDependencyUsage.java),
...
rewrite {
    activeRecipe("io.moderne.prethink.ExtractDependencyUsage")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>io.moderne.prethink.ExtractDependencyUsage</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-prethink:RELEASE -Drewrite.activeRecipes=io.moderne.prethink.ExtractDependencyUsage -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe ExtractDependencyUsage
```
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.ExtractDependencyUsage" />
