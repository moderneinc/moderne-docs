---
title: "Extract Ruby dependencies"
sidebar_label: "Extract Ruby dependencies"
hide_title: true
---
...
<RecipeMeta
  displayName={"Extract Ruby dependencies"}
  description={"Read Gemfile, gemspec and Gemfile.lock manifests and emit rows into the shared dependency-list-report table, mirroring the JVM dependency inventory. Records the Bundler group a gem was declared in and whether it comes from a git or path source rather than RubyGems, and joins the resolved versions in Gemfile.lock, including transitive gems, onto the gems the Gemfile and gemspec declare."}
  fqName={"io.moderne.prethink.ExtractRubyDependencies"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.prethink.ExtractRubyDependencies"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/prethink/extractrubydependencies.md"}
  moderneOnly
>

<RecipeHeader.Title>Extract Ruby dependencies</RecipeHeader.Title>

<RecipeHeader.Description>Read Gemfile, gemspec and Gemfile.lock manifests and emit rows into the shared dependency-list-report table, mirroring the JVM dependency inventory. Records the Bundler group a gem was declared in and whether it comes from a git or path source rather than RubyGems, and joins the resolved versions in Gemfile.lock, including transitive gems, onto the gems the Gemfile and gemspec declare.</RecipeHeader.Description>
