...
_Compute per-struct code quality metrics for Go including WMC, LCOM4, TCC, CBO, and maintainability index. Aggregates methods with the same receiver type across files._
...
<RunRecipe
  recipeName="io.moderne.prethink.quality.FindGoTypeMetrics"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.quality.FindGoTypeMetrics" />
