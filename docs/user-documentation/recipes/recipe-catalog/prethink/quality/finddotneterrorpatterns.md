...
_Detect .NET logging frameworks (Microsoft.Extensions.Logging, Serilog, NLog, log4net) and catch-block strategies (swallow, rethrow, log, wrap)._
...
<RunRecipe
  recipeName="io.moderne.prethink.quality.FindDotnetErrorPatterns"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.quality.FindDotnetErrorPatterns" />
