---
title: "Find Ruby type quality metrics"
sidebar_label: "Find Ruby type quality metrics"
hide_title: true
---
...
<RecipeMeta
  displayName={"Find Ruby type quality metrics"}
  description={"Compute per-class code quality metrics for Ruby including WMC, LCOM4, TCC, CBO, and maintainability index. Aggregates classes and modules of the same name across files."}
  fqName={"io.moderne.prethink.quality.FindRubyTypeMetrics"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.prethink.quality.FindRubyTypeMetrics"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/prethink/quality/findrubytypemetrics.md"}
  moderneOnly
>

<RecipeHeader.Title>Find Ruby type quality metrics</RecipeHeader.Title>

<RecipeHeader.Description>Compute per-class code quality metrics for Ruby including WMC, LCOM4, TCC, CBO, and maintainability index. Aggregates classes and modules of the same name across files.</RecipeHeader.Description>
