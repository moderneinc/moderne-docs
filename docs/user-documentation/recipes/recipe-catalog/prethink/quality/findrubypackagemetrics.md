---
title: "Find Ruby package quality metrics"
sidebar_label: "Find Ruby package quality metrics"
hide_title: true
---
...
<RecipeMeta
  displayName={"Find Ruby package quality metrics"}
  description={"Per-directory architectural metrics for Ruby: afferent/efferent coupling, instability, abstractness (module ratio), distance from main sequence, and cycle detection."}
  fqName={"io.moderne.prethink.quality.FindRubyPackageMetrics"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.prethink.quality.FindRubyPackageMetrics"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/prethink/quality/findrubypackagemetrics.md"}
  moderneOnly
>

<RecipeHeader.Title>Find Ruby package quality metrics</RecipeHeader.Title>

<RecipeHeader.Description>Per-directory architectural metrics for Ruby: afferent/efferent coupling, instability, abstractness (module ratio), distance from main sequence, and cycle detection.</RecipeHeader.Description>

</RecipeHeader>

<UsageList usage={{"recipeName":"io.moderne.prethink.quality.FindRubyPackageMetrics","displayName":"Find Ruby package quality metrics","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
