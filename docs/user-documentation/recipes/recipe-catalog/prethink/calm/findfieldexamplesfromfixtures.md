...
_Walk JSON and YAML fixture files under src/test/resources and emit raw (fixturePath, jsonPath, value, valueType) rows so that an LLM can mine realistic example values for OpenAPI specs and contract tests._
...
<RunRecipe
  recipeName="io.moderne.prethink.calm.FindFieldExamplesFromFixtures"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.calm.FindFieldExamplesFromFixtures" />
