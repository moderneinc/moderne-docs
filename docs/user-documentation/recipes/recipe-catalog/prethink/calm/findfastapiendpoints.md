...
_Identify REST/HTTP endpoints in FastAPI applications. Detects @app.get(), @router.post(), and similar route decorator patterns._
...
<RunRecipe
  recipeName="io.moderne.prethink.calm.FindFastAPIEndpoints"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.calm.FindFastAPIEndpoints" />
