...
canonical_url: "https://docs.openrewrite.org/recipes/prethink/calm/findmessagingconnections"
---
...
rewrite {
    activeRecipe("io.moderne.prethink.calm.FindMessagingConnections")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>io.moderne.prethink.calm.FindMessagingConnections</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-prethink:RELEASE -Drewrite.activeRecipes=io.moderne.prethink.calm.FindMessagingConnections -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe FindMessagingConnections
```
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.calm.FindMessagingConnections" />
