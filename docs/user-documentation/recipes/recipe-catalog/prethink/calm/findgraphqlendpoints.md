...
_Identify GraphQL endpoints exposed by the application. Supports Spring GraphQL, Netflix DGS, and GraphQL Java (graphql-java-tools)._
...
<RunRecipe
  recipeName="io.moderne.prethink.calm.FindGraphQLEndpoints"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.calm.FindGraphQLEndpoints" />
