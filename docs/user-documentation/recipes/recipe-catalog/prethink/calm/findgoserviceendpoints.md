...
_Detect HTTP endpoints registered via net/http, gin, echo, chi, gorilla/mux, and fiber routers._
...
<RunRecipe
  recipeName="io.moderne.prethink.calm.FindGoServiceEndpoints"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.calm.FindGoServiceEndpoints" />
