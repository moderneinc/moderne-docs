---
title: "Find Python gRPC services"
sidebar_label: "Find Python gRPC services"
hide_title: true
---
...
<RecipeMeta
  displayName={"Find Python gRPC services"}
  description={"Detect gRPC service implementations in Python by classes subclassing generated *Servicer base classes (grpcio), emitting one endpoint per RPC handler method."}
  fqName={"io.moderne.prethink.calm.FindPythonGrpcServices"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.prethink.calm.FindPythonGrpcServices"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/prethink/calm/findpythongrpcservices.md"}
  moderneOnly
>

<RecipeHeader.Title>Find Python gRPC services</RecipeHeader.Title>

<RecipeHeader.Description>Detect gRPC service implementations in Python by classes subclassing generated *Servicer base classes (grpcio), emitting one endpoint per RPC handler method.</RecipeHeader.Description>
