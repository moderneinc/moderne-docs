...
<RecipeMeta
  displayName={"Find Go database connections"}
  description={"Detect database/sql, GORM, sqlx, pgx, and ent usage in Go source."}
  fqName={"io.moderne.prethink.calm.FindGoDatabaseConnections"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.prethink.calm.FindGoDatabaseConnections"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/prethink/calm/findgodatabaseconnections.md"}
  moderneOnly
>

<RecipeHeader.Title>Find Go database connections</RecipeHeader.Title>

<RecipeHeader.Description>Detect database/sql, GORM, sqlx, pgx, and ent usage in Go source.</RecipeHeader.Description>
