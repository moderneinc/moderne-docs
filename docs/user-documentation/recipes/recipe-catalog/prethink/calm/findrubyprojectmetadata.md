---
title: "Find Ruby project metadata"
sidebar_label: "Find Ruby project metadata"
hide_title: true
---
...
<RecipeMeta
  displayName={"Find Ruby project metadata"}
  description={"Extract project metadata (name, version, summary) from Ruby gemspecs, from the Rails application module declared in config/application.rb, or failing both from the directory holding a Gemfile. Only the most specific of the three sources present contributes rows, so a repository resolves to one identity."}
  fqName={"io.moderne.prethink.calm.FindRubyProjectMetadata"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.prethink.calm.FindRubyProjectMetadata"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/prethink/calm/findrubyprojectmetadata.md"}
  moderneOnly
>

<RecipeHeader.Title>Find Ruby project metadata</RecipeHeader.Title>

<RecipeHeader.Description>Extract project metadata (name, version, summary) from Ruby gemspecs, from the Rails application module declared in config/application.rb, or failing both from the directory holding a Gemfile. Only the most specific of the three sources present contributes rows, so a repository resolves to one identity.</RecipeHeader.Description>
