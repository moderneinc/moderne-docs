...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/prethink/calm/generatecalmarchitecture" />
</head>
...
[GitHub: GenerateCalmArchitecture.java](https://github.com/openrewrite/rewrite-prethink/blob/main/src/main/java/org/openrewrite/prethink/calm/GenerateCalmArchitecture.java),
...
rewrite {
    activeRecipe("org.openrewrite.prethink.calm.GenerateCalmArchitecture")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.prethink.calm.GenerateCalmArchitecture</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-prethink:RELEASE -Drewrite.activeRecipes=org.openrewrite.prethink.calm.GenerateCalmArchitecture -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe GenerateCalmArchitecture
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.prethink.calm.GenerateCalmArchitecture" />
