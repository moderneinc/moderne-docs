...
<RecipeMeta
  ...
  fqName={"org.openrewrite.prethink.calm.GenerateCalmArchitecture"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-prethink/blob/main/src/main/java/org/openrewrite/prethink/calm/GenerateCalmArchitecture.java"}
/>
