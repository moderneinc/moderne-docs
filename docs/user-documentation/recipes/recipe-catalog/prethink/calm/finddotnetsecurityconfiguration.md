...
_Detect ASP.NET Core authentication (JwtBearer/OpenIdConnect/Cookie), authorization, CORS, HSTS, and HTTPS redirection middleware registrations._
...
<RunRecipe
  recipeName="io.moderne.prethink.calm.FindDotnetSecurityConfiguration"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.calm.FindDotnetSecurityConfiguration" />
