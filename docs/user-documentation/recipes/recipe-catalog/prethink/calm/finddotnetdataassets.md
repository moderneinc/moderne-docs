...
_Detect C# DTOs, records, and entity types based on property/method ratio, [DataContract] / [Table] attributes, and `record` keyword._
...
<RunRecipe
  recipeName="io.moderne.prethink.calm.FindDotnetDataAssets"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.calm.FindDotnetDataAssets" />
