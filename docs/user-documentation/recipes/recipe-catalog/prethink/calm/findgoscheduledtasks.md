---
title: "Find Go scheduled tasks"
sidebar_label: "Find Go scheduled tasks"
hide_title: true
---
...
<RecipeMeta
  displayName={"Find Go scheduled tasks"}
  description={"Detect background work scheduled through robfig/cron, go-co-op/gocron, `time.NewTicker`/`time.Tick`, and `time.AfterFunc` in Go source."}
  fqName={"io.moderne.prethink.calm.FindGoScheduledTasks"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.prethink.calm.FindGoScheduledTasks"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/prethink/calm/findgoscheduledtasks.md"}
  moderneOnly
>

<RecipeHeader.Title>Find Go scheduled tasks</RecipeHeader.Title>

<RecipeHeader.Description>Detect background work scheduled through robfig/cron, go-co-op/gocron, `time.NewTicker`/`time.Tick`, and `time.AfterFunc` in Go source.</RecipeHeader.Description>
