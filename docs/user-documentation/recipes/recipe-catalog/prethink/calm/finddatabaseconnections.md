...
<RecipeMeta
  ...
  fqName={"io.moderne.prethink.calm.FindDatabaseConnections"}
...
<UsageList usage={{"recipeName":"io.moderne.prethink.calm.FindDatabaseConnections","displayName":"Find database connections","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
