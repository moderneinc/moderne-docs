...
_Identify Go test/benchmark/fuzz functions in *_test.go files and record them in the test mapping table._
...
<RunRecipe
  recipeName="io.moderne.prethink.calm.FindGoTestCoverage"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.calm.FindGoTestCoverage" />
