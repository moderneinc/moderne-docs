...
<RecipeMeta
  displayName={"Find TypeORM entities"}
  description={"Identify TypeORM entities in Node.js applications. Detects @Entity() decorator on classes and populates the DatabaseConnections table."}
  fqName={"io.moderne.prethink.calm.FindTypeORMEntities"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.prethink.calm.FindTypeORMEntities"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/prethink/calm/findtypeormentities.md"}
  moderneOnly
>

<RecipeHeader.Title>Find TypeORM entities</RecipeHeader.Title>

<RecipeHeader.Description>Identify TypeORM entities in Node.js applications. Detects @Entity() decorator on classes and populates the DatabaseConnections table.</RecipeHeader.Description>

</RecipeHeader>

<UsageList usage={{"recipeName":"io.moderne.prethink.calm.FindTypeORMEntities","displayName":"Find TypeORM entities","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
