---
title: "Find ASP.NET Framework endpoints (Web API 2 and MVC 5)"
sidebar_label: "Find ASP.NET Framework endpoints (Web API 2 and MVC 5)"
hide_title: true
---
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.prethink.calm.FindAspNetFrameworkEndpoints"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/prethink/calm/findaspnetframeworkendpoints.md"}
  moderneOnly
>

<RecipeHeader.Title>Find ASP.NET Framework endpoints (Web API 2 and MVC 5)</RecipeHeader.Title>

<RecipeHeader.Description>Identify HTTP endpoints declared in classic .NET Framework web applications: ASP.NET Web API 2 controllers (System.Web.Http.ApiController) and ASP.NET MVC 5 controllers (System.Web.Mvc.Controller), covering both attribute routing ([Route], [RoutePrefix], [HttpGet/Post/...], [AcceptVerbs]) and the default convention-based routes.</RecipeHeader.Description>

</RecipeHeader>

<UsageList usage={{"recipeName":"io.moderne.prethink.calm.FindAspNetFrameworkEndpoints","displayName":"Find ASP.NET Framework endpoints (Web API 2 and MVC 5)","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
