---
title: "Find Ruby messaging"
sidebar_label: "Find Ruby messaging"
hide_title: true
---
...
<RecipeMeta
  displayName={"Find Ruby messaging"}
  description={"Identify messaging patterns in Ruby applications. Detects Sidekiq, ActiveJob, Resque, ActionCable, Karafka, Racecar, and Shoryuken consumers, including those that reach their framework through a base class of the application's own, along with the call sites that enqueue to them."}
  fqName={"io.moderne.prethink.calm.FindRubyMessaging"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.prethink.calm.FindRubyMessaging"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/prethink/calm/findrubymessaging.md"}
  moderneOnly
>

<RecipeHeader.Title>Find Ruby messaging</RecipeHeader.Title>

<RecipeHeader.Description>Identify messaging patterns in Ruby applications. Detects Sidekiq, ActiveJob, Resque, ActionCable, Karafka, Racecar, and Shoryuken consumers, including those that reach their framework through a base class of the application's own, along with the call sites that enqueue to them.</RecipeHeader.Description>
