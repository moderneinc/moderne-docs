...
<RecipeMeta
  ...
  fqName={"io.moderne.prethink.calm.FindDotnetProjectMetadata"}
...
<UsageList usage={{"recipeName":"io.moderne.prethink.calm.FindDotnetProjectMetadata","displayName":"Find .NET project metadata","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
