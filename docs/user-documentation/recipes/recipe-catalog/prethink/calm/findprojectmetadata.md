...
<RecipeMeta
  ...
  fqName={"io.moderne.prethink.calm.FindProjectMetadata"}
...
<UsageList usage={{"recipeName":"io.moderne.prethink.calm.FindProjectMetadata","displayName":"Find project metadata","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
