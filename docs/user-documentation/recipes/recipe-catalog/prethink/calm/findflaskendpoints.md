...
_Identify REST/HTTP endpoints in Flask applications. Detects @app.route(), @blueprint.route(), and Flask 2.0+ shortcut decorators like @app.get() and @app.post()._
...
<RunRecipe
  recipeName="io.moderne.prethink.calm.FindFlaskEndpoints"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.calm.FindFlaskEndpoints" />
