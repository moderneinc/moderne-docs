...
_Extract project metadata (name, version, description) from Python pyproject.toml files._
...
<RunRecipe
  recipeName="io.moderne.prethink.calm.FindPythonProjectMetadata"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.calm.FindPythonProjectMetadata" />
