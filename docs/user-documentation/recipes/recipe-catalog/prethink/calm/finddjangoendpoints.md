...
<RecipeMeta
  ...
  fqName={"io.moderne.prethink.calm.FindDjangoEndpoints"}
...
<UsageList usage={{"recipeName":"io.moderne.prethink.calm.FindDjangoEndpoints","displayName":"Find Django endpoints","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
