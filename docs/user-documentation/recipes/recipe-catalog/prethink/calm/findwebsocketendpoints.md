...
<RecipeMeta
  ...
  fqName={"io.moderne.prethink.calm.FindWebSocketEndpoints"}
...
<UsageList usage={{"recipeName":"io.moderne.prethink.calm.FindWebSocketEndpoints","displayName":"Find WebSocket endpoints","groupId":"io.moderne.recipe","artifactId":"rewrite-prethink","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PRETHINK","requiresConfiguration":false}}>
