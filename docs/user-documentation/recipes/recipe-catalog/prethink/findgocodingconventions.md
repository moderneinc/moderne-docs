...
_Detect Go naming patterns (package names, exported vs unexported, interface -er suffix, error variable prefix, test prefix)._
...
<RunRecipe
  recipeName="io.moderne.prethink.FindGoCodingConventions"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.FindGoCodingConventions" />
