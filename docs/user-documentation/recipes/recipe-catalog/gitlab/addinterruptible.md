...
_Set `interruptible: true` in `.gitlab-ci.yml` to allow pipelines to be cancelled when superseded._

## Recipe source

[GitHub: AddInterruptible.java](https://github.com/openrewrite/rewrite-gitlab/blob/main/src/main/java/org/openrewrite/gitlab/AddInterruptible.java),
...
| --- | --- | --- | --- |
| `String` | jobName | *Optional*. The job to make interruptible. If not provided, applies to the `default` section. | `build_job` |
...
* [Merge YAML snippet](../yaml/mergeyaml)
  * key: `$`
  * yaml: `default:   interruptible: true`
...
name: org.openrewrite.gitlab.AddInterruptible
...
<RunRecipe
  recipeName="org.openrewrite.gitlab.AddInterruptible"
  displayName="Add interruptible"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.gitlab.AddInterruptible" />
