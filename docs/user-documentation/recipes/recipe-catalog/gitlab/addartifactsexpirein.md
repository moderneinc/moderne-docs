...
_Set `artifacts:expire_in` in `.gitlab-ci.yml` to prevent storage bloat from indefinitely stored artifacts._

## Recipe source

[GitHub: AddArtifactsExpireIn.java](https://github.com/openrewrite/rewrite-gitlab/blob/main/src/main/java/org/openrewrite/gitlab/AddArtifactsExpireIn.java),
...
| --- | --- | --- | --- |
| `String` | expireIn | Duration after which artifacts expire. | `1 week` |
| `String` | jobName | *Optional*. The job to apply this to. If not provided, applies to the `default` section. | `build_job` |
...
* [Merge YAML snippet](../yaml/mergeyaml)
  * key: `$`
  * yaml: `default:   artifacts:     expire_in: null`
...
---
type: specs.openrewrite.org/v1beta/recipe
name: com.yourorg.AddArtifactsExpireInExample
displayName: Add artifacts expire_in example
recipeList:
  - org.openrewrite.gitlab.AddArtifactsExpireIn:
      expireIn: 1 week
      jobName: build_job
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.gitlab.AddArtifactsExpireIn" />
