...
<RecipeHeader.Title>Add cache configuration</RecipeHeader.Title>

<RecipeHeader.Description>Add `cache` configuration to `.gitlab-ci.yml` for faster builds.</RecipeHeader.Description>
