...
_Find usages of the deprecated `only` keyword in `.gitlab-ci.yml`. The `only` keyword is deprecated in favor of `rules`._

## Recipe source

[GitHub: FindDeprecatedOnly.java](https://github.com/openrewrite/rewrite-gitlab/blob/main/src/main/java/org/openrewrite/gitlab/search/FindDeprecatedOnly.java),
...
name: org.openrewrite.gitlab.search.FindDeprecatedOnly
...
<RunRecipe
  recipeName="org.openrewrite.gitlab.search.FindDeprecatedOnly"
  displayName="Find deprecated `only` keyword"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.gitlab.search.FindDeprecatedOnly" />
