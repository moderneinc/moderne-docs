...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gitlab.search.FindDeprecatedExcept"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-gitlab/blob/main/src/main/java/org/openrewrite/gitlab/search/FindDeprecatedExcept.java"}
/>
...
<ExampleList examples={[{"variants":[{"language":"yaml","before":"deploy_job:\n  script: make deploy\n  except:\n    - tags\n","after":"deploy_job:\n  script: make deploy\n  ~~>except:\n    - tags\n","diff":"--- .gitlab-ci.yml\n+++ .gitlab-ci.yml\n@@ -3,1 +3,1 @@\ndeploy_job:\n  script: make deploy\n- except:\n+ ~~>except:\n    - tags\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.gitlab.search.FindDeprecatedExcept","displayName":"Find deprecated `except` keyword","groupId":"org.openrewrite.recipe","artifactId":"rewrite-gitlab","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_GITLAB","requiresConfiguration":false}}>
