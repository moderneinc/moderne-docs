...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/gitlab/adddefaultkeyword" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gitlab.AddDefaultKeyword"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-gitlab/blob/main/src/main/java/org/openrewrite/gitlab/AddDefaultKeyword.java"}
/>
...
<OptionsTable options={[{"type":"String","name":"keyword","required":true,"description":"The keyword to add under the `default` section.","example":"image"},{"type":"String","name":"value","required":true,"description":"The value for the keyword.","example":"ruby:3.0"},{"type":"Boolean","name":"acceptTheirs","required":false,"description":"When the keyword already exists, prefer the original value."}]}>

## Options

</OptionsTable>

<ExampleList examples={[{"parameters":[{"parameter":"keyword","value":"image"},{"parameter":"value","value":"ruby:3.0"},{"parameter":"acceptTheirs","value":"null"}],"variants":[{"language":"yaml","before":"","after":"default:\n  image: ruby:3.0\n","newFile":true}]}]}>
