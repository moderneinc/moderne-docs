...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/gitlab/changecomponent" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gitlab.ChangeComponent"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-gitlab/blob/main/src/main/java/org/openrewrite/gitlab/ChangeComponent.java"}
/>
...
<OptionsTable options={[{"type":"String","name":"oldComponent","required":true,"description":"The name of the component to match.","example":"$CI_SERVER_FQDN/components/opentofu/full-pipeline"},{"type":"String","name":"oldComponentVersion","required":true,"description":"Version of the existing component to use match.","example":"0.10.0"},{"type":"String","name":"newComponent","required":false,"description":"Name of the new component to use instead.","example":"$CI_SERVER_FQDN/components/opentofu/full-pipeline"},{"type":"String","name":"newComponentVersion","required":true,"description":"Version of the new component to use instead.","example":"0.10.0"}]}>

## Options

</OptionsTable>

<ExampleList examples={[{"parameters":[{"parameter":"oldComponent","value":"some-component"},{"parameter":"oldComponentVersion","value":"0.10.0"},{"parameter":"newComponent","value":"other-component"},{"parameter":"newComponentVersion","value":"1.0.0"}],"variants":[{"language":"yaml","before":"include:\n  - component: some-component@0.10.0\n","after":"include:\n  - component: other-component@1.0.0\n","diff":"--- .gitlab-ci.yml\n+++ .gitlab-ci.yml\n@@ -2,1 +2,1 @@\ninclude:\n- - component: some-component@0.10.0\n+ - component: other-component@1.0.0\n\n","newFile":false}]}]}>
