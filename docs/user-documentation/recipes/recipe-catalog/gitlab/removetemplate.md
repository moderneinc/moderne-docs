...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/gitlab/removetemplate" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gitlab.RemoveTemplate"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-gitlab/blob/main/src/main/java/org/openrewrite/gitlab/RemoveTemplate.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"oldTemplate","value":"Terraform/Base.gitlab-ci.yml"}],"variants":[{"language":"yaml","before":"include:\n  - template: Terraform/Base.gitlab-ci.yml\n  - template: OpenTofu/Base.gitlab-ci.yml\n","after":"include:\n  - template: OpenTofu/Base.gitlab-ci.yml\n","diff":"--- .gitlab-ci.yml\n+++ .gitlab-ci.yml\n@@ -2,1 +2,0 @@\ninclude:\n- - template: Terraform/Base.gitlab-ci.yml\n  - template: OpenTofu/Base.gitlab-ci.yml\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.gitlab.RemoveTemplate","displayName":"Remove GitLab template","groupId":"org.openrewrite.recipe","artifactId":"rewrite-gitlab","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_GITLAB","requiresConfiguration":true,"cliOptions":" --recipe-option \"oldTemplate=Terraform/Base.gitlab-ci.yml\""}}>
