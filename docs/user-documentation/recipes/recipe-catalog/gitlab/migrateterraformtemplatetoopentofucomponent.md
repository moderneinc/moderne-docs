...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/gitlab/migrateterraformtemplatetoopentofucomponent" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.gitlab.MigrateTerraformTemplateToOpenTofuComponent"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-gitlab/blob/main/src/main/resources/META-INF/rewrite/opentofu.yml"}
/>

<RecipeHeader
  type={"Composite recipe"}
  languages={["OpenRewrite"]}
  tags={["gitlab","terraform","ci","opentofu"]}
  license={"Moderne Source Available License"}
  fqName={"org.openrewrite.gitlab.MigrateTerraformTemplateToOpenTofuComponent"}
...
<ExampleList examples={[{"variants":[{"language":"yaml","before":"include:\n  - template: Terraform/Base.latest.gitlab-ci.yml\n","after":"include:\n  - component: $CI_SERVER_FQDN/components/opentofu/job-templates@~latest\n    inputs:\n      opentofu_version: 1.11.6\n","diff":"--- .gitlab-ci.yml\n+++ .gitlab-ci.yml\n@@ -2,1 +2,3 @@\ninclude:\n- - template: Terraform/Base.latest.gitlab-ci.yml\n+ - component: $CI_SERVER_FQDN/components/opentofu/job-templates@~latest\n+   inputs:\n+     opentofu_version: 1.11.6\n\n","newFile":false}]},{"variants":[{"language":"yaml","before":"include:\n  - template: Terraform/Base.latest.gitlab-ci.yml\n","after":"include:\n  - component: $CI_SERVER_FQDN/components/opentofu/job-templates@~latest\n    inputs:\n      opentofu_version: 1.11.6\n","diff":"--- .gitlab-ci.yml\n+++ .gitlab-ci.yml\n@@ -2,1 +2,3 @@\ninclude:\n- - template: Terraform/Base.latest.gitlab-ci.yml\n+ - component: $CI_SERVER_FQDN/components/opentofu/job-templates@~latest\n+   inputs:\n+     opentofu_version: 1.11.6\n\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.gitlab.MigrateTerraformTemplateToOpenTofuComponent","displayName":"Migrate GitLab Terraform template to OpenTofu component","groupId":"org.openrewrite.recipe","artifactId":"rewrite-gitlab","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_GITLAB","requiresConfiguration":false}}>
