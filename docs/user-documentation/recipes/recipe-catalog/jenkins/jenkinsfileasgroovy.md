...
<RecipeMeta
  ...
  fqName={"org.openrewrite.jenkins.JenkinsfileAsGroovy"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-jenkins/blob/main/src/main/java/org/openrewrite/jenkins/JenkinsfileAsGroovy.java"}
/>
