...
[GitHub: hudson-migrations.yml](https://github.com/openrewrite/rewrite-jenkins/blob/main/src/main/resources/META-INF/rewrite/hudson-migrations.yml),
...
## Examples
##### Example 1
`UtilGetPastTimeStringToTimeSpanStringTest#shouldReplaceFullyQualifiedMethodCall`
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.jenkins.migrate.hudson.UtilGetPastTimeStringToGetTimeSpanString" />
