...
canonical_url: "https://docs.openrewrite.org/recipes/jenkins/addjellyxmldeclaration"
---
...
[GitHub: AddJellyXmlDeclaration.java](https://github.com/openrewrite/rewrite-jenkins/blob/main/src/main/java/org/openrewrite/jenkins/AddJellyXmlDeclaration.java),
...
rewrite {
    activeRecipe("org.openrewrite.jenkins.AddJellyXmlDeclaration")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.jenkins.AddJellyXmlDeclaration</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mod run . --recipe AddJellyXmlDeclaration
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.jenkins.AddJellyXmlDeclaration" />
