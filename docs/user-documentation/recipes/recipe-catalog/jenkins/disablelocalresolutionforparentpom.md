...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/jenkins/disablelocalresolutionforparentpom" />
</head>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-jenkins:RELEASE -Drewrite.activeRecipes=org.openrewrite.jenkins.DisableLocalResolutionForParentPom -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.jenkins.DisableLocalResolutionForParentPom" />
