...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/software/amazon/awssdk/v2migration/numbertoduration" />
</head>
...
_Convert the method parameter from numeric types to duration._

## Recipe source

[GitHub: search?type=code&q=software.amazon.awssdk.v2migration.NumberToDuration](https://github.com/search?type=code&q=software.amazon.awssdk.v2migration.NumberToDuration),
...
Now that `com.yourorg.NumberToDurationExample` has been defined, activate it and take a dependency on `org.openrewrite.recipe:rewrite-third-party:{{VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY}}` in your build file:
...
rewrite {
    activeRecipe("com.yourorg.NumberToDurationExample")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.yourorg.NumberToDurationExample</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
<RecipeCallout link="https://app.moderne.io/recipes/software.amazon.awssdk.v2migration.NumberToDuration" />
