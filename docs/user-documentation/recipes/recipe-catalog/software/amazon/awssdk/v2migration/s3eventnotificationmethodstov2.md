...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/software/amazon/awssdk/v2migration/s3eventnotificationmethodstov2" />
</head>
...
_Change S3EventNotification methods to v2._
...
rewrite {
    activeRecipe("software.amazon.awssdk.v2migration.S3EventNotificationMethodsToV2")
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=software.amazon.awssdk.v2migration.S3EventNotificationMethodsToV2 -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe S3EventNotificationMethodsToV2
```
...
<RecipeCallout link="https://app.moderne.io/recipes/software.amazon.awssdk.v2migration.S3EventNotificationMethodsToV2" />
