...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/software/amazon/awssdk/v2migration/addcommenttomethod" />
</head>
...
_Add a comment to a method._

## Recipe source

[GitHub: search?type=code&q=software.amazon.awssdk.v2migration.AddCommentToMethod](https://github.com/search?type=code&q=software.amazon.awssdk.v2migration.AddCommentToMethod),
...
This recipe has required configuration parameters. Recipes with required configuration parameters cannot be activated directly (unless you are running them via the Moderne CLI). To activate this recipe you must create a new recipe which fills in the required parameters. In your `rewrite.yml` create a new recipe with a unique name. For example: `com.yourorg.AddCommentToMethodExample`.
...
Now that `com.yourorg.AddCommentToMethodExample` has been defined, activate it and take a dependency on `org.openrewrite.recipe:rewrite-third-party:{{VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY}}` in your build file:
...
<RecipeCallout link="https://app.moderne.io/recipes/software.amazon.awssdk.v2migration.AddCommentToMethod" />
