...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/analysis/search/findmethods" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.analysis.search.FindMethods"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-analysis/blob/main/src/main/java/org/openrewrite/analysis/search/FindMethods.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"methodPattern","value":"A <constructor>(String)"},{"parameter":"matchOverrides","value":"false"},{"parameter":"flow","value":"null"}],"unchanged":{"language":"java","code":"class A {\n    public A(String s) {}\n}\n"},"variants":[{"language":"java","before":"class Test {\n    A a = new A(\"test\");\n}\n","after":"class Test {\n    A a = /*~~>*/new A(\"test\");\n}\n","diff":"@@ -2,1 +2,1 @@\nclass Test {\n-   A a = new A(\"test\");\n+   A a = /*~~>*/new A(\"test\");\n}\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.analysis.search.FindMethods","displayName":"Find method usages","groupId":"org.openrewrite.meta","artifactId":"rewrite-analysis","versionKey":"VERSION_ORG_OPENREWRITE_META_REWRITE_ANALYSIS","requiresConfiguration":true,"cliOptions":" --recipe-option \"methodPattern=java.util.List add(..)\""}}>
