...
<RecipeMeta
  ...
  fqName={"org.openrewrite.analysis.java.FindNullPointerIssues"}
...
<UsageList usage={{"recipeName":"org.openrewrite.analysis.java.FindNullPointerIssues","displayName":"Find null pointer issues","groupId":"io.moderne.recipe","artifactId":"rewrite-program-analysis","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PROGRAM_ANALYSIS","requiresConfiguration":false}}>
