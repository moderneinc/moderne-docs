...
_Detects when user-controlled input flows into array or collection index expressions without proper bounds validation, which could allow out-of-bounds access or denial of service (CWE-129)._

### Tags

* [CWE-129](/user-documentation/recipes/lists/recipes-by-tag#cwe)
...
<RunRecipe
  recipeName="org.openrewrite.analysis.java.security.FindArrayIndexInjection"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.analysis.java.security.FindArrayIndexInjection" />
