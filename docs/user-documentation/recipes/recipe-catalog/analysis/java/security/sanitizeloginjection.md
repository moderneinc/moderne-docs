...
_Sanitizes user-controlled input before it flows into logging methods by stripping newline, carriage return, and tab characters that could enable log forging._
...
<RunRecipe
  recipeName="org.openrewrite.analysis.java.security.SanitizeLogInjection"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.analysis.java.security.SanitizeLogInjection" />
