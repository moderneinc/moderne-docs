...
_Detects when user-controlled input flows into logging methods without sanitization, which could allow attackers to forge log entries by injecting newline characters._
...
<RunRecipe
  recipeName="org.openrewrite.analysis.java.security.FindLogInjection"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.analysis.java.security.FindLogInjection" />
