...
_Identifies when personally identifiable information (PII) is stored in databases, files, or other persistent storage without encryption._
...
<RunRecipe
  recipeName="org.openrewrite.analysis.java.security.FindUnencryptedPiiStorage"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.analysis.java.security.FindUnencryptedPiiStorage" />
