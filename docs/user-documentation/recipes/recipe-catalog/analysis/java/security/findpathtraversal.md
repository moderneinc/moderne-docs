...
<RecipeMeta
  ...
  fqName={"org.openrewrite.analysis.java.security.FindPathTraversal"}
...
<UsageList usage={{"recipeName":"org.openrewrite.analysis.java.security.FindPathTraversal","displayName":"Find path traversal vulnerabilities","groupId":"io.moderne.recipe","artifactId":"rewrite-program-analysis","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PROGRAM_ANALYSIS","requiresConfiguration":false}}>
