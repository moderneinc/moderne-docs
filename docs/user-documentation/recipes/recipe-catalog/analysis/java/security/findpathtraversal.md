...
_Detects potential path traversal vulnerabilities where user input flows to file system operations without proper validation._
...
<RunRecipe
  recipeName="org.openrewrite.analysis.java.security.FindPathTraversal"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.analysis.java.security.FindPathTraversal" />
