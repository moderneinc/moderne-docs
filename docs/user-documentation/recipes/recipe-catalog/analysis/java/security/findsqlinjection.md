...
_Detects potential SQL injection vulnerabilities where user input flows to SQL execution methods without proper sanitization._
...
<RunRecipe
  recipeName="org.openrewrite.analysis.java.security.FindSqlInjection"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.analysis.java.security.FindSqlInjection" />
