...
_Detects when user-controlled input flows into reflection-based class loading or instantiation without proper validation, which could allow an attacker to instantiate arbitrary classes (CWE-470)._

### Tags

* [CWE-470](/user-documentation/recipes/lists/recipes-by-tag#cwe)
...
<RunRecipe
  recipeName="org.openrewrite.analysis.java.security.FindUnsafeReflectionInjection"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.analysis.java.security.FindUnsafeReflectionInjection" />
