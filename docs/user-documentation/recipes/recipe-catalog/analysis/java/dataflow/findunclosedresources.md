...
<RecipeMeta
  ...
  fqName={"org.openrewrite.analysis.java.dataflow.FindUnclosedResources"}
...
<UsageList usage={{"recipeName":"org.openrewrite.analysis.java.dataflow.FindUnclosedResources","displayName":"Find unclosed resources (S2095)","groupId":"io.moderne.recipe","artifactId":"rewrite-program-analysis","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_PROGRAM_ANALYSIS","requiresConfiguration":false}}>
