---
title: "Parameterize raw `Collection`-typed local variables"
sidebar_label: "Parameterize raw `Collection`-typed local variables"
hide_title: true
---
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.analysis.java.dataflow.ParameterizeRawCollection"}
