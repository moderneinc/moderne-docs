...
_Change the value of a Terraform resource attribute if it matches a given pattern._
...
| --- | --- | --- | --- |
| `String` | resourceName | A Terraform resource type, without the quotes. | `aws_db_instance` |
| `String` | attributeName | The name of the attribute to change. | `engine_version` |
| `String` | oldValuePattern | *Optional*. A regular expression to match the current attribute value. Only matching attributes will be changed. If not provided, all values will be changed. For quoted string values, match against the content without quotes. | `5\.7.*` |
| `String` | newValue | The new value to set. For quoted string attributes, provide the value without quotes. | `8.0` |
...
name: com.yourorg.ChangeResourceAttributeExample
displayName: Change Terraform resource attribute example
recipeList:
  - org.openrewrite.terraform.ChangeResourceAttribute:
      resourceName: aws_db_instance
      attributeName: engine_version
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.terraform.ChangeResourceAttribute" />
