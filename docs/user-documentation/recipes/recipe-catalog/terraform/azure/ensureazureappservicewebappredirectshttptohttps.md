...
<RecipeMeta
  ...
  fqName={"org.openrewrite.terraform.azure.EnsureAzureAppServiceWebAppRedirectsHTTPToHTTPS"}
...
<RecipeHeader
  ...
  languages={["OpenRewrite"]}
  tags={["CKV_AZURE_14","terraform","Azure"]}
  license={"Moderne Proprietary License"}
  fqName={"org.openrewrite.terraform.azure.EnsureAzureAppServiceWebAppRedirectsHTTPToHTTPS"}
...
<UsageList usage={{"recipeName":"org.openrewrite.terraform.azure.EnsureAzureAppServiceWebAppRedirectsHTTPToHTTPS","displayName":"Ensure Azure App Service Web app redirects HTTP to HTTPS","groupId":"org.openrewrite.recipe","artifactId":"rewrite-terraform","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TERRAFORM","requiresConfiguration":false}}>
