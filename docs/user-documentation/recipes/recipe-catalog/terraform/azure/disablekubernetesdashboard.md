...
<RecipeMeta
  ...
  fqName={"org.openrewrite.terraform.azure.DisableKubernetesDashboard"}
...
<RecipeHeader
  ...
  languages={["OpenRewrite"]}
  tags={["terraform","Azure","CKV_AZURE_8"]}
  license={"Moderne Proprietary License"}
  fqName={"org.openrewrite.terraform.azure.DisableKubernetesDashboard"}
...
<UsageList usage={{"recipeName":"org.openrewrite.terraform.azure.DisableKubernetesDashboard","displayName":"Disable Kubernetes dashboard","groupId":"org.openrewrite.recipe","artifactId":"rewrite-terraform","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TERRAFORM","requiresConfiguration":false}}>
