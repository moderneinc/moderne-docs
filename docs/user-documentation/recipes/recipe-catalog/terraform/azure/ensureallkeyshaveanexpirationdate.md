...
<RecipeMeta
  ...
  fqName={"org.openrewrite.terraform.azure.EnsureAllKeysHaveAnExpirationDate"}
...
<RecipeHeader
  ...
  languages={["OpenRewrite"]}
  tags={["CKV_AZURE_40","terraform","Azure"]}
  license={"Moderne Proprietary License"}
  fqName={"org.openrewrite.terraform.azure.EnsureAllKeysHaveAnExpirationDate"}
...
<UsageList usage={{"recipeName":"org.openrewrite.terraform.azure.EnsureAllKeysHaveAnExpirationDate","displayName":"Ensure all keys have an expiration date","groupId":"org.openrewrite.recipe","artifactId":"rewrite-terraform","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TERRAFORM","requiresConfiguration":false}}>
