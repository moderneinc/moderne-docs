...
<RecipeMeta
  ...
  fqName={"org.openrewrite.terraform.terraform013.UpgradeRequiredProvidersSyntax"}
...
<ExampleList examples={[{"parameters":[{"parameter":"defaultNamespace","value":"null"}],"variants":[{"language":"hcl","before":"terraform {\n  required_providers {\n    aws = \"~> 3.0\"\n  }\n}\n","after":"terraform {\n  required_providers {\n    aws = {\n      source  = \"hashicorp/aws\"\n      version = \"~> 3.0\"\n    }\n  }\n}\n","diff":"@@ -3,1 +3,4 @@\nterraform {\n  required_providers {\n-   aws = \"~> 3.0\"\n+   aws = {\n+     source  = \"hashicorp/aws\"\n+     version = \"~> 3.0\"\n+   }\n  }\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.terraform.terraform013.UpgradeRequiredProvidersSyntax","displayName":"Upgrade `required_providers` to object syntax","groupId":"org.openrewrite.recipe","artifactId":"rewrite-terraform","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TERRAFORM","requiresConfiguration":false}}>
