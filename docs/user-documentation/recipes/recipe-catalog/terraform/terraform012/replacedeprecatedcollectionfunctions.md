...
_In Terraform 0.12+, the `list()` function is replaced by `[...]` tuple syntax and the `map()` function is replaced by `{...}` object syntax._
...
<RunRecipe
  recipeName="org.openrewrite.terraform.terraform012.ReplaceDeprecatedCollectionFunctions"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.terraform.terraform012.ReplaceDeprecatedCollectionFunctions" />
