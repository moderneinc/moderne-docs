...
_In Terraform 0.12+, variable type constraints should be bare types instead of quoted strings. For example, `type = "string"` becomes `type = string`._
...
<RunRecipe
  recipeName="org.openrewrite.terraform.terraform012.UnquoteTypeConstraints"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.terraform.terraform012.UnquoteTypeConstraints" />
