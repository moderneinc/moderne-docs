...
<RecipeMeta
  ...
  fqName={"org.openrewrite.terraform.search.FindRequiredProvider"}
...
<ExampleList examples={[{"parameters":[{"parameter":"source","value":"null"}],"variants":[{"language":"hcl","before":"terraform {\n  required_providers {\n    aws = {\n      source  = \"hashicorp/aws\"\n      version = \"~> 3.0\"\n    }\n  }\n}\n","after":"terraform {\n  required_providers {\n    /*~~>*/aws = {\n      source  = \"hashicorp/aws\"\n      version = \"~> 3.0\"\n    }\n  }\n}\n","diff":"@@ -3,1 +3,1 @@\nterraform {\n  required_providers {\n-   aws = {\n+   /*~~>*/aws = {\n      source  = \"hashicorp/aws\"\n","newFile":false}]}]}>
