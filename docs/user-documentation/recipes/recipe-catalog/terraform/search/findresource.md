...
<RecipeMeta
  ...
  fqName={"org.openrewrite.terraform.search.FindResource"}
...
<ExampleList examples={[{"parameters":[{"parameter":"resourceName","value":"aws_ebs_volume"}],"variants":[{"language":"hcl","before":"variable \"aws_ebs_volume\" {\n  default = \"somewhat_convoluted_naming_example\"\n}\n\nresource \"aws_ebs_volume\" {\n  size      = 1\n  encrypted = true\n}\n\nresource \"azure_storage_volume\" {\n  size = 1\n}\n","after":"variable \"aws_ebs_volume\" {\n  default = \"somewhat_convoluted_naming_example\"\n}\n\n/*~~>*/resource \"aws_ebs_volume\" {\n  size      = 1\n  encrypted = true\n}\n\nresource \"azure_storage_volume\" {\n  size = 1\n}\n","diff":"@@ -5,1 +5,1 @@\n}\n\n-resource \"aws_ebs_volume\" {\n+/*~~>*/resource \"aws_ebs_volume\" {\n  size      = 1\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.terraform.search.FindResource","displayName":"Find Terraform resource","groupId":"org.openrewrite.recipe","artifactId":"rewrite-terraform","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TERRAFORM","requiresConfiguration":true,"cliOptions":" --recipe-option \"resourceName=aws_ebs_volume\""}}>
