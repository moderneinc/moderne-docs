...
<RecipeMeta
  ...
  fqName={"org.openrewrite.terraform.SecureRandom"}
...
<ExampleList examples={[{"parameters":[{"parameter":"byteLength","value":"20"}],"variants":[{"language":"hcl","before":"resource \"random_id\" \"random\" {\n  byte_length = 11\n}\n","after":"resource \"random_id\" \"random\" {\n  byte_length = 20\n}\n","diff":"@@ -2,1 +2,1 @@\nresource \"random_id\" \"random\" {\n- byte_length = 11\n+ byte_length = 20\n}\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.terraform.SecureRandom","displayName":"Use a long enough byte length for `random` resources","groupId":"org.openrewrite.recipe","artifactId":"rewrite-terraform","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_TERRAFORM","requiresConfiguration":false}}>
