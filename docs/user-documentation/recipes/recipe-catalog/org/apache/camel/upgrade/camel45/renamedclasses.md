...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/org/apache/camel/upgrade/camel45/renamedclasses" />
</head>
...
[GitHub: search?type=code&q=org.apache.camel.upgrade.camel45.renamedClasses](https://github.com/search?type=code&q=org.apache.camel.upgrade.camel45.renamedClasses),
...
rewrite {
    activeRecipe("org.apache.camel.upgrade.camel45.renamedClasses")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.apache.camel.upgrade.camel45.renamedClasses</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=org.apache.camel.upgrade.camel45.renamedClasses -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.apache.camel.upgrade.camel45.renamedClasses" />
