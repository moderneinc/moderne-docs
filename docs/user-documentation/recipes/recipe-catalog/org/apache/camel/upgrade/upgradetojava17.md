...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/org/apache/camel/upgrade/upgradetojava17" />
</head>
...
[GitHub: search?type=code&q=org.apache.camel.upgrade.UpgradeToJava17](https://github.com/search?type=code&q=org.apache.camel.upgrade.UpgradeToJava17),
...
* [Upgrade `actions/setup-java` `java-version`](../../../../org/apache/camel/upgrade/setupjavaupgradejavaversion)
...
rewrite {
    activeRecipe("org.apache.camel.upgrade.UpgradeToJava17")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.apache.camel.upgrade.UpgradeToJava17</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=org.apache.camel.upgrade.UpgradeToJava17 -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.apache.camel.upgrade.UpgradeToJava17" />
