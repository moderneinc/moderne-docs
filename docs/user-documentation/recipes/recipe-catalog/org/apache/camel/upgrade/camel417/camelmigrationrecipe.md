...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/org/apache/camel/upgrade/camel417/camelmigrationrecipe" />
</head>
...
_Migrates `camel 4.16` application to `camel 4.17`._
...
* [Change method name](../../../../../java/changemethodname)
  ...
  * matchOverrides: `true`
* [Camel YML transform changes](../../../../../org/apache/camel/upgrade/camel417/yamltransform417recipe)
...
rewrite {
    activeRecipe("org.apache.camel.upgrade.camel417.CamelMigrationRecipe")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.apache.camel.upgrade.camel417.CamelMigrationRecipe</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=org.apache.camel.upgrade.camel417.CamelMigrationRecipe -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.apache.camel.upgrade.camel417.CamelMigrationRecipe" />
