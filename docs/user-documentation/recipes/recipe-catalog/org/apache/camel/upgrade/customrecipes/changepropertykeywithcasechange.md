...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/org/apache/camel/upgrade/customrecipes/changepropertykeywithcasechange" />
</head>
...
rewrite {
    activeRecipe("com.yourorg.ChangePropertyKeyWithCaseChangeExample")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.yourorg.ChangePropertyKeyWithCaseChangeExample</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
