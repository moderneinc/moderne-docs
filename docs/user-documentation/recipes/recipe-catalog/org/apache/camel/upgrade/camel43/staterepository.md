...
[GitHub: search?type=code&q=org.apache.camel.upgrade.camel43.StateRepository](https://github.com/search?type=code&q=org.apache.camel.upgrade.camel43.StateRepository),
...
rewrite {
    activeRecipe("org.apache.camel.upgrade.camel43.StateRepository")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.apache.camel.upgrade.camel43.StateRepository</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=org.apache.camel.upgrade.camel43.StateRepository -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.apache.camel.upgrade.camel43.StateRepository" />
