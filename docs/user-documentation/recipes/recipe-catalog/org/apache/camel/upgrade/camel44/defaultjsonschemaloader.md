...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/org/apache/camel/upgrade/camel44/defaultjsonschemaloader" />
</head>
...
rewrite {
    activeRecipe("org.apache.camel.upgrade.camel44.DefaultJsonSchemaLoader")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.apache.camel.upgrade.camel44.DefaultJsonSchemaLoader</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=org.apache.camel.upgrade.camel44.DefaultJsonSchemaLoader -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.apache.camel.upgrade.camel44.DefaultJsonSchemaLoader" />
