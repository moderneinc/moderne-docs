...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/org/apache/logging/log4j/inlinelog4japimethods" />
</head>
...
[GitHub: inline-log4j-api-methods.yml](https://github.com/openrewrite/rewrite-logging-frameworks/blob/main/src/main/resources/META-INF/rewrite/inline-log4j-api-methods.yml),
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.apache.logging.log4j.InlineLog4jApiMethods</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mod run . --recipe InlineLog4jApiMethods
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.apache.logging.log4j.InlineLog4jApiMethods" />
