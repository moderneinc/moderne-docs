...
[GitHub: NoExplicitEmptyLabelList.java](https://github.com/openrewrite/rewrite-micrometer/blob/main/src/main/java/org/openrewrite/micrometer/misk/NoExplicitEmptyLabelList.java),
