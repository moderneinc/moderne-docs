...
<RecipeMeta
  ...
  fqName={"io.moderne.kafka.RemoveDeprecatedKafkaProperties"}
...
<ExampleList examples={[{"parameters":[{"parameter":"propertyKey","value":"log.message.format.version"}],"variants":[{"language":"java","before":"import java.util.Properties;\n\nclass KafkaProducerConfig {\n    Properties getProducerProps() {\n        Properties props = new Properties();\n        props.put(\"bootstrap.servers\", \"localhost:9092\");\n        props.put(\"log.message.format.version\", \"2.8\");\n        props.put(\"message.format.version\", \"2.8\");\n        return props;\n    }\n}\n","after":"import java.util.Properties;\n\nclass KafkaProducerConfig {\n    Properties getProducerProps() {\n        Properties props = new Properties();\n        props.put(\"bootstrap.servers\", \"localhost:9092\");\n        props.put(\"message.format.version\", \"2.8\");\n        return props;\n    }\n}\n","diff":"@@ -7,1 +7,0 @@\n        Properties props = new Properties();\n        props.put(\"bootstrap.servers\", \"localhost:9092\");\n-       props.put(\"log.message.format.version\", \"2.8\");\n        props.put(\"message.format.version\", \"2.8\");\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"io.moderne.kafka.RemoveDeprecatedKafkaProperties","displayName":"Remove deprecated Kafka property","groupId":"io.moderne.recipe","artifactId":"rewrite-kafka","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_KAFKA","requiresConfiguration":true,"cliOptions":" --recipe-option \"propertyKey=log.message.format.version\""}}>
