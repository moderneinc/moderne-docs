...
<RecipeMeta
  ...
  fqName={"io.moderne.kafka.UpgradeJavaForKafkaClients"}
...
<UsageList usage={{"recipeName":"io.moderne.kafka.UpgradeJavaForKafkaClients","displayName":"Upgrade Java to 11+ for Kafka clients","groupId":"io.moderne.recipe","artifactId":"rewrite-kafka","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_KAFKA","requiresConfiguration":false}}>
