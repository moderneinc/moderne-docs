...
<RecipeMeta
  ...
  fqName={"io.moderne.kafka.MigrateSendOffsetsToTransaction"}
...
<UsageList usage={{"recipeName":"io.moderne.kafka.MigrateSendOffsetsToTransaction","displayName":"Migrate deprecated `sendOffsetsToTransaction` to use `ConsumerGroupMetadata`","groupId":"io.moderne.recipe","artifactId":"rewrite-kafka","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_KAFKA","requiresConfiguration":false}}>
