...
<RecipeMeta
  ...
  fqName={"io.moderne.kafka.streams.ProcessingGuaranteeExactlyOnceToBeta"}
...
<UsageList usage={{"recipeName":"io.moderne.kafka.streams.ProcessingGuaranteeExactlyOnceToBeta","displayName":"Migrate `exactly_once` to `exactly_once_beta`","groupId":"io.moderne.recipe","artifactId":"rewrite-kafka","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_KAFKA","requiresConfiguration":false}}>
