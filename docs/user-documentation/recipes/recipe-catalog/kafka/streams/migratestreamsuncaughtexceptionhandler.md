...
<RecipeMeta
  ...
  fqName={"io.moderne.kafka.streams.MigrateStreamsUncaughtExceptionHandler"}
...
<UsageList usage={{"recipeName":"io.moderne.kafka.streams.MigrateStreamsUncaughtExceptionHandler","displayName":"Migrate to StreamsUncaughtExceptionHandler API","groupId":"io.moderne.recipe","artifactId":"rewrite-kafka","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_KAFKA","requiresConfiguration":false}}>
