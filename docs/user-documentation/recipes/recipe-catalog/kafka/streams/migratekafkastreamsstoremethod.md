...
<RecipeMeta
  ...
  fqName={"io.moderne.kafka.streams.MigrateKafkaStreamsStoreMethod"}
...
<UsageList usage={{"recipeName":"io.moderne.kafka.streams.MigrateKafkaStreamsStoreMethod","displayName":"Migrate deprecated `KafkaStreams#store` method","groupId":"io.moderne.recipe","artifactId":"rewrite-kafka","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_KAFKA","requiresConfiguration":false}}>
