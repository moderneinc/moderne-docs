...
<RecipeMeta
  ...
  fqName={"io.moderne.kafka.streams.MigrateKStreamToTable"}
...
<UsageList usage={{"recipeName":"io.moderne.kafka.streams.MigrateKStreamToTable","displayName":"Migrate KStream to KTable conversion to use `toTable()` method","groupId":"io.moderne.recipe","artifactId":"rewrite-kafka","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_KAFKA","requiresConfiguration":false}}>
