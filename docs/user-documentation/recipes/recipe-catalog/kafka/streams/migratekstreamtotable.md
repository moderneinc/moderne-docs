...
_In Kafka Streams 2.5, a new `toTable()` method was added to simplify converting a KStream to a KTable. This recipe replaces the manual aggregation pattern `.groupByKey().reduce((oldVal, newVal) -> newVal)` with the more concise `.toTable()` method._
...
<RunRecipe
  recipeName="io.moderne.kafka.streams.MigrateKStreamToTable"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.kafka.streams.MigrateKStreamToTable" />
