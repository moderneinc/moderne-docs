...
<RecipeMeta
  ...
  fqName={"io.moderne.kafka.streams.RemovePartitionGrouperConfiguration"}
...
<UsageList usage={{"recipeName":"io.moderne.kafka.streams.RemovePartitionGrouperConfiguration","displayName":"Remove `PartitionGrouper` configuration","groupId":"io.moderne.recipe","artifactId":"rewrite-kafka","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_KAFKA","requiresConfiguration":false}}>
