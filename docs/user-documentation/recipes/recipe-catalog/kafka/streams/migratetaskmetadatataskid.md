...
_In Kafka Streams 3.0, `TaskMetadata.taskId()` changed its return type from `String` to `TaskId`. This recipe adds `.toString()` calls where necessary to maintain String compatibility._
...
<RunRecipe
  recipeName="io.moderne.kafka.streams.MigrateTaskMetadataTaskId"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.kafka.streams.MigrateTaskMetadataTaskId" />
