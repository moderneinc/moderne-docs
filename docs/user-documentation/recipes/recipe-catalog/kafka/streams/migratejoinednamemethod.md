...
<RecipeMeta
  ...
  fqName={"io.moderne.kafka.streams.MigrateJoinedNameMethod"}
...
<ExampleList examples={[{"variants":[{"language":"java","before":"import org.apache.kafka.streams.kstream.Joined;\n\nclass KafkaProcessor {\n    void configureJoin(Joined<String, String, String> joined) {\n        joined.named(\"my-join\");\n    }\n}\n","after":"import org.apache.kafka.streams.kstream.Joined;\n\nclass KafkaProcessor {\n    void configureJoin(Joined<String, String, String> joined) {\n        joined.as(\"my-join\");\n    }\n}\n","diff":"@@ -5,1 +5,1 @@\nclass KafkaProcessor {\n    void configureJoin(Joined<String, String, String> joined) {\n-       joined.named(\"my-join\");\n+       joined.as(\"my-join\");\n    }\n","newFile":false}]},{"variants":[{"language":"java","before":"import org.apache.kafka.streams.kstream.Joined;\n\nclass KafkaProcessor {\n    void configureJoin(Joined<String, String, String> joined) {\n        joined.named(\"my-join\");\n    }\n}\n","after":"import org.apache.kafka.streams.kstream.Joined;\n\nclass KafkaProcessor {\n    void configureJoin(Joined<String, String, String> joined) {\n        joined.as(\"my-join\");\n    }\n}\n","diff":"@@ -5,1 +5,1 @@\nclass KafkaProcessor {\n    void configureJoin(Joined<String, String, String> joined) {\n-       joined.named(\"my-join\");\n+       joined.as(\"my-join\");\n    }\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"io.moderne.kafka.streams.MigrateJoinedNameMethod","displayName":"Migrate `Joined.named()` to `Joined.as()`","groupId":"io.moderne.recipe","artifactId":"rewrite-kafka","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_KAFKA","requiresConfiguration":false}}>
