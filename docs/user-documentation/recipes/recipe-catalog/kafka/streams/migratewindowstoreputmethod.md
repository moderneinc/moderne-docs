...
_In Kafka Streams 2.4, `WindowStore.put()` requires a timestamp parameter. This recipe adds `context.timestamp()` as the third parameter._
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.kafka.streams.MigrateWindowStorePutMethod" />
