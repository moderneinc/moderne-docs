...
<RecipeMeta
  ...
  fqName={"io.moderne.kafka.MigrateConsumerPollToDuration"}
...
<UsageList usage={{"recipeName":"io.moderne.kafka.MigrateConsumerPollToDuration","displayName":"Migrate `KafkaConsumer.poll(long)` to `poll(Duration)`","groupId":"io.moderne.recipe","artifactId":"rewrite-kafka","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_KAFKA","requiresConfiguration":false}}>
