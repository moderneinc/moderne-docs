...
<RecipeMeta
  ...
  fqName={"io.moderne.kafka.MigrateToKafka24"}
...
<UsageList usage={{"recipeName":"io.moderne.kafka.MigrateToKafka24","displayName":"Migrate to Kafka 2.4","groupId":"io.moderne.recipe","artifactId":"rewrite-kafka","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_KAFKA","requiresConfiguration":false}}>
