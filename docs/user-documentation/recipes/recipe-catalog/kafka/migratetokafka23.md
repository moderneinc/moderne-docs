...
<RecipeMeta
  ...
  fqName={"io.moderne.kafka.MigrateToKafka23"}
...
<UsageList usage={{"recipeName":"io.moderne.kafka.MigrateToKafka23","displayName":"Migrate to Kafka 2.3","groupId":"io.moderne.recipe","artifactId":"rewrite-kafka","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_KAFKA","requiresConfiguration":false}}>
