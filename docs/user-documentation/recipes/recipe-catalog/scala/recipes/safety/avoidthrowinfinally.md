...
_Finds `throw` statements inside `finally` blocks. Throwing in a `finally` block can mask the original exception, making debugging harder._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.safety.AvoidThrowInFinally"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.safety.AvoidThrowInFinally" />
