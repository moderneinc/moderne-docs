...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.safety.NarrowCatchClause"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.safety.NarrowCatchClause","displayName":"Narrow catch clauses that catch `Throwable`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
