...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.safety.RemoveUnusedImport"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.safety.RemoveUnusedImport","displayName":"Remove potentially unused imports (heuristic)","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
