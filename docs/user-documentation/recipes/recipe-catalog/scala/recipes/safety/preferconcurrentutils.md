...
_Finds `synchronized` blocks in Scala code. Consider using `java.util.concurrent` alternatives for better performance and composability._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.safety.PreferConcurrentUtils"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.safety.PreferConcurrentUtils" />
