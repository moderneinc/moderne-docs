...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.safety.PreferConcurrentUtils"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.safety.PreferConcurrentUtils","displayName":"Prefer `java.util.concurrent` over `synchronized`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
