...
_Finds `Await.result` and `Await.ready` calls which block the current thread. Consider using non-blocking Future composition with map, flatMap, or for-comprehensions._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.concurrency.AvoidBlockingCalls"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.concurrency.AvoidBlockingCalls" />
