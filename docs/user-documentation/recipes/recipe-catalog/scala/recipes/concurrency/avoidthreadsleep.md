...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.concurrency.AvoidThreadSleep"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.concurrency.AvoidThreadSleep","displayName":"Avoid `Thread.sleep`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
