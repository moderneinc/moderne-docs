...
_Finds `Thread.sleep` calls which block the current thread. Consider using scheduled executors or akka scheduler instead._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.concurrency.AvoidThreadSleep"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.concurrency.AvoidThreadSleep" />
