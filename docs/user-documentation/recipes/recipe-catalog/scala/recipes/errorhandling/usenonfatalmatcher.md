...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.errorhandling.UseNonFatalMatcher"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.errorhandling.UseNonFatalMatcher","displayName":"Use `NonFatal` matcher for broad catch patterns","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
