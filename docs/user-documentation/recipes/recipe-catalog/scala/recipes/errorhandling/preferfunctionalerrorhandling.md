...
_Finds `throw` expressions inside method bodies that should use functional error handling. Throwing exceptions breaks referential transparency; prefer returning `Try`, `Either`, or `Option`._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.errorhandling.PreferFunctionalErrorHandling"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.errorhandling.PreferFunctionalErrorHandling" />
