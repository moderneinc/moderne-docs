...
_Finds calls to `.get` on `scala.util.Try` values that should use safer alternatives. Calling `.get` on a `Failure` throws the contained exception; prefer `getOrElse`, `map`, or pattern matching._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.errorhandling.UseTrySafely"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.errorhandling.UseTrySafely" />
