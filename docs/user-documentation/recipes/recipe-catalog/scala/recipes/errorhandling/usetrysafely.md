...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.errorhandling.UseTrySafely"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.errorhandling.UseTrySafely","displayName":"Use `Try` safely without calling `.get`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
