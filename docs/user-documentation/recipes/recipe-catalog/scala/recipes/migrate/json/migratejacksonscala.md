...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.json.MigrateJacksonScala"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.json.MigrateJacksonScala","displayName":"Remove Jackson Scala module imports","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
