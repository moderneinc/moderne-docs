...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.json.MigrateLiftJson"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.json.MigrateLiftJson","displayName":"Remove lift-json imports","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
