...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.json.MigrateSprayJson"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.json.MigrateSprayJson","displayName":"Remove spray-json imports","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
