...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.json.MigrateJson4s"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.json.MigrateJson4s","displayName":"Remove json4s imports","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
