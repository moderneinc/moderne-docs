...
_Finds symbol literals like `'foo` which were deprecated in Scala 2.13 and removed in Scala 3. Use `Symbol("foo")` instead._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.RemoveSymbolLiterals"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.RemoveSymbolLiterals" />
