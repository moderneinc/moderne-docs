...
_Finds classes or objects extending `DelayedInit` or `App`. The `DelayedInit` trait was deprecated in Scala 2.13 and removed in Scala 3. Use `@main` annotation instead._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.scala3.MigrateDelayedInit"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.scala3.MigrateDelayedInit" />
