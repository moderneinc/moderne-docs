...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.scala3.MigrateDelayedInit"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.scala3.MigrateDelayedInit","displayName":"Migrate from `DelayedInit`/`App` to `@main`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
