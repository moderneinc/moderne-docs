...
_Finds `do-while` loops which were removed in Scala 3. Rewrite using a `while` loop with initial execution of the loop body._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.scala3.ReplaceDoWhileLoop"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.scala3.ReplaceDoWhileLoop" />
