...
_Finds imports of `scala.language.autoTupling`. Auto-tupling is not available in Scala 3 and code relying on it must be rewritten._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.scala3.RemoveAutoTupling"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.scala3.RemoveAutoTupling" />
