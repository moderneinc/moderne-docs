...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.play.UseAsyncPlayAction"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.play.UseAsyncPlayAction","displayName":"Use `Action.async` with `Future` instead of blocking","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
