...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.play.UsePlayJsonDirectly"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.play.UsePlayJsonDirectly","displayName":"Use Play JSON `JsValue` directly","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
