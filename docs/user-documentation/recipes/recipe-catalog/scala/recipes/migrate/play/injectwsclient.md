...
_Finds imports of the deprecated `play.api.libs.ws.WS` object. In Play 2.6+, `WS` was deprecated; inject `WSClient` instead._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.play.InjectWsClient"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.play.InjectWsClient" />
