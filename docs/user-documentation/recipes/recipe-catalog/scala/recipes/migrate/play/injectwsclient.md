...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.play.InjectWsClient"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.play.InjectWsClient","displayName":"Inject `WSClient` instead of using deprecated `WS`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
