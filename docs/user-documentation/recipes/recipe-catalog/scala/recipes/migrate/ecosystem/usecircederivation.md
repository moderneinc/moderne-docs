...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.ecosystem.UseCirceDerivation"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.ecosystem.UseCirceDerivation","displayName":"Use circe `derives` for Scala 3","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
