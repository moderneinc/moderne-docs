...
_Finds Cats Effect 2 imports by detecting `cats.effect.IO` without `cats.effect.unsafe`, or CE2-specific types like `ContextShift` and `Timer`. Consider migrating to Cats Effect 3._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.ecosystem.MigrateCatsEffect2To3"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.ecosystem.MigrateCatsEffect2To3" />
