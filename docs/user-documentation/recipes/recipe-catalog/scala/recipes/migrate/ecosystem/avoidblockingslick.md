...
_Finds methods that combine `Await.result` with `db.run`, indicating a blocking Slick database call. Use streaming or async patterns instead._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.ecosystem.AvoidBlockingSlick"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.ecosystem.AvoidBlockingSlick" />
