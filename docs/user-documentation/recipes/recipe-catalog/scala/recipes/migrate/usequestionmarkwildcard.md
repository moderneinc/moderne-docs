...
_Finds usage of `_` as a wildcard type in type parameters (e.g., `List[_]`). In Scala 3, the wildcard type syntax changed from `_` to `?`._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.UseQuestionMarkWildcard"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.UseQuestionMarkWildcard" />
