...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.UseQuestionMarkWildcard"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.UseQuestionMarkWildcard","displayName":"Use `?` instead of `_` for wildcard types (Scala 3)","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
