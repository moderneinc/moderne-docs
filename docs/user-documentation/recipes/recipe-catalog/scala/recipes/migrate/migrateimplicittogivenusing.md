...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.MigrateImplicitToGivenUsing"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.MigrateImplicitToGivenUsing","displayName":"Migrate `implicit` to `given`/`using` (Scala 3)","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
