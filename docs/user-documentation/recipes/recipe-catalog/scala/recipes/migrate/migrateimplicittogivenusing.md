...
_Finds `implicit` keyword usage on methods and parameters. In Scala 3, `implicit` is replaced with `given`/`using`._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.MigrateImplicitToGivenUsing"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.MigrateImplicitToGivenUsing" />
