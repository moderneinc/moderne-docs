...
_Finds traits that have initialized `var` fields. In Scala 3, trait initialization semantics changed and these may need review._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.ReviewTraitVarInit"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.ReviewTraitVarInit" />
