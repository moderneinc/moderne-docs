...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.http.MigrateFinagle"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.http.MigrateFinagle","displayName":"Migrate Finagle to http4s, tapir, or pekko-http","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
