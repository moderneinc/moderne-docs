...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.http.MigrateAkkaHttpToPekko"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.http.MigrateAkkaHttpToPekko","displayName":"Find Akka HTTP imports to migrate to Apache Pekko","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
