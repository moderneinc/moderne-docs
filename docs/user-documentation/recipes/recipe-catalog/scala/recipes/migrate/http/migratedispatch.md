...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.http.MigrateDispatch"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.http.MigrateDispatch","displayName":"Migrate Dispatch to sttp or http4s-client","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
