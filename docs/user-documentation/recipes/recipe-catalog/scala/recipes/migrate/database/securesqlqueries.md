...
_Finds raw SQL string patterns such as `sql"..."`, `SQL(...)`, or `s"SELECT..."`. Ensure parameterized queries are used to prevent SQL injection._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.database.SecureSqlQueries"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.database.SecureSqlQueries" />
