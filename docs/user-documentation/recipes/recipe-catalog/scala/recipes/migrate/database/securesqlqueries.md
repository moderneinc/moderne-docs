...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.database.SecureSqlQueries"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.database.SecureSqlQueries","displayName":"Ensure parameterized SQL queries","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
