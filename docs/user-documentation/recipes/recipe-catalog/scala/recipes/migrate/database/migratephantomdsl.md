...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.database.MigratePhantomDsl"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.database.MigratePhantomDsl","displayName":"Migrate Phantom DSL to Datastax driver or quill-cassandra","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
