...
_Removes imports of the Phantom DSL library (`com.outworkers.phantom.*`). Consider migrating to the direct Datastax driver or quill-cassandra._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.database.MigratePhantomDsl"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.database.MigratePhantomDsl" />
