...
_Finds existential types using `forSome` syntax. Existential types were removed in Scala 3 and must be rewritten._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.RemoveExistentialTypes"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.RemoveExistentialTypes" />
