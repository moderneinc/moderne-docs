...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.RemoveExistentialTypes"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.RemoveExistentialTypes","displayName":"Remove existential types (removed in Scala 3)","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
