...
_Removes `akka.actor.Actor` imports and marks classes extending `Actor` or `UntypedActor` from classic Akka for migration to Akka Typed `Behavior`._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.akka.MigrateToTypedActor"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.akka.MigrateToTypedActor" />
