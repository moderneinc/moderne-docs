...
_Finds classic Akka actor messaging patterns (`actorRef ! msg` or `actorRef.tell(msg)`). Consider migrating to typed `ActorRef` messaging._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.akka.MigrateActorRefTell"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.akka.MigrateActorRefTell" />
