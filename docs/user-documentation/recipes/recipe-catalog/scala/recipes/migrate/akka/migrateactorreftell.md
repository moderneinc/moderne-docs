...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.akka.MigrateActorRefTell"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.akka.MigrateActorRefTell","displayName":"Migrate classic actor tell to typed ActorRef","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
