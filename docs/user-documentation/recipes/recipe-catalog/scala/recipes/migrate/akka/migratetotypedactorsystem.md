...
_Replaces the import `akka.actor.ActorSystem` with `akka.actor.typed.ActorSystem` to migrate from the classic untyped actor system to Akka Typed._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.migrate.akka.MigrateToTypedActorSystem"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.migrate.akka.MigrateToTypedActorSystem" />
