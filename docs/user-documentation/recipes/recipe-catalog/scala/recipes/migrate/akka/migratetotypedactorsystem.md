...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.migrate.akka.MigrateToTypedActorSystem"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.migrate.akka.MigrateToTypedActorSystem","displayName":"Migrate `akka.actor.ActorSystem` to `akka.actor.typed.ActorSystem`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
