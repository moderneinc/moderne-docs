...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.performance.UseHeadOption"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.performance.UseHeadOption","displayName":"Replace `.head` with `.headOption`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
