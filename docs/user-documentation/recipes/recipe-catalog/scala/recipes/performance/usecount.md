...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.performance.UseCount"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.performance.UseCount","displayName":"Replace `filter` then `size` with `count`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
