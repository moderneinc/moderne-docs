...
_Finds usage of the `:+` operator to append to a List, which is O(n). Prefer Vector for append-heavy workloads or prepend with `::` instead._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.performance.PreferVectorOrPrepend"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.performance.PreferVectorOrPrepend" />
