...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.performance.UseLastOption"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.performance.UseLastOption","displayName":"Replace `.last` with `.lastOption`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
