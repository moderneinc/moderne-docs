...
_Replaces `.last` calls on collections with `.lastOption` to avoid `NoSuchElementException` on empty collections._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.performance.UseLastOption"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.performance.UseLastOption" />
