...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.performance.UseFlatMap"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.performance.UseFlatMap","displayName":"Replace `map` then `flatten` with `flatMap`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
