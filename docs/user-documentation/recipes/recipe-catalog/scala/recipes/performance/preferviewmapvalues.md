...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.performance.PreferViewMapValues"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.performance.PreferViewMapValues","displayName":"Prefer `.view.mapValues` for Scala 2.13+","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
