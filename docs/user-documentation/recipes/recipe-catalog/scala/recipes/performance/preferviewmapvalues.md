...
_Finds calls to `.mapValues` which is deprecated in Scala 2.13+ and returns a lazy view instead of a strict Map. Use `.view.mapValues(...).toMap` instead._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.performance.PreferViewMapValues"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.performance.PreferViewMapValues" />
