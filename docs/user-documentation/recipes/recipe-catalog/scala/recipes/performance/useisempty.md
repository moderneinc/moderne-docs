...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.performance.UseIsEmpty"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.performance.UseIsEmpty","displayName":"Use `isEmpty` instead of `size == 0`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
