...
_Finds `assert(x == y)` patterns and `assertEquals` calls. Consider using ScalaTest matchers: `x shouldBe y`._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.testing.UseScalaTestMatchers"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.testing.UseScalaTestMatchers" />
