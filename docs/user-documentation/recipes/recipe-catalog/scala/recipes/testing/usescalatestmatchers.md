...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.testing.UseScalaTestMatchers"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.testing.UseScalaTestMatchers","displayName":"Use ScalaTest matchers instead of `assert(x == y)`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
