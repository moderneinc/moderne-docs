...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.testing.MigrateToAnyFlatSpec"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.testing.MigrateToAnyFlatSpec","displayName":"Migrate from `FlatSpec` to `AnyFlatSpec`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
