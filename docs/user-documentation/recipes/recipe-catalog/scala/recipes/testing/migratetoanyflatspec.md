...
_Renames `FlatSpec` to `AnyFlatSpec` in extends clauses and updates the import from `org.scalatest.FlatSpec` to `org.scalatest.flatspec.AnyFlatSpec` (ScalaTest 3.x)._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.testing.MigrateToAnyFlatSpec"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.testing.MigrateToAnyFlatSpec" />
