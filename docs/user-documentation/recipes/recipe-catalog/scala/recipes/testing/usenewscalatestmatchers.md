...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.testing.UseNewScalaTestMatchers"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.testing.UseNewScalaTestMatchers","displayName":"Migrate to `org.scalatest.matchers.should.Matchers`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
