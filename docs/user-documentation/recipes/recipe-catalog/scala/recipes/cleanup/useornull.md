...
_Replaces `.getOrElse(null)` on `Option` values with `.orNull` for a cleaner, idiomatic alternative._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.UseOrNull"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.UseOrNull" />
