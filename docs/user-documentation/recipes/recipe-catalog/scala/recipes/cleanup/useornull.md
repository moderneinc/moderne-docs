...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.UseOrNull"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.UseOrNull","displayName":"Replace `.getOrElse(null)` with `.orNull`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
