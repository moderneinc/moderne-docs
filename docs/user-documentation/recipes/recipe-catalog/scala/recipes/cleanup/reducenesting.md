...
_Finds `def` methods with deeply nested code (5+ indentation levels). Deeply nested code is hard to follow; consider extracting methods._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.ReduceNesting"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.ReduceNesting" />
