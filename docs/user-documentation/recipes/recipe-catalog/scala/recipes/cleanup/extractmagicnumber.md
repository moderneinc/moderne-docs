...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.ExtractMagicNumber"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.ExtractMagicNumber","displayName":"Extract magic numbers to named constants","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
