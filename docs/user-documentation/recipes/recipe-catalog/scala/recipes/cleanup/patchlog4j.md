...
_Finds imports of Log4j 1.x (`org.apache.log4j`) or Log4j 2.x (`org.apache.logging.log4j`). Ensure your Log4j version is patched against CVE-2021-44228._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.PatchLog4j"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.PatchLog4j" />
