...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.PatchLog4j"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.PatchLog4j","displayName":"Ensure Log4j is patched against CVE-2021-44228","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
