...
_Removes calls to `.toString` on expressions that are already of type `String`. Such calls are redundant._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.RemoveRedundantToString"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.RemoveRedundantToString" />
