...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.RemoveRedundantToString"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.RemoveRedundantToString","displayName":"Remove redundant `toString` on `String`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
