...
_Finds declarations annotated with `@deprecated` in Scala code. Deprecated APIs should be reviewed for removal or migration._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.ReviewDeprecatedApi"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.ReviewDeprecatedApi" />
