...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.UseOptionSafely"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.UseOptionSafely","displayName":"Use `Option` safely","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
