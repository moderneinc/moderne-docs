...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.UseDirectToSet"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.UseDirectToSet","displayName":"Replace unnecessary intermediate collection before `.toSet`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
