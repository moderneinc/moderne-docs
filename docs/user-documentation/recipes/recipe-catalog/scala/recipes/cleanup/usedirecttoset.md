...
_Replaces patterns like `.toList.toSet` or `.toSeq.toSet` with `.toSet` to avoid creating an unnecessary intermediate collection._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.UseDirectToSet"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.UseDirectToSet" />
