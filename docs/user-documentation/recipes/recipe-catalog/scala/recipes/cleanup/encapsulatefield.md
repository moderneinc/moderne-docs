...
_Finds public `var` fields in classes. Public mutable fields break encapsulation; consider using a private var with accessor methods._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.EncapsulateField"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.EncapsulateField" />
