...
_Finds wildcard imports (`import foo._` or `import foo.*`). Explicit imports are generally preferred for clarity._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.PreferExplicitImports"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.PreferExplicitImports" />
