...
_Finds Java-style getter methods (`getName`, `getValue`, etc.) that could be replaced with Scala-style property access._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.PreferScalaPropertyAccess"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.PreferScalaPropertyAccess" />
