...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.PreferOption"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.PreferOption","displayName":"Prefer `Option` over `null`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
