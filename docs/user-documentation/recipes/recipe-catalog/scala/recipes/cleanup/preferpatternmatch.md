...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.PreferPatternMatch"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.PreferPatternMatch","displayName":"Prefer pattern matching over `asInstanceOf` casts","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
