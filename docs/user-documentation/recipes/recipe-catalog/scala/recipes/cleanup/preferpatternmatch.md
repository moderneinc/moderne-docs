...
_Finds `.asInstanceOf[T]` type casts that should be replaced with pattern matching. Idiomatic Scala prefers pattern matching over explicit casts._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.PreferPatternMatch"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.PreferPatternMatch" />
