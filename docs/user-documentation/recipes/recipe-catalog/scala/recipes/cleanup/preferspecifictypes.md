...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.PreferSpecificTypes"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.PreferSpecificTypes","displayName":"Prefer specific types over `Any`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
