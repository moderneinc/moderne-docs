...
_Finds hardcoded timeout values such as `Duration(5, ...)`, `5.seconds`, or `Timeout(...)` with numeric literals. Consider making timeouts configurable._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.ExternalizeTimeout"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.ExternalizeTimeout" />
