...
_Finds string concatenation using the `+` operator. Idiomatic Scala prefers string interpolation (e.g., `s"hello $name"`) over concatenation with `+`._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.PreferStringInterpolation"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.PreferStringInterpolation" />
