...
_Finds `def` methods with more than 5 parameters. Long parameter lists hurt readability; consider using a case class._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.ReduceParameterCount"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.ReduceParameterCount" />
