...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.UseCollectionConverters"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.UseCollectionConverters","displayName":"Replace `JavaConverters` with `CollectionConverters`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
