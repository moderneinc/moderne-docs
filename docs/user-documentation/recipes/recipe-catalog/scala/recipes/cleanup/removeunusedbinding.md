...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.RemoveUnusedBinding"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.RemoveUnusedBinding","displayName":"Remove unused variable bindings","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
