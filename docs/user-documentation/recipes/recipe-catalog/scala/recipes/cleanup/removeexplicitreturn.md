...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.RemoveExplicitReturn"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.RemoveExplicitReturn","displayName":"Remove explicit `return` statements","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
