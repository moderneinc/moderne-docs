...
_Finds `if` statements that check `isInstanceOf` in the condition and use `asInstanceOf` in the then-part. Replace with pattern matching for idiomatic Scala._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.PreferPatternMatchOverInstanceOf"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.PreferPatternMatchOverInstanceOf" />
