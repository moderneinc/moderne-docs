...
_Finds `System.exit` and `sys.exit` calls which terminate the JVM. Avoid using these in library code; prefer exceptions or controlled shutdown._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.AvoidSystemExit"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.AvoidSystemExit" />
