...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.AvoidSystemExit"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.AvoidSystemExit","displayName":"Avoid `System.exit` in library code","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
