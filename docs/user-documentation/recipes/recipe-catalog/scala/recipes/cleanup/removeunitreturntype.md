...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.RemoveUnitReturnType"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.RemoveUnitReturnType","displayName":"Remove unnecessary `: Unit` return type","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
