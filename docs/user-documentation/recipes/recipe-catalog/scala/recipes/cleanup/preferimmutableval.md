...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.PreferImmutableVal"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.PreferImmutableVal","displayName":"Prefer `val` over `var`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
