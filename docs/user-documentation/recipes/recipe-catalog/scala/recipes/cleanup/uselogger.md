...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.UseLogger"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.UseLogger","displayName":"Use logging framework instead of `println`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
