...
_Finds `.printStackTrace` calls. Use a logging framework instead of writing directly to `System.err`._
...
<RunRecipe
  recipeName="org.openrewrite.scala.recipes.cleanup.UseLoggerForExceptions"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.scala.recipes.cleanup.UseLoggerForExceptions" />
