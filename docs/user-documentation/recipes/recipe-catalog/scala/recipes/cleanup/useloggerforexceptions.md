...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.recipes.cleanup.UseLoggerForExceptions"}
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.recipes.cleanup.UseLoggerForExceptions","displayName":"Use logging framework instead of `printStackTrace`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
