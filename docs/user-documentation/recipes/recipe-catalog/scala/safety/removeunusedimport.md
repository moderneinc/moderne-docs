...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.safety.RemoveUnusedImport"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.safety.RemoveUnusedImport"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/safety/removeunusedimport.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.safety.RemoveUnusedImport","displayName":"Remove potentially unused imports (heuristic)","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
