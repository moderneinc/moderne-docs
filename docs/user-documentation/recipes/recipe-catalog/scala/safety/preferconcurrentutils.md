...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.safety.PreferConcurrentUtils"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.safety.PreferConcurrentUtils"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/safety/preferconcurrentutils.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.safety.PreferConcurrentUtils","displayName":"Prefer `java.util.concurrent` over `synchronized`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
