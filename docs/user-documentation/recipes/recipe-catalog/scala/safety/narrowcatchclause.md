...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.safety.NarrowCatchClause"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.safety.NarrowCatchClause"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/safety/narrowcatchclause.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.safety.NarrowCatchClause","displayName":"Narrow catch clauses that catch `Throwable`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
