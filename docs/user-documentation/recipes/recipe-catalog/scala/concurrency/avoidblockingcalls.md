...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.concurrency.AvoidBlockingCalls"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.concurrency.AvoidBlockingCalls"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/concurrency/avoidblockingcalls.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.concurrency.AvoidBlockingCalls","displayName":"Avoid blocking calls (`Await.result`/`Await.ready`)","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
