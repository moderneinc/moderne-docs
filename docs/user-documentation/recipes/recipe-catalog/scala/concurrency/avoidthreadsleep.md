...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.concurrency.AvoidThreadSleep"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.concurrency.AvoidThreadSleep"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/concurrency/avoidthreadsleep.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.concurrency.AvoidThreadSleep","displayName":"Avoid `Thread.sleep`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
