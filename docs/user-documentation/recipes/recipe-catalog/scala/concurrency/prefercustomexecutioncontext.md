...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.concurrency.PreferCustomExecutionContext"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.concurrency.PreferCustomExecutionContext"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/concurrency/prefercustomexecutioncontext.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.concurrency.PreferCustomExecutionContext","displayName":"Prefer custom `ExecutionContext` over global","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
