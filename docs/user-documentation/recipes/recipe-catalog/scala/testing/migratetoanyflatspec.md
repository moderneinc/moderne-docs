...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.testing.MigrateToAnyFlatSpec"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.testing.MigrateToAnyFlatSpec"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/testing/migratetoanyflatspec.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.testing.MigrateToAnyFlatSpec","displayName":"Migrate from `FlatSpec` to `AnyFlatSpec`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
