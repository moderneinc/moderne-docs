...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.testing.UseNewScalaTestMatchers"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.testing.UseNewScalaTestMatchers"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/testing/usenewscalatestmatchers.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.testing.UseNewScalaTestMatchers","displayName":"Migrate to `org.scalatest.matchers.should.Matchers`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
