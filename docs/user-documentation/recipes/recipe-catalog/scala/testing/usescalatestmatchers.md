...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.testing.UseScalaTestMatchers"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.testing.UseScalaTestMatchers"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/testing/usescalatestmatchers.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.testing.UseScalaTestMatchers","displayName":"Use ScalaTest matchers instead of `assert(x == y)`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
