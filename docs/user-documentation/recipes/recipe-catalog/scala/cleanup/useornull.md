...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.cleanup.UseOrNull"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.cleanup.UseOrNull"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/cleanup/useornull.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.cleanup.UseOrNull","displayName":"Replace `.getOrElse(null)` with `.orNull`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
