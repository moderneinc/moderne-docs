...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.cleanup.RemoveExplicitReturn"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.cleanup.RemoveExplicitReturn"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/cleanup/removeexplicitreturn.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.cleanup.RemoveExplicitReturn","displayName":"Remove explicit `return` statements","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
