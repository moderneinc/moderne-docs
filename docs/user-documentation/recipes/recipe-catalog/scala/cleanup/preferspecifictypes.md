...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.cleanup.PreferSpecificTypes"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.cleanup.PreferSpecificTypes"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/cleanup/preferspecifictypes.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.cleanup.PreferSpecificTypes","displayName":"Prefer specific types over `Any`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
