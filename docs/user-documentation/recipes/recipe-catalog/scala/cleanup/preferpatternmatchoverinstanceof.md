...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.cleanup.PreferPatternMatchOverInstanceOf"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.cleanup.PreferPatternMatchOverInstanceOf"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/cleanup/preferpatternmatchoverinstanceof.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.cleanup.PreferPatternMatchOverInstanceOf","displayName":"Prefer pattern matching over `isInstanceOf`/`asInstanceOf` chains","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
