...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.cleanup.PreferPatternMatch"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.cleanup.PreferPatternMatch"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/cleanup/preferpatternmatch.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.cleanup.PreferPatternMatch","displayName":"Prefer pattern matching over `asInstanceOf` casts","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
