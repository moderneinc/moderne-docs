...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.errorhandling.UseTrySafely"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.errorhandling.UseTrySafely"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/errorhandling/usetrysafely.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.errorhandling.UseTrySafely","displayName":"Use `Try` safely without calling `.get`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
