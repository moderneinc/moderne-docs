...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.migrate.database.SecureSqlQueries"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.migrate.database.SecureSqlQueries"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/migrate/database/securesqlqueries.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.migrate.database.SecureSqlQueries","displayName":"Ensure parameterized SQL queries","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
