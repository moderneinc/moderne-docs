...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.migrate.database.MigrateScalikeJdbc"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.migrate.database.MigrateScalikeJdbc"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/migrate/database/migratescalikejdbc.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.migrate.database.MigrateScalikeJdbc","displayName":"Migrate ScalikeJDBC to Doobie or Quill","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
