...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.migrate.scala3.ReplaceDoWhileLoop"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.migrate.scala3.ReplaceDoWhileLoop"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/migrate/scala3/replacedowhileloop.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.migrate.scala3.ReplaceDoWhileLoop","displayName":"Replace do-while loops (removed in Scala 3)","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
