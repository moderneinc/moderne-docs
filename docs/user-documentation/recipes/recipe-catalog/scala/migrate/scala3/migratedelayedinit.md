...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.migrate.scala3.MigrateDelayedInit"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.migrate.scala3.MigrateDelayedInit"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/migrate/scala3/migratedelayedinit.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.migrate.scala3.MigrateDelayedInit","displayName":"Migrate from `DelayedInit`/`App` to `@main`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
