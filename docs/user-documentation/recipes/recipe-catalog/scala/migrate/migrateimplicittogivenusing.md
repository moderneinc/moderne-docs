...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.migrate.MigrateImplicitToGivenUsing"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.migrate.MigrateImplicitToGivenUsing"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/migrate/migrateimplicittogivenusing.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.migrate.MigrateImplicitToGivenUsing","displayName":"Migrate `implicit` to `given`/`using` (Scala 3)","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
