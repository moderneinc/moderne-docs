...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.migrate.akka.MigrateActorRefTell"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.migrate.akka.MigrateActorRefTell"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/migrate/akka/migrateactorreftell.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.migrate.akka.MigrateActorRefTell","displayName":"Migrate classic actor tell to typed ActorRef","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
