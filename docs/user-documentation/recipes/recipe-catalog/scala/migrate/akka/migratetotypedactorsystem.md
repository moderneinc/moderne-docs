...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.migrate.akka.MigrateToTypedActorSystem"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.migrate.akka.MigrateToTypedActorSystem"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/migrate/akka/migratetotypedactorsystem.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.migrate.akka.MigrateToTypedActorSystem","displayName":"Migrate `akka.actor.ActorSystem` to `akka.actor.typed.ActorSystem`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
