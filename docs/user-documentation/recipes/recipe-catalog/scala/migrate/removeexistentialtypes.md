...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.migrate.RemoveExistentialTypes"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.migrate.RemoveExistentialTypes"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/migrate/removeexistentialtypes.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.migrate.RemoveExistentialTypes","displayName":"Remove existential types (removed in Scala 3)","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
