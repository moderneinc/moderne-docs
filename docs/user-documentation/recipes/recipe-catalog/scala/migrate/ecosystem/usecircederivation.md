...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.migrate.ecosystem.UseCirceDerivation"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.migrate.ecosystem.UseCirceDerivation"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/migrate/ecosystem/usecircederivation.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.migrate.ecosystem.UseCirceDerivation","displayName":"Use circe `derives` for Scala 3","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
