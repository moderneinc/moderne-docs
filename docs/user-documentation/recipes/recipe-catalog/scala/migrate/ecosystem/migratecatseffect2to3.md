...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.migrate.ecosystem.MigrateCatsEffect2To3"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.migrate.ecosystem.MigrateCatsEffect2To3"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/migrate/ecosystem/migratecatseffect2to3.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.migrate.ecosystem.MigrateCatsEffect2To3","displayName":"Migrate Cats Effect 2 to Cats Effect 3","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
