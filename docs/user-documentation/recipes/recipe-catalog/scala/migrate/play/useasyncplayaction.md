...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.migrate.play.UseAsyncPlayAction"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.migrate.play.UseAsyncPlayAction"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/migrate/play/useasyncplayaction.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.migrate.play.UseAsyncPlayAction","displayName":"Use `Action.async` with `Future` instead of blocking","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
