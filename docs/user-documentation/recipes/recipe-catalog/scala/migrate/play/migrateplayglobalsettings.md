...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.migrate.play.MigratePlayGlobalSettings"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.migrate.play.MigratePlayGlobalSettings"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/migrate/play/migrateplayglobalsettings.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.migrate.play.MigratePlayGlobalSettings","displayName":"Migrate `GlobalSettings` to dependency injection (Play 2.6+)","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
