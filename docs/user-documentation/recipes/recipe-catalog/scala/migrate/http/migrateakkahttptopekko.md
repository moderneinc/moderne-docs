...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.migrate.http.MigrateAkkaHttpToPekko"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.migrate.http.MigrateAkkaHttpToPekko"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/migrate/http/migrateakkahttptopekko.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.migrate.http.MigrateAkkaHttpToPekko","displayName":"Find Akka HTTP imports to migrate to Apache Pekko","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
