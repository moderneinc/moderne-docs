...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.performance.UseIsEmpty"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.performance.UseIsEmpty"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/performance/useisempty.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.performance.UseIsEmpty","displayName":"Use `isEmpty` instead of `size == 0`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
