...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.performance.UseLastOption"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.performance.UseLastOption"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/performance/uselastoption.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.performance.UseLastOption","displayName":"Replace `.last` with `.lastOption`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
