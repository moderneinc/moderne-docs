...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.performance.UseFlatMap"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.performance.UseFlatMap"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/performance/useflatmap.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.performance.UseFlatMap","displayName":"Replace `map` then `flatten` with `flatMap`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
