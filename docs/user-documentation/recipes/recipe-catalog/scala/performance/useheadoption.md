...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.performance.UseHeadOption"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.performance.UseHeadOption"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/performance/useheadoption.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.performance.UseHeadOption","displayName":"Replace `.head` with `.headOption`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
