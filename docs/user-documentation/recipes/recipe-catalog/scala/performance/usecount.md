...
<RecipeMeta
  ...
  fqName={"org.openrewrite.scala.performance.UseCount"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.scala.performance.UseCount"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/scala/performance/usecount.md"}
  moderneOnly
>
...
<UsageList usage={{"recipeName":"org.openrewrite.scala.performance.UseCount","displayName":"Replace `filter` then `size` with `count`","groupId":"io.moderne.recipe","artifactId":"recipes-scala","versionKey":"VERSION_IO_MODERNE_RECIPE_RECIPES_SCALA","requiresConfiguration":false}}>
