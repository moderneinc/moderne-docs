---
sidebar_label: "io.quarkus.updates.core.quarkus30.JavaxToJakartaDocumentationAdoc"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/io/quarkus/updates/core/quarkus30/javaxtojakartadocumentationadoc" />
</head>
...
[GitHub: search?type=code&q=io.quarkus.updates.core.quarkus30.JavaxToJakartaDocumentationAdoc](https://github.com/search?type=code&q=io.quarkus.updates.core.quarkus30.JavaxToJakartaDocumentationAdoc),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=io.quarkus.updates.core.quarkus30.JavaxToJakartaDocumentationAdoc -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/io.quarkus.updates.core.quarkus30.JavaxToJakartaDocumentationAdoc" />
