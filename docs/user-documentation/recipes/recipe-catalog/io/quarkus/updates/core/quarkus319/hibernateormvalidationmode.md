...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/io/quarkus/updates/core/quarkus319/hibernateormvalidationmode" />
</head>
...
rewrite {
    activeRecipe("io.quarkus.updates.core.quarkus319.HibernateORMValidationMode")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>io.quarkus.updates.core.quarkus319.HibernateORMValidationMode</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=io.quarkus.updates.core.quarkus319.HibernateORMValidationMode -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe HibernateORMValidationMode
```
