...
canonical_url: "https://docs.openrewrite.org/recipes/io/quarkus/updates/core/quarkus37/upgradetojava17"
---
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>io.quarkus.updates.core.quarkus37.UpgradeToJava17</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=io.quarkus.updates.core.quarkus37.UpgradeToJava17 -Drewrite.exportDatatables=true
```
</TabItem>
