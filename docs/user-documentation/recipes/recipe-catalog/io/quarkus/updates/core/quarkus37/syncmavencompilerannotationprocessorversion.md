...
canonical_url: "https://docs.openrewrite.org/recipes/io/quarkus/updates/core/quarkus37/syncmavencompilerannotationprocessorversion"
---
...
[GitHub: search?type=code&q=io.quarkus.updates.core.quarkus37.SyncMavenCompilerAnnotationProcessorVersion](https://github.com/search?type=code&q=io.quarkus.updates.core.quarkus37.SyncMavenCompilerAnnotationProcessorVersion),
...
Now that `com.yourorg.SyncMavenCompilerAnnotationProcessorVersionExample` has been defined, activate it and take a dependency on `org.openrewrite.recipe:rewrite-third-party:{{VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY}}` in your build file:
...
<RecipeCallout link="https://app.moderne.io/recipes/io.quarkus.updates.core.quarkus37.SyncMavenCompilerAnnotationProcessorVersion" />
