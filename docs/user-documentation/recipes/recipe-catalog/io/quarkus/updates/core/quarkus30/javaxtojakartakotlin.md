---
sidebar_label: "io.quarkus.updates.core.quarkus30.JavaxToJakartaKotlin"
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/io/quarkus/updates/core/quarkus30/javaxtojakartakotlin" />
</head>
...
[GitHub: search?type=code&q=io.quarkus.updates.core.quarkus30.JavaxToJakartaKotlin](https://github.com/search?type=code&q=io.quarkus.updates.core.quarkus30.JavaxToJakartaKotlin),
...
displayName: io.quarkus.updates.core.quarkus30.JavaxToJakartaKotlin
description: |
...
rewrite {
    activeRecipe("io.quarkus.updates.core.quarkus30.JavaxToJakartaKotlin")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>io.quarkus.updates.core.quarkus30.JavaxToJakartaKotlin</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=io.quarkus.updates.core.quarkus30.JavaxToJakartaKotlin -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe JavaxToJakartaKotlin
```
...
<RecipeCallout link="https://app.moderne.io/recipes/io.quarkus.updates.core.quarkus30.JavaxToJakartaKotlin" />
