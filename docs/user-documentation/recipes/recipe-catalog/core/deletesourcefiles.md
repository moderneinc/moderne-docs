...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/core/deletesourcefiles" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.DeleteSourceFiles"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-core/src/main/java/org/openrewrite/DeleteSourceFiles.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.DeleteSourceFiles","displayName":"Delete files","groupId":"org.openrewrite","artifactId":"rewrite-core","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_CORE","requiresConfiguration":true,"cliOptions":" --recipe-option \"filePattern=.github/workflows/*.yml\""}}>
