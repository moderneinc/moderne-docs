...
* [Remove Maven wrapper](/user-documentation/recipes/recipe-catalog/maven/removemavenwrapper.md)
...
<RunRecipe
  recipeName="org.openrewrite.DeleteSourceFiles"
  ...
  cliOptions={' --recipe-option "filePattern=.github/workflows/*.yml"'}
  showGradle={false}
  showMaven={false}
  hasDataTables
/>
