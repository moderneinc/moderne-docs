...
<RecipeMeta
  ...
  fqName={"org.openrewrite.ExcludeFileFromGitignore"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-core/src/main/java/org/openrewrite/ExcludeFileFromGitignore.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.ExcludeFileFromGitignore","displayName":"Remove ignoral of files or directories from .gitignore","groupId":"org.openrewrite","artifactId":"rewrite-core","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_CORE","requiresConfiguration":true,"cliOptions":" --recipe-option \"paths=/folder/file.txt\""}}>
