...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.FindLstProvenance -Drewrite.exportDatatables=true
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.FindLstProvenance" />
...
<TabItem value="org.openrewrite.table.LstProvenanceTable" label="LstProvenanceTable">

### LST provenance
**org.openrewrite.table.LstProvenanceTable**
