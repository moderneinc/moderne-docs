...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/core/singleton" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.Singleton"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-core/src/main/java/org/openrewrite/Singleton.java"}
/>
