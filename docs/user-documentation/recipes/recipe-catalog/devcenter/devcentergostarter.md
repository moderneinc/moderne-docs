---
title: "DevCenter for Go"
sidebar_label: "DevCenter for Go"
hide_title: true
---
...
<RecipeMeta
  displayName={"DevCenter for Go"}
  description={"A default DevCenter configuration for Go repositories. Track Go version adoption across your organization."}
  fqName={"io.moderne.devcenter.DevCenterGoStarter"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.devcenter.DevCenterGoStarter"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/devcenter/devcentergostarter.md"}
  moderneOnly
>

<RecipeHeader.Title>DevCenter for Go</RecipeHeader.Title>

<RecipeHeader.Description>A default DevCenter configuration for Go repositories. Track Go version adoption across your organization.</RecipeHeader.Description>

</RecipeHeader>

<RecipeList recipes={[{"name":"Move to a later Go version","href":"/user-documentation/recipes/recipe-catalog/devcenter/goversionupgrade/"},{"name":"Find organization statistics","href":"/user-documentation/recipes/recipe-catalog/devcenter/findorganizationstatistics/"},{"name":"Find committers on repositories","href":"/user-documentation/recipes/recipe-catalog/search/findcommitters/"}]}>

## Definition

</RecipeList>

<UsageList usage={{"recipeName":"io.moderne.devcenter.DevCenterGoStarter","displayName":"DevCenter for Go","groupId":"io.moderne.recipe","artifactId":"rewrite-devcenter","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_DEVCENTER","requiresConfiguration":false}}>
