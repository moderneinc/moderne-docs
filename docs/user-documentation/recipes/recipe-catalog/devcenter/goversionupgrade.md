---
title: "Move to a later Go version"
sidebar_label: "Move to a later Go version"
hide_title: true
---
...
<RecipeMeta
  displayName={"Move to a later Go version"}
  description={"Determine the current state of a repository relative to a desired Go version upgrade."}
  fqName={"io.moderne.devcenter.GoVersionUpgrade"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.devcenter.GoVersionUpgrade"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/devcenter/goversionupgrade.md"}
  moderneOnly
>

<RecipeHeader.Title>Move to a later Go version</RecipeHeader.Title>

<RecipeHeader.Description>Determine the current state of a repository relative to a desired Go version upgrade.</RecipeHeader.Description>

</RecipeHeader>

<OptionsTable options={[{"type":"int","name":"minorVersion","required":true,"description":"The minor version of Go (1.x) to upgrade to.","example":"26"},{"type":"String","name":"upgradeRecipe","required":false,"description":"The recipe to use to upgrade.","example":"org.openrewrite.golang.migration.UpgradeGoTo126"}]}>
