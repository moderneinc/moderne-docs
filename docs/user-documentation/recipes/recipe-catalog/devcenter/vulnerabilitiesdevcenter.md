...
canonical_url: "https://docs.openrewrite.org/recipes/devcenter/vulnerabilitiesdevcenter"
---
...
_Recipes to analyze and manage dependency vulnerabilities using Moderne DevCenter._
...
* [Vulnerabilities status](../devcenter/dependencyvulnerabilitycheck)
  * measure: `Severity`
* [Vulnerabilities status](../devcenter/dependencyvulnerabilitycheck)
  * measure: `UpgradeDelta`
* [Vulnerabilities status](../devcenter/dependencyvulnerabilitycheck)
  * measure: `RiskScore`
...
name: io.moderne.devcenter.VulnerabilitiesDevCenter
...
rewrite {
    activeRecipe("io.moderne.devcenter.VulnerabilitiesDevCenter")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>io.moderne.devcenter.VulnerabilitiesDevCenter</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=io.moderne.recipe:rewrite-devcenter:RELEASE -Drewrite.activeRecipes=io.moderne.devcenter.VulnerabilitiesDevCenter -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe VulnerabilitiesDevCenter
```
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.devcenter.VulnerabilitiesDevCenter" />
