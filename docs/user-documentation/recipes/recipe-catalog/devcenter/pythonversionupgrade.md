---
title: "Move to a later Python version"
sidebar_label: "Move to a later Python version"
---
...
_Determine the current state of a repository relative to a desired Python version upgrade._

## Recipe source

[GitHub: PythonVersionUpgrade.java](https://github.com/moderneinc/rewrite-devcenter/blob/main/src/main/java/io/moderne/devcenter/PythonVersionUpgrade.java),
...
| --- | --- | --- | --- |
| `int` | minorVersion | The minor version of Python 3 to upgrade to. | `13` |
| `String` | upgradeRecipe | *Optional*. The recipe to use to upgrade. | `org.openrewrite.python.migrate.UpgradeToPython313` |
...
name: com.yourorg.PythonVersionUpgradeExample
displayName: Move to a later Python version example
recipeList:
  - io.moderne.devcenter.PythonVersionUpgrade:
      minorVersion: 13
      upgradeRecipe: org.openrewrite.python.migrate.UpgradeToPython313
```

<RunRecipe
  recipeName="io.moderne.devcenter.PythonVersionUpgrade"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.devcenter.PythonVersionUpgrade" />
