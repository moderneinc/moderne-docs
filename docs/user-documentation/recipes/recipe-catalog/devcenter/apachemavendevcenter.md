...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/devcenter/apachemavendevcenter" />
</head>
...
_A DevCenter that tracks the latest Apache Maven parent POM versions and applies best practices. This DevCenter includes recipes to upgrade the parent POMs of Apache Maven, as well as a collection of best practices for Maven POMs._

## Recipe source

[GitHub: apache-maven-devcenter.yml](https://github.com/moderneinc/rewrite-devcenter/blob/main/src/main/resources/META-INF/rewrite/apache-maven-devcenter.yml),
...
* [Apache Maven best practices](../devcenter/apachemavenbestpractices)
...
rewrite {
    activeRecipe("io.moderne.devcenter.ApacheMavenDevCenter")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>io.moderne.devcenter.ApacheMavenDevCenter</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=io.moderne.recipe:rewrite-devcenter:RELEASE -Drewrite.activeRecipes=io.moderne.devcenter.ApacheMavenDevCenter -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe ApacheMavenDevCenter
```
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.devcenter.ApacheMavenDevCenter" />
