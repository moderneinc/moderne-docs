...
_Determine the current state of a repository relative to a desired Scala version upgrade._

## Recipe source

[GitHub: ScalaVersionUpgrade.java](https://github.com/moderneinc/rewrite-devcenter/blob/main/src/main/java/io/moderne/devcenter/ScalaVersionUpgrade.java),
...
| --- | --- | --- | --- |
| `int` | majorVersion | The major version of Scala to upgrade to. | `3` |
| `String` | upgradeRecipe | *Optional*. The recipe to use to upgrade. | `org.openrewrite.scala.migrate.UpgradeScala_2_12` |
...
name: com.yourorg.ScalaVersionUpgradeExample
displayName: Move to a later Scala version example
recipeList:
  - io.moderne.devcenter.ScalaVersionUpgrade:
      majorVersion: 3
      upgradeRecipe: org.openrewrite.scala.migrate.UpgradeScala_2_12
```

<RunRecipe
  recipeName="io.moderne.devcenter.ScalaVersionUpgrade"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.devcenter.ScalaVersionUpgrade" />
