...
_A DevCenter that finds class quality metrics for repositories and buckets the average LCOM4 (Lack of Cohesion of Methods, version 4) into HIGH / MEDIUM / LOW cohesion categories._

## Recipe source

[GitHub: code-quality-devcenter.yml](https://github.com/moderneinc/rewrite-devcenter/blob/main/src/main/resources/META-INF/rewrite/code-quality-devcenter.yml),
...
* [Find class quality metrics](../prethink/quality/findclassmetrics)
* [Find test coverage gaps](../prethink/testing/coverage/findtestgaps)
* [DevCenter card from a data table column](../devcenter/bucketedmetriccard)
...
<RunRecipe
  recipeName="io.moderne.devcenter.ClassCohesionDevCenter"
  displayName="Class cohesion DevCenter"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.devcenter.ClassCohesionDevCenter" />
