...
<RecipeMeta
  displayName={"Move to a later Node.js version"}
  description={"Determine the current state of a repository relative to a desired Node.js version upgrade."}
  fqName={"io.moderne.devcenter.NodeVersionUpgrade"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.devcenter.NodeVersionUpgrade"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/devcenter/nodeversionupgrade.md"}
  moderneOnly
>

<RecipeHeader.Title>Move to a later Node.js version</RecipeHeader.Title>

<RecipeHeader.Description>Determine the current state of a repository relative to a desired Node.js version upgrade.</RecipeHeader.Description>

</RecipeHeader>

<OptionsTable options={[{"type":"int","name":"majorVersion","required":true,"description":"The major version of Node.js to upgrade to.","example":"22"},{"type":"String","name":"upgradeRecipe","required":false,"description":"The recipe to use to upgrade.","example":"org.openrewrite.node.migrate.upgrade-node-22"}]}>
