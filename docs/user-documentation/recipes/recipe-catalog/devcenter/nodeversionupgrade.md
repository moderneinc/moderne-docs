...
_Determine the current state of a repository relative to a desired Node.js version upgrade._

## Recipe source

[GitHub: NodeVersionUpgrade.java](https://github.com/moderneinc/rewrite-devcenter/blob/main/src/main/java/io/moderne/devcenter/NodeVersionUpgrade.java),
...
name: com.yourorg.NodeVersionUpgradeExample
displayName: Move to a later Node.js version example
recipeList:
  - io.moderne.devcenter.NodeVersionUpgrade:
      majorVersion: 22
```
...
<RunRecipe
  recipeName="io.moderne.devcenter.NodeVersionUpgrade"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.devcenter.NodeVersionUpgrade" />
