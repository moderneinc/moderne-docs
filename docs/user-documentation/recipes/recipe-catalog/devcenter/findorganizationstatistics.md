...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/devcenter/findorganizationstatistics" />
</head>
...
_Counts lines of code per repository for organization-level statistics._

## Recipe source

[GitHub: FindOrganizationStatistics.java](https://github.com/moderneinc/rewrite-devcenter/blob/main/src/main/java/io/moderne/devcenter/FindOrganizationStatistics.java),
...
```shell title="shell"
mod run . --recipe FindOrganizationStatistics
```
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.devcenter.FindOrganizationStatistics" />
