...
_Determine the current state of a repository relative to a desired Groovy version upgrade._

## Recipe source

[GitHub: GroovyVersionUpgrade.java](https://github.com/moderneinc/rewrite-devcenter/blob/main/src/main/java/io/moderne/devcenter/GroovyVersionUpgrade.java),
...
name: com.yourorg.GroovyVersionUpgradeExample
displayName: Move to a later Groovy version example
recipeList:
  - io.moderne.devcenter.GroovyVersionUpgrade:
      majorVersion: 4
```
...
<RunRecipe
  recipeName="io.moderne.devcenter.GroovyVersionUpgrade"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.devcenter.GroovyVersionUpgrade" />
