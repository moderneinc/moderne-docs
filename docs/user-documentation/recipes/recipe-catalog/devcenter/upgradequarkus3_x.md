...
canonical_url: "https://docs.openrewrite.org/recipes/devcenter/upgradequarkus3_x"
---
...
**io.moderne.devcenter.UpgradeQuarkus3\_x**

_Upgrades Quarkus dependencies to version 3.26.x, including core, extensions, and tooling._
...
* [Quarkus 2.x migration from Quarkus 1.x](../quarkus/quarkus2/quarkus1to2migration)
...
name: io.moderne.devcenter.UpgradeQuarkus3_x
...
rewrite {
    activeRecipe("io.moderne.devcenter.UpgradeQuarkus3_x")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>io.moderne.devcenter.UpgradeQuarkus3_x</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=io.moderne.recipe:rewrite-devcenter:RELEASE -Drewrite.activeRecipes=io.moderne.devcenter.UpgradeQuarkus3_x -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe UpgradeQuarkus3_x
```
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.devcenter.UpgradeQuarkus3_x" />
