...
_Determine the current state of a repository relative to a desired .NET version upgrade._

## Recipe source

[GitHub: CSharpVersionUpgrade.java](https://github.com/moderneinc/rewrite-devcenter/blob/main/src/main/java/io/moderne/devcenter/CSharpVersionUpgrade.java),
...
name: com.yourorg.CSharpVersionUpgradeExample
displayName: Move to a later .NET version example
recipeList:
  - io.moderne.devcenter.CSharpVersionUpgrade:
      majorVersion: 9
```
...
<RunRecipe
  recipeName="io.moderne.devcenter.CSharpVersionUpgrade"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.devcenter.CSharpVersionUpgrade" />
