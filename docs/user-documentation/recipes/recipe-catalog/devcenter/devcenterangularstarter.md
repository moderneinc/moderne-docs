...
<RecipeMeta
  displayName={"DevCenter for Angular"}
  description={"A default DevCenter configuration for Angular repositories. Track Angular version adoption across your organization."}
  fqName={"io.moderne.devcenter.DevCenterAngularStarter"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/io.moderne.devcenter.DevCenterAngularStarter"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/devcenter/devcenterangularstarter.md"}
  moderneOnly
>

<RecipeHeader.Title>DevCenter for Angular</RecipeHeader.Title>

<RecipeHeader.Description>A default DevCenter configuration for Angular repositories. Track Angular version adoption across your organization.</RecipeHeader.Description>

</RecipeHeader>

<RecipeList recipes={[{"name":"Move to a later Angular version","href":"/user-documentation/recipes/recipe-catalog/devcenter/angularversionupgrade/"},{"name":"Find organization statistics","href":"/user-documentation/recipes/recipe-catalog/devcenter/findorganizationstatistics/"},{"name":"Find committers on repositories","href":"/user-documentation/recipes/recipe-catalog/search/findcommitters/"}]}>

## Definition

</RecipeList>

<UsageList usage={{"recipeName":"io.moderne.devcenter.DevCenterAngularStarter","displayName":"DevCenter for Angular","groupId":"io.moderne.recipe","artifactId":"rewrite-devcenter","versionKey":"VERSION_IO_MODERNE_RECIPE_REWRITE_DEVCENTER","requiresConfiguration":false}}>
