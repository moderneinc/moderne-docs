...
_Determine the current state of a repository relative to a desired Kotlin version upgrade._

## Recipe source

[GitHub: KotlinVersionUpgrade.java](https://github.com/moderneinc/rewrite-devcenter/blob/main/src/main/java/io/moderne/devcenter/KotlinVersionUpgrade.java),
...
| --- | --- | --- | --- |
| `String` | version | The target Kotlin version to upgrade to, in major.minor format. | `2.1` |
...
name: com.yourorg.KotlinVersionUpgradeExample
displayName: Move to a later Kotlin version example
recipeList:
  - io.moderne.devcenter.KotlinVersionUpgrade:
      version: 2.1
      upgradeRecipe: org.openrewrite.kotlin.migrate.UpgradeToKotlin2
```

<RunRecipe
  recipeName="io.moderne.devcenter.KotlinVersionUpgrade"
  ...
  cliOptions={' --recipe-option "version=2.1" --recipe-option "upgradeRecipe=org.openrewrite.kotlin.migrate.UpgradeToKotlin2"'}
  showGradle={false}
  showMaven={false}
  hasDataTables
/>
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.devcenter.KotlinVersionUpgrade" />
