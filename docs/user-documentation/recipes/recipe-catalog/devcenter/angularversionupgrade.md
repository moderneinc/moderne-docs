...
_Determine the current state of a repository relative to a desired Angular version upgrade._

## Recipe source

[GitHub: AngularVersionUpgrade.java](https://github.com/moderneinc/rewrite-devcenter/blob/main/src/main/java/io/moderne/devcenter/AngularVersionUpgrade.java),
...
| --- | --- | --- | --- |
| `int` | majorVersion | The major version of Angular to upgrade to. | `21` |
| `String` | upgradeRecipe | *Optional*. The recipe to use to upgrade. | `org.openrewrite.codemods.migrate.angular.ApplyAngularCLI` |
...
name: com.yourorg.AngularVersionUpgradeExample
displayName: Move to a later Angular version example
recipeList:
  - io.moderne.devcenter.AngularVersionUpgrade:
      majorVersion: 21
      upgradeRecipe: org.openrewrite.codemods.migrate.angular.ApplyAngularCLI
```

<RunRecipe
  recipeName="io.moderne.devcenter.AngularVersionUpgrade"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.devcenter.AngularVersionUpgrade" />
