...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/openapi/swagger/migrateapiparamdefaultvalue" />
</head>
...
_Migrate `@ApiParam(defaultValue)` to `@Parameter(schema = @Schema(defaultValue))`._

## Recipe source

[GitHub: MigrateApiParamDefaultValue.java](https://github.com/openrewrite/rewrite-openapi/blob/main/src/main/java/org/openrewrite/openapi/swagger/MigrateApiParamDefaultValue.java),
...
rewrite {
    activeRecipe("org.openrewrite.openapi.swagger.MigrateApiParamDefaultValue")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.openapi.swagger.MigrateApiParamDefaultValue</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-openapi:RELEASE -Drewrite.activeRecipes=org.openrewrite.openapi.swagger.MigrateApiParamDefaultValue -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe MigrateApiParamDefaultValue
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.openapi.swagger.MigrateApiParamDefaultValue" />
