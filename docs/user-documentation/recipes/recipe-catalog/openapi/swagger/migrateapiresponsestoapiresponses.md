...
canonical_url: "https://docs.openrewrite.org/recipes/openapi/swagger/migrateapiresponsestoapiresponses"
---
...
## Examples
##### Example 1
`MigrateApiResponsesToApiResponsesTest#convertApiResponseCodesToStrings`
