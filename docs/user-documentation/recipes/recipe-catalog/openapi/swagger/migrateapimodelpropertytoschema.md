---
title: "Migrate from `@ApiModelProperty` to `@Schema`"
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.openapi.swagger.MigrateApiModelPropertyToSchema"}
...
<UsageList usage={{"recipeName":"org.openrewrite.openapi.swagger.MigrateApiModelPropertyToSchema","displayName":"Migrate from `@ApiModelProperty` to `@Schema`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-openapi","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_OPENAPI","requiresConfiguration":false}}>
