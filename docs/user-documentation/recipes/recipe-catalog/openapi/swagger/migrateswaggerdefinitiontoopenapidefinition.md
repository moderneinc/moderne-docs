...
<RecipeMeta
  ...
  fqName={"org.openrewrite.openapi.swagger.MigrateSwaggerDefinitionToOpenAPIDefinition"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-openapi/blob/main/src/main/java/org/openrewrite/openapi/swagger/MigrateSwaggerDefinitionToOpenAPIDefinition.java"}
/>
