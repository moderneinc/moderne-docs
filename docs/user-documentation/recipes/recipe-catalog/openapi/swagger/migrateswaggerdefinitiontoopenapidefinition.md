...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/openapi/swagger/migrateswaggerdefinitiontoopenapidefinition" />
</head>
...
_Migrate from `@SwaggerDefinition` to `@OpenAPIDefinition`._
...
rewrite {
    activeRecipe("org.openrewrite.openapi.swagger.MigrateSwaggerDefinitionToOpenAPIDefinition")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.openapi.swagger.MigrateSwaggerDefinitionToOpenAPIDefinition</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-openapi:RELEASE -Drewrite.activeRecipes=org.openrewrite.openapi.swagger.MigrateSwaggerDefinitionToOpenAPIDefinition -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe MigrateSwaggerDefinitionToOpenAPIDefinition
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.openapi.swagger.MigrateSwaggerDefinitionToOpenAPIDefinition" />
