...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/openapi/swagger/migrateapimodeltoschema" />
</head>
...
[GitHub: MigrateApiModelToSchema.java](https://github.com/openrewrite/rewrite-openapi/blob/main/src/main/java/org/openrewrite/openapi/swagger/MigrateApiModelToSchema.java),
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.openapi.swagger.MigrateApiModelToSchema</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-openapi:RELEASE -Drewrite.activeRecipes=org.openrewrite.openapi.swagger.MigrateApiModelToSchema -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe MigrateApiModelToSchema
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.openapi.swagger.MigrateApiModelToSchema" />
