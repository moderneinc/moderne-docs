...
<RecipeMeta
  ...
  fqName={"org.openrewrite.openapi.swagger.MigrateApiModelToSchema"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-openapi/blob/main/src/main/java/org/openrewrite/openapi/swagger/MigrateApiModelToSchema.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.openapi.swagger.MigrateApiModelToSchema","displayName":"Migrate from `@ApiModel` to `@Schema`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-openapi","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_OPENAPI","requiresConfiguration":false}}>
