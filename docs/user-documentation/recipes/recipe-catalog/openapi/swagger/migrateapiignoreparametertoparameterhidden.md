---
title: "Replace springfox `@ApiIgnore` on method parameters with `@Parameter(hidden = true)`"
sidebar_label: "Replace springfox `@ApiIgnore` on method parameters with `@Parameter(hidden = true)`"
hide_title: true
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/openapi/swagger/migrateapiignoreparametertoparameterhidden" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.openapi.swagger.MigrateApiIgnoreParameterToParameterHidden"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite-openapi/blob/main/src/main/java/org/openrewrite/openapi/swagger/MigrateApiIgnoreParameterToParameterHidden.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.openapi.swagger.MigrateApiIgnoreParameterToParameterHidden","displayName":"Replace springfox `@ApiIgnore` on method parameters with `@Parameter(hidden = true)`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-openapi","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_OPENAPI","requiresConfiguration":false}}>
