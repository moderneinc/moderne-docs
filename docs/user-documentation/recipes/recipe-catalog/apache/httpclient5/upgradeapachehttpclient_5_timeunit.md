...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/apache/httpclient5/upgradeapachehttpclient_5_timeunit" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.apache.httpclient5.UpgradeApacheHttpClient_5_TimeUnit"}
...
<UsageList usage={{"recipeName":"org.openrewrite.apache.httpclient5.UpgradeApacheHttpClient_5_TimeUnit","displayName":"Adds `TimeUnit` to timeouts and duration methods","groupId":"org.openrewrite.recipe","artifactId":"rewrite-apache","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_APACHE","requiresConfiguration":false}}>
