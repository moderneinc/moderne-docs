...
<RecipeMeta
  ...
  fqName={"org.openrewrite.apache.httpclient5.MigrateAuthState"}
...
<UsageList usage={{"recipeName":"org.openrewrite.apache.httpclient5.MigrateAuthState","displayName":"Migrate `AuthState` to `AuthExchange`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-apache","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_APACHE","requiresConfiguration":false}}>
