...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/apache/httpclient5/migrateauthstate" />
</head>
...
_Migrate Apache HttpClient 4.x `AuthState` and related types to the HttpClient 5.x `AuthExchange` API, including the `AuthProtocolState` enum, `AuthOption` queue elements, and credential-handling call sites._
...
* [Migrate `AuthScheme` credential handling](../../apache/httpclient5/migrateauthschemecredentials)
...
<RunRecipe
  recipeName="org.openrewrite.apache.httpclient5.MigrateAuthState"
  displayName="Migrate `AuthState` to `AuthExchange`"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.apache.httpclient5.MigrateAuthState" />
