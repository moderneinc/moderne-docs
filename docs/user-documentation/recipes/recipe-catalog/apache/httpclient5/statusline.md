...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/apache/httpclient5/statusline" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.apache.httpclient5.StatusLine"}
...
<UsageList usage={{"recipeName":"org.openrewrite.apache.httpclient5.StatusLine","displayName":"Migrate to ApacheHttpClient 5.x deprecated methods from 4.x","groupId":"org.openrewrite.recipe","artifactId":"rewrite-apache","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_APACHE","requiresConfiguration":false}}>
