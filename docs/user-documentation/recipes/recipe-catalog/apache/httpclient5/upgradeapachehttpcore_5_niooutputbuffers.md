...
_Mapping of specifically `*OutputBuffer` classes of Apache HttpCore 5.x from Apache HttpCore Nio 4.4.x._
...
<RunRecipe
  recipeName="org.openrewrite.apache.httpclient5.UpgradeApacheHttpCore_5_NioOutputBuffers"
  displayName="Migrate Apache HttpCore Nio Output Buffer classes to Apache HttpCore 5.x"
