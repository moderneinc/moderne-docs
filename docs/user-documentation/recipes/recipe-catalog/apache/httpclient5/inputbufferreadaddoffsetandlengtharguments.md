...
canonical_url: "https://docs.openrewrite.org/recipes/apache/httpclient5/inputbufferreadaddoffsetandlengtharguments"
---
...
_In Apache Http Client 5.x migration, the shortened form of the `read(byte[])` has been removed._
...
rewrite {
    activeRecipe("org.openrewrite.apache.httpclient5.InputBufferReadAddOffsetAndLengthArguments")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.apache.httpclient5.InputBufferReadAddOffsetAndLengthArguments</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-apache:RELEASE -Drewrite.activeRecipes=org.openrewrite.apache.httpclient5.InputBufferReadAddOffsetAndLengthArguments -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe InputBufferReadAddOffsetAndLengthArguments
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.apache.httpclient5.InputBufferReadAddOffsetAndLengthArguments" />
