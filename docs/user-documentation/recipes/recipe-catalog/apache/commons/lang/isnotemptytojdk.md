---
title: "Replace any StringUtils#isEmpty(String) and #isNotEmpty(String)"
...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/apache/commons/lang/isnotemptytojdk" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.apache.commons.lang.IsNotEmptyToJdk"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-apache/blob/main/src/main/java/org/openrewrite/apache/commons/lang/IsNotEmptyToJdk.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.apache.commons.lang.IsNotEmptyToJdk","displayName":"Replace any StringUtils#isEmpty(String) and #isNotEmpty(String)","groupId":"org.openrewrite.recipe","artifactId":"rewrite-apache","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_APACHE","requiresConfiguration":false}}>
