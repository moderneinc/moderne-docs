...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/apache/commons/lang/wordutilstocommonstext" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.apache.commons.lang.WordUtilsToCommonsText"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-apache/blob/main/src/main/resources/META-INF/rewrite/apache-commons-lang-2-3.yml"}
/>
...
<ExampleList examples={[{"variants":[{"language":"java","before":"import org.apache.commons.lang.WordUtils;\n\nclass Lang2 {\n    String capitalize(String str) {\n        return WordUtils.capitalize(str);\n    }\n\n    String wrap(String str, int width) {\n        return WordUtils.wrap(str, width);\n    }\n}\n","after":"import org.apache.commons.text.WordUtils;\n\nclass Lang2 {\n    String capitalize(String str) {\n        return WordUtils.capitalize(str);\n    }\n\n    String wrap(String str, int width) {\n        return WordUtils.wrap(str, width);\n    }\n}\n","diff":"@@ -1,1 +1,1 @@\n-import org.apache.commons.lang.WordUtils;\n+import org.apache.commons.text.WordUtils;\n\n","newFile":false}]},{"variants":[{"language":"java","before":"import org.apache.commons.lang.WordUtils;\n\nclass Lang2 {\n    String capitalize(String str) {\n        return WordUtils.capitalize(str);\n    }\n\n    String wrap(String str, int width) {\n        return WordUtils.wrap(str, width);\n    }\n}\n","after":"import org.apache.commons.text.WordUtils;\n\nclass Lang2 {\n    String capitalize(String str) {\n        return WordUtils.capitalize(str);\n    }\n\n    String wrap(String str, int width) {\n        return WordUtils.wrap(str, width);\n    }\n}\n","diff":"@@ -1,1 +1,1 @@\n-import org.apache.commons.lang.WordUtils;\n+import org.apache.commons.text.WordUtils;\n\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.apache.commons.lang.WordUtilsToCommonsText","displayName":"Migrate `WordUtils` to Apache Commons Text","groupId":"org.openrewrite.recipe","artifactId":"rewrite-apache","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_APACHE","requiresConfiguration":false}}>
