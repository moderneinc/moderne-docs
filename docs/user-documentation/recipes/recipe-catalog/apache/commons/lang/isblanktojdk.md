...
_Replace any `StringUtils#isBlank(String)` and `#isNotBlank(String)` with `s == null || s.isBlank()` and `s != null && !s.isBlank()`._
...
[GitHub: IsBlankToJdk.java](https://github.com/openrewrite/rewrite-apache/blob/main/src/main/java/org/openrewrite/apache/commons/lang/IsBlankToJdk.java),
...
<RunRecipe
  recipeName="org.openrewrite.apache.commons.lang.IsBlankToJdk"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.apache.commons.lang.IsBlankToJdk" />
