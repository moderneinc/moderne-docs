...
<RecipeMeta
  ...
  fqName={"org.openrewrite.apache.poi.ReplaceSetBoldweightWithSetBold"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-apache/blob/main/src/main/java/org/openrewrite/apache/poi/ReplaceSetBoldweightWithSetBold.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.apache.poi.ReplaceSetBoldweightWithSetBold","displayName":"Replace `Font.setBoldweight(short)` with `Font.setBold(boolean)`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-apache","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_APACHE","requiresConfiguration":false}}>
