...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/apache/logging/log4j/inlinelog4japimethods" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.apache.logging.log4j.InlineLog4jApiMethods"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/openrewrite/rewrite-logging-frameworks/blob/main/src/main/resources/META-INF/rewrite/inline-log4j-api-methods.yml"}
/>
...
<UsageList usage={{"recipeName":"org.apache.logging.log4j.InlineLog4jApiMethods","displayName":"Inline `log4j-api-2` methods annotated with `@InlineMe`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-logging-frameworks","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LOGGING_FRAMEWORKS","requiresConfiguration":false}}>
