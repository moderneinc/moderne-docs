...
canonical_url: "https://docs.openrewrite.org/recipes/apache/maven/shared/mavensharedstringutilsrecipes$uppercaserecipe"
---
...
```shell title="shell"
mod run . --recipe MavenSharedStringUtilsRecipes$UppercaseRecipe
```
