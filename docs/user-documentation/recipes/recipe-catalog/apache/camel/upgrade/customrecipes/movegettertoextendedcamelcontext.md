---
title: "Move getter from context to ExtendedCamelContext."
sidebar_label: "Move getter from context to ExtendedCamelContext."
---


<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/apache/camel/upgrade/customrecipes/movegettertoextendedcamelcontext" />
</head>
...
[GitHub: search?type=code&q=org.apache.camel.upgrade.customRecipes.MoveGetterToExtendedCamelContext](https://github.com/search?type=code&q=org.apache.camel.upgrade.customRecipes.MoveGetterToExtendedCamelContext),
...
* [Replace `context.$\{method\}(*)` with `context.getCamelContextExtension().$\{method\}(*)`](/user-documentation/recipes/recipe-catalog/apache/camel/upgrade/camel45/useextendedcamelcontextgetters.md)
...
<RunRecipe
  recipeName="org.apache.camel.upgrade.customRecipes.MoveGetterToExtendedCamelContext"
