...
<RecipeMeta
  ...
  description={""}
  fqName={"org.apache.camel.upgrade.camel44.RouteControllerProperties"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=org.apache.camel.upgrade.camel44.RouteControllerProperties"}
/>
