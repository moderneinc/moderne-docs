...
[GitHub: search?type=code&q=org.apache.camel.upgrade.camel45.UseExtendedCamelContextGetters](https://github.com/search?type=code&q=org.apache.camel.upgrade.camel45.UseExtendedCamelContextGetters),
...
* [Move getter from context to ExtendedCamelContext.](../../../../apache/camel/upgrade/customrecipes/movegettertoextendedcamelcontext)
...
* [Migrates `camel 4.4` application to `camel 4.5`](/user-documentation/recipes/recipe-catalog/apache/camel/upgrade/camel45/camelmigrationrecipe.md)


## Usage

<RunRecipe
  recipeName="org.apache.camel.upgrade.camel45.UseExtendedCamelContextGetters"
  displayName="Replace `context.$\{method\}(*)` with `context.getCamelContextExtension().$\{method\}(*)`"
