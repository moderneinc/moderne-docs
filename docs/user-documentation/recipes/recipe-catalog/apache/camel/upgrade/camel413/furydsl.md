...
<RecipeMeta
  ...
  description={""}
  fqName={"org.apache.camel.upgrade.camel413.furyDsl"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=org.apache.camel.upgrade.camel413.furyDsl"}
/>
...
<UsageList usage={{"recipeName":"org.apache.camel.upgrade.camel413.furyDsl","displayName":"Change dataformat fury to fury in xml/java dsl.","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
