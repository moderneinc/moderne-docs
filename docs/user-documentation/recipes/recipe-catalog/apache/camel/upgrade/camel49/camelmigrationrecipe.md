...
<RecipeMeta
  ...
  fqName={"org.apache.camel.upgrade.camel49.CamelMigrationRecipe"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=org.apache.camel.upgrade.camel49.CamelMigrationRecipe"}
/>
...
<UsageList usage={{"recipeName":"org.apache.camel.upgrade.camel49.CamelMigrationRecipe","displayName":"Migrates `camel 4.8` application to `camel 4.9`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
