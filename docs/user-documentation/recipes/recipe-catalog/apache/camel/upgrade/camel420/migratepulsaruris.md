...
* [Change Camel component URI across all DSLs](../../../../apache/camel/upgrade/customrecipes/changecomponenturirecipe)
...
* [Migrates `camel 4.19` application to `camel 4.20`](/user-documentation/recipes/recipe-catalog/apache/camel/upgrade/camel420/camelmigrationrecipe.md)
