...
<RecipeMeta
  ...
  description={""}
  fqName={"org.apache.camel.upgrade.camel40.UsePluginHelperForContextGetters"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/search?type=code&q=org.apache.camel.upgrade.camel40.UsePluginHelperForContextGetters"}
/>
...
<UsageList usage={{"recipeName":"org.apache.camel.upgrade.camel40.UsePluginHelperForContextGetters","displayName":"Replace context.getExtension(ExtendedCamelContext.class).get* with PluginHelper.get*(context)","groupId":"org.openrewrite.recipe","artifactId":"rewrite-third-party","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_THIRD_PARTY","requiresConfiguration":false}}>
