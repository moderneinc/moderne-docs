...
canonical_url: "https://docs.openrewrite.org/recipes/maven/managedtoruntimedependencies"
---
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.maven.ManagedToRuntimeDependencies</recipe>
          </activeRecipes>
        </configuration>
      </plugin>
    </plugins>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.maven.ManagedToRuntimeDependencies -Drewrite.exportDatatables=true
```
...
```shell title="shell"
mod run . --recipe ManagedToRuntimeDependencies
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.maven.ManagedToRuntimeDependencies" />
