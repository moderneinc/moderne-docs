...
<RecipeHeader.Title>Exclude Maven dependency</RecipeHeader.Title>

<RecipeHeader.Description>Exclude specified dependency from any dependency that transitively includes it.</RecipeHeader.Description>
