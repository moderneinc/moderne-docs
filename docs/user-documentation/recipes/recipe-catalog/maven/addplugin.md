...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/maven/addplugin" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.maven.AddPlugin"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-maven/src/main/java/org/openrewrite/maven/AddPlugin.java"}
/>
