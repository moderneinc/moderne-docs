...
[GitHub: ChangeParentPom.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-maven/src/main/java/org/openrewrite/maven/ChangeParentPom.java),
...
* [Change `net.wasdev.maven.parent:java8-parent` to `:parent`](/user-documentation/recipes/recipe-catalog/java/migrate/wasdevmvnchangeparentartifactid.md)
...
* [Update to Micronaut 4.x platform BOM](/user-documentation/recipes/recipe-catalog/java/micronaut/updatemicronautplatformbom.md)
