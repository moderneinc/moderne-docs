...
[GitHub: UpdateMavenWrapper.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-maven/src/main/java/org/openrewrite/maven/UpdateMavenWrapper.java),
...
<RunRecipe
  recipeName="org.openrewrite.maven.UpdateMavenWrapper"
