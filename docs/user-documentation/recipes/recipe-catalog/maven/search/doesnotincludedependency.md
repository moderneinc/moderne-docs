...
<RecipeHeader.Title>Does not include Maven dependency</RecipeHeader.Title>

<RecipeHeader.Description>A precondition which returns false if visiting a Maven pom which includes the specified dependency in the classpath of some scope. For compatibility with multimodule projects, this should most often be applied as a precondition.</RecipeHeader.Description>
