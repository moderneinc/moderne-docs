...
[GitHub: ModuleHasPlugin.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-maven/src/main/java/org/openrewrite/maven/search/ModuleHasPlugin.java),
...
<RunRecipe
  recipeName="org.openrewrite.maven.search.ModuleHasPlugin"
