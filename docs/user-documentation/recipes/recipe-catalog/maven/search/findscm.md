...
<RecipeMeta
  ...
  fqName={"org.openrewrite.maven.search.FindScm"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-maven/src/main/java/org/openrewrite/maven/search/FindScm.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.maven.search.FindScm","displayName":"Find SCM tag","groupId":"org.openrewrite","artifactId":"rewrite-maven","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_MAVEN","requiresConfiguration":false}}>
