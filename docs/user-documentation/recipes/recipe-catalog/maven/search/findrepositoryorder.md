...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/maven/search/findrepositoryorder" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.maven.search.FindRepositoryOrder"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-maven/src/main/java/org/openrewrite/maven/search/FindRepositoryOrder.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.maven.search.FindRepositoryOrder","displayName":"Maven repository order","groupId":"org.openrewrite","artifactId":"rewrite-maven","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_MAVEN","requiresConfiguration":false}}>
