...
[GitHub: FindPlugin.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-maven/src/main/java/org/openrewrite/maven/search/FindPlugin.java),
...
```shell title="shell"
mod run . --recipe FindPlugin --recipe-option "groupId=org.openrewrite.maven" --recipe-option "artifactId=rewrite-maven-plugin"
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.maven.search.FindPlugin" />
