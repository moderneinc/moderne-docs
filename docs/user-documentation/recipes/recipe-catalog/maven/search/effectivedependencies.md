...
[GitHub: EffectiveDependencies.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-maven/src/main/java/org/openrewrite/maven/search/EffectiveDependencies.java),
...
This recipe has required configuration parameters. Recipes with required configuration parameters cannot be activated directly (unless you are running them via the Moderne CLI). To activate this recipe you must create a new recipe which fills in the required parameters. In your `rewrite.yml` create a new recipe with a unique name. For example: `com.yourorg.EffectiveDependenciesExample`.
...
```shell title="shell"
mod run . --recipe EffectiveDependencies --recipe-option "scope=compile"
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.maven.search.EffectiveDependencies" />
...
<TabItem value="org.openrewrite.maven.table.DependencyGraph" label="DependencyGraph">
