...
<RecipeMeta
  ...
  fqName={"org.openrewrite.maven.cleanup.NoSystemScopeDependencies"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-maven/src/main/java/org/openrewrite/maven/cleanup/NoSystemScopeDependencies.java"}
/>
