...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/maven/cleanup/prefixlessexpressions" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.maven.cleanup.PrefixlessExpressions"}
...
<UsageList usage={{"recipeName":"org.openrewrite.maven.cleanup.PrefixlessExpressions","displayName":"Drop prefixless expressions in POM","groupId":"org.openrewrite","artifactId":"rewrite-maven","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_MAVEN","requiresConfiguration":false}}>
