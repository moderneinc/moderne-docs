...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/maven/removerepository" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.maven.RemoveRepository"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-maven/src/main/java/org/openrewrite/maven/RemoveRepository.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"id","value":"myRepo"},{"parameter":"url","value":"https://myrepo.maven.com/repo"}],"variants":[{"language":"xml","before":"<project>\n  <groupId>com.mycompany.app</groupId>\n  <artifactId>my-app</artifactId>\n  <version>1</version>\n  <repositories>\n    <repository>\n      <id>myRepo</id>\n      <url>https://myrepo.maven.com/repo</url>\n    </repository>\n    <repository>\n      <id>same_repo_different_id</id>\n      <url>https://myrepo.maven.com/repo</url>\n    </repository>\n  </repositories>\n  <pluginRepositories>\n    <pluginRepository>\n      <id>myRepo</id>\n      <url>https://someOtherUrl</url>\n    </pluginRepository>\n    <pluginRepository>\n      <id>identicalRepo</id>\n      <url>https://myrepo.maven.com/repo</url>\n    </pluginRepository>\n  </pluginRepositories>\n</project>\n","after":"<project>\n  <groupId>com.mycompany.app</groupId>\n  <artifactId>my-app</artifactId>\n  <version>1</version>\n  <repositories>\n    <repository>\n      <id>same_repo_different_id</id>\n      <url>https://myrepo.maven.com/repo</url>\n    </repository>\n  </repositories>\n  <pluginRepositories>\n    <pluginRepository>\n      <id>myRepo</id>\n      <url>https://someOtherUrl</url>\n    </pluginRepository>\n    <pluginRepository>\n      <id>identicalRepo</id>\n      <url>https://myrepo.maven.com/repo</url>\n    </pluginRepository>\n  </pluginRepositories>\n</project>\n","diff":"--- pom.xml\n+++ pom.xml\n@@ -7,4 +7,0 @@\n  <repositories>\n    <repository>\n-     <id>myRepo</id>\n-     <url>https://myrepo.maven.com/repo</url>\n-   </repository>\n-   <repository>\n      <id>same_repo_different_id</id>\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.maven.RemoveRepository","displayName":"Remove repository","groupId":"org.openrewrite","artifactId":"rewrite-maven","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_MAVEN","requiresConfiguration":true,"cliOptions":" --recipe-option \"id=repo-id\" --recipe-option \"url=http://myrepo.maven.com/repo\""}}>
