...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/maven/bestpractices" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.maven.BestPractices"}
...
<UsageList usage={{"recipeName":"org.openrewrite.maven.BestPractices","displayName":"Apache Maven best practices","groupId":"org.openrewrite","artifactId":"rewrite-maven","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_MAVEN","requiresConfiguration":false}}>
