...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/maven/removemavenwrapper" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.maven.RemoveMavenWrapper"}
...
<UsageList usage={{"recipeName":"org.openrewrite.maven.RemoveMavenWrapper","displayName":"Remove Maven wrapper","groupId":"org.openrewrite","artifactId":"rewrite-maven","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_MAVEN","requiresConfiguration":false}}>
