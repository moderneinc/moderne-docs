...
[GitHub: UpdateScmFromGitOrigin.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-maven/src/main/java/org/openrewrite/maven/UpdateScmFromGitOrigin.java),
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.maven.UpdateScmFromGitOrigin</recipe>
          </activeRecipes>
        </configuration>
      </plugin>
    </plugins>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.maven.UpdateScmFromGitOrigin -Drewrite.exportDatatables=true
```
...
```shell title="shell"
mod run . --recipe UpdateScmFromGitOrigin
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.maven.UpdateScmFromGitOrigin" />
