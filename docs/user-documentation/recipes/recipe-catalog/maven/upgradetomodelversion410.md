...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/maven/upgradetomodelversion410" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.maven.UpgradeToModelVersion410"}
...
<UsageList usage={{"recipeName":"org.openrewrite.maven.UpgradeToModelVersion410","displayName":"Upgrade to Maven model version 4.1.0","groupId":"org.openrewrite","artifactId":"rewrite-maven","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_MAVEN","requiresConfiguration":false}}>
