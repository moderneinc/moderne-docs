...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/maven/orderpomelements" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.maven.OrderPomElements"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-maven/src/main/java/org/openrewrite/maven/OrderPomElements.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.maven.OrderPomElements","displayName":"Order POM elements","groupId":"org.openrewrite","artifactId":"rewrite-maven","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_MAVEN","requiresConfiguration":false}}>
