...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/xml/format/normalizelinebreaks" />
</head>
...
[GitHub: NormalizeLineBreaks.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-xml/src/main/java/org/openrewrite/xml/format/NormalizeLineBreaks.java),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.xml.format.NormalizeLineBreaks -Drewrite.exportDatatables=true
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.xml.format.NormalizeLineBreaks" />
