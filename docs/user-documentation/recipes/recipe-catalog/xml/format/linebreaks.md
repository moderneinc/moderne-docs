...
<RecipeMeta
  ...
  fqName={"org.openrewrite.xml.format.LineBreaks"}
  languages={["XML"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-xml/src/main/java/org/openrewrite/xml/format/LineBreaks.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.xml.format.LineBreaks","displayName":"Blank lines","groupId":"org.openrewrite","artifactId":"rewrite-xml","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_XML","requiresConfiguration":false}}>
