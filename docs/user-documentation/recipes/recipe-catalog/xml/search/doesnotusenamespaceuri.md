...
_Find XML root elements that do not have a specific Namespace URI, optionally restricting the search by an XPath expression._
...
This recipe has required configuration parameters. Recipes with required configuration parameters cannot be activated directly (unless you are running them via the Moderne CLI). To activate this recipe you must create a new recipe which fills in the required parameters. In your `rewrite.yml` create a new recipe with a unique name. For example: `com.yourorg.DoesNotUseNamespaceUriExample`.
Here's how you can define and customize such a recipe within your rewrite.yml:
```yaml title="rewrite.yml"
---
type: specs.openrewrite.org/v1beta/recipe
name: com.yourorg.DoesNotUseNamespaceUriExample
displayName: Find files without Namespace URI example
recipeList:
  - org.openrewrite.xml.search.DoesNotUseNamespaceUri:
      namespaceUri: http://www.w3.org/2001/XMLSchema-instance
```

Now that `com.yourorg.DoesNotUseNamespaceUriExample` has been defined, activate it in your build file:
...
rewrite {
    activeRecipe("com.yourorg.DoesNotUseNamespaceUriExample")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.yourorg.DoesNotUseNamespaceUriExample</recipe>
          </activeRecipes>
        </configuration>
      </plugin>
    </plugins>
...
```shell title="shell"
mod run . --recipe DoesNotUseNamespaceUri --recipe-option "namespaceUri=http://www.w3.org/2001/XMLSchema-instance"
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.xml.search.DoesNotUseNamespaceUri" />
