...
_Find XML namespace URIs, optionally restricting the search by a XPath expression._

## Recipe source

[GitHub: HasNamespaceUri.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-xml/src/main/java/org/openrewrite/xml/search/HasNamespaceUri.java),
...
| --- | --- | --- | --- |
| `String` | namespaceUri | The Namespace URI to find. | `http://www.w3.org/2001/XMLSchema-instance` |
...
Now that `com.yourorg.HasNamespaceUriExample` has been defined, activate it in your build file:
...
rewrite {
    activeRecipe("com.yourorg.HasNamespaceUriExample")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.yourorg.HasNamespaceUriExample</recipe>
          </activeRecipes>
        </configuration>
      </plugin>
    </plugins>
...
```shell title="shell"
mod run . --recipe HasNamespaceUri --recipe-option "namespaceUri=http://www.w3.org/2001/XMLSchema-instance" --recipe-option "xPath=/dependencies/dependency"
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.xml.search.HasNamespaceUri" />
