...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/xml/security/isowaspsuppressionsfile" />
</head>
...
[GitHub: IsOwaspSuppressionsFile.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-xml/src/main/java/org/openrewrite/xml/security/IsOwaspSuppressionsFile.java),
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.xml.security.IsOwaspSuppressionsFile -Drewrite.exportDatatables=true
```
...
```shell title="shell"
mod run . --recipe IsOwaspSuppressionsFile
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.xml.security.IsOwaspSuppressionsFile" />
