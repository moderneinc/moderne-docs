...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/xml/liberty/persistencexmllocationrule" />
</head>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-liberty:RELEASE -Drewrite.activeRecipes=org.openrewrite.xml.liberty.PersistenceXmlLocationRule -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.xml.liberty.PersistenceXmlLocationRule" />
