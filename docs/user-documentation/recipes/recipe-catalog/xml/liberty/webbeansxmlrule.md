...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/xml/liberty/webbeansxmlrule" />
</head>
...
<RecipeMeta
  ...
  sourceUrl={"https://github.com/openrewrite/rewrite-liberty/blob/main/src/main/java/org/openrewrite/xml/liberty/WebBeansXmlRule.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.xml.liberty.WebBeansXmlRule","displayName":"Replace beans.xml file","groupId":"org.openrewrite.recipe","artifactId":"rewrite-liberty","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_LIBERTY","requiresConfiguration":false}}>
