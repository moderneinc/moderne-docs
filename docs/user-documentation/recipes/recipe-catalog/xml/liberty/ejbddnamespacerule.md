...
<RecipeHeader.Title>Use correct ejb-jar namespace values</RecipeHeader.Title>

<RecipeHeader.Description>Namespace values in ejb-jar.xml must be consistent with the descriptor version.</RecipeHeader.Description>
