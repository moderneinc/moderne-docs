...
<RecipeMeta
  ...
  fqName={"org.openrewrite.xml.AddTagAttribute"}
  languages={["XML"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-xml/src/main/java/org/openrewrite/xml/AddTagAttribute.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"elementName","value":"bean"},{"parameter":"attributeName","value":"scope"},{"parameter":"newValue","value":"singleton"}],"variants":[{"language":"xml","before":"<beans>\n    <bean id=\"myBean\"/>\n    <bean id=\"anotherBean\" scope=\"prototype\"/>\n</beans>\n","after":"<beans>\n    <bean id=\"myBean\" scope=\"singleton\"/>\n    <bean id=\"anotherBean\" scope=\"prototype\"/>\n</beans>\n","diff":"@@ -2,1 +2,1 @@\n<beans>\n-   <bean id=\"myBean\"/>\n+   <bean id=\"myBean\" scope=\"singleton\"/>\n    <bean id=\"anotherBean\" scope=\"prototype\"/>\n","newFile":false}]}]}>

## Examples

</ExampleList>

<UsageList usage={{"recipeName":"org.openrewrite.xml.AddTagAttribute","displayName":"Add new XML attribute for an Element","groupId":"org.openrewrite","artifactId":"rewrite-xml","versionKey":"VERSION_ORG_OPENREWRITE_REWRITE_XML","requiresConfiguration":true,"cliOptions":" --recipe-option \"elementName=//beans/bean\" --recipe-option \"attributeName=attribute-name\" --recipe-option \"newValue=value-to-add\""}}>
