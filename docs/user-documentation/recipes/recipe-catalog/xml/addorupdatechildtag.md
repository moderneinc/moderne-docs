...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/xml/addorupdatechildtag" />
</head>
...
_Adds or updates a child element below the parent(s) matching the provided `parentXPath` expression. If a child with the same name already exists, it will be replaced by default. Otherwise, a new child will be added. This ensures idempotent behaviour._

## Recipe source

[GitHub: AddOrUpdateChildTag.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-xml/src/main/java/org/openrewrite/xml/AddOrUpdateChildTag.java),
...
Now that `com.yourorg.AddOrUpdateChildTagExample` has been defined, activate it in your build file:
...
rewrite {
    activeRecipe("com.yourorg.AddOrUpdateChildTagExample")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.yourorg.AddOrUpdateChildTagExample</recipe>
          </activeRecipes>
        </configuration>
      </plugin>
    </plugins>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.xml.AddOrUpdateChildTag" />
