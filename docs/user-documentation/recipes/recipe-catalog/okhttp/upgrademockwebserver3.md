...
canonical_url: "https://docs.openrewrite.org/recipes/okhttp/upgrademockwebserver3"
---
...
_Migrate from the legacy `mockwebserver` artifact to `mockwebserver3` core module without JUnit dependency._
...
name: org.openrewrite.okhttp.UpgradeMockWebServer3
...
## Examples
##### Example 1
`UpgradeMockWebServer3Test#upgradeMockWebServer3Core`
...
rewrite {
    activeRecipe("org.openrewrite.okhttp.UpgradeMockWebServer3")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.okhttp.UpgradeMockWebServer3</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-okhttp:RELEASE -Drewrite.activeRecipes=org.openrewrite.okhttp.UpgradeMockWebServer3 -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe UpgradeMockWebServer3
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.okhttp.UpgradeMockWebServer3" />
