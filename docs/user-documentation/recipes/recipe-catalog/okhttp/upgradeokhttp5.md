...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/okhttp/upgradeokhttp5" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.okhttp.UpgradeOkHttp5"}
...
<UsageList usage={{"recipeName":"org.openrewrite.okhttp.UpgradeOkHttp5","displayName":"Migrate to OkHttp 5.x","groupId":"org.openrewrite.recipe","artifactId":"rewrite-okhttp","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_OKHTTP","requiresConfiguration":false}}>
