...
_Migrate from the legacy `mockwebserver` artifact to `mockwebserver3-junit5` with JUnit 5 integration._
...
* [Rename package name](../java/changepackage)
  ...
  * newPackageName: `mockwebserver3.junit5`
  * recursive: `true`
...
name: org.openrewrite.okhttp.UpgradeMockWebServer3JUnit5
...
rewrite {
    activeRecipe("org.openrewrite.okhttp.UpgradeMockWebServer3JUnit5")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.okhttp.UpgradeMockWebServer3JUnit5</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-okhttp:RELEASE -Drewrite.activeRecipes=org.openrewrite.okhttp.UpgradeMockWebServer3JUnit5 -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe UpgradeMockWebServer3JUnit5
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.okhttp.UpgradeMockWebServer3JUnit5" />
