...
_Find Gradle project IDs in build.gradle files to determine the project ID._
...
<RunRecipe
  recipeName="io.moderne.recipe.releasemetro.FindGradleProjectIDs"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.recipe.releasemetro.FindGradleProjectIDs" />
