...
_Find Maven group Id and artifactId in pom.xml files to determine the project ID._
...
<RunRecipe
  recipeName="io.moderne.recipe.releasemetro.FindMavenProjectIDs"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.recipe.releasemetro.FindMavenProjectIDs" />
