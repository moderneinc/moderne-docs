...
<RecipeMeta
  ...
  fqName={"androidx.compose.material.ReplaceDeprecatedMaterial1Methods"}
...
<UsageList usage={{"recipeName":"androidx.compose.material.ReplaceDeprecatedMaterial1Methods","displayName":"Replace deprecated `material` methods","groupId":"org.openrewrite.recipe","artifactId":"rewrite-migrate-kotlin","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_MIGRATE_KOTLIN","requiresConfiguration":false}}>
