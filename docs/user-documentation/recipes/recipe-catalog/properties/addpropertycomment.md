...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/properties/addpropertycomment" />
</head>
...
_Add a new comment before a property key if not already present, optionally commenting out the property._

## Recipe source

[GitHub: AddPropertyComment.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-properties/src/main/java/org/openrewrite/properties/AddPropertyComment.java),
...
Now that `com.yourorg.AddPropertyCommentExample` has been defined, activate it in your build file:
...
rewrite {
    activeRecipe("com.yourorg.AddPropertyCommentExample")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.yourorg.AddPropertyCommentExample</recipe>
          </activeRecipes>
        </configuration>
      </plugin>
    </plugins>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.properties.AddPropertyComment" />
