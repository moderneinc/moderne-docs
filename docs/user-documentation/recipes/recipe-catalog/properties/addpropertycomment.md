...
<RecipeMeta
  ...
  fqName={"org.openrewrite.properties.AddPropertyComment"}
  languages={["OpenRewrite"]}
  license={"Apache License Version 2.0"}
  sourceUrl={"https://github.com/openrewrite/rewrite/blob/main/rewrite-properties/src/main/java/org/openrewrite/properties/AddPropertyComment.java"}
/>
...
<ExampleList examples={[{"parameters":[{"parameter":"propertyKey","value":"management.metrics.enable.process.files"},{"parameter":"comment","value":"myComment"},{"parameter":"commentOutProperty","value":"false"}],"variants":[{"language":"properties","before":"management.metrics.enable.process.files=true\nyyy=true\n","after":"# myComment\nmanagement.metrics.enable.process.files=true\nyyy=true\n","diff":"@@ -1,0 +1,1 @@\n+# myComment\nmanagement.metrics.enable.process.files=true\n","newFile":false}]}]}>
