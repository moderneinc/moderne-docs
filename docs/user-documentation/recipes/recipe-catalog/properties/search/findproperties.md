...
[GitHub: FindProperties.java](https://github.com/openrewrite/rewrite/blob/main/rewrite-properties/src/main/java/org/openrewrite/properties/search/FindProperties.java),
...
```shell title="shell"
mod run . --recipe FindProperties --recipe-option "propertyKey=management.metrics.binders.files.enabled"
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.properties.search.FindProperties" />
