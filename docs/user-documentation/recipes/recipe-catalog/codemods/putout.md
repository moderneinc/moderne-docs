...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/putout" />
</head>
...
_Run [Putout](https://github.com/coderaiser/putout) on your projects._

## Recipe source

[GitHub: Putout.java](https://github.com/moderneinc/rewrite-codemods/blob/main/src/main/java/org/openrewrite/codemods/Putout.java),
...
rewrite {
    activeRecipe("org.openrewrite.codemods.Putout")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.codemods.Putout</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-codemods:RELEASE -Drewrite.activeRecipes=org.openrewrite.codemods.Putout -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.Putout" />
