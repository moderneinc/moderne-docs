...
_Run `ng update` to upgrade Angular CLI and Angular Core to the specified version._
...
name: com.yourorg.ApplyAngularCLIExample
displayName: Upgrade Angular versions example
recipeList:
  - org.openrewrite.codemods.migrate.angular.ApplyAngularCLI: 
      version: 17
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.migrate.angular.ApplyAngularCLI" />
