...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/migrate/mui/collapserenamecollapsedheight" />
</head>
...
_See Material UI codemod projects for more [details](https://github.com/mui/material-ui/tree/master/packages/mui-codemod#collapse-rename-collapsedheight)._

### Tags

* [mui](/user-documentation/recipes/lists/recipes-by-tag#mui)
* [codemods](/user-documentation/recipes/lists/recipes-by-tag#codemods)
* [material-ui](/user-documentation/recipes/lists/recipes-by-tag#material)

## Recipe source

[GitHub: material-ui.yml](https://github.com/moderneinc/rewrite-codemods/blob/main/src/main/resources/META-INF/rewrite/material-ui.yml),
...
rewrite {
    activeRecipe("org.openrewrite.codemods.migrate.mui.CollapseRenameCollapsedheight")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.codemods.migrate.mui.CollapseRenameCollapsedheight</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-codemods:RELEASE -Drewrite.activeRecipes=org.openrewrite.codemods.migrate.mui.CollapseRenameCollapsedheight -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe CollapseRenameCollapsedheight
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.migrate.mui.CollapseRenameCollapsedheight" />
