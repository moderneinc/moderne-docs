...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/migrate/mui/joyavatarremoveimgprops" />
</head>
...
_See Material UI codemod projects for more [details](https://github.com/mui/material-ui/tree/master/packages/mui-codemod#joy-avatar-remove-imgProps)._
...
rewrite {
    activeRecipe("org.openrewrite.codemods.migrate.mui.JoyAvatarRemoveImgprops")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.codemods.migrate.mui.JoyAvatarRemoveImgprops</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-codemods:RELEASE -Drewrite.activeRecipes=org.openrewrite.codemods.migrate.mui.JoyAvatarRemoveImgprops -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe JoyAvatarRemoveImgprops
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.migrate.mui.JoyAvatarRemoveImgprops" />
