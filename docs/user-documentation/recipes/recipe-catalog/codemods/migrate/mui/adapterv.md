...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.migrate.mui.AdapterV"}
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.migrate.mui.AdapterV","displayName":"Converts components to use the v4 adapter module","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
