...
* [lodash](/user-documentation/recipes/lists/recipes-by-tag#lodash)
* [underscore](/user-documentation/recipes/lists/recipes-by-tag#underscore)

## Recipe source

[GitHub: migrate.yml](https://github.com/moderneinc/rewrite-codemods/blob/main/src/main/resources/META-INF/rewrite/migrate.yml),
...
rewrite {
    activeRecipe("org.openrewrite.codemods.migrate.lodash.LodashUnderscoreFunction")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.codemods.migrate.lodash.LodashUnderscoreFunction</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-codemods:RELEASE -Drewrite.activeRecipes=org.openrewrite.codemods.migrate.lodash.LodashUnderscoreFunction -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe LodashUnderscoreFunction
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.migrate.lodash.LodashUnderscoreFunction" />
