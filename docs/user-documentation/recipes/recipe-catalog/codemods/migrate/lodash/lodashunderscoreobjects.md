...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/migrate/lodash/lodashunderscoreobjects" />
</head>
...
rewrite {
    activeRecipe("org.openrewrite.codemods.migrate.lodash.LodashUnderscoreObjects")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.codemods.migrate.lodash.LodashUnderscoreObjects</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-codemods:RELEASE -Drewrite.activeRecipes=org.openrewrite.codemods.migrate.lodash.LodashUnderscoreObjects -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe LodashUnderscoreObjects
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.migrate.lodash.LodashUnderscoreObjects" />
