...
canonical_url: "https://docs.openrewrite.org/recipes/codemods/ecmascript/5to6/simplearrow"
---
...
_Replace all function expressions with only `return` statement with simple arrow function._

### Tags

* [codemods](/user-documentation/recipes/lists/recipes-by-tag#codemods)
* [5to6](/user-documentation/recipes/lists/recipes-by-tag#5to6)

## Recipe source

[GitHub: ecmascript.yml](https://github.com/moderneinc/rewrite-codemods/blob/main/src/main/resources/META-INF/rewrite/ecmascript.yml),
...
* [Upgrade ECMAScript 5 to ECMAScript 6](/user-documentation/recipes/recipe-catalog/codemods/ecmascript/5to6/ecmascript6bestpractices.md)
...
rewrite {
    activeRecipe("org.openrewrite.codemods.ecmascript.5to6.simpleArrow")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.codemods.ecmascript.5to6.simpleArrow</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-codemods:RELEASE -Drewrite.activeRecipes=org.openrewrite.codemods.ecmascript.5to6.simpleArrow -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.ecmascript.5to6.simpleArrow" />
