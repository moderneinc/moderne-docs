...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/ecmascript/5to6/ecmascript6bestpractices" />
</head>
...
_A collection of common ECMAScript 5 to ECMAScript 6 updates._
...
rewrite {
    activeRecipe("org.openrewrite.codemods.ecmascript.5to6.ECMAScript6BestPractices")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.codemods.ecmascript.5to6.ECMAScript6BestPractices</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-codemods:RELEASE -Drewrite.activeRecipes=org.openrewrite.codemods.ecmascript.5to6.ECMAScript6BestPractices -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe ECMAScript6BestPractices
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.ecmascript.5to6.ECMAScript6BestPractices" />
