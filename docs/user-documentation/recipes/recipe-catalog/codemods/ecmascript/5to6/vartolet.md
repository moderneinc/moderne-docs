...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/ecmascript/5to6/vartolet" />
</head>
...
rewrite {
    activeRecipe("org.openrewrite.codemods.ecmascript.5to6.varToLet")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.codemods.ecmascript.5to6.varToLet</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-codemods:RELEASE -Drewrite.activeRecipes=org.openrewrite.codemods.ecmascript.5to6.varToLet -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.ecmascript.5to6.varToLet" />
