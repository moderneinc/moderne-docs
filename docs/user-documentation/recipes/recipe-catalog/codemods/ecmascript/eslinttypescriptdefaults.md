...
canonical_url: "https://docs.openrewrite.org/recipes/codemods/ecmascript/eslinttypescriptdefaults"
---
...
_The default config includes the `@typescript-eslint` plugin and the corresponding `plugin:@typescript-eslint/recommended` extend._
...
rewrite {
    activeRecipe("org.openrewrite.codemods.ecmascript.ESLintTypeScriptDefaults")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.codemods.ecmascript.ESLintTypeScriptDefaults</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-codemods:RELEASE -Drewrite.activeRecipes=org.openrewrite.codemods.ecmascript.ESLintTypeScriptDefaults -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe ESLintTypeScriptDefaults
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.ecmascript.ESLintTypeScriptDefaults" />
