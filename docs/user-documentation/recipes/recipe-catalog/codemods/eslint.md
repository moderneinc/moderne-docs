...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/eslint" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.ESLint"}
  languages={["OpenRewrite"]}
  license={"Moderne Source Available License"}
  sourceUrl={"https://github.com/moderneinc/rewrite-codemods/blob/main/src/main/java/org/openrewrite/codemods/ESLint.java"}
/>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.ESLint","displayName":"Lint source code with ESLint","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
