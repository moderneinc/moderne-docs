...
canonical_url: "https://docs.openrewrite.org/recipes/codemods/ui5"
---
...
_Runs the [UI5 Linter](https://github.com/SAP/ui5-linter), a static code analysis tool for UI5 projects. It checks JavaScript, TypeScript, XML, JSON, and other files in your project and reports findings._

## Recipe source

[GitHub: UI5.java](https://github.com/moderneinc/rewrite-codemods/blob/main/src/main/java/org/openrewrite/codemods/UI5.java),
...
rewrite {
    activeRecipe("org.openrewrite.codemods.UI5")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.codemods.UI5</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-codemods:RELEASE -Drewrite.activeRecipes=org.openrewrite.codemods.UI5 -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.UI5" />
...
<TabItem value="org.openrewrite.codemods.UI5Messages" label="UI5Messages">

### UI5 messages
**org.openrewrite.codemods.UI5Messages**

_Errors and warnings as reported by UI5._

| Column Name | Description |
| ----------- | ----------- |
| File Path | The source path of the file. |
| Rule ID | UI5 rule ID. |
