...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/format/jsxfirstpropnewline" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.JsxFirstPropNewLine"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.JsxFirstPropNewLine"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/jsxfirstpropnewline.md"}
>

<RecipeHeader.Title>Enforce proper position of the first property in JSX</RecipeHeader.Title>

<RecipeHeader.Description>Enforce proper position of the first property in JSX  See [rule details](https://eslint.style/rules/default/jsx-first-prop-new-line).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.JsxFirstPropNewLine","displayName":"Enforce proper position of the first property in JSX","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
