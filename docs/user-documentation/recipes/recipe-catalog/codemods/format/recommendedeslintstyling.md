...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/format/recommendedeslintstyling" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.RecommendedESLintStyling"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.RecommendedESLintStyling"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/recommendedeslintstyling.md"}
>

<RecipeHeader.Title>Recommended ESLint Styling</RecipeHeader.Title>

<RecipeHeader.Description>Collection of stylistic ESLint rules that are recommended by the [ESLint Style.](https://eslint.style/).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.RecommendedESLintStyling","displayName":"Recommended ESLint Styling","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
