...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/format/switchcolonspacing" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.SwitchColonSpacing"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.SwitchColonSpacing"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/switchcolonspacing.md"}
>

<RecipeHeader.Title>Enforce spacing around colons of switch statements</RecipeHeader.Title>

<RecipeHeader.Description>Enforce spacing around colons of switch statements  See [rule details](https://eslint.style/rules/default/switch-colon-spacing).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.SwitchColonSpacing","displayName":"Enforce spacing around colons of switch statements","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
