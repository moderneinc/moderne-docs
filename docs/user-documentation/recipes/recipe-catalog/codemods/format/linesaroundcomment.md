...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/format/linesaroundcomment" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.LinesAroundComment"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.LinesAroundComment"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/linesaroundcomment.md"}
>

<RecipeHeader.Title>Require empty lines around comments</RecipeHeader.Title>

<RecipeHeader.Description>Require empty lines around comments  See [rule details](https://eslint.style/rules/default/lines-around-comment).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.LinesAroundComment","displayName":"Require empty lines around comments","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
