...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/format/linesbetweenclassmembers" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.LinesBetweenClassMembers"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.LinesBetweenClassMembers"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/linesbetweenclassmembers.md"}
>

<RecipeHeader.Title>Require or disallow an empty line between class members</RecipeHeader.Title>

<RecipeHeader.Description>Require or disallow an empty line between class members  See [rule details](https://eslint.style/rules/default/lines-between-class-members).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.LinesBetweenClassMembers","displayName":"Require or disallow an empty line between class members","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
