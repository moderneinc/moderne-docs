...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/format/commastyle" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.CommaStyle"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.CommaStyle"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/commastyle.md"}
>

<RecipeHeader.Title>Enforce consistent comma style</RecipeHeader.Title>

<RecipeHeader.Description>Enforce consistent comma style  See [rule details](https://eslint.style/rules/default/comma-style).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.CommaStyle","displayName":"Enforce consistent comma style","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
