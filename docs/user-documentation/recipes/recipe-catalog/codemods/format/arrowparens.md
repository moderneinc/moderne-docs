...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/format/arrowparens" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.ArrowParens"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.ArrowParens"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/arrowparens.md"}
>

<RecipeHeader.Title>Require parentheses around arrow function arguments</RecipeHeader.Title>

<RecipeHeader.Description>Require parentheses around arrow function arguments  See [rule details](https://eslint.style/rules/default/arrow-parens).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.ArrowParens","displayName":"Require parentheses around arrow function arguments","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
