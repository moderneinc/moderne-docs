...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.WrapIife"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.WrapIife"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/wrapiife.md"}
>

<RecipeHeader.Title>Require parentheses around immediate &#x60;function&#x60; invocations</RecipeHeader.Title>

<RecipeHeader.Description>Require parentheses around immediate &#x60;function&#x60; invocations  See [rule details](https://eslint.style/rules/default/wrap-iife).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.WrapIife","displayName":"Require parentheses around immediate &#x60;function&#x60; invocations","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
