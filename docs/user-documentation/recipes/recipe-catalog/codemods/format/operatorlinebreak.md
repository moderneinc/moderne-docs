...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/format/operatorlinebreak" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.OperatorLinebreak"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.OperatorLinebreak"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/operatorlinebreak.md"}
>

<RecipeHeader.Title>Enforce consistent linebreak style for operators</RecipeHeader.Title>

<RecipeHeader.Description>Enforce consistent linebreak style for operators  See [rule details](https://eslint.style/rules/default/operator-linebreak).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.OperatorLinebreak","displayName":"Enforce consistent linebreak style for operators","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
