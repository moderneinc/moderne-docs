...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.EolLast"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.EolLast"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/eollast.md"}
>

<RecipeHeader.Title>Require or disallow newline at the end of files</RecipeHeader.Title>

<RecipeHeader.Description>Require or disallow newline at the end of files  See [rule details](https://eslint.style/rules/default/eol-last).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.EolLast","displayName":"Require or disallow newline at the end of files","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
