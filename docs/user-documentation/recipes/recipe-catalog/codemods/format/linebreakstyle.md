...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/format/linebreakstyle" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.LinebreakStyle"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.LinebreakStyle"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/linebreakstyle.md"}
>

<RecipeHeader.Title>Enforce consistent linebreak style</RecipeHeader.Title>

<RecipeHeader.Description>Enforce consistent linebreak style  See [rule details](https://eslint.style/rules/default/linebreak-style).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.LinebreakStyle","displayName":"Enforce consistent linebreak style","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
