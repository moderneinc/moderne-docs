...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.TypeGenericSpacing"}
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.TypeGenericSpacing","displayName":"Enforces consistent spacing inside TypeScript type generics","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
