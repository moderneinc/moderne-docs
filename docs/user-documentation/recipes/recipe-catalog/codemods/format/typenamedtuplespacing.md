...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.TypeNamedTupleSpacing"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.TypeNamedTupleSpacing"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/typenamedtuplespacing.md"}
>

<RecipeHeader.Title>Expect space before the type declaration in the named tuple</RecipeHeader.Title>

<RecipeHeader.Description>Expect space before the type declaration in the named tuple  See [rule details](https://eslint.style/rules/default/type-named-tuple-spacing).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.TypeNamedTupleSpacing","displayName":"Expect space before the type declaration in the named tuple","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
