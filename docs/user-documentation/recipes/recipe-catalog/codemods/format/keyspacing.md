...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.KeySpacing"}
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.KeySpacing","displayName":"Enforce consistent spacing between keys and values in object literal properties","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
