...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.JsxOneExpressionPerLine"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.JsxOneExpressionPerLine"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/jsxoneexpressionperline.md"}
>

<RecipeHeader.Title>Require one JSX element per line</RecipeHeader.Title>

<RecipeHeader.Description>Require one JSX element per line  See [rule details](https://eslint.style/rules/default/jsx-one-expression-per-line).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.JsxOneExpressionPerLine","displayName":"Require one JSX element per line","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
