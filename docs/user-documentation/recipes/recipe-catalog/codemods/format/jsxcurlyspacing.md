...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/format/jsxcurlyspacing" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.JsxCurlySpacing"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.JsxCurlySpacing"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/jsxcurlyspacing.md"}
>

<RecipeHeader.Title>Enforce or disallow spaces inside of curly braces in JSX attributes and expressions</RecipeHeader.Title>

<RecipeHeader.Description>Enforce or disallow spaces inside of curly braces in JSX attributes and expressions  See [rule details](https://eslint.style/rules/default/jsx-curly-spacing).</RecipeHeader.Description>
