...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.NoMultipleEmptyLines"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.NoMultipleEmptyLines"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/nomultipleemptylines.md"}
>

<RecipeHeader.Title>Disallow multiple empty lines</RecipeHeader.Title>

<RecipeHeader.Description>Disallow multiple empty lines  See [rule details](https://eslint.style/rules/default/no-multiple-empty-lines).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.NoMultipleEmptyLines","displayName":"Disallow multiple empty lines","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
