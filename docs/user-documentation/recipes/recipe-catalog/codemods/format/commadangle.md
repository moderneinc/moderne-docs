---
title: "Require or disallow trailing commas"
...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/format/commadangle" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.format.CommaDangle"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.format.CommaDangle"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/format/commadangle.md"}
>

<RecipeHeader.Title>Require or disallow trailing commas</RecipeHeader.Title>

<RecipeHeader.Description>Require or disallow trailing commas  See [rule details](https://eslint.style/rules/default/comma-dangle).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.format.CommaDangle","displayName":"Require or disallow trailing commas","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
