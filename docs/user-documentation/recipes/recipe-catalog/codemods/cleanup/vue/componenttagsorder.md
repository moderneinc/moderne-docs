...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.vue.ComponentTagsOrder"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.vue.ComponentTagsOrder"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/cleanup/vue/componenttagsorder.md"}
>

<RecipeHeader.Title>Enforce order of component top-level elements</RecipeHeader.Title>

<RecipeHeader.Description>Enforce order of component top-level elements See rule details for [vue/component-tags-order](https://eslint.vuejs.org/rules/component-tags-order.html).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.vue.ComponentTagsOrder","displayName":"Enforce order of component top-level elements","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
