...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.vue.PaddingLineBetweenTags"}
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.vue.PaddingLineBetweenTags","displayName":"Require or disallow newlines between sibling tags in template","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
