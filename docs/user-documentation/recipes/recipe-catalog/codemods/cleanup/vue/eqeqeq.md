...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/cleanup/vue/eqeqeq" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.vue.Eqeqeq"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.vue.Eqeqeq"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/cleanup/vue/eqeqeq.md"}
>

<RecipeHeader.Title>Require the use of === and !== in `<template>`</RecipeHeader.Title>

<RecipeHeader.Description>Require the use of === and !== in `<template>` See rule details for [vue/eqeqeq](https://eslint.vuejs.org/rules/eqeqeq.html).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.vue.Eqeqeq","displayName":"Require the use of === and !== in `<template>`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
