...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.vue.BlockTagNewline"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.vue.BlockTagNewline"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/cleanup/vue/blocktagnewline.md"}
>

<RecipeHeader.Title>Enforce line breaks after opening and before closing block-level tags</RecipeHeader.Title>

<RecipeHeader.Description>Enforce line breaks after opening and before closing block-level tags See rule details for [vue/block-tag-newline](https://eslint.vuejs.org/rules/block-tag-newline.html).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.vue.BlockTagNewline","displayName":"Enforce line breaks after opening and before closing block-level tags","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
