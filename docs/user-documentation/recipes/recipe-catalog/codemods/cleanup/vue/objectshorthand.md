...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.vue.ObjectShorthand"}
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.vue.ObjectShorthand","displayName":"Require or disallow method and property shorthand syntax for object literals in `<template>`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
