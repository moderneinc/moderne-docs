...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/cleanup/vue/noextraparens" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.vue.NoExtraParens"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.vue.NoExtraParens"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/cleanup/vue/noextraparens.md"}
>

<RecipeHeader.Title>Disallow unnecessary parentheses in `<template>`</RecipeHeader.Title>

<RecipeHeader.Description>Disallow unnecessary parentheses in `<template>` See rule details for [vue/no-extra-parens](https://eslint.vuejs.org/rules/no-extra-parens.html).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.vue.NoExtraParens","displayName":"Disallow unnecessary parentheses in `<template>`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
