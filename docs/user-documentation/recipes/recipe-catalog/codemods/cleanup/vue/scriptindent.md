---
title: "Enforce consistent indentation in `&lt;script&gt;`"
...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/cleanup/vue/scriptindent" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.vue.ScriptIndent"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.vue.ScriptIndent"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/cleanup/vue/scriptindent.md"}
>

<RecipeHeader.Title>Enforce consistent indentation in `<script>`</RecipeHeader.Title>

<RecipeHeader.Description>Enforce consistent indentation in `<script>` See rule details for [vue/script-indent](https://eslint.vuejs.org/rules/script-indent.html).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.vue.ScriptIndent","displayName":"Enforce consistent indentation in `<script>`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
