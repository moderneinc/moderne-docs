...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.vue.StaticClassNamesOrder"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.vue.StaticClassNamesOrder"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/cleanup/vue/staticclassnamesorder.md"}
>

<RecipeHeader.Title>Enforce static class names order</RecipeHeader.Title>

<RecipeHeader.Description>Enforce static class names order See rule details for [vue/static-class-names-order](https://eslint.vuejs.org/rules/static-class-names-order.html).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.vue.StaticClassNamesOrder","displayName":"Enforce static class names order","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
