...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.vue.ArrayBracketNewline"}
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.vue.ArrayBracketNewline","displayName":"Enforce linebreaks after opening and before closing array brackets in `<template>`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
