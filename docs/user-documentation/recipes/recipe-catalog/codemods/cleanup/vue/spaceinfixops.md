...
<head>
  <link rel="canonical" href="https://docs.openrewrite.org/recipes/codemods/cleanup/vue/spaceinfixops" />
</head>
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.vue.SpaceInfixOps"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.vue.SpaceInfixOps"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/cleanup/vue/spaceinfixops.md"}
>

<RecipeHeader.Title>Require spacing around infix operators in `<template>`</RecipeHeader.Title>

<RecipeHeader.Description>Require spacing around infix operators in `<template>` See rule details for [vue/space-infix-ops](https://eslint.vuejs.org/rules/space-infix-ops.html).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.vue.SpaceInfixOps","displayName":"Require spacing around infix operators in `<template>`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
