---
title: "Enforce consistent spacing inside parentheses in `&lt;template&gt;`"
...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.vue.SpaceInParens"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.vue.SpaceInParens"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/cleanup/vue/spaceinparens.md"}
>

<RecipeHeader.Title>Enforce consistent spacing inside parentheses in `<template>`</RecipeHeader.Title>

<RecipeHeader.Description>Enforce consistent spacing inside parentheses in `<template>` See rule details for [vue/space-in-parens](https://eslint.vuejs.org/rules/space-in-parens.html).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.vue.SpaceInParens","displayName":"Enforce consistent spacing inside parentheses in `<template>`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
