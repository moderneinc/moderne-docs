...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.jest.PreferMockPromiseShorthand"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.jest.PreferMockPromiseShorthand"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/cleanup/jest/prefermockpromiseshorthand.md"}
>

<RecipeHeader.Title>Prefer mock resolved/rejected shorthands for promises</RecipeHeader.Title>

<RecipeHeader.Description>Prefer mock resolved/rejected shorthands for promises See rule details for [jest/prefer-mock-promise-shorthand](https://github.com/jest-community/eslint-plugin-jest/blob/HEAD/docs/rules/prefer-mock-promise-shorthand.md).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.jest.PreferMockPromiseShorthand","displayName":"Prefer mock resolved/rejected shorthands for promises","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
