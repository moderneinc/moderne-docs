...
rewrite {
    activeRecipe("org.openrewrite.codemods.cleanup.jest.NoJasmineGlobals")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.codemods.cleanup.jest.NoJasmineGlobals</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mod run . --recipe NoJasmineGlobals
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.jest.NoJasmineGlobals" />
