...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.storybook.PreferPascalCase"}
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.storybook.PreferPascalCase","displayName":"Stories should use PascalCase","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
