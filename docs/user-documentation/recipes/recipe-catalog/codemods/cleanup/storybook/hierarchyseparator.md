...
canonical_url: "https://docs.openrewrite.org/recipes/codemods/cleanup/storybook/hierarchyseparator"
---
...
rewrite {
    activeRecipe("org.openrewrite.codemods.cleanup.storybook.HierarchySeparator")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.codemods.cleanup.storybook.HierarchySeparator</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-codemods:RELEASE -Drewrite.activeRecipes=org.openrewrite.codemods.cleanup.storybook.HierarchySeparator -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe HierarchySeparator
```
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.storybook.HierarchySeparator" />
