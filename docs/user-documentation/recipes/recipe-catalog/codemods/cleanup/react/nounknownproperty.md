...
_Disallow usage of unknown DOM property See rule details for [react/no-unknown-property](https://github.com/jsx-eslint/eslint-plugin-react/blob/HEAD/docs/rules/no-unknown-property.md)._
...
* [Lint source code with ESLint](../../../codemods/eslint)
  * fix: `true`
  * configFile: `{   "root": true,   "parser": "@typescript-eslint/parser",   "parserOptions": { "project": ["./tsconfig.json"] },   "plugins": ["react"],   "rules": {     "react/no-unknown-property": 2   },   "globals": {     "browser": true,     "node": true   } } `
...
<RunRecipe
  recipeName="org.openrewrite.codemods.cleanup.react.NoUnknownProperty"
  displayName="Disallow usage of unknown DOM property"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.react.NoUnknownProperty" />
