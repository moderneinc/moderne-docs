...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.react.JsxNoTargetBlank"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.react.JsxNoTargetBlank"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/cleanup/react/jsxnotargetblank.md"}
>

<RecipeHeader.Title>Disallow target="_blank" attribute without rel="noreferrer"</RecipeHeader.Title>

<RecipeHeader.Description>Disallow target="_blank" attribute without rel="noreferrer" See rule details for [react/jsx-no-target-blank](https://github.com/jsx-eslint/eslint-plugin-react/blob/HEAD/docs/rules/jsx-no-target-blank.md).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.react.JsxNoTargetBlank","displayName":"Disallow target=\"_blank\" attribute without rel=\"noreferrer\"","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
