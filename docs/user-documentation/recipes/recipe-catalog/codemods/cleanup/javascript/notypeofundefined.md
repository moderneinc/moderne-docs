...
<RecipeMeta
  displayName={"Disallow comparing `undefined` using `typeof`"}
  ...
  fqName={"org.openrewrite.codemods.cleanup.javascript.NoTypeofUndefined"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.javascript.NoTypeofUndefined"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/cleanup/javascript/notypeofundefined.md"}
>

<RecipeHeader.Title>Disallow comparing `undefined` using `typeof`</RecipeHeader.Title>

<RecipeHeader.Description>Disallow comparing `undefined` using `typeof`. See [rule details](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/main/docs/rules/no-typeof-undefined.md).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.javascript.NoTypeofUndefined","displayName":"Disallow comparing `undefined` using `typeof`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
