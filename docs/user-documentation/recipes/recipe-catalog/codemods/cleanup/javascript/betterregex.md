...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.javascript.BetterRegex"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.javascript.BetterRegex"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/cleanup/javascript/betterregex.md"}
>

<RecipeHeader.Title>Improve regexes by making them shorter, consistent, and safer</RecipeHeader.Title>

<RecipeHeader.Description>Improve regexes by making them shorter, consistent, and safer. See [rule details](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/main/docs/rules/better-regex.md).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.javascript.BetterRegex","displayName":"Improve regexes by making them shorter, consistent, and safer","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
