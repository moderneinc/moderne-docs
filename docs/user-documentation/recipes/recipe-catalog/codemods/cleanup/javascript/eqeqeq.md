...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.javascript.Eqeqeq"}
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.javascript.Eqeqeq","displayName":"Require the use of `===` and `!==`","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
