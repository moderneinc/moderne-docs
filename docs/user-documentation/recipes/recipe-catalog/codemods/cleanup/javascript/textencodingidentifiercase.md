...
<RecipeMeta
  ...
  fqName={"org.openrewrite.codemods.cleanup.javascript.TextEncodingIdentifierCase"}
...
<RecipeHeader
  ...
  appLink={"https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.javascript.TextEncodingIdentifierCase"}
  markdownUrl={"https://raw.githubusercontent.com/moderneinc/moderne-docs/refs/heads/main/docs/user-documentation/recipes/recipe-catalog/codemods/cleanup/javascript/textencodingidentifiercase.md"}
>

<RecipeHeader.Title>Enforce consistent case for text encoding identifiers</RecipeHeader.Title>

<RecipeHeader.Description>Enforce consistent case for text encoding identifiers. See [rule details](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/main/docs/rules/text-encoding-identifier-case.md).</RecipeHeader.Description>
...
<UsageList usage={{"recipeName":"org.openrewrite.codemods.cleanup.javascript.TextEncodingIdentifierCase","displayName":"Enforce consistent case for text encoding identifiers","groupId":"org.openrewrite.recipe","artifactId":"rewrite-codemods","versionKey":"VERSION_ORG_OPENREWRITE_RECIPE_REWRITE_CODEMODS","requiresConfiguration":false}}>
